...
- [The Apple vs. OpenAI legal showdown](sources/tech-20260717-0717-mp-tech-pod-128-tech-20260717-0717-mp-tech-pod-128.md) — Marketplace Tech Bytes episode with Paresh Dave on Apple's trade-secret lawsuit against OpenAI, New York's hyperscale data-center moratorium, and Uber's hybrid robotaxi lobbying against driverless-car expansion in Washington, D.C.
...
- [146. 对Physical Intelligence柯丽一鸣4小时访谈：Pi的开源模型研究，机器人的江湖、族谱与主角](sources/146-dui-physical-intelligence-ke-li-yiming-4-xiaoshi-fangtan-pi-de-kaiyuan-moxing-yanjiu-jiqiren-de-jianghu-zupu-yu-zhujiao-ljmazvdvad7o5md-nuiompd6-1nv.md) — 张小珺Jùn｜商业访谈录 episode with K of Physical Intelligence on Pi 0/0.5/0.6*, robot experience data, reinforcement learning, VLA, evaluation, form factors, and embodied-AI company routes.
...
- [《光棍危机》](entities/GuanggunWeiji.md) — Book recommended for linking Asian male population surplus to security, stability, politics, and gender demography.
- [《居酒屋的诞生》](entities/JiujiuwuDeDansheng.md) — Japanese izakaya culture history used as an approachable everyday food-culture study.
...
- [Minoxidil / 米诺地尔](entities/Minoxidil.md) — Hair-growth ingredient discussed in the episode's sponsor section as acting through follicle-cycle dynamics.
- [Alan Turing / 图灵](entities/AlanTuring.md) — Mathematician used by episode 93 to explain morphogenesis and hair-follicle pattern formation.
- [Donald Gates](entities/DonaldGates.md) — Wrongful-conviction case used by episode 93 to warn against overclaiming visual hair evidence.
- [Kenneth Cole](entities/KennethCole.md) — Fashion founder and Advice Line guest linking durable brands to distinct voice, social purpose, emotional relevance, and repeat customer experience.
- [Pedestrian Project](entities/PedestrianProject.md) — Modern foot-wellness brand advised to pair conversion-first channel learning with a positive emotional foot-care story.
- [Matt Jacobs](entities/MattJacobs.md) — Pedestrian Project co-founder asking whether to take existing foot-care share or educate a broader proactive wellness category.
- [Israel Acabla](entities/IsraelAcabla.md) — Toronto-made women's fashion label facing the gap between wholesale traction and direct customer relationship.
- [Emma Fiquade](entities/EmmaFiquade.md) — Israel Acabla founder advised to sharpen the brand's emotional statement and bridge wholesale shoppers into DTC relationships.
- [Swing Sculpt](entities/SwingSculpt.md) — Custom sports-art business turning golf swings into metal sculptures and repositioning around emotional keepsakes.
- [Levi Case](entities/LeviCase.md) — Swing Sculpt founder asking how to reduce buyer friction for a novel custom sports sculpture.
- [Gentle Souls](entities/GentleSouls.md) — Comfort-footwear brand suggested by Kenneth Cole as a possible collaboration target for Pedestrian Project.
...
- [K (Physical Intelligence)](entities/KPhysicalIntelligence.md) — Physical Intelligence researcher whose long interview explains Pi research, robot reinforcement learning, experience data, evaluation, and form-factor pragmatism.
...
- [Physical Intelligence Pi Model Series](entities/PhysicalIntelligencePiSeries.md) — Pi 0/0.5/0.6*/0.7 robot-model sequence used to track capability, generalization, performance, and VLA/world-model convergence.
...
- [Ragweed Ecological Feedback](concepts/RagweedEcologicalFeedback.md) — Cautionary ecology frame where disturbance, bare ground, urban lots, and herbicide pressure can intensify ragweed allergy problems.
- [Allergy As Immune Response](concepts/AllergyAsImmuneResponse.md) — Medical frame that treats allergy as immune reaction rather than weakness, while keeping treatment claims bounded.
- [Allergy Source Control](concepts/AllergySourceControl.md) — Public-environment strategy for reducing allergen exposure through plant choice, land management, indoor filtration, and ecological tradeoff accounting.
...
- [Wholesale-To-Direct Customer Bridge](concepts/WholesaleToDirectCustomerBridge.md) — Tactics that turn wholesale discovery into owned customer relationship without undermining the retail partner.
...
- [Robotaxi Hybrid Deployment](concepts/RobotaxiHybridDeployment.md) — Rollout strategy combining human-driven rides and robotaxis while cities, platforms, and autonomous-vehicle operators manage safety evidence, edge cases, and supply concentration.
...
- [Hyperscale Data Center Moratorium](concepts/HyperscaleDataCenterMoratorium.md) — Temporary construction pause on very large data centers used to reassess power, water, land, tax breaks, utility bills, and local political consent.
...
- [AI Hardware Trade Secret Dispute](concepts/AIHardwareTradeSecretDispute.md) — Legal and operating risk that emerges when AI companies move into device design and recruit from incumbent hardware firms.
