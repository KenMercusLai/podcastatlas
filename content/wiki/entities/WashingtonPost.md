...
[[sp-05-liuqing-linyao-qiangsha-yibao-jutou-an-beihou-de-sikao-xia-fenlie-de-meiguo-hui-you-xianzheng-weiji-ma-790241978]] adds the Washington Post as a commentary reference in a dispute over campus speech-punishment data. [[LinYao|林垚]] uses the example to stress that claims about firings or lost positions depend on definitions, statistical scope, and whether the article is a reported news piece or opinion/commentary.

The Washington Post appears in [[tech-20260311-0311-mp-tech-pod-128-tech-20260311-0311-mp-tech-pod-128]] as [[WillaRemus]]'s reporting affiliation. The episode uses her reporting to examine [[ThePlainDealer|the Plain Dealer]] and the broader question of whether [[NewsroomAIAdoption]] helps local journalism survive or accelerates generic, cost-driven publishing.
...
- [[InstitutionalSpeechPunishment]] - campus-speech and data-boundary context added by sp.05.
- [[ThePlainDealer]] and [[ChrisQuinn]] - local-news AI case.
