...
type: entity
tags: [person, late-han, loyalty, party-prohibition, political-persecution]
sources:
...
Zhu Zhen's source role is not court argument but post-defeat obligation. He retrieves and buries Chen Fan's body when the political environment makes even honoring the dead dangerous. He also hides Chen Fan's son Chen Yi.

When the concealment is exposed, Zhu Zhen's whole family is jailed and tortured, but the family does not reveal Chen Yi's whereabouts. The episode uses this case to show that loyalty after a political purge can depend on funeral honor, household endurance, and silent protection rather than public memorials.

## Key Characteristics

- Zhu Zhen is defined by personal loyalty to Chen Fan after Chen Fan's political defeat and death.
...
- The source gives Zhu Zhen through the Chen Fan aftermath and does not yet establish his broader offices, dates, or lineage.
- The family's members are unnamed in the source note, so their collective silence is recorded without adding unsupported identities.
- Zhu Zhen's loyalty is clandestine and protective, not the same action-type as direct remonstrance or voluntary surrender.
...
- [[LoyaltyCollateralDilemma|忠义牵连困境]] - related dilemma because loyalty exposes a whole household to punishment.
- [[MoralDesertPoliticalOutcomeGap|善恶报应与政治结果错位]] - wider frame where loyal action does not receive protective institutional reward.
