...
Coinbase's wiki role is also regulatory. Bank-transfer support required conversations with [[SiliconValleyBank]], an [[AntiMoneyLaundering]] policy, legal opinions, and later broader licensing work. Armstrong presents this as [[RegulatedCryptoTrustStrategy]]: Coinbase could not deliver the feature users wanted unless banks, regulators, and customers could treat the company as legitimate.
...
- [[CustomerPull]], [[FastProductValidation]], [[RegulatedCryptoTrustStrategy]], [[EarlyFintechFraudControls]], and [[MissionFocusedCompany]] - main concepts attached to Coinbase.
- [[CryptocurrencyMarketStructure]], [[VirtualAssetAMLRisk]], [[AntiMoneyLaundering]], and [[BankingKYCCompliance]] - broader finance and compliance concepts.
