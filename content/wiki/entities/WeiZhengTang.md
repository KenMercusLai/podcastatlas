---
title: "魏征 / Wei Zheng (Tang)"
type: entity
knowledge_schema: synthesis-v1
tags: [person, tang, remonstrance, official]
sources:
  - zizhi-tongjian-hanji-467-guanchang-li-jiang-zhenhua-shuo-shihua-you-duo-nan-ls_zlyqolvpfttspah8wery4e3fs
...
The source does not build a full Wei Zheng biography. It uses him as a public-duty exemplar: an official should not keep dangerous words in the throat when crisis is visible. His later remembrance through Taizong's mirror metaphor gives the episode a ruler-side condition as well: direct remonstrance becomes durable when the ruler can receive it.

## Key Characteristics

- Tang official used as a model of direct remonstrance.
- Cited for treating unspoken warning as disloyal when danger is visible.
- Remembered through Emperor Taizong's mirror metaphor after his death.
- Functions as a contrast case to true but evasive speech.
...
- [[TrueButEvasiveRemonstrance|真实但避重就轻的进谏]] - contrast concept because Wei Zheng represents direct naming rather than safer truthful omission.
- [[ScholarOfficialPublicDuty|士大夫公共责任]] - duty frame for why warning speech cannot remain private when danger is visible.
- [[GongYuWesternHan|贡禹]] - contrasted official whose truthful thrift advice avoids the episode's central danger.
- [[EmperorTaizongOfTang|唐太宗]] - ruler-side condition for Wei Zheng's remembered direct-speech role.
