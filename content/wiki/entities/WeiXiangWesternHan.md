---
title: "魏相 / Wei Xiang (Western Han)"
type: entity
knowledge_schema: synthesis-v1
tags: [person, western-han, chancellor, remonstrance, frontier]
sources:
...
His practical case is equally important. Wei Xiang says Xiongnu has recently released Han captives and not raided the border for some time, while Han frontier people are poor and internal governance is strained by official incompetence, disasters, and criminal disorder. The episode therefore makes him a figure of restrained statecraft: military prestige must be tested against naming, proportionality, public burden, and internal capacity.

The profile also includes his governing method. Wei Xiang reads earlier histories, policy proposals, and memorials, pushes useful older measures back into discussion, and asks officials returning from commanderies about anomalies, rebellions, and disasters. When local officials fail to report serious events, he reports them directly to Xuan.
...
- Historically literate administrator who mines earlier policy records for usable governance.
- Upward-information gatherer who uses returning officials to detect local events hidden from the court.
...
- [[EmperorXuanOfHan]] - ruler Wei Xiang persuades away from a broad Xiongnu expedition.
- [[HuoXianWesternHan]] - Huo household actor whose exposure risk rises after Wei Xiang's memorial-channel reform.
- [[HuoFamilyPurgeAfterHuoGuang]] - later collapse field for the anti-Huo information-control repair.
- [[MilitaryJustificationTypology]] - concept grounded in Wei Xiang's fivefold classification of armies.
- [[CheshiKingdomWesternHan]] - frontier crisis field that triggers Wei Xiang's remonstrance.
- [[ZhengJiWesternHan]] - besieged Western Regions officer whose rescue request creates the court debate.
- [[Xiongnu]] - target of the proposed western strike Wei Xiang rejects.
- [[StrategicForbearanceGovernance]] - related restraint pattern because Wei Xiang chooses limited rescue over prestige-driven escalation.
- [[InternalCapacityBeforeWar]] - related principle that domestic burdens and official disorder should constrain external campaigns.
