...
tags: [person, late-han, official, remonstrance, succession]
sources:
...
Emperor An ignores the memorial. Zhang Hao therefore represents a failed but sharply framed warning: precedent, age-based responsibility, and father-son caution can all be overrun when the ruler has already converted the heir question into a political-security problem.

## Key Characteristics

- Former weiwei who joins the initial senior objection to deposing Liu Bao.
- Uses age and lack of knowledge to separate a child's responsibility from palace actors' alleged misconduct.
- Converts the case into a historical-precedent warning through Han Wudi, Jiang Chong, and the Li Crown Prince.
- Failed adviser whose accurate analogy does not overcome Emperor An's anger.
- Disambiguated from [[ZhangHaoTaiweiLateHan|张颢]], the later Ling-era taiwei and omen-promotion case.
...
- Created a disambiguated Zhang Hao page for the 124 CE Liu Bao deposition remonstrator.

## Relationships

- [[EmperorAnOfHan|汉安帝]] - ruler whose anger and succession decision Zhang Hao tries to redirect.
- [[EmperorShunOfHan|汉顺帝 / 刘保]] - ten-year-old crown prince defended by Zhang Hao's age and precedent arguments.
- [[LaiLiLateHan|来历]] - fellow objector whose later Hongdu Gate persistence extends the same position.
- [[HuanYanLateHan|桓焉]] - fellow first-round objector in the deposition debate.
- [[HanWudi|汉武帝]] - precedent ruler whose later regret becomes Zhang Hao's warning example.
- [[HeirSupportThreatPerception|储君拥戴威胁感]] - pattern explaining why Zhang Hao's legal and historical argument fails to move An.
- [[ZhangHaoTaiweiLateHan|张颢]] - distinct later namesake whose canonical route must not be merged into this page.
