...
tags: [event, late-han, jiangdong, danyang, assassination]
sources:
...
The event then becomes a revenge-and-stabilization case. Lady Xu delays Gui Lan through mourning propriety, stages willingness to remarry, hides Sun Gao and Fu Ying in her room, and coordinates a wider action that kills Gui Lan, Dai Yuan, and other conspirators. Sun Quan later arrives, destroys the remaining conspirator side, and rewards the loyalists.

## Key Characteristics
- Shows that Sun-family control in Jiangdong remains exposed to local elite backlash after succession.
- Begins through intimate access and cover-story management rather than open battle.
- Escalates when an investigator from the Sun side is also killed.
- Turns on Lady Xu's use of ritual, reputation, and enemy desire as tactical resources.
- Ends with Sun Quan's punitive cleanup and reward of loyal followers.
...
## What Changed
- Created an event node for the Sun Yi assassination and Lady Xu revenge sequence.

## Relationships
- [[DanyangCommandery|丹阳郡]] - place where the event occurs.
- [[SunYiLateHan|孙翊]] - first victim.
- [[SunHeLateHan|孙河]] - investigator also killed.
- [[LadyXuSunYi|徐夫人]] - revenge planner.
- [[GuiLanLateHan|妫览]] - local conspirator killed in the trap.
- [[DaiYuanLateHan|戴员]] - local conspirator killed by the wider loyalist group.
- [[BianHongLateHan|边鸿]] - intimate assassin.
- [[SunQuan|孙权]] - ruler who carries out post-event cleanup and rewards.
- [[FemaleRevengeAndPoliticalOrder|女性复仇与政治秩序]] - concept for the revenge as partial restoration of order.
