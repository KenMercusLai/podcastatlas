...
type: entity
tags: [place, city, military-base, late-han, yangzhou, jianghuai]
sources:
...
- Gains political meaning when Liu Fu locates the Yangzhou office there and makes the imperial appointment visible.
- Functions as an absorption platform for local armed groups and displaced people.
- Accumulates practical capacity through water works, agriculture, crafts, education, walls, and defensive stores.
- Becomes part of the later Cao-Sun Jiang-Huai frontier because administrative settlement precedes military durability.
...
## What Changed
- Created a disambiguated late-Han Hefei page so the Liu Fu/Yangzhou branch does not collapse into the modern city or marquis-title pages.
- Identified Hefei as a weak-base transformation case rather than only a place-name in Cao-Sun frontier history.

## Relationships
- [[LiuFuLateHan|Liu Fu]] - turns Hefei from weak city into provincial and frontier base.
- [[YangzhouLateHan|Yangzhou]] - uses Hefei as the western provincial office in the source's Cao-side branch.
- [[CaoCao|Cao Cao]] - benefits strategically from Hefei's later frontier value.
- [[JiujiangCommandery|Jiujiang Commandery]] - is the limited foothold near the Hefei project.
- [[LujiangCommandery|Lujiang Commandery]] - is the unstable neighboring commandery that makes Hefei's consolidation urgent.
- [[WeakPositionPacification|Weak-Position Pacification]] - describes the governing logic by which Hefei becomes controllable.
- [[RootBasePriority|Root-Base Priority]] - relates Hefei to the broader pattern of making a defensible base before expansion.
