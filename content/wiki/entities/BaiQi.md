...
白起 / Bai Qi enters the wiki through [[zizhi-tongjian-zhouji-67-zhanguo-mieba-baiqi-de-junshi-caineng-jiujing-ruhe-ljw0lltowxd4qz75v-wcnlkwqskv]] as the Qin commander whose first major appearance is [[YiqueBattle|伊阙之战]] in 293 BCE. The episode stresses that his rise is not explained only by personal bravery: [[QinState|秦国]]'s post-[[ShangYangReforms|商鞅变法]] order and [[MilitaryMeritRankSystem|军功爵制]] create an environment in which battlefield performance can turn a lower-status soldier or officer into a senior commander.

In the episode, [[WeiRan|魏冉]] recommends Bai Qi to [[QinZhaoxiangwang|秦昭襄王]] after the Han-Wei coalition attacks Qin. Bai Qi reads the allied army as fractured: [[HanState|韩国]] and [[WeiState|魏国]] are using each other and neither side wants to spend its own strength first. His answer is to avoid the strongest point, hit weaker elements, maneuver into the rear, and concentrate Qin force to defeat coalition units one by one.

The result is presented as a decisive and destructive Qin victory. The episode reports 240,000 Han-Wei soldiers killed, [[GongsunXiWarringStates|公孙喜]] captured, and Bai Qi promoted from 左庶长 to 国尉 and then 大良造. The source therefore makes Bai Qi the face of [[CoalitionFractureExploitation|联盟裂缝利用]] and of Qin's shift from pressure to annihilating campaigns.
...
[[zizhi-tongjian-zhouji-95-changping-zhi-zhan-hou-qinguo-weishenme-meiyou-mie-le-zhaoguo-1-lq4wvkd8qx3q7zji6fnnkxi3qcl1]] adds the other side of Bai Qi's post-Changping position. The episode says Bai Qi's killing of surrendered troops, Bai Qi platform / jingguan memory, and release of 240 young Zhao survivors are not only brutal aftermath but also [[PostBattleTerrorSignaling|战后恐怖震慑]] designed to break [[ZhaoState|赵国]]'s will before the next campaign.

The same source has Bai Qi favor rapid exploitation despite Qin's losses. He orders [[WangHe|王龁]] toward [[WuanWarringStates|武安]] and [[Pilao|皮牢]] and [[SimaGeng|司马梗]] toward [[TaiyuanWarringStates|太原]] and [[Shangdang|上党郡]], with [[Handan|邯郸]] looming as the next target. Bai Qi's path is then blocked not by battlefield defeat but by [[SuDai|苏代]]'s successful pressure on [[FanJu|范雎]], who fears that Bai Qi's merit from destroying Zhao would grow beyond him.

[[zizhi-tongjian-zhouji-95-changping-zhi-zhan-hou-qinguo-weishenme-meiyou-mie-le-zhaoguo-2-lutsvwvnwzsezoorhe-vu7yjthyx]] extends Bai Qi through reputation rather than new command action. In [[WeiState|魏国]], [[KongBin|孔斌]] invokes Bai Qi's command and Qin's post-[[ShangYangReforms|商鞅变法]] war machine to warn that Qin's pressure on Zhao should not be mistaken for Wei's opportunity.
...
- [[HanState|韩国]], [[WeiState|魏国]], and [[GongsunXiWarringStates|公孙喜]] - opposing coalition and captured commander.
...
- [[PostBattleTerrorSignaling|战后恐怖震慑]], [[SimaGeng|司马梗]], [[WuanWarringStates|武安]], [[Pilao|皮牢]], [[TaiyuanWarringStates|太原]], [[SuDai|苏代]], and [[StatusAnxietyPersuasion|位阶焦虑式说服]] - Zhouji 95 terror, follow-on routes, and the court-political stop.
