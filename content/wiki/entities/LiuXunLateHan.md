...
type: entity
tags: [person, late-han, official, jiangdong, lujiang]
sources:
...
- Holds a base strong enough that Sun Ce initially avoids direct frontal assault.
- Serves as a refuge for Yuan Shu remnants after Yuan Shu's death.
- Accepts armed and dependent groups whose food and discipline costs strain his position.
- Misreads Sun Ce's gift-and-deference performance as opportunity rather than bait.
- Rejects Liu Ye's accurate warning about Shangliao difficulty and rear-base exposure.
...
- [[SunCe|孙策]] - rival who turns Liu Xun's strong base into an exposed rear target.
- [[LiuYeLateHan|刘晔 / 刘业]] - adviser whose followers-transfer and later warning both shape Liu Xun's branch.
- [[ZhengBaoLateHan|郑宝]] - dead armed leader whose followers are transferred to Liu Xun.
- [[YuanYinLateHan|袁胤]] - Yuan-family remnant carrier whose arrival adds to Liu Xun's food burden.
- [[LujiangCommandery|庐江郡]] - commandery Liu Xun receives and then loses.
- [[WanChengLujiang|皖城]] - base captured after Liu Xun leaves for Shangliao.
- [[HuangZu|黄祖]] - outside aid channel that fails to reverse Liu Xun's defeat.
- [[ArmedFollowerIntegrationCost|武装部众整合成本]] - cost pattern explaining the burden of absorbed followers.
- [[LureEnemyOutOfPosition|诱敌离位]] - campaign pattern that explains Liu Xun's displacement.
