...
The "装逼" panel adds a social-theory side to this interviewer role. Luo frames [[XiaoQiStandup|小齐]], [[ZhangJunStandup|张俊]], and [[ShiLifen|史礼芬]] as contrasting cases and keeps converting jokes about education, accent, vocabulary, hotels, books, taste, and social media into claims about [[ZhuangbiAsSocialSignaling|status signaling]].
...
- Added the emotional-stability panel as evidence for Luo's public-conflict layer around composure, argument energy, blocking, Smartisan failure judgment, and expression against trolls.
...
- [[XiaoQiStandup|小齐]], [[ZhangJunStandup|张俊]], and [[ShiLifen|史礼芬]] - panelists whose status-display contrast Luo frames.
