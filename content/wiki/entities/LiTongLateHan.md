...
type: entity
tags: [person, late-han, three-kingdoms, military, law, china]
sources:
...
## Key Characteristics
- Serves as the household-pressure side of Zhao Yan's legal case while refusing to use Cao-side access to rescue a wife-side relative.
- Converts a potential kinship exemption into public support for the magistrate's enforcement.
- Faces direct recruitment by Yuan Shao and Liu Pi in the Runan branch rather than only household pressure.
- Rejects Yuan Shao's commission by killing the envoy and sending the seal and ribbon to Cao Cao.
- Treats Cao Cao's future victory over Yuan Shao as a matter of political quality, not visible force alone.
- Worries that delayed taxation could be read as disloyal fence-sitting, showing the signaling pressure on local commanders.
...
- [[CaoCao|曹操]] - leader whose camp duty Li Tong refuses to compromise for private kinship.
- [[YuanShao|袁绍]] - rival warlord whose commission Li Tong rejects.
- [[LiuPiRunanLateHan|刘辟]] - Runan rebel pressure linked to the recruitment attempt.
- [[RunanCommanderyLateHan|汝南郡]] - local allegiance theater around Li Tong's refusal.
- [[YangAnLateHan|阳安]] - locality Li Tong must keep stable while trying to show loyalty through fiscal remittance.
- [[XunYu|荀彧]] - adviser channel through which Zhao Yan's warning reaches Cao Cao.
- [[RuleOverKinshipPower|法度压过亲缘特权]] - concept illustrated by Li Tong's refusal to plead kinship into exemption.
- [[TaxationStabilityTradeoff|税赋与地方稳定权衡]] - concept illustrated by Li Tong's cotton-silk dilemma.
