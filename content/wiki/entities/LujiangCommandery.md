...
- Becomes a reward-credit test after Yuan Shu promises it to Sun Ce for defeating Lu Kang.
- Deepens Sun Ce's distrust when Yuan Shu appoints Liu Xun instead.
- Functions later as a strong base whose direct assault is unattractive.
...
## Relationships
- [[LuKangLateHan|陆康]] - administrator whose grain refusal starts the first Lujiang campaign.
- [[YuanShu|袁术]] - promise maker whose appointment reversal damages subordinate trust.
- [[SunCe|孙策]] - commander first denied Lujiang and later able to seize it indirectly.
- [[LiuXunLateHan|刘勋]] - Yuan Shu appointee who holds and then loses the commandery.
- [[WanChengLujiang|皖城]] - city whose fall converts Lujiang into Sun Ce's prize.
- [[PromiseCredibilityTalentRetention|承诺信用与人才流失]] - concept anchored by the broken Lujiang promise.
- [[RootBasePriority|根本根据地优先]] - concept explaining why leaving Lujiang exposed is fatal.
