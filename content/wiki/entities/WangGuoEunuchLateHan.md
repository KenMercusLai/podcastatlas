...
tags: [person, late-han, eunuch, court-politics, restoration-merit, disambiguation]
sources:
...
- Shun-restoration eunuch, not the later Liangzhou rebel of the same rendered name.
- High-ranking member of the nineteen-eunuch reward bloc.
- Relational counterweight in the host's analysis of Sun Cheng's internal eunuch management.
...
- Created a disambiguated page for the Shun-restoration eunuch Wang Guo and kept him separate from [[WangGuoLateHan|the Liangzhou rebel Wang Guo]].

## Relationships

- [[SunChengLateHan|孙程]] - senior merit-holder whose internal management includes balancing Wang Guo and Wang Kang.
- [[WangKangLateHan|王康]] - reward peer and balancing counterpart in the eunuch merit group.
- [[EmperorShunOfHan|汉顺帝]] - restored ruler whose accession creates Wang Guo's reward status.
- [[CoupCreditAllocationRisk|宫变功劳分配风险]] - concept linked to the reward-ranking field in which Wang Guo appears.
- [[WangGuoLateHan|王国 / Wang Guo (late Han rebel)]] - same rendered name but different late-Han actor, requiring disambiguation.
