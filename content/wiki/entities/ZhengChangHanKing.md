...
type: entity
tags: [person, chu-han, han-state, xiang-yu]
...
The page is source-scoped around this narrow role: Zheng Chang shows Xiang Yu using personal trust to patch a title problem, while Liu Bang uses surrender and old Han legitimacy to reverse that patch.

## Connections
- [[XiangYu|项羽]] and [[XiangLiang|项梁]] - political patron and early Xiang base.
- [[HanCheng|韩成]] - killed predecessor in the Han kingship branch.
- [[HanWangXin|韩王信]] and [[LiuBang|刘邦]] - replacement arrangement after Zheng Chang surrenders.
- [[HanState|韩国]], [[CoalitionSettlementFailure|联军战后安排失败]], and [[RewardAllocationBacklash|分配反噬]] - old-state title and settlement failure frame.
