...
- The company is described as pursuing a mass-production flywheel from around 2018: ship assisted-driving products, collect data, generate revenue, and eventually move toward Robotaxi.
- Gao says he worked across perception, localization, parking, infrastructure, planning/control, and NOA mass production, becoming a "catfish" who entered unfamiliar modules and forced progress.
- The deepest lesson he says he took from Momenta is customer-centered work: understanding the customer's real problem and proposing a better solution, not simply obeying requests.
- Cao says [[Momenta]] and [[Huawei]] are the top third-party city-NOA suppliers in China in his account, and he expects the third-party supplier field to consolidate around a small number of players.
- The IPO-era source presents listing as a trust and brand event more than a financing event, with "safety and reassurance" as the desired consumer association.
...
- [[Waymo]] — contrast case for engineering strength versus product and customer pressure.
- [[Xinghaitu]] — robotics company whose culture inherits the customer-value orientation.
- [[Huawei]] and [[Tesla]] — advanced-driving competition and benchmark context.
