...
- Western Han remonstrant using secret memorial form.
- Defends limits on the anti-Wang-family purge through succession obligation rather than simple factional loyalty.
- Makes Wang Zhengjun's age, bereavement, and public sympathy politically relevant.
- Uses Chengdi's tomb and Aidi's inherited duty as shame pressure.
- Contributes to Aidi's partial compensation to the Wang family.
...
- [[HanAidi|汉哀帝]] - ruler Yang Xuan remonstrates with.
- [[WangZhengjun|王政君]] - senior dowager whose treatment Yang Xuan makes central.
- [[HanChengdi|汉成帝]] - prior emperor whose succession choice becomes Yang Xuan's pressure point.
- [[WangMang|王莽]] - Wang-family figure indirectly protected by the same court recalibration.
- [[AdviceFramingUnderHierarchy|等级场景中的进言包装]] - related because Yang Xuan uses private, shame-based framing rather than open attack.
- [[OuterRelativeCourtPower|外戚专权与清算]] - broader factional field in which the memorial restrains a purge.
