...
tags: [person, late-han, court-politics, title-succession, palace-favor]
sources:
...
Liu Gui matters because his case shows private household access working across marriage, office, and title. Wang Sheng's status as An's wet nurse, Bo Rong's favored position, and Liu Gui's new office/title path combine into a compact example of [[PrivateFavorAppointmentErosion|私恩任官侵蚀]].

## Key Characteristics

- Shaoyang marquisate beneficiary whose title path is challenged as procedurally improper.
- Cousin-line successor presented against the nearer claim of Liu Hu's younger brother Liu Wei.
- Bo Rong's husband, making marriage into Wang Sheng's favored household politically consequential.
- Shizhong whose office and title rise are tied to palace proximity rather than demonstrated public merit.
- Source-bounded figure whose importance is institutional rather than biographical.
...
- Created Liu Gui as the title-succession actor in the 120-121 CE An-era favorite-household layer.
- Added a disambiguated late-Han route so this figure remains separate from unrelated modern Liu Kai/Liu Gui-style names.

## Relationships

- [[BoRongLateHan|伯荣]] - wife whose favored position links Liu Gui to Wang Sheng's palace household.
- [[WangShengPalaceActorLateHan|王圣]] - wet nurse whose household forms the access field behind Liu Gui's title path.
- [[YangZhenLateHan|杨震]] - remonstrant who challenges Liu Gui's succession as a violation of title order.
- [[EmperorAnOfHan|汉安帝]] - ruler under whom Liu Gui's office and marquisate path become possible.
- [[PrivateFavorAppointmentErosion|私恩任官侵蚀]] - institutional pattern illustrated by Liu Gui's marriage-linked office and title rise.
