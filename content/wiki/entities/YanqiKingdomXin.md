...
tags: [place, polity, western-regions, xin-dynasty, frontier]
sources:
...
- Western Regions polity in the Xin-period source.
- Uses false submission and ambush against Wang Jun's expedition.
- Benefits from defections among other Western Regions troops in the source narrative.
- Suffers retaliatory killing of old and weak civilians by Guo Qing.
- Kept distinct from later Eastern Han Yanqi pages until a full cross-period synthesis is warranted.
...
The source transcript uses 燕齐, while this page uses the normalized Yanqi / 焉耆 identity based on the Western Regions context. Exact geography, ruler names, troop numbers, and whether every named neighboring polity maps cleanly to later received names remain source-scoped.
...
- [[WangJunXinGeneral|王骏]] - Xin commander killed after entering Yanqi territory.
- [[GuoQingXinGeneral|郭清]] - Xin officer who retaliates against Yanqi civilians.
- [[LiChongXinProtector|李崇]] - Western Regions protector left with remnants after the ambush branch.
- [[WesternRegionsProtectorate|西域都护府]] - institutional frame around Xin and Han authority in the region.
- [[YanqiKingdomLateHan|焉耆国 / Yanqi Kingdom (late Han)]] - later-period page for the same normalized polity in Eastern Han evidence.
