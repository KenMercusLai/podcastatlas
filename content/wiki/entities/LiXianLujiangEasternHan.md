...
tags: [person, eastern-han, rebel, lujiang, military]
sources:
...
- Lujiang-area rebel target in Jianwu 4.
- Same-pinyin figure disambiguated from other Li Xian pages.
- Opponent of Liu Xiu's Shouchun-stage campaign planning.
- Target of Ma Cheng and multi-commandery troop mobilization.
- Besieged at Shu County in the source's September notice.
...
This is a source-bounded identity page. It does not settle Li Xian's title, full territorial base, earlier career, or outcome after the Shu County siege. The route is semantically suffixed to avoid collision with [[LiXianLateHan|李暹]], [[LiXianTaiweiLateHan|李贤]], and other same-pinyin names.

## What Changed

- Created a disambiguated Lujiang/Eastern Han page for 李宪 / Li Xian.

## Relationships

- [[LiuXiu|光武帝刘秀]] - opposing ruler who orders the campaign against Li Xian.
- [[MaChengEasternHan|马成]] - commander assigned to attack and besiege Li Xian.
- [[DongXianEasternHan|董宪]] - parallel Jianwu 4 rebel target in the same source.
- [[CoreBeforePeripheryStrategy|先内后外式战略顺序]] - related because the source shows Liu Xiu sequencing multiple unsettled domestic fronts.
- [[XingshiqingStrategicAssessment|行势情战略评估]] - related because the Li Xian branch depends on force concentration and regional troop mobilization.
