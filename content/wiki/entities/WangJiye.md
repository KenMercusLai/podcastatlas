...
## Overview
王季叶 / Wang Jiye appears as a panel participant in [[LuoyonghaosCrossroads|罗永浩的十字路口]] and [[SixiaoComedy|四孝喜剧]] live episodes on borrowing, money, debt pressure, snobbery, workplace status, and romantic consumption. The newer source spells the name as 王继业; the current route preserves the existing canonical key while treating the spelling variation as source-scoped.

## Current Profile
Wang Jiye's source role is to make borrowing risk concrete through operational mistakes and peer credit. He describes a dormitory campus-loan chain, a mistaken 3-million-yuan payout during [[Zhihu]] operations work, a smaller bank-transfer error, and the social difficulty of asking people to repay directly.
...
- Platform-payment error: [[luoyonghao-de-x-zilukou-bu-jieqian-gei-pengyou-jiu-hui-shiqu-pengyou-shiqu-qian-ls3bbpqjtmtij4qdd5b0al07gm-f]] says he accidentally sent 3 million yuan instead of points during Zhihu operations work before the transfer was reversed.
...
- [[Zhihu]] - platform context for his mistaken payout story.
- [[ConsumerLoanRisk]] - concept extended by his dormitory campus-loan chain.
