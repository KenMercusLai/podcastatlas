---
title: "周建 / Zhou Jian (Eastern Han)"
type: entity
...
After the first defeat, Zhou Jian returns with Su Mao to challenge Wang Ba. Wang Ba stays fortified, reads the enemy's poor provisions, and does not give battle. During the withdrawal, Zhou Jian's nephew Zhou Song closes Chuihui's gate, and Zhou Jian dies on retreat.

## Key Characteristics
- Su Mao-aligned battle participant at Chuihui.
- Opponent whose long pressure on Ma Wu contributes to the exhaustion window Wang Ba uses.
- Figure whose defeat becomes final when internal gate closure blocks retreat.
...
## Relationships
- [[SuMaoEasternHan|苏茂]] - ally who comes to rescue Zhou Jian and fights beside him.
- [[WangBaEasternHan|王霸]] - opposing commander whose delayed strike and fortified refusal defeat Zhou Jian's side.
- [[MaWuEasternHan|马武]] - Han commander Zhou Jian helps defeat before Wang Ba's counterattack.
- [[FortifiedAttritionPatience|坚壁耗敌式耐心]] - concept illustrated by Zhou Jian's side being worn down before Wang Ba acts.
- [[BattlefieldInformationControl|战场信息控制]] - related mechanism because Wang Ba's closed-camp posture shapes Zhou Jian's side's attack choices.
