...
tags: [person, eastern-han, minister, frontier, fiscal-policy, logistics]
sources:
...
Zheng Hong first appears in the current bounded sequence as a logistics and fiscal official. He shifts Jiaozhi tribute away from the dangerous Dongye sea route toward mountain roads through Lingling and Guiyang, saving cost and reducing danger, then as Da Sinong advises [[EmperorZhangOfHan|Zhangdi]] to reduce tribute demands during crisis so households are not crushed by transport and corvee burdens.

The later sources move him into court and frontier politics. He becomes Taiwei after Diwu Lun, warns that diplomatic rupture and restitution should be handled carefully, supports restoring Xiongnu hostages, and joins the early pattern of opposition to Dou Xian. Across these layers he appears as a minister who translates public burden into policy constraint.

## Key Characteristics

- Logistics reformer: Zheng Hong treats route selection as a way to reduce death, waste, and public burden.
- Fiscal restraint adviser: his tribute-relief proposal argues that state demand should adjust to drought, border alarm, and food shortage.
- Frontier-stability minister: later sources show him favoring restitution and careful handling of Xiongnu relations.
- Anti-overreach court voice: he is part of the pattern of ministers who warn against decisions that expose the court to avoidable instability.
- Burden-centered administrator: his southern and frontier roles both test policy by concrete costs to households and the state.
...
- [[EmperorZhangOfHan]] - receives Zheng Hong's southern route and tribute-relief advice.
- [[TransportRouteBurdenRelief]] - captures Zheng Hong's Jiaozhi route redesign and tribute-exemption logic.
- [[JiaozhiCommandery]] - southern region whose tribute route makes Zheng Hong's logistics reform visible.
- [[LocalGovernanceAsCare]] - shares Zheng Hong's test of policy by concrete burden and risk to people.
- [[DouXianEasternHan]] - Zheng Hong belongs to the broader cautionary environment around Dou-clan overreach in later sources.
