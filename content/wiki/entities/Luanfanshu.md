...
乱翻书 is the podcast/show context for [[263-sora-si-le-adobe-die-le-meitu-he-qu-he-cong-lgjmyveooc8wpzr0yviggvzvdyfs]], where [[ZhuangMinghao]] and [[WeiXi]] discuss [[Sora]], [[Adobe]], and [[Meitu]] as cases in the debate over whether models will swallow applications.

The episode places the show inside the wiki's AI product and application-layer branch. Its contribution is less about a single model release and more about how tool companies can defend value through [[AIApplicationLayerMoat]], [[VerticalWorkflowAI]], [[ModelContainerStrategy]], and [[ToAgentDistribution]].
...
[[270-da-chang-yazhu-ai-bangong-feishu-he-dingding-que-xian-chengle-peijue-lmb4dgcgov3mr4cn7cikbghpfro4]] adds Luanfanshu's AI-office and enterprise-software mode. The episode uses Feishu's organization adjustment to connect [[Feishu]], [[DingTalk]], [[Doubao]], [[Qwen]], [[TencentWorkBody]], C-end monetization pressure, enterprise data, and coding-like office agents into one [[AIOfficeAgent|AI office agent]] frame.
...
- [[Meitu]], [[Sora]], and [[Adobe]] — main cases discussed.
