...
tags: [person, western-han, rebellion, wang-mang]
sources:
...
Zhang Shao's profile is tied to the same fragile resistance judgment as Liu Chong. He shares the belief that Wang Mang's actions will threaten the Liu house and that wider opposition exists but lacks a first mover.

The source gives him no independent command success. His importance is that a local chancellor joins a Liu royal's symbolic challenge, making the Wan episode a small but visible anti-Wang Mang action before later, larger uprisings.

## Key Characteristics

- Fengguo chancellor associated with Liu Chong's anti-Wang Mang planning.
- Shares the judgment that Wang Mang will harm the Liu royal house.
- Treats Liu-led action as a possible trigger for wider opposition.
- Participates in the failed Wan attack.
- Remains source-scoped with no independent later career in this note.
...
- [[LiuChongAnzhongMarquis|安众侯刘崇]] - Liu royal co-planner whose banner gives the action dynastic meaning.
- [[WangMang|王莽]] - regent targeted by the failed Wan action.
- [[ZhangSongXinPetitioner|张竦]] - cousin whose later petition marks the family survival branch after defeat.
- [[FirstAntiWangMangRising|刘氏反莽第一枪]] - concept relationship because Zhang Shao helps turn the idea into action.
