...
tags: [person, eastern-han, recluse, scholar-officials, guangwu]
sources:
...
Zhou Dang therefore functions less as a policy adviser than as a ruler-side legitimacy test. His value in the wiki is that Liu Xiu treats refusal as something a confident ruler can tolerate when no active betrayal is shown.

## Key Characteristics
- Summoned recluse whose court appearance does not turn into ordinary service.
- Protocol-resisting figure whose refusal creates a public-status problem for Liu Xiu's court.
- Target of Fan Sheng's critique that reclusive reputation can mask empty fame or avoidance of duty.
- Test case for Liu Xiu's noncoercive handling of office refusal.
...
## Relationships
- [[LiuXiu|光武帝刘秀]] - ruler who summons Zhou Dang, receives his nonconformity, and lets him return.
- [[YanGuangEasternHan|严光]] - paired early Guangwu recluse whose refusal is also tolerated.
- [[WangLiangEasternHan|王梁]] - adjacent office-refusal case grouped in Fan Sheng's criticism.
- [[PrincipledOfficeRefusal|原则性拒仕]] - concept extended by Zhou Dang's refusal under a noncoercive court.
- [[ReclusionAuthenticityAssessment|真隐士与伪隐士辨别]] - evaluative frame because Zhou Dang's reputation is publicly challenged but not coercively judged.
- [[MoralReputationPoliticalCapital|道德名望政治资本]] - related because Zhou Dang's public meaning rests on moral reputation outside office.
