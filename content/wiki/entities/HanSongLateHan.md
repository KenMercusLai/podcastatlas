...
# 韩嵩 / Han Song (late Han)

## Overview
韩嵩 / Han Song (late Han) is the Jingzhou-linked official whose mission to [[Xudu|许都]] turns into a test of whether duty to [[LiuBiao|刘表]] can remain private once the recognized Han court under [[CaoCao|曹操]] grants office.
...
- States before departure that the mission is legitimate only if Liu Biao has already decided to submit to the court-Cao side.
- Frames his choice through "圣达节，次守节": he cannot flex above norms like a sage, so he keeps fixed duty.
- Accepts court appointment as attendant-in-ordinary and Lingling administrator after the Xudu mission.
- Publicly pressures Liu Biao toward court alignment by praising Cao Cao and urging a son-at-court signal.
- Survives the execution threat but is imprisoned after Liu Biao finds no proof of concrete betrayal.
...
- [[CaoCao|曹操]] - court-controlling power whose side benefits from Han Song's Xudu mission and later praise.
- [[Xudu|许都]] - court center where Han Song receives appointments.
- [[EmperorXianOfHan|汉献帝]] - sovereign whose title order gives Han Song's court loyalty its public language.
- [[LiuXianLateHan|刘先]] - fellow Jingzhou adviser who urges Liu Biao to choose a side before the Yuan-Cao contest hardens.
- [[CourtLegitimacyOverPatronLoyalty|朝廷名义高于主君私属]] - concept describing Han Song's loyalty-priority conflict.
- [[FenceSittingStrategicExposure|骑墙式战略暴露]] - Liu Biao's strategic posture that makes Han Song's mission unstable.
- [[SuspicionDrivenEliteAlienation|猜疑驱动的士族离心]] - Liu Biao-side consequence exposed by Han Song's warning and return.
