...
type: entity
tags: [event, late-han, three-kingdoms, xuzhou, atrocity, civilian-suffering]
...
The event is a key late-Han case for [[PersonalRevengeThroughStatePower|以国力行私仇]] and [[PeopleBasedPoliticalSecurity|民心型政治安全]]. A real family loss becomes politically and morally catastrophic when a regional commander answers it with campaign capacity, while later Xuzhou strategy pages note that harsh earlier warfare damaged the local people-support environment.

## Connections
- [[CaoCao|曹操]] - commander whose retaliation drives the massacre branch.
- [[CaoSongMurder|曹嵩遇害]] - trigger event.
- [[TaoQianLateHan|陶谦]] and [[Xuzhou|徐州]] - political target and regional setting.
- [[SiRiver|泗水]] - river massacre geography in the source.
- [[HouHanshu|《后汉书》]] - source tradition cited for the atrocity wording.
- [[PersonalRevengeThroughStatePower|以国力行私仇]], [[PeopleBasedPoliticalSecurity|民心型政治安全]], and [[AtrocityBackfireMobilization|暴行反噬式动员]] - interpretive frames.
