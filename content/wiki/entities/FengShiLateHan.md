...
tags: [person, late-han, military, palace-coup, succession]
sources:
...
- Yueqi xiaowei whose military commitment is sought by the losing Yan side.
- Tactical noncommitter who appears to accept orders but exits the palace before acting.
- Actor whose killing of Fan Deng blocks one Yan communication and mobilization route.
- Example of how a coup can be decided by refusal to join as much as by active support.
- Later cleanup target, indicating that nonalignment during the coup does not erase political suspicion.
...
- Created Feng Shi as the noncommitting military actor whose refusal helps collapse the Yan counterattack.

## Relationships

- [[YanXianLateHan|阎显]] - Yan-family powerholder whose counterattack depends on Feng Shi's troops.
- [[EmpressDowagerYanLateHan|阎太后]] - dowager whose authority is used to summon Feng Shi.
- [[EmperorShunOfHan|汉顺帝]] - restored ruler whom Feng Shi does not move to capture.
- [[LiRunLateHan|李润]] - target of the Yan bounty alongside Liu Bao.
- [[YuXuEasternHan|虞诩]] - later official who impeaches Feng Shi in the restoration cleanup.
- [[PalaceCoupSymbolControl|宫廷政变中的符印与门户控制]] - operational context where gates, troop access, and messenger control shape the outcome.
- [[NonalignedCourtSurvival|不依附式朝廷生存]] - adjacent pattern because Feng Shi survives the immediate crisis by avoiding full commitment.
