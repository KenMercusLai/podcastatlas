...
tags: [person, eastern-han, military, frontier, xiongnu, border-defense]
sources:
...
- Eastern Han Yangwu general placed into frontier command after Du Mao's removal.
- Acting Da Sikong in Liu Xiu's 37 CE post-unification personnel order.
- Border-defense organizer associated with beacon stations at regular intervals.
- Military-administrative actor in the same 39 CE frontier branch as Lu Fang's Gaoliu return and Zhang Kan's later Yuyang tenure.
- Evidence point for the court correcting frontier personnel and infrastructure after command failure.
...
- [[LiuXiu|光武帝刘秀]] - ruler whose post-unification office order and frontier personnel system place Ma Cheng in command roles.
- [[DuMaoEasternHan|杜茂]] - predecessor removed in the same command-correction sequence.
- [[ZhangKanEasternHan|张堪]] - parallel frontier actor whose Gaoliu victory follows the same personnel disruption.
- [[LuFangEasternHan|卢芳]] - Xiongnu-linked claimant whose Gaoliu return forms part of the same frontier setting.
- [[Xiongnu|匈奴]] - frontier opponent around whom Ma Cheng's beacon defense is organized.
- [[FrontierCommanderyRestoration|边郡恢复]] - related concept because warning infrastructure supports restored frontier settlement.
