...
- [[ZhangXiu|张绣]] - kin-linked surrendering commander whose resentment escalates.
- [[ZhangJiLateHan|张济]] - deceased husband whose death leaves Lady Zou as the widowed aunt in Zhang Xiu's household network.
- [[WanCounty|宛城]] - setting of the episode's disaster.
- [[HuCheEr|胡车儿]], [[JiaXu|贾诩]], and [[DianWei|典韦]] - military branch opened after the insult and threat perception.
- [[DesireDrivenCommandExposure|私欲驱动的统帅暴露]] and [[StatusInsultDefectionCascade|名分羞辱触发叛变]] - concepts that explain her structural role in the source.
