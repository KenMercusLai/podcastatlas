...
[[the-ice-hiring-boom]] adds DHS as the administration-facing institution behind disputed claims about ICE hiring, training, and deployment. [[TriciaMcLaughlin]] speaks for DHS in the episode, saying officers receive the same number of training hours, while the source also reports NPR numbers and documents released by [[RichardBlumenthal]]'s office that indicate shorter or reduced training.

The episode extends DHS from the wiki's data-access branch into an enforcement-capacity branch: [[USImmigrationAndCustomsEnforcement|ICE]], [[USBorderPatrol]], and [[USCustomsAndBorderProtection|CBP]] are tied to [[FederalLawEnforcementTrainingCenters]], [[FederalLawEnforcementTraining]], and [[LawEnforcementCultureAccountability]].

The U.S. Department of Homeland Security is the government agency at the center of [[tech-20260302-0302-mp-tech-pod-128-tech-20260302-0302-mp-tech-pod-128]], which discusses lawsuits and concerns over how DHS collects or accesses private-sector data. [[JeremyScott]] says DHS can obtain data through [[AdministrativeSubpoenaDataAccess]], purchases from brokers, and [[SurveillanceAsAService]] tools.
