...
- Protector of the Qiang whose divide-and-watch plan fails when target groups detect the manipulation.
- Frontier commander whose requested force scale exceeds what he actually waits to control.
- Premature attacker whose pursuit outruns caution and assembly conditions.
- Negative example for overextended expedition at a local frontier scale.
- Distinct from modern [[FuYu|傅宇]], whose page belongs to a podcast-host context.
...
- Created Fu Yu as the Eastern Han Qiang protector whose failed manipulation and premature pursuit create an overextension case.

## Relationships

- [[ShaodangQiang|烧当羌]] - frontier group context for Fu Yu's attempted suppression.
- [[MiWuQiangLeader|迷雾 / Mi Wu]] - Qiang leader who defeats and kills Fu Yu.
- [[ZhangYuEasternHan|张于 / Zhang Yu]] - successor appointed after Fu Yu's death.
- [[OverextendedFrontierExpedition|边境远征过度]] - strategic pattern illustrated by Fu Yu's attack before force assembly.
- [[CoalitionFractureExploitation|联盟裂缝利用]] - contrast because Fu Yu attempts fracture but instead causes enemy coordination.
- [[EmperorZhangOfHan|汉章帝]] - ruler who reacts to Fu Yu's death by appointing Zhang Yu.
