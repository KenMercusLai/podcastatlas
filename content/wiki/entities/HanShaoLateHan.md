...
type: entity
tags: [person, late-han, local-governance, yingchuan, famine-relief]
sources:
...
Han Shao's current profile is source-bounded but strong. The Shangshu office selects him because the rebellion has damaged Qing, Yan, and Xu areas for years, and ordinary military suppression has not restored order. Once he arrives at Ying county, bandits warn one another not to enter, suggesting that his personal reputation becomes part of local security before any detailed enforcement scene is reported.
...
- Crisis county magistrate appointed to Ying county when regional rebellion had overwhelmed ordinary response.
- Reputation-based security figure whose arrival makes thieves avoid his jurisdiction.
- Risk-bearing relief official who opens public granaries for displaced hungry households despite procedural objection.
- Moral actor who explicitly accepts personal punishment if the choice saves people.
- Member of the Yingchuan Four Magistrates reputation field for county-level virtuous governance.
- Example of appointment fit because his character and authority match a local refugee-and-security crisis.
...
The current page rests on one source note and does not yet provide Han Shao's full biography, exact office chronology, or post-relief accounting. The granary decision is treated as emergency relief under war and refugee pressure, not as a general license for arbitrary use of public stores.

## What Changed

- Created Han Shao as the canonical page for the 156 CE Ying county magistrate and granary-relief case.
- Established him as the primary person case for risk-bearing relief governance and the Yingchuan Four Magistrates cohort.

## Relationships

- [[RiskBearingReliefGovernance|担责开仓式救民]] - Han Shao is the current primary case for this relief pattern.
- [[HumaneLocalGovernance|仁厚地方治理]] - Han Shao extends humane governance into emergency granary release.
- [[YingchuanFourMagistrates|颍川四长]] - Han Shao is one of the four county-magistrate exemplars.
- [[ZhongHaoYingchuanLateHan|钟皓]] - peer in the same Yingchuan Four Magistrates cohort.
- [[XunShuLateHan|荀淑]] - peer in the same Yingchuan Four Magistrates cohort.
- [[ChenShiLateHan|陈寔]] - peer in the same Yingchuan Four Magistrates cohort.
- [[YingchuanCommandery|颍川郡]] - origin and reputation field attached to the four magistrates.
- [[PeopleBasedPoliticalSecurity|民心型政治安全]] - Han Shao's reputation and relief make people treat his county as a safe destination.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - Han Shao shows state capacity through matching an official to a local crisis.
