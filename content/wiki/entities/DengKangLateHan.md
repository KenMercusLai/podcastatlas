...
tags: [person, late-han, outer-relative-power, court-politics, remonstrance]
sources:
...
The break fails politically. Empress Dowager Deng rejects the memorials and becomes angry. Deng Kang then feigns illness and stops attending court, but the dowager sends an inner-palace attendant to check on him. Because that attendant had once been a servant in Deng Kang's household and now comes under palace authority, the visit becomes a status trap: Deng Kang curses her as a former household slave after she calls herself "daren."

The attendant reports both his feigned illness and disrespect. Deng then removes Deng Kang from office, sends him back to his fief, and cancels his household registration/status connection. The host reads this as a possible blessing in disguise because being pushed out of the power center may later reduce his exposure when the Deng family is purged after the dowager's death.

## Key Characteristics
- Deng-family insider whose warning makes outer-relative danger visible before Empress Dowager Deng's death.
- Yueqi xiaowei and Northern Army manager, so his criticism comes from a figure with military-administrative proximity rather than from an outside moralist.
- Repeated remonstrator who asks for stronger court authority and weaker outer-relative power.
- Failed withdrawal actor whose feigned illness does not prevent palace monitoring.
- Status-conflict offender whose contempt for a former household servant becomes a reportable offense under dowager authority.
...
- [[DengFamilyAnEraLateHan]] - family network from which Deng Kang separates before the later purge.
- [[EmperorAnOfHan]] - reigning emperor whose court authority Deng Kang says should be strengthened under the Deng regency.
- [[OuterRelativeCourtPower]] - structural danger Deng Kang names before the household's fall.
- [[FamilyRiskDiversification]] - interpretive frame for why removal from the family power core may become later protection.
- [[CrisisWithdrawalSelfProtection]] - adjacent pattern because Deng Kang's feigned illness lowers exposure but does not safely exit the crisis.
