...
## Key Characteristics
- Young Sun-family successor figure attached to Sun He's remaining force.
- Converts inherited troops into organized city defense.
- Responds effectively to a night readiness test.
- Receives formal appointment after proving command capacity.
...
- [[SunQuan|孙权]] - ruler who tests the defense and formalizes Sun Shao's command.
- [[JingCountyLateHan|泾县]] - defended city in the episode's opening branch.
- [[DanyangCoupLateHan|丹阳郡变]] - prior violence that makes Sun-family local control vulnerable.
- [[SuccessionAuthorityConsolidation|继位权威整合]] - adjacent Sun Quan-era problem of turning inherited people and offices into working command.
