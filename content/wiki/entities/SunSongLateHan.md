...
type: entity
tags: [person, late-han, shelter, political-persecution, hospitality]
sources:
...
- Anqiu shelterer who recognizes hidden status beneath Zhao Qi's market disguise.
- Risk-bearing host who protects a politically endangered person with a prepared hiding place.
- Practical counterpart to Wang Cheng's Li Xie concealment branch.
- Source-bounded example of hospitality under collateral-punishment risk.
...
The raw source writes 孙松; this page normalizes the route to 孙嵩 while preserving that transcript variant. The source does not develop Sun Song's office, family background, or later career, so the profile should remain focused on the shelter episode.
...
- [[ZhaoQiLateHan|赵岐]] - fugitive whose life Sun Song protects.
- [[TangXuanLateHan|唐玹]] - persecutor whose household destruction creates Zhao Qi's need for shelter.
- [[BeihaiCommandery|北海国 / 北海郡]] - market region where Zhao Qi survives under disguise before Sun Song recognizes him.
- [[FugitiveShelterCollateralRisk|收留逃亡者的牵连风险]] - concept directly illustrated by Sun Song's risk-bearing hospitality.
- [[CrisisWithdrawalSelfProtection|危局抽身自保]] - survival frame for concealment before reemergence.
