...
[[e247-duihua-shengying-xai-infra-de-langman-sglang-kaiyuan-pingquan-yu-zhenhuanchuan-6c9d13b1-ac9a-4a7a-a35b-99bfb8374668]] adds Stanford through [[ShengYing|盛颖]]'s PhD path in [[FormalVerification]] with [[ClarkeBarrett]]. The source uses Stanford as the environment where she moved from mathematical proof and [[SMTSolver|SMT solver]] work toward large-model inference, [[LMSYS|LM-SYS]], and [[SGLang]].
...
[[tsr-s5-christinac-v2audio-tsr-s5-christinac-v2audio]] adds Stanford as part of [[ChristinaCacioppo]]'s pre-founder path before [[UnionSquareVentures]], self-directed coding, [[Dropbox]], and [[Vanta]]. In this source, Stanford is mostly an exposure and network starting point rather than the decisive product insight; the Vanta idea comes later from compliance pain and customer discovery.
