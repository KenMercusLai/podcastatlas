...
type: entity
tags: [person, late-han, official, local-government, integrity, china]
sources:
...
- Remembered for low-extraction Kuaiji governance that reduces local burdens rather than monetizing office.
- Uses restraint in the farewell-token scene, accepting symbolic gratitude without converting it into payment.
- Becomes a plausible Three Excellencies appointee because his local reputation can be carried into central office.
...
## Relationships
- [[HuangQiongLateHan|黄琼]] - predecessor in the sikong turnover sequence that brings Liu Chong into office.
- [[EmperorHuanOfHan|汉桓帝]] - ruler under whom Liu Chong's Huan-era office movement occurs.
- [[HumaneLocalGovernance|仁厚地方治理]] - concept extended by Liu Chong's low-extraction Kuaiji administration.
- [[ThreeRefusalsIntegrity|三不沾式清廉自守]] - neighboring integrity discipline that clarifies why small gifts and clean conduct matter.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - concept explaining Liu Chong as a case where clean local reputation can justify central appointment.
