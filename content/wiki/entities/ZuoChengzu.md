...
type: entity
tags: [person, adviser, late-han, china]
...
## Connections
- [[KongRong|孔融]] - ruler who receives and then kills him.
- [[LiuYixun|刘义逊]] - fellow guest whose departure follows the killing.
- [[BeihaiCommandery|北海郡]] - crisis setting for the advice.
- [[YuanShao|袁绍]], [[CaoCao|曹操]], and [[GongsunZan|公孙瓒]] - stronger powers named in the source's alignment context.
- [[XingshiqingStrategicAssessment|行势情战略评估]], [[PoliticalSurvivalFirst|安全第一政治生存]], and [[CourtFeedbackCollapse|君臣反馈失灵]] - concepts linked to realistic condition-reading, survival strategy, and punished advice.
