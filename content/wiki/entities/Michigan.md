...
The source also uses Michigan to describe the traditional [[DemocraticParty]] base: African-American voters, working-class voters, the car industry, and a large [[UnitedAutoWorkers|UAW]] presence. That makes the state the test bed for [[StatewideLeftPrimaryTest]] and [[PrimaryElectorateDistortion]] rather than only a local campaign setting.

## Connections
- [[AbdulElSayed]], [[HaleyStevens]], and [[MikeRogers]] - Senate race actors in the source.
