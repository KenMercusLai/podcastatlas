...
type: entity
tags: [place, commandery, late-han, jiangxi]
sources:
...
# 豫章郡 / Yuzhang Commandery

## Overview
豫章郡 / Yuzhang Commandery is the late-Han commandery that shifts from Liu Yao's recommended refuge route into Sun Ce's fragmented expansion target and then a surrendered administrative field.

## Current Profile
The current evidence treats Yuzhang as strategically attractive but politically unstable. Its value lies in routes and survival space, yet its office chain is contested, Hua Xin's control is limited, and Sun Ce ultimately turns its weakness into surrender and administrative division.

## Key Characteristics
- Functions as the safer alternative to Kuaiji for Liu Yao because it offers north and west routes away from Sun Ce's coastal pressure.
- Carries a contested administrative history involving Yuan Shu, Zhuge Xuan, Zhu Hao, Ze Rong, Liu Yao, and Hua Xin.
- Reveals fragmented control through Tong Zhi in Luling and Panyang local forces near Haihun.
- Becomes vulnerable to Yu Fan's force-backed surrender argument because Hua Xin lacks the resources to resist Sun Ce.
...
## Relationships
- [[LiuYaoLateHan|刘繇]] - displaced power for whom Yuzhang becomes the safer route.
- [[XuShao|许劭]] - adviser who recommends Yuzhang over Kuaiji.
- [[HuaXin|华歆]] - formal administrator whose control and surrender define the commandery's late stage.
- [[SunCe|孙策]] - conquering power who absorbs and reorganizes Yuzhang.
- [[LulingLateHan|庐陵]] - subregion separated from Yuzhang after Sun Ce's takeover.
- [[TongZhiLateHan|僮芝]] - local actor whose Luling control reveals Yuzhang fragmentation.
- [[XingshiqingStrategicAssessment|行势情战略评估]] - concept for reading the commandery's route and control conditions.
