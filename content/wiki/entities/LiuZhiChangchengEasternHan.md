...
tags: [person, eastern-han, hebei, commander, alliance, disambiguation]
sources:
...
- Changcheng supporter who brings several thousand soldiers into Liu Xiu's expanding Hebei coalition.
- Source-normalized from 刘直 / 刘侄 to Liu Zhi / 刘植.
- Early commander appointed by Liu Xiu after the Xindu turn.
- Political broker sent to persuade Zhending King Liu Yang.
- Link between local armed support and the Guo Shengtong marriage alliance.
- Disambiguated from unrelated Liu Zhi routes in the wiki.
...
This page is bounded to one source note and keeps several details source-scoped. The source writes 刘直 for the Changcheng supporter and 刘侄 for the envoy to Liu Yang; the route normalizes them together as Liu Zhi / 刘植 because the sequence matches the established Guangwu-era story. The exact title rendered in the source as 萧綦将军, the geography of Changcheng, kinship with Liu Yang, and later career remain outside the current evidence.
...
- [[LiuXiu|刘秀]] - leader whom Liu Zhi joins with local soldiers and serves as envoy.
- [[WangLangHebeiClaimant|王郎]] - rival claimant whose potential Zhending support Liu Zhi helps neutralize.
- [[LiuYangZhendingKingEasternHan|真定王刘杨]] - royal ally persuaded by Liu Zhi to submit to Liu Xiu.
- [[GuoShengtong|郭圣通]] - Liu Yang's niece whose marriage to Liu Xiu follows the persuasion mission.
- [[PoliticalMarriageAllianceDepreciation|政治婚姻联盟折价]] - downstream concept because Liu Zhi's mission sets up the founding marriage alliance.
