...
tags: [history, china, western-han, court-politics, diplomacy]
sources:
...
The proposal then expands inside the imperial audience. After [[GongsunLuWesternHan|公孙禄]] objects, Xi Fu Gong argues that he is eliminating danger before rebellion happens. In private discussion with Aidi, he invokes repeated disasters, proposes sending a great general to inspect the frontier, and suggests killing a commandery governor to create fear. [[WangJiaWesternHan|王嘉]]'s later objection makes Xi Fu Gong the episode's main example of how ambition, disaster interpretation, and security language can turn a small diplomatic delay into war pressure.

## Key Characteristics

- Late Western Han accusation actor whose wiki profile begins with the Dongping king case.
- Reward-seeking informant who treats a royal-kin omen case as a path to advancement.
- Dongping-case reward beneficiary who later becomes a feared near-court accuser.
- Converts uncertainty into a broad frontier-security narrative involving Wusun and Xiongnu.
- Proposes false-envoy diplomacy and intentional leakage as a divide-and-pressure tactic.
- Uses "preventive" language to defend escalation before rebellion has occurred.
- Connects disasters and border anxiety to military inspection and exemplary killing.
...
- [[SunChongWesternHan|孙宠]] - co-accuser in the Dongping case.
- [[FuYanWesternHan|傅晏]] - paired advancement-seeking actor in the later Xiongnu illness-delay debate.
- [[HanAidi|汉哀帝]] - ruler attracted by Xi Fu Gong's preventive-security argument.
- [[DongXian|董贤]] - co-beneficiary in the Dongping-case reward package, though Dong Xian's merit is treated as fabricated or contested.
- [[LiuYunDongpingKingWesternHan|刘云]] - target of Xi Fu Gong's original reward-seeking accusation.
- [[GongsunLuWesternHan|公孙禄]] - first major objector to the deceptive diplomatic plan.
- [[WangJiaWesternHan|王嘉]] - senior official whose remonstrance rejects Xi Fu Gong's disaster-war-punishment logic.
- [[Xiongnu|匈奴]] - target of the suspicion and leakage strategy.
- [[Wusun|乌孙]] - western polity whose internal weakness is used in Xi Fu Gong's threat model.
- [[DisasterOmenTreasonAccusation|灾异谋反指控]] - earlier pattern in which Xi Fu Gong uses an anomalous sign as accusation material.
- [[NaturalDisasterPoliticalOmen|自然灾害政治征兆]] - reasoning field Xi Fu Gong uses to support escalation.
