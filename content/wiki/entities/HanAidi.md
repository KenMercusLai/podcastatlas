...
The Xiangrui source says Han Aidi tried to constrain the Wang consort family, reduce imperial expenses, attend to government, and consider limits on land and enslaved dependents. It uses him to show how historical reputation can be shaped by later power: if [[WangMang|王莽]]'s rise influenced how Emperor Ai was posthumously framed, then Aidi belongs to [[HistoricalMemoryContest]] around the end of Western Han.
...
- [[HistoricalMemoryContest]] - reputation frame for whether later power damaged Aidi's image.
