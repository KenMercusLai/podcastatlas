...
type: entity
tags: [battle, late-han, yuan-shao, gongsun-zan, cavalry, crossbow]
...
For the wiki, Jieqiao is a source case for [[ShieldCrossbowAntiCavalry|盾弩反骑兵战术]]. It complicates the simple cavalry-superiority story: mounted shock can dominate under some conditions, but disciplined infantry, distance control, and projectile timing can reverse the expected force ratio.

## Connections

- [[YuanShao|袁绍]] - commander whose side wins the battle.
- [[GongsunZan|公孙瓒]] - northern rival whose mounted force is defeated.
- [[QuYiLateHan|麹义]] - Yuan Shao-side tactical commander.
- [[YanGangLateHan|严纲]] - Gongsun Zan appointee killed in the battle.
- [[ShieldCrossbowAntiCavalry|盾弩反骑兵战术]], [[BattlefieldInformationControl|战场信息控制]], and [[CavalryShockCommandStrike|骑兵奇袭指挥中枢]] - tactical concepts connected to the battle.
