...
type: entity
tags: [person, late-han, han-dynasty, ruler, military]
...
The same strength creates exposure. After [[YuanShu|袁术]] demands grain and Chen refuses, Yuan Shu sends [[ZhangKaiAssassin|张闿]] under a surrender pretext to kill Liu Chong and Luo Jun. The episode treats Liu Chong's death as a failure to account for a desperate actor's risk, connecting him to [[XingshiqingStrategicAssessment|行势情战略评估]] and [[PersonDependentGovernanceFragility|人亡政息式治理脆弱性]].

## Connections
- [[LuoJun|骆俊]] - civil-governance partner in Chen.
- [[ChenStateLateHan|陈国]] - local polity protected and then destabilized around Liu Chong.
- [[YuanShu|袁术]] and [[ZhangKaiAssassin|张闿]] - hostile power and assassin in the source.
- [[PeopleBasedPoliticalSecurity|民心型政治安全]] and [[PersonDependentGovernanceFragility|人亡政息式治理脆弱性]] - concepts extended by the Chen case.
