...
《西游记》 is the Chinese classic and adaptation field that the wiki reads through textual history, comparative mythology, folk religion, hero narrative, management analogy, and modern film interpretation.

## Current Profile

The current synthesis treats 《西游记》 as a culturally stable but internally layered work. It is not only a childhood television memory or a single authorial artifact: sources connect it to [[Xuanzang|玄奘]] pilgrimage history, Buddhist and Daoist imagery, oral and dramatic layers, folk monsters, author-attribution debates, underworld satire, and modern symbolic adaptation in [[JourneyToTheWestConqueringDemons|《西游降魔篇》]].

## Key Characteristics

- The classic functions as an accretive text whose received form preserves multiple historical, religious, and narrative layers.
...
- Accretive text: [[43-xiyouji-duo-ni-shi-shenme-yaojing-618154182]] argues that television familiarity is not the same as reading the novel, then reconstructs the work through pilgrimage history, religious imagery, oral literature, zaju, folk monsters, and authorship debates.
...
The sources disagree less than they diversify the field. Authorship claims, hidden-political readings, and symbolic film readings remain bounded interpretations. The wiki should not flatten the Ming novel, television memory, folk religion, and Stephen Chow's film into one identical object.

## What Changed

- Recast the page into the synthesis-v1 schema.
- Added [[JourneyToTheWestConqueringDemons|《西游降魔篇》]] as a modern symbolic adaptation that reads the pilgrimage team as inner capacities.

## Relationships

- [[Xuanzang|玄奘]] - historical pilgrimage source behind the取经 tradition.
- [[SunWukong|孙悟空]] - major character whose origin and adaptation readings anchor multiple sources.
- [[ZhuBajie|猪八戒]] - companion figure with later and comic-religious source layers.
- [[ShaWujing|沙和尚]] - companion figure tied to karmic crossing and later inner-compassion symbolism.
- [[AccretiveTextFormation]] - textual-history frame for the classic's layered formation.
- [[MythicSourceLayering]] - character and motif layer frame.
- [[JourneyToTheWestConqueringDemons|《西游降魔篇》]] - modern film adaptation in the wiki.
