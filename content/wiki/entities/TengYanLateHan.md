...
type: entity
tags: [person, late-han, local-official, law-enforcement, eunuch-politics]
sources:
...
- Jibei chancellor who enforces against road robbery by protected retainers.
- Local official whose punishment shows how eunuch complaint can override local legal action.
- Early Huan-era example of enforcement inversion before the later Zhang Jian and Huang Fu branches.
- Source-bounded figure tied to Hou Lan and Duan Gui's property-and-servant power.
...
The raw source writes 滕炎; this page normalizes the route to 滕延 while preserving the source-scoped variant. The source does not develop Teng Yan's later career, the exact legal proceeding, or the full Jibei administrative context.
...
- [[HouLanLateHan|侯览]] - eunuch whose servants and guests create the enforcement case against Teng Yan.
- [[DuanGuiLateHan|段珪]] - small yellow-gate figure paired with Hou Lan in the complaint branch.
- [[EmperorHuanOfHan|汉桓帝]] - ruler whose court receives the complaint and dismisses Teng Yan.
- [[EunuchPatronageViolenceShield|宦官庇护下的地方暴行]] - concept directly illustrated by the punishment of valid local enforcement.
- [[PalaceAccessMonopoly|宫廷接触垄断]] - access structure that lets the protected side control the court-facing complaint.
