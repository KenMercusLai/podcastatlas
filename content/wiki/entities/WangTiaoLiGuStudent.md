...
type: entity
tags: [person, late-han, student, petition, political-persecution]
sources:
...
- Student of Li Gu whose loyalty becomes public action.
- Uses punishment gear as a visible signal that he accepts personal risk.
- Helps create the pressure that leads Liang Na to release Li Gu.
- Source-bounded figure whose importance lies in petition action, not broader biography.
...
- [[LiGuLateHan|李固]] - teacher whose imprisonment triggers Wang Tiao's petition.
- [[ZhaoChengLiGuPetitioner|赵成]] - palace-gate petitioner whose broader group action reinforces Wang Tiao's appeal.
- [[EmpressDowagerLiangNaLateHan|梁妠 / 梁太后]] - ruler-side recipient whose release order follows the petition pressure.
- [[GuoLiangLiGuStudent|郭亮]] - later Li Gu student whose loyalty appears after Li Gu's death.
- [[FuneraryDefianceUnderPoliticalTerror|恐怖政治下的丧葬抗命]] - adjacent loyalty-under-risk pattern that follows after petition channels fail.
