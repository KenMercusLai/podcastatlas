...
tags: [person, late-han, court-politics, correspondence, disambiguation]
sources:
...
- Shangshulang tied to a high-level correspondence leak under the Deng regency.
- Source of risk to Yuan Chang's household because private letters expose court secrets.
- Nearly executed, then spared after appeal and court reconsideration.
- Functions as a reputational mirror: his survival helps make Yuan Chang's harsher outcome look excessive.
- Kept distinct from the already indexed Zhang Jun written 张钧.
...
This page is source-bounded and primarily serves identity hygiene. It should not be merged with [[ZhangJunLateHan|张钧 / Zhang Jun (late Han)]] without explicit evidence that the two forms refer to the same person.
...
- [[YuanChangLateHan]] - Zhang Jun's correspondence with Yuan Chang's son triggers Yuan Chang's dismissal and suicide.
- [[EmpressDowagerDengLateHan]] - the case unfolds under her regency and court-secret discipline.
- [[EmperorAnOfHan]] - the An-era court context frames the pardon and later reputation handling.
- [[CourtFeedbackCollapse]] - private correspondence becomes dangerous once court information flows through unofficial channels.
- [[MoralReputationPoliticalCapital]] - Zhang Jun's plea contributes to posthumous sympathy for Yuan Chang.
- [[ZhangJunLateHan]] - disambiguation target with a different Chinese name form and source context.
