...
tags: [qiang, late-han, frontier, rebellion, leader]
sources:
...
滇零 / Dianling appears as an early An-era Qiang leader whose imperial claim and coalition building give the Deng-regency frontier crisis its opening scale before the later Lin Chang / Lingchang succession and proxy-assassination layers.
...
- Qiang leader whose current direct evidence begins with an imperial claim in Beidi.
...
The source set is thin on Dianling's internal organization, tribal base, and death sequence. The current page therefore keeps his identity narrow: coalition-opening Qiang leader before the later Lin Chang / Lingchang field. It does not infer a continuous command structure beyond what the source notes support.
...
- [[EmpressDowagerDengLateHan]] - regent whose opening frontier crisis is intensified by Dianling's coalition.
- [[DengZhiLateHan]] - Han commander-politician whose campaign structure fails against the Dianling field.
- [[RenShangLateHan]] - Han field commander defeated in the early campaign against Dianling's forces.
- [[PangCanLateHan]] - official whose retrenchment memorial responds to the war costs of the Dianling crisis.
- [[LinChangQiang]] - downstream Qiang successor field that follows after Dianling rather than being merged with him.
- [[DuJigongLateHan]] - Hanyang-area rebel actor whose later field overlaps with post-Dianling Qiang pressure.
- [[HanyangCommanderyLateHan]] - frontier commandery where Han response and later Qiang-linked disorder concentrate.
- [[RegencyUnderCompoundCrisis]] - concept that uses the Dianling crisis as part of Deng's opening compound pressure.
