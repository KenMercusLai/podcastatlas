...
tags: [person, late-han, official, local-government, humane-governance, official-dignity, china]
sources:
...
- High official whose bodily treatment becomes a test of nine-minister dignity under Emperor Shun.
- Later Taichang appointed taiwei in the Huan-era disaster and office-turnover layer.
- Former Yongqiu magistrate remembered for teaching-based dispute resolution.
- Humane-governance exemplar whose method prevents small conflicts from becoming formal cases.
- Appointment-quality case: central elevation is explained through local administrative character.
...
- [[ZuoXiongLateHan|左雄]] - official whose memorial turns Liu Ju's beating into a nine-minister dignity repair.
- [[EmperorShunOfHan|汉顺帝]] - ruler who accepts the correction after Liu Ju's beating.
- [[Shangshu|尚书]] - court office setting where the summoning and beating case occurs.
- [[MinisterialDignityProtection|九卿体面保护]] - concept directly grounded by Liu Ju's treatment and the resulting rule change.
- [[HuangQiongLateHan|黄琼]] - predecessor removed before Liu Ju's later taiwei appointment.
