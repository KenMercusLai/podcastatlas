...
type: entity
tags: [person, late-han, inspector, jingzhou, military-failure]
sources:
...
刘度 / Liu Du is a source-bounded late-Han Jingzhou inspector in the 162 CE southern crisis. He is currently important less for a full biography than for a failure pattern: defeat by rebels is followed by flight, leaving later officials such as [[LiSuNanCommanderyLateHan|李肃]] to face, and fail, a widening provincial emergency.
...
- Jingzhou inspector during the 162 CE southern rebellion crisis.
- Defeated together with envoy Ma Mu in the Ai County rebel branch.
- Flees after defeat, weakening provincial command credibility.
- Punished but spared execution through a one-degree reduction of the death penalty.
- Comparative failure case between ordinary battlefield defeat and Li Su's harsher dereliction.
...
This page is limited to Liu Du's 162 CE Jingzhou crisis role. The transcript form "刘渡" is normalized to 刘度 from the received historical sequence. No relation is inferred to other Liu Du figures without source evidence.
...
- [[MaMuLateHan|马睦]] - envoy defeated and fleeing alongside Liu Du.
- [[LiSuNanCommanderyLateHan|李肃]] - later southern failure case whose punishment is harsher than Liu Du's.
- [[HuShuangLateHan|胡爽]] - duty contrast whose remonstrance exposes what Liu Du's flight lacks.
- [[Jingzhou|荆州]] - province Liu Du is responsible for as inspector during the crisis.
- [[StrategicEmotionConcealment|情绪不外露的战略纪律]] - negative case where pressure turns fear into visible retreat.
