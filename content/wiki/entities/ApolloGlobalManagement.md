...
The episode also uses Apollo as part of the insurance-capital story: large private-credit managers can pair lending assets with long-duration insurance funding, then use structures such as [[RatedNoteFeeders]] to make private-credit exposure more acceptable to regulated or rating-sensitive investors.

## Connections
- [[PrivateCreditMarket]], [[DirectLending]], [[AssetBasedFinance]], and [[AIDataCenterPrivateCreditFinancing]] - market and product context from the source.
- [[XAI|xAI]] - AI company tied to the chip-financing example discussed by the episode.
- [[Blackstone]], [[KKR]], [[AresManagement]], and [[BlueOwlCapital]] - peer private-market managers named by the source.
- [[RatedNoteFeeders]], [[SyntheticRiskTransfer]], and [[PrivateCreditTailRisk]] - structuring and systemic-risk concepts associated with the episode.
