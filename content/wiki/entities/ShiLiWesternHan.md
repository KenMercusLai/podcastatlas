...
tags: [history, china, western-han, court-politics, legal-process]
sources:
...
- Western Han investigator assigned after Ding Xuan finds no result in the Feng Yuan accusation.
- Uses torture against Feng-family women and helps expand the case.
- Frames the accusation as treason: cursing Aidi and planning to enthrone Liu Jizi.
- Accidentally exposes palace sponsorship by invoking Feng Yuan's old bear-rescue act.
- Receives promotion despite the source treating his case as wrongful.
...
The source does not provide Shi Li's full biography, exact office career, complete interrogation record, or full list of victims. His private motive is presented through the episode's interpretation of career incentive and Fu Taihou's desired outcome.

## What Changed

- Created Shi Li as the coercive investigator in the Feng Yuan false-accusation case.

## Relationships

- [[FuTaihouWesternHan|傅太后]] - patron-like pressure source whose desired outcome Shi Li serves.
- [[FengYuanWesternHan|冯媛 / 冯太后]] - central target of Shi Li's interrogation and treason framing.
- [[ZhangYouWesternHan|张尤]] - initial false reporter whose accusation Shi Li operationalizes.
- [[HanAidi|汉哀帝]] - ruler named as the alleged curse target and receiver of Shi Li's treason report.
- [[CoerciveImplicationCascade|刑讯攀引扩大]] - adjacent failure mode because torture and loyalty signaling expand accusation into deaths.
- [[PalaceAccusationVerification|宫廷指控核验]] - procedural contrast because Shi Li's case represents verification failure.
