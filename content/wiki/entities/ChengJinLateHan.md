...
type: entity
tags: [person, late-han, local-government, nanyang, law-enforcement, china]
sources:
...
- Nanyang administrator whose enforcement capacity runs through Cen Zhi and Zhang Mu.
- Local official willing to punish a palace-connected wealthy actor.
- Vulnerable to procedural attack because the executions occur after an amnesty and before upward reporting.
- Remonstrance example of a capable official harmed by eunuch slander.
- Prison-death case that later shapes Jia Biao's refusal to shelter Cen Zhi.
...
The page preserves a procedural qualification: the source defends Cheng Jin's intention and public-harm target, but it also keeps the post-amnesty execution as the legal vulnerability exploited by opponents. The transcript's Chen Jing/Chen Jin forms are normalized to 成瑨 / Cheng Jin based on the Zizhi Tongjian sequence.
...
- [[CenZhiLateHan|岑晊]] - 功曹 whose persuasion and later flight are bound to Cheng Jin's case.
- [[ZhangMuLateHan|张牧]] - Nanyang official who joins Cen Zhi in urging the Zhang Fan arrest.
- [[ZhangFanWanLateHan|张汎]] - palace-connected Wan merchant whom Cheng Jin executes.
- [[LiuZhiTaiyuanLateHan|刘质]] - parallel local official accused after punishing Zhao Jin.
- [[HouLanLateHan|侯览]] - eunuch whose complaint channel helps turn enforcement into imprisonment.
- [[EunuchPatronageViolenceShield|宦官庇护下的地方暴行]] - concept directly illustrated by Cheng Jin's enforcement rebound.
