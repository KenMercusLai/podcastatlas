...
type: entity
tags: [book, literature, three-kingdoms, china]
sources:
...
## Overview
《三国演义》 / Romance of the Three Kingdoms is represented in this wiki as a powerful reception filter for the Three Kingdoms period, not as the controlling source for event attribution. Ruiqi episodes use it to explain memorable images of [[CaoCao|曹操]] and [[GuanYu|关羽]] while repeatedly returning to chronicle-source comparison.

## Current Profile
The current profile is source-scoped and methodological. The novel supplies scenes, reputation frames, and moral expectations that shape popular memory: Cao Cao can appear villainized through a Liu Bei-centered lens, Guan Yu becomes the hero of "warm wine and Hua Xiong," and "关公约三事" makes Guan Yu's temporary service under Cao Cao look contractually clean. The wiki preserves those as literary-memory evidence while using [[ZizhiTongjian|《资治通鉴》]], [[Sanguozhi|《三国志》]], and actor-logic reconstruction for source-grounded claims.

## Key Characteristics
- Functions as the major literary contrast for the show's historical-source Three Kingdoms reading.
- Shapes popular memory by making scenes morally vivid even when event attribution differs from chronicle-source claims.
- Can obscure Cao Cao's command capacity by filtering him through a villainized literary image.
- Stabilizes Guan Yu's loyalty image through memorable episodes such as Hua Xiong and the three surrender conditions.
