...
type: entity
tags: [person, late-han, astrology, court-politics, eunuch-politics]
sources:
...
刘瑜 / Liu Yu (late Han astrologer) is a disambiguated Guangling scholar, political remonstrant, and omen interpreter in the Emperor Huan and Emperor Ling transition. His current profile begins with [[YangBingLateHan|杨秉]] recommending him and Liu Yu submitting a long memorial against eunuch privilege and palace waste, then continues into the 168 CE Dou Wu crisis where he turns an abnormal Venus position into palace-security advice.
...
- Liu Yu is a Guangling scholar whose current profile joins remonstrance, court-entry reputation, and omen interpretation.
- His early memorial treats eunuch privilege, fiscal waste, judicial corruption, and rebellion risk as linked governance failures.
- His warning makes sky-sign interpretation actionable as palace-security advice.
- He addresses both the dowager side and the Dou/Chen minister side, making the warning a bridge between omen reading and operational preparation.
- His role sharpens the pre-leak timing problem: danger is identified, but the political response remains slow and partial.
- His page is intentionally disambiguated from Liu Yu / 刘虞 of Youzhou.
...
- The source records omen reasoning as historical political reasoning, not as proof of celestial causation.
- Liu Yu's full biography and later fate remain outside the current bounded evidence.
- The page uses `LiuYuAstrologerLateHan` to avoid collision with [[LiuYuLateHan|刘虞 / Liu Yu (Late Han)]], whose chronology and role are different.
...
- [[YangBingLateHan|杨秉]] - recommender whose death and clean profile frame Liu Yu's early memorial.
- [[EmperorHuanOfHan|汉桓帝]] - ruler who questions Liu Yu about disasters and appoints him yilang.
- [[RootCausePacification|查因安抚式治理]] - governance concept supported by Liu Yu's linkage between public distress and rebellion risk.
