...
tags: [person, eastern-han, patronage, youxia, court-risk, self-protection]
sources:
...
- Wealth-backed local youxia figure who moves into capital elite circles.
- Connected by marriage to Ma Yuan's family and by descent to Ping'a Marquis Wang Ren.
- Presented as a case where changing social circles can raise exposure as well as opportunity.
- Ignores the low-profile posture Ma Yuan thinks his family position requires.
- Later killed for a crime, with details of that crime not developed in the source note.
...
The source gives Wang Pan's political-social risk profile but not a full legal case. The host's "changing circles changes fate" framing is retained as interpretation, not as proof that all elite association is good or bad.
...
- [[MaYuanEasternHan|马援]] - warning figure who diagnoses Wang Pan's capital behavior as dangerous.
- [[WangSuEasternHan|王肃]] - Wang Pan's son, whose continued princely-house access extends the family's exposure.
- [[HighStatusCautionSelfProtection|高位谨慎自保]] - contrast relationship because Wang Pan displays the risks Fan Hong avoids.
- [[PrivateRetainerNetworkRisk|私人宾客网络风险]] - related because Wang Pan's family branch feeds into the later princely guest suspicion.
