...
type: entity
tags: [person, late-han, accuser, party-prohibition, china]
sources:
...
- Local accuser tied to Hou Lan by shared place and political backing.
- Person previously criticized by Zhang Jian, giving the accusation a private-grievance layer.
- Denouncer who frames Zhang Jian and twenty-four others as title-making party figures.
- Intermediary through whom local resentment becomes state arrest machinery.
...
- [[HouLanLateHan|侯览]] - eunuch patron or backing figure whose intent Zhu Bi relies on.
- [[ZhangJianLateHan|张俭]] - target whose criticism of Zhu Bi precedes the accusation.
- [[PartyNetworkTreasonFraming|朋党网络谋反化]] - accusation pattern Zhu Bi helps initiate.
- [[ReputationListPersecutionTarget|名望榜单迫害目标化]] - public-name environment that makes the accusation easier to weaponize.
- [[TreasonAccusationTrap|谋反指控陷阱]] - broader wiki concept for translating association into ruler-security danger.
