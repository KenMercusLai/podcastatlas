...
type: entity
tags: [person, late-han, party-prohibition, refuge]
sources:
...
- Beihai-region refuge contact in Zhang Jian's escape route.
- Part of the multi-household chain that lets Zhang Jian evade arrest.
- Shows how political pursuit spreads danger beyond one host or county.
...
This is a route-node page from one source. It does not establish Xizi Ran's office, family background, later fate, or whether the episode's name form requires normalization against another textual tradition.
...
- [[ZhangJianLateHan|张俭]] - fugitive whose route passes through Xizi Ran's home.
- [[LiDuLateHan|李笃]] - prior shelter provider in the same escape sequence.
- [[FugitiveShelterCollateralRisk|收留逃亡者的牵连风险]] - concept supported by Xizi Ran's place in the chain.
- [[WangmenTouzhi|望门投止]] - idiom-memory branch made concrete by repeated refuge-seeking.
