...
type: entity
tags: [person, late-han, student, mentorship, china]
sources:
...
- Student figure who names the difference between textual instruction and moral mentorship.
- Learner who accepts humble service as a path to formation.
- Character-test case whose response to repeated rebuke reveals inner steadiness.
- Recognition object whose teacher relationship becomes friendship after the test.
- Source-scoped case for [[MoralMentorshipTalentCultivation|人师型人才成全]].
...
This page records the late-Han episode's teacher-student test, not a general endorsement of humiliation as pedagogy. The source is treated as a character-reading story inside its historical and moral-literary frame.
...
- [[GuoTaiLateHan|郭泰]] - teacher who tests and then recognizes Wei Zhao.
- [[MoralMentorshipTalentCultivation|人师型人才成全]] - concept directly grounded in Wei Zhao's request.
- [[SituationalCharacterTests|五观识人法]] - adjacent framework for conduct revealed under pressure.
- [[MengMinLateHan|孟敏]] - parallel case where a small incident reveals character.
- [[ZuoYuanLateHan|左原]] - contrast case where mentorship redirects an offender rather than testing a seeker.
