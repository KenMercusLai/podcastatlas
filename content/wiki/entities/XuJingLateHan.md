---
title: "徐敬 / Xu Jing (late Han)"
type: entity
knowledge_schema: synthesis-v1
tags: [person, eastern-han, late-han, court-politics, outer-relative-power]
sources:
...
The host therefore treats him as skilled at being an official without claiming that he had extraordinary visible achievements. His reliability rests on not being marked as an outer-relative dependent, which made him useful to Shun's court. The source also notes the later Runan Xu family reputation and links it to [[XuShao|Xu Shao]]'s famous judgment of Cao Cao.

## Key Characteristics

- Runan official appointed situ in the early Shun court.
- Valued for a clean factional record more than for source-named policy accomplishments.
- Avoids dependence on successive outer-relative houses during Emperor He and Emperor An's political field.
- Becomes trustworthy to Shun precisely because his earlier survival did not require visible factional corruption.
- Serves as the source's example of reliable, non-flashy court survival.
...
- [[EmperorShunOfHan|汉顺帝]] - ruler whose court appoints Xu Jing as situ.
- [[OuterRelativeCourtPower|外戚专权与清算]] - power field that Xu Jing survives without visible dependence.
- [[NonalignedCourtSurvival|不依附式朝廷生存]] - concept modeled by Xu Jing's clean record across outer-relative regimes.
- [[ModerationAsPoliticalSurvival|中庸圆滑政治生存]] - adjacent survival style focused on usefulness and non-offense inside volatile office life.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - broader survival frame that Xu Jing's clean nonalignment qualifies.
- [[XuShao|许劭]] - later Runan Xu figure whose famous judgment is used by the source to make the family reputation legible.
