...
type: entity
tags: [person, official, late-han, remonstrance, court-politics]
sources:
...
- Wuling administrator whose earliest current action is recruiting rebellious Wuling Man leaders into surrender.
- Former Wuling administrator later used by Feng Gun as a campaign aide in the 162 CE Jingzhou pacification.
- Credited by Feng Gun after victory and recommended for further office, reinforcing a field-competence profile.
- Memorialist who reframes punishment review as a state-security and personnel-capacity problem.
- Formal-status defender who blocks a favored consort's elevation to empress.
- Official who succeeds after an earlier tearful petition fails to move Emperor Huan.
- Precedent and frontier-risk interpreter who argues that capable officials should not be discarded when the state is exposed.
...
- [[TianShengLateHan|田圣 / 田胜]] - favored consort whose empress elevation Ying Feng blocks on formal-status grounds.
- [[EmpressDowagerDouMiao|窦妙 / 窦皇太后]] - politically acceptable empress candidate whose selection follows the blocked Tian Sheng plan.
- [[ChenFanLateHan|陈蕃]] - official who supports Ying Feng's empress-status objection before the later pardon-petition contrast.
- [[LiYingLateHan|李膺]] - punished official whose restoration follows Ying Feng's memorial in the source.
- [[PowerStructureTargeting|权力结构定向求援]] - adjacent strategy pattern because Ying Feng changes the argument to fit the decision-maker's concern.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - broader risk field that makes successful conversion of advice into action notable.
- [[MingqiLegitimacy|名器合法性]] - formal-status frame behind the empress-title objection.
