...
type: entity
tags: [election, politics, united-states, 1968]
sources:
...
The 1968 United States presidential election is the contest in which [[RichardNixon]] defeated [[HubertHumphrey]] while [[GeorgeWallace]] carried five states as a third-party candidate.
...
- Wallace won five states and roughly ten million votes but lost support to both major candidates in different regions.
- Wallace sought to deny both major candidates an Electoral College majority and turn regional victories into leverage in the House.
- The result remained close enough that California, Ohio, Illinois, and late urban returns mattered on election night.
...
- Wallace campaign and leverage strategy: [[511-america-in-68-george-wallace-the-first-donald-trump-part-4-glt8855008412]] traces ballot access, Northern support, national rhetoric, early October polling, the contingent-election plan, LeMay's damage, and the five-state result.
...
- [[RichardNixon]] - Republican nominee and winner.
- [[HubertHumphrey]] - Democratic nominee whose late recovery narrowed the race.
- [[GeorgeWallace]] - third-party candidate who carried five states.
- [[LurleenWallace]] - proxy Alabama governor whose death occurred during Wallace's campaign.
- [[CurtisLeMay]] - Wallace running mate whose nuclear-weapons remarks damaged the ticket.
- [[AmericanIndependentParty]] - party vehicle for Wallace's national ballot campaign.
- [[LyndonBJohnson]] - incumbent president whose Vietnam decisions shaped Humphrey's campaign.
- [[ControlledTelevisionCampaign]] - media-control mechanism central to Nixon's strategy.
- [[LawAndOrderRacialSignaling]] - campaign-message ambiguity linking disorder and racial anxiety.
- [[ElectoralBackchannelCausationBoundary]] - framework for assessing the disputed Chennault episode.
- [[Chicago1968DemocraticConvention]] - convention crisis that damaged the Democratic campaign environment.
- [[ProtestMediaSpectacle]] - mechanism through which protest and police violence acquired electoral meaning.
- [[ThirdPartyElectoralCollegeLeverage]] - Wallace strategy for forcing a contingent election.
- [[SouthernConservativeRealignmentSignal]] - longer-term coalition meaning assigned to Wallace's result.
