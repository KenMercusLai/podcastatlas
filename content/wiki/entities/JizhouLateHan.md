...
type: entity
tags: [place, province, late-han, yuan-shao, governance]
sources:
...
冀州 / Jizhou is a late-Han northern province whose current wiki profile now begins as a 153 CE disaster-response and law-enforcement field, then later becomes an appointment-capacity problem, coup-mobilization pretext, and strategic base transferred from [[HanFuLateHan|韩馥]] to [[YuanShao|袁绍]]. The page treats Jizhou less as static territory than as a recurring test of whether the court or a regional holder can convert population, grain, office, and advisers into durable order.
...
- Early Huan-era disaster province where famine and displacement require emergency appointment.
- Law-enforcement field where Zhu Mu's cleanup collides with eunuch-family privilege.
- Late-Han appointment bottleneck under overextended reciprocal-avoidance rules.
- Military resource usable as a coup-mobilization pretext before the Yuan Shao transfer.
- Materially strong strategic base whose loss transforms Han Fu's safety and Yuan Shao's platform.
- Recurrent case where provincial capacity depends on leadership judgment, not territory alone.
...
- [[PsychologicalSurrenderTrap|心理迫降陷阱]] - concept sharpened by Han Fu yielding a still-capable province.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - recurrent failure mode when warnings about Jizhou staffing or transfer are ignored.
