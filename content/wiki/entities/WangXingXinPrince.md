...
The episode says Wang Xing and [[WangKuangXinPrince|王匡]] were born from Wang Mang's earlier relationship with an attendant when he had gone to his fief after becoming a marquis. Because their status was unclear, they remained in Xindu until Wang Mang's public sons were gone and he had to recall them.

## Key Characteristics

- Private son whose existence complicates Wang Mang's moral public image.
- Succession fallback after the deaths of Wang Mang's publicly recognized sons.
- Source-scoped figure whose significance is less personal biography than dynastic repair.
...
- [[WangMang|王莽]] - father whose public moral image and succession need shape Wang Xing's role.
- [[WangKuangXinPrince|王匡]] - brother recalled in the same succession branch.
- [[WangLinXinCrownPrince|王林]] - public heir whose death opens the recall problem.
- [[DynasticHeirLossShock|王朝继承人骤失冲击]] - succession shock that makes Wang Xing politically visible.
