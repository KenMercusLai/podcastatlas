...
type: entity
tags: [person, late-han, imperial-kin, bohai, eunuch-politics]
sources:
...
- Imperial brother whose royal status creates both protection and heightened political risk.
- 147 CE Bohai successor placed by Liang Na after Liu Hong dies without a son.
- Earlier Huan-era Bohai king whose later misconduct prompts a proposed law-first correction.
- Case where ignoring a moderate procedural repair leaves later royal-kin danger unresolved.
- Later access-brokerage user whose restored title becomes tied to private debt.
- Treason-accusation victim whose fall spreads to family, entertainers, and fief officials.
...
- [[ShiBiLateHan|史弼]] - official who proposes law-first handling of Liu Kui's misconduct.
- [[LegalJudgmentBeforeImperialGrace|先法度后恩宥]] - procedural concept created from Shi Bi's proposed handling of Liu Kui.
- [[BohaiKingdomLateHan|渤海王国]] - royal fief at stake in both Liu Kui's early warning layer and later purge.
- [[EmpressDowagerLiangNaLateHan|梁妠 / 梁太后]] - dowager whose 147 CE order places Liu Kui into Bohai.
- [[EmperorHuanOfHan|汉桓帝]] - elder brother whose ignored warning leaves the Liu Kui problem unresolved.
- [[EmperorLingOfHan|汉灵帝]] - later ruler who accepts the forged treason accusation against Liu Kui.
- [[WangFuLateHan|王甫]] - access broker, creditor, accuser, and beneficiary in Liu Kui's later restoration trap.
- [[InnerCourtAccessBrokerageRisk|内廷通道攀附风险]] - mechanism by which Liu Kui's restored title creates private leverage.
- [[TreasonAccusationTrap|谋反指控陷阱]] - accusation pattern used to destroy Liu Kui after the brokerage conflict.
- [[CollateralPunishmentAndGuiltByAssociation]] - punishment-spillover pattern visible in the Bohai purge.
