...
The source also cites an Israeli display of a large tunnel allegedly used to assemble attack drones. In the episode's logic, Hezbollah matters less as a stand-alone topic than as the unresolved armed actor that can turn [[USIranNuclearDiplomacy]] into a [[ProxyConflictSpoilerRisk]] case.

## Connections
- [[Israel]] - state actor framing Hezbollah as an immediate military threat.
