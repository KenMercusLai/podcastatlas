...
tags: [archaeology, documents, western-regions, evidence, jingjue]
sources:
...
## Key Characteristics
- The documents are the core textual bridge between Niya archaeology and Jingjue identification.
- Their Kharosthi script makes the site part of a wider Central and South Asian contact zone.
- A Han wooden slip supplies the episode's strongest explicit Jingjue-name evidence.
- The "Surpiece" references provide the source's main military-pressure evidence.
...
## What Changed
- Created a document-corpus page so the episode's evidence chain is not reduced to either archaeology or legend.

## Relationships
- [[NiyaSite]] - archaeological site where the documents are found and interpreted.
- [[JingjueKingdom]] - polity identified and reconstructed through the document evidence.
- [[SupiRegime]] - pressure actor inferred through the "Surpiece" references.
- [[AurelStein]] - collector-explorer whose Niya activity frames the documents' modern discovery and removal.
- [[WesternRegionsProtectorate]] - institutional background for Jingjue's position in Han Western Regions order.
