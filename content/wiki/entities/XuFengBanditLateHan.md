...
tags: [person, late-han, rebel, bandit, xu-yang]
sources:
...
His later burning of Dongcheng makes him a local public danger rather than a merely defeated fugitive. Xie An's ambush and beheading of Xu Feng closes this branch of the campaign and converts local action into court reward.

## Key Characteristics
- Xu-Yang bandit leader in the 145 CE unrest field.
- Defeated but not immediately eliminated in Teng Fu's campaign.
- Fugitive who burns Dongcheng after escaping.
...
## What Changed
- Created a disambiguated Xu Feng bandit page for the 145 CE unrest layer.
- Recorded the Dongcheng arson and Xie An ambush as the source-bounded reason for the page.

## Relationships
- [[XieAnXiapiLateHan|下邳谢安]] - local actor who kills Xu Feng.
- [[TengFuLateHan|滕抚]] - commander whose campaign first defeats Xu Feng's rebel field.
- [[Xuzhou|徐州]] and [[YangzhouLateHan|扬州]] - provincial unrest frame for Xu Feng's campaign context.
- [[BountyMobilizedPacification|赏募动员式平乱]] - reward-backed campaign environment that turns Xu Feng's death into a public merit case.
