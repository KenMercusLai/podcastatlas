...
type: entity
tags: [person, late-han, rebellion, local-governance, corruption, jiaozhi]
sources:
...
- Zhu Da's revolt begins with a corrupt and bullying county magistrate, making local administration the immediate trigger.
- His force includes county people and non-Han frontier actors, so the source frames the crisis as social and regional rather than purely personal.
- The rebellion escalates from killing a county magistrate to attacking Jiuzhen and killing the commandery administrator.
- Suppression by Wei Lang is presented as a personnel-fit response after the earlier official failure.
- His canonical page is narrow because the source gives no durable program, ideology, or later career.
...
The page is bounded to one podcast source note. Jiuzhen, Ni Shi, Wei Lang, and the exact non-Han groups remain source-scoped here because this ingest does not yet supply enough evidence for separate canonical pages.
...
- [[PeopleBasedPoliticalSecurity|民本政治安全]] - related because local popular grievance becomes a state-security problem.
