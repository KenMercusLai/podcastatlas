...
tags: [person, late-han, official, frontier, yizhou, jiaozhi, pacification]
sources:
...
- Frontier official whose Yizhou record begins with Yang Song's delegated campaign against Feng Li before the 123 CE Maoniu Yi victory.
- Superior who can use a trusted field officer while still owning the broader administrative settlement.
- Later precedent in Li Gu's argument that local fit can outperform an externally imposed general.
- Jiaozhi inspector appointed after Li Gu rejects the 40,000-soldier expedition plan.
- Reassurance-based pacifier whose method emphasizes trust, disclosure, and voluntary submission.
- Example of appointment quality grounded in prior regional competence.
...
- [[YizhouLateHan|益州]] - frontier region where Zhang Qiao defeats the Maoniu Yi rebellion.
- [[YangSongLateHan|杨宋]] - field officer Zhang Qiao dispatches against Feng Li in the earlier Yizhou pacification layer.
- [[LiGuLateHan|李固]] - cites Zhang Qiao as precedent and recommends him for the Jiaozhi crisis.
- [[ZhuLiangLateHan|祝良]] - paired appointee in Li Gu's two-person alternative to a mass expedition.
- [[EmperorShunOfHan|汉顺帝]] - ruler who accepts Li Gu's recommendation and appoints Zhang Qiao.
- [[JiaozhiCommandery|交趾郡]] - southern-frontier field where Zhang Qiao serves as inspector.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - Zhang Qiao is evidence that fit and trust can substitute for larger mobilization.
- [[RootCausePacification|查因安抚式治理]] - adjacent pattern because Zhang Qiao's later method works through reassurance and submission rather than punishment alone.
- [[YizhouPacificationByLeniency]] - earlier concept now strengthened by Zhang Qiao's delegated force, leniency, and official-punishment pattern.
