...
tags: [person, western-han, royal-family, succession]
sources:
...
- Western Han royal son considered by Xuan as a possible replacement for crown prince Liu Shi.
- Framed as legally minded, intelligent, capable, and temperamentally similar to Xuan.
- Son of Zhang Jieyu, whose consort status adds plausibility to his alternative-heir position.
- Functions in the source as a succession-risk pressure point rather than as a fully narrated ruler.
- His branch is ultimately contained by Xuan's decision to preserve Liu Shi's established嫡长 status.
...
- [[EmperorXuanOfHan|汉宣帝]] - father who considers Liu Qin as a replacement heir.
- [[HanYuandi|汉元帝]] - elder brother and established crown prince whom Liu Qin might have displaced.
- [[EstablishedHeirReplacementRisk|既定太子改立风险]] - succession-stability concept that explains why Liu Qin's appeal does not become a replacement.
- [[WeiXuanchengWesternHan|韦玄成]] - official appointed to Huaiyang as a restraint-and-instruction signal in the source.
- [[XuPingjunWesternHan|许平君]] - Liu Shi's mother whose memory constrains Xuan's willingness to elevate Liu Qin.
