...
tags: [person, late-han, official, remonstrance, appointments]
sources:
...
桓焉 / Huan Yan is a late-Han official whose current evidence has two bounded roles: an early 124 CE objection to [[EmperorAnOfHan|汉安帝]]'s planned deposition of [[EmperorShunOfHan|刘保]], and a later 135 CE role carrying the appointment document that brings [[LiangShangLateHan|梁商]] into the Grand General office under Shun.
...
- Taichang who joins the first principled objection to Liu Bao's deposition.
- Uses the shared age-responsibility and loyal-guidance argument rather than a factional counterclaim.
- Later serves as the document-bearing envoy in Liang Shang's Grand General appointment.
- Recurrent but still sparse official whose current profile is office-function focused.
...
- Created Huan Yan as a recurrent late-Han official bridging Liu Bao's 124 CE deposition debate and Liang Shang's 135 CE Grand General appointment.

## Relationships

- [[LaiLiLateHan|来历]] - fellow senior objector in the first Liu Bao deposition debate.
- [[ZhangHaoRemonstratorLateHan|张皓]] - fellow objector who extends the warning through historical precedent.
- [[EmperorAnOfHan|汉安帝]] - ruler whose planned deposition Huan Yan opposes.
- [[EmperorShunOfHan|汉顺帝 / 刘保]] - crown prince Huan Yan helps defend and later emperor who sends him to Liang Shang.
- [[LiangShangLateHan|梁商]] - Grand General appointee to whom Huan Yan carries the appointment document.
- [[DirectRemonstranceCriminalization|直谏入罪]] - adjacent pattern because Huan Yan's initial objection is later overshadowed by threats against the Hongdu Gate remonstrants.
- [[HeirSupportThreatPerception|储君拥戴威胁感]] - succession-security frame that explains why the objectors' age argument loses force.
