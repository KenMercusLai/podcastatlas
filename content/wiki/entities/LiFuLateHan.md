---
title: "李孚 / Li Fu (late Han)"
type: entity
knowledge_schema: synthesis-v1
tags: [person, late-han, yuan-family, messenger, infiltration]
sources:
...
- Tactical operator whose importance comes from breaking Cao Cao's information isolation.
- Uses performed command authority rather than stealth alone.
- Combines entry deception with an exit plan based on mass surrender cover.
- Later becomes a surrendered intermediary whose local credibility helps pacify Nanpi after Cao Cao's victory.
...
- [[ShenPeiLateHan|审配]] - Ye defender who receives Li Fu's message.
- [[YeLateHan|邺城]] - besieged city Li Fu enters and exits.
- [[CaoCao|曹操]] - besieger whose camp Li Fu penetrates.
- [[NanpiLateHan|南皮]] - captured city Li Fu helps stabilize after surrender.
- [[AuthorityDisguiseInfiltration|官威伪装渗透]] - concept directly created from Li Fu's camp passage.
- [[HydraulicSiegeWarfare|水攻围城]] - siege environment that makes Li Fu's mission necessary.
- [[BattlefieldInformationControl|战场信息控制]] - broader deception frame for controlling what soldiers believe during a campaign.
- [[SurrenderedLocalMessengerPacification|降人传令式安民]] - concept created from Li Fu's post-Nanpi message role.
- [[LiFuWarringStates|栗腹 / Li Fu (Warring States)]] - homonym kept separate by period and subject.
