...
tags: [institution, eastern-han, frontier, military, xiongnu, wuyuan]
sources:
...
- Eastern Han frontier camp or command arrangement created to manage Xiongnu branch instability.
- Institutional answer to Southern/Northern Xiongnu collusion risk after visible Han-Northern contact.
- Built at Wuyuan, a frontier location suited to watching Southern Xiongnu movement and northern contact.
- Triggered by Zheng Zhong's intelligence capture rather than by abstract planning alone.
- Prefigures later Duliao-general pages where frontier commanders affect Southern Xiongnu legitimacy and crisis handling.
...
The current page stays at the institutional level and does not claim a complete administrative history of the Duliao general office. Geng Guo, Wu Tang, force size, command hierarchy, and exact Wuyuan deployment details remain source-scoped. Later pages about Duliao generals should be linked as evidence accumulates, but this page is anchored to the initial 65 CE creation notice.
...
- [[ZhengZhongFrontierEasternHan|郑众]] - intelligence actor whose captured messenger triggers the camp's creation.
- [[SouthernXiongnu|南匈奴]] - submitted frontier branch whose possible flight and rebellion the camp is meant to prevent.
- [[NorthernXiongnuLateHan|北匈奴]] - rival branch whose contact with Southern Xiongnu creates the institutional risk.
- [[XuguDuhouSouthernXiongnu|虚骨都侯]] - Southern Xiongnu actor whose plot turns the proposal into action.
- [[FrontierRecognitionCredibilityTradeoff|边疆册封信用权衡]] - related concept because visible Han-Northern contact damages Southern Xiongnu trust and requires containment.
- [[DiplomaticRitualDignity|使节礼节国威]] - adjacent concept because the same envoy context also turns ritual posture into state dignity.
- [[ChenGuiDuliaoGeneralLateHan|陈龟]] - later Duliao general whose unauthorized action shows how the office can affect Southern Xiongnu legitimacy.
