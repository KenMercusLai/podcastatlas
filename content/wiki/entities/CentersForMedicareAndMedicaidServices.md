...
In Tyler's account, CMS found lab practices that put patient health in immediate jeopardy, and inspectors found records showing quality controls failed while patient samples were still run. The page therefore connects CMS to [[MedicalTestingValidationIntegrity]]: diagnostics governance depends on regulators seeing real quality-control evidence rather than a staged or incomplete inspection surface.

## Connections
- [[Theranos]], [[TylerShultz|Tyler Shultz]], and [[ElizabethHolmes|Elizabeth Holmes]] - company, source witness, and executive context.
