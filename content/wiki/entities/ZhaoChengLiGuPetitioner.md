...
type: entity
tags: [person, late-han, petitioner, political-persecution]
sources:
...
- Henei petitioner tied to the public defense of Li Gu.
- Acts collectively with dozens of others rather than as a lone court official.
- Uses punishment gear at the palace gate to make injustice visible.
- Helps produce Li Gu's temporary release.
- Requires disambiguation from unrelated Zhao Cheng identities already in the wiki.
...
This page is source-bounded and does not identify Zhao Cheng beyond the Henei petition scene. He is distinct from [[ZhaoChengQin|赵成 / Zhao Cheng (Qin)]], [[ZhaoChengWarringStates|赵成 / Zhao Cheng (Warring States)]], and [[ZhaoChenghou|赵成侯 / Marquis Cheng of Zhao]].

## What Changed

- Created a disambiguated late-Han Zhao Cheng page for the Li Gu palace-gate petition.

## Relationships

- [[LiGuLateHan|李固]] - imprisoned official whose release Zhao Cheng seeks.
- [[WangTiaoLiGuStudent|王调]] - parallel petitioner whose student appeal combines with the palace-gate action.
- [[EmpressDowagerLiangNaLateHan|梁妠 / 梁太后]] - dowager whose temporary release order follows the petition pressure.
- [[LiangJiLateHan|梁冀]] - powerholder whose renewed accusation later reverses the petition's practical success.
- [[ZhaoChengQin|赵成 / Zhao Cheng (Qin)]] - unrelated same-name page requiring disambiguation.
- [[ZhaoChengWarringStates|赵成 / Zhao Cheng (Warring States)]] - unrelated same-name page requiring disambiguation.
