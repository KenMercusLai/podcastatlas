...
- Xie Bi is a direct remonstrant who turns the treatment of Empress Dowager Dou into a ritual, filial, and political problem.
- His memorial escalates from one dowager case into a broader indictment of court reward, personnel, and anti-eunuch injustice.
- His fate is mediated through Cao Jie-linked local power rather than only through immediate imperial punishment.
- The page is source-scoped around a single episode and does not yet establish a full biography beyond the remonstrance and death sequence.
...
- The page follows the source's podcast summary and transcript normalization; if later source notes supply stronger variant evidence, the route may need disambiguation.
- The episode uses Xie Bi primarily as a contrast case against Yang Ci's indirect strategy, so his broader career remains underdeveloped.
- His death does not prove that all direct remonstrance fails; it shows direct speech becoming lethal when the targeted faction can control retaliation.
...
- [[YangCiLateHan|杨赐]] - contrast case for indirect, survivable remonstrance.
- [[ObliqueRemonstranceSelfProtection|迂回进谏自保]] - related concept sharpened by Xie Bi's negative boundary.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - wider setting where corrective speech becomes punishable exposure.
