...
In the wiki, the Philippines anchors the more punitive end of [[FilialPietyLaws]]. The case raises the same question as [[Malaysia]] and [[Telangana]]: whether punishment can protect older people without a stronger [[ElderCareStateCapacity]] base.

## Connections
- [[FilialPietyLaws]] - legal category the proposed bill fits.
