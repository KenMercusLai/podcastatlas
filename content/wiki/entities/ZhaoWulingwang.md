...
赵武灵王 / King Wuling of Zhao appears in [[zizhi-tongjian-zhouji-35-lishishang-diyi-qibing-jiaofu-shi-ta-lnxgnu1czkl-ftfb3gq9kzxwnxdk]] at his accession after [[ZhaoSuhou|赵肃侯]] dies in 326 BCE. The episode's title points toward his later reputation as a cavalry-oriented reformer, but this source covers only the political prelude before that reform.

His first moves are institutional and symbolic. Zhao Wuling Wang creates three broad-learning advisers, appoints left and right fault-correction officers, visits the old minister [[FeiYi|肥义]], and increases Fei Yi's salary. The host reads these gestures as more than ceremonial humility: they reassure senior ministers after succession while preparing room for a future break with expectation.
...
[[zizhi-tongjian-zhouji-54-wo-zun-ni-shi-wang-ni-dang-wo-shi-pi-lvhcz0ban9frlmwshd9vch-q7-ie]] places Zhao Wuling Wang inside [[ZhangYiStrategist|张仪]]'s 311 BCE Qin-facing persuasion tour. Zhang Yi first honors Zhao's past anti-Qin reputation, saying Zhao had once kept Qin inside [[HanguPass|函谷关]] and [[Wuguan|武关]], then shifts to Qin's expansion through [[BaShu|巴蜀]] and [[Hanzhong|汉中]] and to a threat of converging armies. The speech is the most layered example of [[EncirclementThreatPersuasion|包围威胁式说服]] in the episode because it begins with recognition before moving into isolation and partition threats.
...
[[zizhi-tongjian-zhouji-66-zhongguo-lishishang-naxie-diwang-shi-bei-huohuo-e-si-de-1-lvl1uxjadiedqwad-skxrwf-usnq]] turns the partial-exit problem inward. After Zhao destroys [[ZhongshanState|中山国]], Zhao Wuling Wang compensates [[ZhaoZhang|赵章]] with Anyang Jun status and a Dai-region base, placing [[TianBuli|田不李]] beside him while [[ZhaoHe|赵何]] holds the formal court with [[FeiYi|肥义]]. The source shows Zhao Wuling Wang emotionally unable to accept the elder son bowing to the younger king, then considering a divided Zhao and finally choosing the Shaqiu trip as a way to recover leverage outside Handan. He now anchors [[PartialAbdicationPowerSplit|退位留权式权力分裂]] and the prelude to [[ShaqiuCrisis|沙丘之变]].
...
- [[LiDui|李队]], [[TianBuli|田不李]], [[ShaqiuCrisis|沙丘之变]], and [[PartialAbdicationPowerSplit|退位留权式权力分裂]] - Zhouji 66 internal succession crisis after Zhongshan.
