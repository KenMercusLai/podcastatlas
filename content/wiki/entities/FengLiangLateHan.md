...
tags: [person, late-han, scholar, reclusion, office-refusal]
sources:
...
- Nanyang scholar with reputation for learning and upright conduct.
- Recommended by Chen Zhong as worthy of imperial summons.
- Refuses office through the same illness-return tactic as Zhou Xie.
- Paired evidence that recruitment can fail when court credibility is weak.
- Source-bounded figure whose independent biography remains undeveloped in this wiki.
...
- Created Feng Liang as the Nanyang scholar whose refusal pairs with Zhou Xie under Emperor An.

## Relationships

- [[ChenZhongLateHan|陈忠]] - recommender whose praise brings Feng Liang to imperial attention.
- [[ZhouXieLateHan|周燮]] - paired scholar in the same summons and refusal event.
- [[EmperorAnOfHan|汉安帝]] - ruler who issues the summons Feng Liang does not accept.
- [[PrincipledOfficeRefusal|原则性拒仕]] - concept modeled by Feng Liang's refusal to convert summons into service.
- [[OfficialSelectionChannelCompetition|选官通道竞争]] - broader selection field because Feng Liang's public reputation contrasts with private appointment pressure elsewhere in the source.
