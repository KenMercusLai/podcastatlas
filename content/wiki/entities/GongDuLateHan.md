...
type: entity
tags: [person, late-han, runan, rebel, guandu]
sources:
...
## Key Characteristics
- Runan-based rebel or bandit leader active during the Guandu prelude.
- Serves as Liu Bei's local partner after Liu Bei leaves Yuan Shao.
- Helps turn Runan into a recurring Cao-Yuan pressure theater rather than a cleared rear.
...
## Relationships
- [[LiuBei|刘备]] - joins Gong Du after using the Liu Biao alliance proposal to leave Yuan Shao.
- [[RunanCommanderyLateHan|汝南郡]] - local theater where Gong Du's force is active.
- [[YuanShao|袁绍]] - upstream patron whose dispatch of Liu Bei enables the later Runan branch.
- [[CaoCao|曹操]] - opposing power whose local position is pressured by Liu Bei and Gong Du.
- [[CaiYangLateHan|蔡阳]] - Cao-side commander sent against Liu Bei after the Gong Du connection.
- [[StrategicPatronExitJudgment|主公前途与安全退出判断]] - concept for Liu Bei's move from Yuan Shao's camp to a local foothold.
- [[GuanduCampaign|官渡之战]] - larger campaign context for Gong Du's source role.
