...
The source presents Wang Xing as appointment theater rather than proven administrative talent. Ai Zhang's list had included a Wang Xing among the Four Generals even though the name was effectively fabricated. Wang Mang then searches the population and finds a same-named Chengwen clerk whose appearance can be read through physiognomy as fitting the omen.

Wang Xing's importance is therefore symbolic. His appointment lets a contingent name match appear as confirmation that the fuming list was true, helping early Xin personnel selection look preauthorized by Heaven.

## Key Characteristics

- Commoner appointee found to match a fabricated fuming-list name.
- Former Chengwen clerk in the episode's account.
- Included among Xin's Four Generals through omen and physiognomy logic.
- Evidence that Wang Mang converts coincidence into legitimacy theater.
...
- [[WangMang|王莽]] - ruler who turns Wang Xing's name match into appointment evidence.
- [[WangShengXinFourGeneral|王盛]] - paired commoner appointee found for the same fuming-list problem.
...
- [[WangXingXinPrince|王兴]] - distinct later private son with the same name.
