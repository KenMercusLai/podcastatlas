...
type: entity
tags: [person, late-han, eunuch-politics, local-office, law-enforcement]
sources:
...
- Eunuch-connected local official whose status comes through being Zhang Rang's brother.
- Yewang magistrate presented as greedy, brutal, and locally abusive.
- Fugitive who hides in Zhang Rang's Luoyang residence rather than facing Li Ying's enforcement.
- Enforcement target whose execution helps build Li Ying's reputation for fearless law application.
- Countercase showing that eunuch kinship protection can fail when the ruler backs the enforcing official.
...
This page is deliberately narrow. The source does not provide Zhang Shuo's full career, exact legal charges, or independent political network beyond his office, misconduct, flight, and relationship to Zhang Rang. Yewang is kept source-scoped rather than expanded into a separate canonical place page in this ingest.

## What Changed

- Created this entity to anchor the Zhang Shuo enforcement case as an early Li Ying reputation and eunuch-protection countercase.

## Relationships

- [[ZhangRangLateHan|张让]] - brother whose household shelters Zhang Shuo and whose complaint reaches Emperor Huan.
- [[LiYingLateHan|李膺]] - Sili xiaowei who captures and executes Zhang Shuo.
