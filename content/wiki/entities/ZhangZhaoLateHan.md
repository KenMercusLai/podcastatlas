...
# 张昭 / Zhang Zhao (late Han)

## Overview
张昭 / Zhang Zhao is a major Jiangdong adviser whom [[SunCe|孙策]] appoints as 长史 and treats with teacher-friend respect. His current profile spans Sun Ce-era administration, visible stabilization of [[SunQuan|孙权]] after Sun Ce's death, conservative evaluation of [[LuSu|鲁肃]], and a 208 CE capitulation case grounded in Cao Cao's legitimacy and military advantage.
...
- [[SunQuan|孙权]] - young successor whom Zhang Zhao pushes into visible authority and later advises critically.
- [[LadyWuSunJian|吴夫人]] - Sun-family elder who entrusts Zhang Zhao with assisting Sun Quan.
- [[ZhangHongLateHan|张纮]] - paired senior adviser in Sun Ce's bench and Lady Wu's succession entrustment.
- [[DongXiLateHan|董袭]] - military reassurance voice in the same succession-stability scene.
- [[ZhouYuLateHan|周瑜]] - military partner in the post-Sun Ce stabilization.
- [[LuSu|鲁肃]] - new adviser whom Zhang Zhao criticizes before Sun Quan preserves independent judgment.
- [[RoleAsymmetricSurrenderIncentives|身份不对称的投降激励]] - framework that qualifies Zhang Zhao's regime-level surrender case with Sun Quan's ruler-specific downside.
- [[SubordinateSuccessNonJealousy|下属成就不嫉妒]] - leadership pattern anchored by Sun Ce's reaction to Zhang Zhao's fame.
- [[TalentAsStateTreasure|以贤臣为宝]] - adjacent talent-use frame for ministers who compensate for ruler limits.
- [[CommandContinuityDamageControl|统帅连续性危机处置]] - crisis pattern Zhang Zhao helps implement after Sun Ce's death.
- [[SuccessionAuthorityConsolidation|继位权威整合]] - broader succession frame that his civil authority helps support.
