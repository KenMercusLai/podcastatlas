---
title: "张郎 / Zhang Lang (late Han)"
type: entity
knowledge_schema: synthesis-v1
tags: [person, eastern-han, late-han, frontier, western-regions]
sources:
...
- Frontier administrator whose assigned role is cooperative rather than independent conquest.
- Carries personal legal exposure that makes quick visible merit valuable.
- Breaks campaign synchronization by attacking before the agreed meeting date.
- Receives the immediate benefit of Yanqi's surrender while shifting apparent failure to Ban Yong.
...
- Created a focused Zhang Lang page for the Yanqi campaign timing and credit-distortion case.

## Relationships

- [[BanYongLateHan|班勇]] - planned co-commander whose apparent lateness is created by Zhang Lang's early action.
- [[YanqiKingdomLateHan|焉耆国]] - campaign target whose surrender Zhang Lang receives.
- [[EmperorShunOfHan|汉顺帝]] - ruler whose court dispatches Zhang Lang and later punishes Ban Yong.
- [[CommandCreditMisattribution|军功归属错置]] - concept modeled by Zhang Lang's early attack and resulting blame shift.
- [[HexiFourCommanderiesLateHan|河西四郡]] - troop base from which Zhang Lang's force is drawn.
