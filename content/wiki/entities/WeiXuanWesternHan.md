...
- Wei-clan relative connected to Pingdi's maternal family.
- Maternal relative honored with title while kept outside Chang'an.
- Named victim in the case's expanded punishment wave.
- Evidence for the near-destruction of the Wei consort-kin network.
...
- [[EmpressDowagerWeiPingdi|卫太后]] - maternal-clan center whose blocked access starts the case chain.
- [[WeiBaoWesternHan|卫宝]] - Wei relative punished in the same aftermath.
- [[WangMang|王莽]] - dominant actor whose purge destroys the Wei network.
- [[DogBloodCase|狗血案]] - case that gives Wei Xuan his source role.
