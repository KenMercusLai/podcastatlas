...
type: entity
tags: [person, late-han, local-government, nanyang, party-prohibition, china]
sources:
...
- Nanyang功曹 entrusted with unusually strong local-administration authority.
- Moral-enforcement aide paired with Fan Pang's Runan role.
- Prime mover with Zhang Mu in urging action against Zhang Fan.
- Later fugitive whose shelter request becomes a test of collateral-risk ethics.
- Source-bounded example of how righteous enforcement can still create liability for helpers.
...
The page normalizes the transcript's Chen Zhi forms to 岑晊 / Cen Zhi based on the primary Zizhi Tongjian sequence. It does not treat Jia Biao's refusal as proof that Cen Zhi's original target was innocent; the question is collateral liability after the enforcement case has already rebounded.
...
- [[ChengJinLateHan|成瑨]] - superior whose Nanyang administration relies on Cen Zhi.
- [[ZhangMuLateHan|张牧]] - fellow Nanyang official who joins Cen Zhi in urging the arrest of Zhang Fan.
- [[ZhangFanWanLateHan|张汎]] - palace-connected merchant targeted in the enforcement action.
- [[JiaBiaoLateHan|贾彪]] - official who later refuses to shelter Cen Zhi.
- [[FanPangLateHan|范滂]] - Runan counterpart in the episode's paired commandery-cleanup pattern.
- [[FugitiveShelterCollateralRisk|收留逃亡者的牵连风险]] - downstream risk field clarified by Cen Zhi's attempted refuge.
