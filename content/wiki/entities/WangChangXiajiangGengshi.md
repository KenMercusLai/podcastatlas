...
tags: [person, gengshi-regime, lulin, eastern-han, coalition, disambiguation]
sources:
...
The current evidence leaves Wang Chang source-scoped to this coalition-building scene. His later career, precise office, and full Xiajiang command structure are not reconstructed here.

## Key Characteristics

- Xiajiang-side representative who meets Liu Yan during the post-Xiaochang'an coalition crisis.
- Accepts the anti-Wang-Mang and Liu-restoration argument as a reason for joint action.
- Persuades reluctant Xiajiang peers Cheng Dan and Zhang Ang to cooperate.
- Helps turn a demoralized field into a unified coalition capable of the Lanxiang night attack.
- Disambiguated Gengshi-era figure separate from later 王昌 and 王畅 routes.
...
- Created a disambiguated Gengshi-era Wang Chang route for the Xiajiang coalition actor.
- Kept this evidence separate from later Wang Chang/Wang Chang Shumao pages with the same romanization.

## Relationships

- [[LiuYanLiuXiuBrother|刘縯]] - coalition initiator whose proposal Wang Chang accepts and transmits to Xiajiang peers.
- [[LiuXiu|刘秀]] - participant in the Xiajiang visit after the earlier spoils crisis and Xiaochang'an defeat.
