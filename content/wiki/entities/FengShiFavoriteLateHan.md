...
tags: [person, late-han, court-politics, favorite, appointment]
sources:
...
Feng Shi's importance is the household-to-office pattern. Ruler residence, gifts, and appointments for relatives make favor materially public, turning private sociability into office distribution.

## Key Characteristics

- Emperor An favorite whose house becomes a temporary site of imperial residence and feasting.
- Weiwei and Huojia Hou with princess-linked lineage status.
- Household reward beneficiary whose son and brothers receive palace or court appointments.
- Example of interpersonal pleasing skill turning into public office opportunity.
- Disambiguated from the later Yan-crisis Feng Shi / 冯师 page.
...
- Created Feng Shi as Emperor An's favored household actor in the 120-121 CE private-favor sequence.
- Established a disambiguated route separate from the later冯师 page.

## Relationships

- [[EmperorAnOfHan|汉安帝]] - ruler whose residence, gifts, and appointments transform Feng Shi's private favor into public advantage.
- [[PrivateFavorAppointmentErosion|私恩任官侵蚀]] - institutional pattern illustrated by appointments for Feng Shi's son and brothers.
- [[PalaceProximityPower|宫廷近身权力]] - access mechanism visible in the movement from household closeness to office distribution.
- [[WangShengPalaceActorLateHan|王圣]] - parallel An-era favorite-household case in the same episode.
- [[LiuGuiLateHan|刘瑰]] - parallel title-beneficiary case showing private ties disturbing public order.
- [[FengShiLateHan|冯师]] - distinct later late-Han figure with a separate route and event field.
