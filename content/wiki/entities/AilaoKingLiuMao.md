...
tags: [person, eastern-han, ailao, frontier, submission]
sources:
...
- Ailao ruler whose 69 CE submission brings a large population under Eastern Han rule.
- Southwestern frontier incorporation figure tied to Ailao and Bonan county creation.
- Route-opening trigger because the court begins Bonan Mountain and Lancang/Mekong crossing works after submission.
- Earlier positive Ailao counterpart to the later [[AilaoKingLeilao|Lei Lao]] rebellion case.
- Source-bounded marker for frontier integration through administration and infrastructure.
...
The source does not reconstruct Ailao political structure, Liu Mao's motives, or the local costs of incorporation. The road song praises Han reach, but the page treats that as source rhetoric attached to a difficult infrastructure project rather than as proof of uncomplicated local acceptance.

## What Changed

- Created this page to distinguish 哀牢王柳貌 from the existing [[LiuMaoLateHan|刘茂]] route and from the later [[AilaoKingLeilao|哀牢王类牢]] rebellion figure.

## Relationships

- [[EmperorMingOfHan|汉明帝]] - ruler whose court accepts the submission and turns it into counties and road works.
- [[AilaoKingLeilao|哀牢王类牢]] - later Ailao ruler whose rebellion contrasts with Liu Mao's submission layer.
- [[LightTouchFrontierGovernance|宽简边疆治理]] - adjacent frontier-governance frame because later Ailao order depends on administration that can preserve local trust.
- [[MekongRiver|Lancang/Mekong]] - river corridor named in the route-opening branch after Liu Mao's submission.
