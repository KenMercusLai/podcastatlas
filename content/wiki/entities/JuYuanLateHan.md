...
type: entity
tags: [person, eunuch, late-han, court-politics, coup]
sources:
...
- Palace-proximity actor whose first durable role is arresting Liang Ji's monitor inside the palace.
- Coup executor who links inner-palace access control to armed pressure outside Liang's mansion.
- Named founding member of the Huan-era Five Marquises.
- Source-bounded eunuch figure whose current profile is about function in the 159 CE coup rather than a full biography.
...
- [[EmperorHuanOfHan|汉桓帝]] - ruler who uses Ju Yuan as an inner-palace and armed-coup executor.
- [[LiangJiLateHan|梁冀]] - target whose palace monitor and mansion are neutralized through Ju Yuan's actions.
- [[ShanChaoLateHan|单超]], [[XuHuangLateHan|徐璜]], [[ZuoGuanLateHan|左悺]], and [[TangHengLateHan|唐衡]] - other named eunuchs rewarded with Ju Yuan as Five Marquises.
- [[FiveMarquisesHuanEra|桓帝五侯]] - group identity created by the post-coup reward.
- [[PalaceCoupSymbolControl|宫廷政变中的符印与门户控制]] - concept for the broader coup mechanics in which Ju Yuan acts.
- [[PalaceProximityPower|宫廷近身权力]] - access channel that makes Ju Yuan useful before public force is visible.
