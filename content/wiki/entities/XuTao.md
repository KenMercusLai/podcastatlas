...
## Overview
徐涛 is a Shengdong Huopo / 声东击西 media host and team member represented in the wiki through morning audio habits, AI-work conversations, an aviation-history live roundtable, platform-governance discussion, and U.S. political observation.

## Current Profile
Xu Tao's current wiki profile is a non-specialist host who makes technical and social systems legible through practical questions, place, and lived experience. Earlier sources show him as a Shengdong team member with a morning podcast routine and as a host/interviewer translating AI infrastructure, OpenClaw, vibe coding, and agent workflows for non-engineering users.
...
The social-media regulation episode supplies a legal-policy version of the same host role. Xu Tao moves from initial legal caution about causation and age cutoffs toward a stronger product-responsibility frame after reviewing U.S. litigation, platform internal documents, and the shift from content harm to design harm.

Episode 398 adds Xu Tao as a comparative U.S.-politics interlocutor. He connects Los Angeles World Cup scenes, [[DonaldTrump]]'s reported red-card pressure, [[AmericanExceptionalism]], and [[LiuXiaoqian|Liu Xiaoqian]]'s Mississippi interviews to a broader question: when does a group that has held privilege experience a partial loss of advantage as discrimination?
...
- [[FangKecheng]] - guest in the youth social-media regulation episode.
- [[SocialMediaProductLiability]] - legal-policy concept discussed in the episode.
- [[LiuXiaoqian]] - co-speaker in the U.S. observation and Mississippi field-reporting episode.
- [[AmericanExceptionalism]] - sports-politics frame Xu Tao discusses.
