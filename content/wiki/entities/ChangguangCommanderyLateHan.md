...
type: entity
tags: [place, late-han, three-kingdoms, governance, taxation, china]
sources:
...
## Key Characteristics
- Represents the newly attached remote-region version of Cao-side local governance.
- Serves as He Kui's vantage point for warning against premature legal and fiscal uniformity.
- Makes staged integration visible: local settlement comes before full central standardization.
...
- [[CaoCao|曹操]] - ruler who accepts the flexible treatment recommendation.
- [[NewlyAttachedRegionLeniency|新附地区宽缓治理]] - concept directly illustrated by the Changguang case.
- [[TaxationStabilityTradeoff|税赋与地方稳定权衡]] - related fiscal-stability frame.
- [[YangAnLateHan|阳安]] - parallel local case in the same episode.
