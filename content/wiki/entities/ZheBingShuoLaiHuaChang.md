...
- VOL.30 and VOL.31 add urology as an earlier branch of the same medical-literacy pattern, with female urinary symptoms, stress incontinence, pregnancy urine tests, infection behavior, PSA, male urinary symptoms, kidney findings, hygiene, and foreign-body cases treated as context and escalation problems.
