...
title: "阿汤 / A Tang"
type: entity
tags: [person, podcast-host, healthcare, medical-literacy]
sources:
...
VOL.210 adds an audio and music-therapy branch to his host profile. 阿汤 starts from familiar listener experiences such as white noise, spa music, singing bowls, broadcast voice, old songs, and emotion-tagged playlists, then asks [[GuoMusicTherapyGuest|果同学]] to separate those from [[ClinicalMusicTherapy|clinical music therapy]], [[TherapeuticMusicalSynchrony|therapeutic musical synchrony]], [[MusicMemoryCueing|music memory cueing]], hospital emotional support, and [[MusicBasedEmotionRegulation|music-based emotion regulation]].

VOL.208 adds a headphone and hearing-safety branch to his host profile. 阿汤 starts from his own podcast-editing and listening context, including long earphone wear, single-ear monitoring, amplified audio, sudden peaks, active noise cancellation, and commuting noise, then asks [[LvDoctorENT|耳鼻喉吕博士]] to distinguish [[HeadphoneUseHearingRisk]], [[EarCanalInflammationRisk]], [[NoiseExposureLayering]], [[TinnitusSignalBoundary]], and [[SuddenHearingChangeEscalation]].

VOL.211 adds an earlier exercise-safety branch to his host profile. 阿汤 starts from the popular claim that exercise is the best medical aesthetics and from his own experiences with frequent gym training, late workouts, coffee, heart-rate monitoring, and equipment learning. He uses those examples to ask [[AnderMedicalAesthetics|Ander]] and [[DengProfessorCardiology|邓教授]] about [[ExerciseMedicalAestheticBoundary]], [[CardiovascularExerciseRiskBoundary]], supplements, sleep, injuries, large-body-weight training order, and BLS/AED response.
...
VOL.162 adds a hypertension-management branch. 阿汤 starts from [[XiaoLeiHypertensionGuest|小磊]]'s asymptomatic diagnosis, weekend dosing uncertainty, inconsistent measurement, takeout diet, and belief that he does not feel stressed, then asks [[DaLunDingHypertensionGuest|大伦丁老师]] to connect normalized work tension, [[HomeBloodPressureMeasurement|measurement technique]], [[AntihypertensiveMedicationAdherence|medication continuity]], follow-up, lifestyle support, and [[HypertensionTargetOrganDamage|multi-organ risk]].
...
## What Changed
- VOL.162 adds asymptomatic young-adult hypertension, home measurement, medication continuity, follow-up, and target-organ risk to 阿汤's recorded host role.
- The profile now includes his use of a patient's normalized work stress and weekend dosing routine to make chronic-disease control concrete.
- Guest identities, thresholds, drug instructions, and individual risk remain source-scoped rather than becoming diagnosis or treatment advice.
...
- [[LiuChenEmergencyDoctor]] - emergency physician he hosts in the World First Aid Day episode.
- [[ZhuTengjiao]] - orthopedic guest he hosts in the World First Aid Day episode.
- [[PekingUniversityThirdHospital]] - institutional context for the sports-medicine guests he hosts.
- [[YaMengDoctor]] - dermatologist he hosts in clinical and insect-bite discussions.
- [[YinLaoshiZheBing]] - source-scoped speaker he hosts in the mosquito-prevention episode.
...
- [[CardiovascularExerciseRiskBoundary]] - heart-rate, blood-pressure, and cardiopulmonary-risk frame he prompts.
- [[PublicExerciseEmergencyPreparedness]] - BLS/CPR/AED and injury-response frame he raises through exercise scenarios.
- [[FirstAidTriageAndEscalation]] - first-aid judgment and 120-routing frame he prompts through World First Aid Day scenarios.
- [[CPRAEDResponseBoundary]] - CPR/AED threshold and device-use boundary he asks the emergency guest to explain.
- [[ChestPainEmergencyEscalation]] - chest-pain and possible myocardial-infarction routing boundary he prompts.
- [[AcuteSportsInjuryEscalation]] - orthopedic injury warning-sign boundary he prompts.
- [[AcuteWoundBurnFirstAid]] - wound and burn first-aid boundary he prompts.
- [[MedicationSelfCombinationRisk]] - self-medication and overlapping-drug risk he asks about.
- [[SeizureFirstAidBoundary]] - convulsion-response boundary he helps make concrete.
- [[LiDoctorSmokingCessation]] - respiratory and cessation guest he hosts in VOL.164.
- [[ElectronicCigaretteRisk]] - vaping-risk misconception he asks the guest to unpack.
- [[SecondhandThirdhandSmokeExposure]] - environmental-exposure frame he makes concrete through household and public examples.
- [[YouthTobaccoInitiationPrevention]] - first-use prevention frame he develops through peer, family, retail, and media examples.
- [[SmokingCessationSupport]] - quit-date, clinic, medication, and relapse-recovery frame he prompts.
- [[StrengthTrainingJointProtection]] - joint-protection topic he prompts through questions about knees, hips, and muscles.
- [[ExerciseAssistiveGearBoundary]] - support-device boundary he raises through braces, tape, and exoskeleton questions.
- [[StretchingMobilitySafety]] - mobility and recovery topic he raises through stretching examples.
- [[JointSymptomEscalation]] - warning-sign frame he raises through knee popping and soreness questions.
- [[DiagnosticSafetyNetting]] - patient-safety frame he prompts and summarizes.
- [[DoctorPatientCommunication]] - communication practice his questions make concrete.
- [[MosquitoBitePrevention]] - consumer-health and prevention topic he helps frame.
...
- [[FunctionalFoodMarketingClaimSkepticism]] - marketing-claim skepticism he asks the guest to ground in label and evidence checks.
- [[MealReplacementNutritionBoundary]] - meal-replacement boundary he prompts through protein, collagen, vegetable powder, and energy-bar examples.
- [[ElectrolyteDrinkUseBoundary]] - electrolyte-drink boundary he prompts through exercise, sweating, dehydration, and product-label examples.
- [[FishOilNaturalStatinBoundary]] - fish-oil boundary he prompts through "natural statin" and omega-3 questions.
- [[HeadphoneUseHearingRisk]] - headphone and audio-editing risk frame he prompts through listener and creator scenarios.
- [[EarCanalInflammationRisk]] - external ear-canal symptom frame he prompts through itching, pain, discharge, picking, and device hygiene questions.
...
- [[MusicMemoryCueing]] - elder-care and memory practice he connects to old songs and media.
- [[MusicBasedEmotionRegulation]] - playlist and emotion-matching practice he helps turn into ordinary listener language.
...
- [[DaLunDingHypertensionGuest]] - source-scoped hypertension educator he hosts in VOL.162.
- [[XiaoLeiHypertensionGuest]] - source-scoped young patient whose case he explores in VOL.162.
- [[HypertensionLongTermManagement]] - detection, treatment, monitoring, follow-up, and lifestyle frame he prompts.
