...
tags: [person, eastern-han, court-politics, coup, succession, regency]
sources:
...
- Anti-regency conspirator whose plan responds to both succession dissatisfaction and eunuch-adjacent palace assistance.
- Treats Liu Sheng as a rival succession option against Deng's installed Emperor An.
- Targets Deng-family relatives, Zheng Zhong, and Cai Lun, showing that the coup field is household, palace, and succession politics at once.
- Fails before execution because the plot leaks, ending in suicide and punishment of implicated people.
- Becomes a boundary-setting episode for Deng's regency, after which return-power speech becomes more dangerous.
...
This page is based on one source note. The source supplies a political interpretation of Zhou Zhang's action as rebellion against the regency, but it does not give a full faction map, independent testimony, or the detailed procedural handling of everyone implicated. Zheng Zhong, Cai Lun, and Liu Sheng remain source-scoped until future evidence makes separate pages necessary.
...
- [[EmpressDowagerDengLateHan]] - regent whom Zhou Zhang aims to depose.
- [[EmperorAnOfHan]] - child ruler whom Zhou Zhang plans to demote in favor of Liu Sheng.
- [[EmperorShangOfHan]] - prior infant emperor whose death opens the succession setting in which Zhou Zhang acts.
- [[DengFamilyAnEraLateHan]] - outer-relative network directly targeted by Zhou Zhang's planned violence.
- [[ImperialDepositionCoupRisk]] - related pattern because Zhou Zhang's plan combines coerced edict, removal of a ruler, and installation of a rival claimant.
- [[OuterRelativeCourtPower]] - structural pressure because Deng-family and palace-assistant influence helps define the grievance field.
- [[CourtFeedbackCollapse]] - adjacent risk because failed coup politics narrow the space for ordinary correction and transfer-power speech.
