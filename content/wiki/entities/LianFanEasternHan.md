---
title: "廉范 / Lian Fan (Eastern Han)"
type: entity
knowledge_schema: synthesis-v1
tags: [person, eastern-han, military, local-governance, urbanism]
sources:
...
The current profile is therefore not simply "lenient official." Lian Fan's pattern is executable risk design: in war he manipulates what the enemy sees; in city governance he replaces unenforceable prohibition with permission plus preparedness. The popular praise song "平生无襦，今五裤" is treated as source evidence that the policy was remembered as livelihood-improving local rule.

## Key Characteristics

- Eastern Han official whose current profile combines military command and local administration.
- Yunzhong defender who uses fire display and movement to create a false reinforcement signal.
- Commander who prefers immediate deception and dawn attack to waiting for uncertain outside help.
- Chengdu administrator who treats night labor as a livelihood need rather than only a fire hazard.
- Risk manager who permits night lighting while requiring household water storage.
- Source case for ancient after-dark economic governance before modern nightlife-policy frameworks.
...
- [[NorthernXiongnuLateHan]] - opponent misled by Lian Fan's torch display at Yunzhong.
- [[NighttimeEconomyGovernance]] - concept extended by Lian Fan's Chengdu policy permitting night work under fire-risk constraints.
- [[Chengdu]] - city setting for the no-night-fire-ban governance case.
- [[LocalGovernanceAsCare]] - related governance pattern because Lian Fan balances livelihood needs with household-level safety preparation.
- [[MilitaryPresenceTheater]] - adjacent pattern because visible force display changes enemy perception before combat.
- [[LianPo]] - claimed ancestor in the source's biographical setup.
