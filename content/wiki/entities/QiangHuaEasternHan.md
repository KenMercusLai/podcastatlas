...
tags: [person, eastern-han, guangwu, chenwei, source-scoped]
sources:
...
- Guanzhong scholar whose current role is bounded to Liu Xiu's accession sequence.
- Carrier of a chenwei-style sign used to make imperial accession publicly legible.
- Source-scoped figure whose importance lies in the function of the text rather than a developed personal biography.
- Actor in the final stage of a repeated urging sequence already prepared by commanders and advisers.
...
The current page does not infer Qiang Hua's broader career, rank, or institutional affiliation. The transcript says 赤符符; the wiki treats this as the 赤伏符 accession sign known from the Guangwu founding context, while keeping the source's exact wording and the host's "true mandate" interpretation source-scoped.
...
- [[LiuXiu|光武帝刘秀]] - claimant whose accession receives symbolic support through Qiang Hua's text.
- [[GengChunEasternHan|耿纯]] - adviser whose follower-expectation argument prepares the accession pressure before Qiang Hua's arrival.
- [[FengYiEasternHan|冯异]] - commander whose Gengshi-failure judgment prepares the accession pressure before Qiang Hua's arrival.
- [[ChenweiPolitics|谶纬政治]] - conceptual frame for prophetic or apocryphal texts functioning as political evidence.
- [[ImperialPreferenceSpeechRisk|帝王偏好下的表达风险]] - related because Liu Xiu's later liking for the 赤伏符 creates a repeated court-expression risk.
- [[AccessionTimingCoalitionSignal|称帝时机与拥戴信号]] - concept directly illustrated by Qiang Hua's final symbolic warrant.
