---
title: "王芳 / Wang Fang (Xin princess)"
type: entity
knowledge_schema: synthesis-v1
tags: [person, xin-dynasty, wang-family, scandal]
sources:
...
The episode says Wang Fang is accused of cursing family members and killing a maid to silence evidence. She and Wang Xing then die by suicide. The source uses the case as part of a compressed Wang-family tragedy, not as a complete legal dossier.

Her wiki role is therefore a bounded scandal node. Together with Wang Zong's imperial-image case, Wang Fang shows how Wang Mang's regime reads symbolic or household accusations as existential danger inside the ruler's own clan.
...
The source does not settle Wang Fang's intent, the accusation's reliability, Wang Xing's full identity, or the case procedure. The page preserves the case as evidence of late-Xin household insecurity and scandal escalation, not as a complete biography.
...
- [[WangZongXinPrince|王宗]] - brother whose imperial-symbol case belongs to the same family-death cluster.
- [[WangMang|王莽]] - ruler whose household and clan politics frame the case.
- [[XinDynasty|新朝]] - regime context for the accusation and suicides.
- [[DynasticScandalSuppression|王朝丑闻压制]] - adjacent pattern for hidden or coercively handled dynastic scandal.
