...
- Top-tier eunuch merit-holder in Shun's restoration group.
- Reward-list operator whose administrative task becomes political leverage.
- Rival or counterweight inside the eunuch merit field, especially in relation to Wang Guo.
- Vulnerable actor because Miao Guang's inclusion exposes private manipulation.
- Example of how post-coup rewards create internal hierarchy and risk.
...
- Created Wang Kang as the high-rank eunuch merit-holder whose list work exposes post-restoration reward risk.

## Relationships

- [[SunChengLateHan|孙程]] - senior eunuch merit leader who delegates the list and later chooses not to punish Wang Kang.
- [[MiaoGuangLateHan|苗光]] - hesitant participant whom Wang Kang quietly includes on the merit list.
- [[WangGuoEunuchLateHan|王国]] - reward peer and possible balancing counterpart in the eunuch merit group.
- [[EmperorShunOfHan|汉顺帝]] - restored ruler whose accession creates Wang Kang's reward field.
- [[CoupCreditAllocationRisk|宫变功劳分配风险]] - concept directly grounded by Wang Kang's list manipulation.
- [[PostRestorationMeritThreat|复国功臣威胁化]] - broader pattern where restoration merit becomes politically dangerous after victory.
