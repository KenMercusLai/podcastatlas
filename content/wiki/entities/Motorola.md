...
[[e229-cong-shougong-zuofang-dao-quanqiu-diyi-zhongguo-dongli-dianchi-nixi-shi]] adds Motorola as an early customer signal in [[BYD]]'s battery-manufacturing story. The source says BYD's low-cost manual and semi-mechanical production methods eventually supported orders from Motorola, making handset-era battery demand part of the prehistory of later EV battery competence.
...
- Its strong design wins, especially StarTAC and RAZR, became both advantage and trap: the company kept optimizing thin, stylish hardware while [[SmartphoneOperatingSystemEcosystems]] moved the center of competition toward software, touch UI, and app ecosystems.
...
- E229 uses Motorola narrowly, as evidence that early consumer-electronics battery work helped BYD build [[BatteryManufacturingKnowHow]] before the power-battery era.

## Connections
- [[Nokia]] and [[Ericsson]] — peer old giants in the episode's "诸神黄昏" structure.
- [[MobileInternetPrehistory]] — Motorola's devices and network participation belong to the pre-smartphone layer that made mobile internet possible.
