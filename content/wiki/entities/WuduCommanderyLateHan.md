...
tags: [place, commandery, late-han, frontier, qiang]
sources:
...
- Frontier commandery exposed to Qiang pressure in the Deng-regency layer.
- Appointment destination for Yu Xu after the court recognizes his military judgment.
- Hard to reach because enemy forces block the route through the Chen Cang small-valley area.
- Defended indirectly through Chiting, where a small Han force uses deception and timing rather than equal numbers.
- Requires disambiguation from the unrelated Han Fei text route [[Wudu|《五蠹》 / Wu Du]].
...
- [[YuXuEasternHan|虞诩]] - appointed Wudu taishou and central defender in the source.
- [[ChitingDefenseLateHan|赤亭守战]] - battle sequence through which Wudu is relieved and preserved.
- [[EmpressDowagerDengLateHan|和熹邓皇后]] - regent whose appointment makes Wudu Yu Xu's dangerous assignment.
- [[IncreasingStovesDeception|增灶示强]] - route deception that helps Yu Xu reach Wudu.
- [[RegencyUnderCompoundCrisis|复合危机下的摄政]] - broader crisis-governance frame for Wudu's appointment and defense.
- [[Wudu|《五蠹》 / Wu Du]] - unrelated existing route that requires disambiguation.
