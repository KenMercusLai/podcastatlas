...
## Overview
庞羲 / Pang Xi is a late-Han Yi Province official whose profile runs from Liu-family continuity broker to Ba-region defender and militarized insider under suspicion. His page shows how old favor, frontier defense, private recruitment, local force, and household marriage can make a provincial strongman useful to [[LiuZhang|刘璋]] while also making him dangerous-looking.
...
- Serves as a frontier defender after failing to defeat Zhang Lu.
- Holds enough Ba/Baxi-area force and Cong relationships to become politically suspect.
- Is tied to Liu Zhang's household through his daughter and Liu Zhang's eldest son Liu Xun.
...
- [[LiuZhang|刘璋]] - provincial ruler who benefits from Pang Xi's past support but later suspects his power.
- [[ZhangLuFivePecks|张鲁]] - Hanzhong opponent Pang Xi fails to subdue.
- [[LiuXunYizhouHeirLateHan|刘循]] - son-in-law link that ties Pang Xi's household to Liu Zhang's succession field.
- [[ChengJiLateHan|程畿]] - subordinate whose refusal checks Pang Xi's self-protective mobilization.
- [[YizhouLateHan|益州]] - provincial setting where Pang Xi's inherited ties become a governance risk.
- [[ImportedTroopsLocalEliteCleavage|外来武装与本土豪族裂缝]] - structural frame for the larger Yi Province integration problem around Pang Xi.
- [[OfficialDutyOverPatronCommand|守职胜私命]] - concept captured by Cheng Ji's response to Pang Xi's command.
- [[GraceDebtLoyaltyPressure|恩义债式忠诚压力]] - adjacent pressure field because Pang Xi's earlier favor to the Liu family does not remove suspicion.
