...
The Agincourt evidence fills part of the former chronological gap. [[Harfleur]] shows a port victory consuming the time and manpower meant for wider conquest, while guarded Somme crossings, damaged routes, fixed provisions, weather, and political reluctance to retreat produced the approach to battle. The exhausted English then won through [[TerrainConstrainedCombinedArms|terrain-constrained combined arms]], command cohesion, and French coordination failure rather than numerical parity or a single miracle weapon.
...
- Agincourt's mechanism: [[489-hundred-years-war-bloodbath-at-agincourt-part-3-glt5834061192]] reconstructs mud, woods, archers, stakes, failed cavalry, crowding, command precedence, and Henry's initiative as interacting causes.
...
Coverage remains discontinuous: it contains the origin and the 1415-1422 sequence, not the intervening early campaigns or later French recovery. Population, financial, route, force, arrow, casualty, and prisoner figures remain podcast claims rather than independently audited data. The evidence does not resolve whether Henry sought battle during the march or could have sustained Troyes had he lived.
...
- [[England]] - weaker challenger and mobilized royal polity in the origin episode.
...
- [[ConquestDisciplineLegitimacy]] - relationship between sovereignty claims, restraint, coercion, and supply.
- [[TerrainConstrainedCombinedArms]] - interaction model explaining how Agincourt's battlefield constrained forces and plans.
