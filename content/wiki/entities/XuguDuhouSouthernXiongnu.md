...
tags: [person, southern-xiongnu, eastern-han, frontier, rebellion-risk]
sources:
...
- Functions as the immediate trigger for establishing Duliaoying at Wuyuan.
...
The page does not identify Xugu Duhou beyond the episode's Southern Xiongnu context. The form may be a title, office, or transcript-rendered name; the wiki preserves it as a disambiguated source-scoped entity until additional sources clarify identity.

## What Changed

- Created the page to prevent the Duliaoying creation story from becoming an unnamed plot reference.
- Connected Xugu Duhou to the frontier-recognition credibility problem.

## Relationships

- [[SouthernXiongnu|南匈奴]] - group context for Xugu Duhou's position and rebellion risk.
- [[NorthernXiongnuLateHan|北匈奴]] - outside branch from which Xugu Duhou seeks help.
- [[ZhengZhongFrontierEasternHan|郑众]] - Han envoy who detects the plot and captures the messenger.
- [[DuliaoCampEasternHan|都辽营]] - institutional result of the incident.
- [[FrontierRecognitionCredibilityTradeoff|边疆册封信用权衡]] - concept illustrated by Han contact with Northern Xiongnu destabilizing Southern Xiongnu trust.
