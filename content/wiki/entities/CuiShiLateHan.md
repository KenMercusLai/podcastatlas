...
type: entity
tags: [person, late-han, writer, political-thought, china]
sources:
...
- Late-Han recommended talent whose wiki entry is anchored in the 151 CE Luoyang earthquake and Emperor Huan's search for independent officials.
- Writer who chooses withdrawal and textual critique over answering the court's immediate policy examination.
- Authorial figure behind Zhenglun's argument that governance must diagnose the disease before prescribing strictness, leniency, law, or moral teaching.
- Critic of complacent rulership and ministerial silence under visible dynastic decline.
- Harsh-law advocate only in a qualified sense: the source and Sima Guang frame his severity as a situational corrective for disorder and elite impunity.
...
This page is grounded in one podcast source, not in a full biographical dossier. The transcript writes 崔石, while the canonical page uses 崔寔 because the Zhenglun attribution and late-Han context identify the received figure. The current profile should not be generalized into a claim that Cui Shi always preferred cruelty; the source's closing framework is strict-lenient balance according to circumstance.
