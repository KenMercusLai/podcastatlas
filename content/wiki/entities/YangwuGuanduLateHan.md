...
type: entity
tags: [place, late-han, guandu, military-camp]
sources:
...
## Key Characteristics
- Yuan Shao army station in the Guandu prelude.
- Setting for Ju Shou's tenfold-manpower, lower-combat-quality, and Cao-supply-shortage analysis.
- Transition point between counsel over campaign tempo and Yuan's later advance to Shaqiu.
...
## What Changed
- Created a disambiguated Guandu-theater Yangwu page for Ju Shou's rejected attrition advice.

## Relationships
- [[YuanShao|袁绍]] - camps at Yangwu before advancing toward Shaqiu.
- [[JuShou|沮授]] - gives the attrition advice located here.
- [[CaoCao|曹操]] - target of the proposed long-war pressure.
- [[ResourceAsymmetryAttrition|资源不对称消耗战]] - concept illustrated by Ju Shou's Yangwu recommendation.
- [[GuanduCampaign|官渡之战]] - larger campaign context for Yangwu's role.
- [[ShaqiuGuanduLateHan|沙丘]] - next named Yuan-side advance point in this source.
