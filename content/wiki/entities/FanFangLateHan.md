...
type: entity
tags: [person, late-han, military, gongsun-zan, yanzhou]
...
- [[GongsunZan|公孙瓒]] - commander who sends Fan Fang and later uses him as a pressure channel.
- [[LiuDaiLateHan|刘岱]] and [[YanzhouLateHan|兖州]] - local official and province under pressure.
- [[YuanShao|袁绍]] - rival whose family-hostage issue triggers the coercion.
- [[ChengYu|程昱]] - adviser who reads the pressure realistically.
- [[XingshiqingStrategicAssessment|行势情战略评估]] and [[InterestStructuredAllianceFragility|利益结构式联盟脆弱性]] - concepts that explain why the alliance role changes.
