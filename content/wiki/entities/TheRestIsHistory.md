...
- Its South Africa, Brazil, Netherlands, Germany, Britain, and Mussolini World Cup branches use anthems, sport, flags, monarchy, republic, revolt, slavery, dictatorship, propaganda, protest, postwar convention, and constituent-nation football to show how public symbols can be inherited, staged, narrowed, or reworked.
...
- National-symbol branches: [[682-south-africa-mandela-and-the-death-of-apartheid-part-6-glt6535658080]] follows [[SouthAfrica]], [[NelsonMandela]], the [[AfricanNationalCongress|ANC]], [[Afrikaners]], the [[Springboks]], [[RugbyWorldCup1995|1995 Rugby World Cup]], [[NkosiSikelelIAfrika|Nkosi Sikelel' iAfrika]], and [[DieStemVanSuidAfrika|Die Stem]] as a symbolic transition field after [[Apartheid|apartheid]]; [[681-brazil-the-emperors-anthem-part-5-glt5596929385]] follows [[Brazil]], [[BrazilianNationalAnthem]], [[DomPedroI]], [[DomPedroII]], [[FranciscoManuelDaSilva]], [[OsorioDuqueEstrada]], [[BrazilianFlag]], [[FafaDeBelem]], and [[DiretasJa]] as a monarchy-to-republic and protest-symbol field; [[680-the-netherlands-the-revolt-that-made-the-modern-world-part-4-glt4209356543]] follows [[Netherlands]], [[HetWilhelmus]], [[WilliamOfOrange]], [[DutchRevolt]], [[PhilipII]], [[ActOfAbjuration]], and [[DutchRepublic]] as an anthem-of-revolt and loyal-rebellion field; [[679-germany-the-song-hitler-stole-part-3-glt6217148052]] follows [[Germany]], [[GermanNationalAnthem]], [[JosefHaydn]], [[AugustHeinrichHoffmannVonFallersleben]], [[WeimarRepublic]], [[NaziGermany]], [[WestGermany]], [[EastGermany]], [[AuferstandenAusRuinen]], and [[Kinderhymne]] as a burdened-anthem and selective-canonization field; [[678-britain-god-save-the-king-part-2-glt2603959218]] follows [[GodSaveTheKing]], [[UnitedKingdom]], [[England]], [[Scotland]], [[Jacobitism]], [[FlowerOfScotland]], and [[JerusalemHymn]] as an origin-ambiguous anthem and constituent-nation sporting-identity field.
- Sports-politics branch: [[the-fascist-world-cup-mussolinis-football-dictatorship-history-of-the-world-cup-glt5810592007]] follows [[BenitoMussolini]], [[ItalianFascism]], [[PaulRouse]], [[VittorioPozzo]], [[ItalyNationalFootballTeam]], [[FIFAWorldCup1934]], [[FIFAWorldCup1938]], and [[SportsPropagandaEffectUncertainty]] as a football, propaganda, and memory-history field.
...
- Added the Britain anthem branch through God Save the King, Jacobite-Hanoverian repurposing, constitutional monarchy, parody, and England/Scotland football identity.
...
- [[Netherlands]] - national setting for the Dutch anthem and revolt branch.
- [[HetWilhelmus]] - central object in the Netherlands episode's national-symbol reading.
- [[Germany]] - national setting for the burdened-anthem and reunification branch.
- [[GermanNationalAnthem]] - central object in the Germany episode's selective-use reading.
- [[AuferstandenAusRuinen]] - East German anthem used as a contrast and reunification alternative.
- [[GodSaveTheKing]] - central object in the Britain episode's origin-ambiguity and sporting-identity reading.
- [[Jacobitism]] - succession-crisis context for the British anthem's 1745 breakthrough.
- [[Scotland]] - constituent-nation context for the anthem's limits in sporting identity.
- [[FlowerOfScotland]] - Scottish sporting anthem contrasted with the British anthem.
- [[JerusalemHymn]] - possible English alternative to God Save the King.
- [[ConstituentNationSportingIdentity]] - concept grounded by the England/Scotland football anthem problem.
- [[DutchRevolt]] - conflict backfilled by the Netherlands anthem episode and earlier Elizabethan branch.
- [[LoyalRebellion]] - political grammar the show uses to explain the Dutch anthem paradox.
...
- [[SelectiveAnthemCanonization]] - concept grounded by Germany's third-verse anthem settlement.
...
- [[RepublicanRestraintLeadership]] - public-authority pattern grounded by Washington's self-command and resignation.
- [[RevolutionaryMilitarySlaveryContradiction]] - slavery and Black-soldier service contradiction added by the Washington branch.
- [[BenjaminFranklin]] - founding figure at the center of the Franklin branch.
...
- [[Springboks]] - rugby team reframed by Mandela as a shared symbol.
- [[RugbyWorldCup1995]] - event used by the show as a reconciliation ritual.
- [[NkosiSikelelIAfrika]] - hymn and anthem component central to the episode's music-history layer.
- [[SymbolicReconciliationStatecraft]] - concept grounded by Mandela's handling of sport and anthem symbols.
- [[BenitoMussolini]] - ruler whose sport-politics branch extends the show's dictatorship and public-symbol coverage.
- [[ItalianFascism]] - regime context for the Mussolini World Cup episode.
- [[FIFAWorldCup1934]] - football tournament staged as a fascist showcase in the new branch.
- [[FIFAWorldCup1938]] - repeat Italian victory and anti-fascist protest context in the new branch.
- [[AuthoritarianSportsPropaganda]] - concept grounded by the Mussolini sport case.
- [[SportsPropagandaEffectUncertainty]] - methodological caution emphasized by Paul Rouse.
