...
Song You's first source role is facilitative. When He Chang argues that a royal kinsman has been murdered in a guarded capital setting and that investigators are blindly pursuing the wrong direction, Song accepts He Chang's participation in the case. The case is then reviewed with the Three Excellencies' offices and points to Dou Xian.

His second source role is a contrast with Yuan An and Ren Kui. When Three Excellencies and Nine Ministers object that the Northern Xiongnu has not recently invaded and that Dou's expedition is not a state-minded policy, Song becomes afraid and refuses to sign. Other high officials also retreat, while [[YuanAnEasternHan|Yuan An]] and [[RenKuiEasternHan|Ren Kui]] continue arguing.
...
- Source-bounded route using the supplied source's name form.
...
- Created Song You as the Taiwei whose hesitation clarifies the risk environment around Dou Xian.
- Added a contrast node for Yuan An and Ren Kui's persistent anti-expedition remonstrance.

## Relationships

- [[HeChangEasternHan|何敞]] - official whose investigation role Song You accepts in the Liu Chang case.
- [[LiuChangDuxiangHouEasternHan|都乡侯刘畅]] - murder victim whose case Song You helps reopen procedurally.
- [[DouXianEasternHan|窦宪]] - powerful outer-relative whose expedition Song You fears opposing.
- [[YuanAnEasternHan|袁安]] - minister who continues resisting after Song You retreats.
- [[RenKuiEasternHan|任隗]] - minister who continues resisting alongside Yuan An.
- [[ReputationConstrainedWarRestraint|名声约束下的战争节制]] - argument field that Song You does not sustain under fear.
- [[OuterRelativeCourtPower|外戚专权与清算]] - political structure explaining why refusal to sign becomes meaningful.
