...
tags: [person, late-han, frontier, xiongnu, military]
sources:
...
- Xiongnu-protector commander attached to the late stage of the 140 CE Southern Xiongnu revolt.
- Uses frontier-local and Wuhuan forces rather than a purely central army frame.
- Achieves surrender from Che Niu after defeating him at Mayi.
- Leaves a residual rebel problem because Wusi continues resistance.
...
- [[SouthernXiongnu|Southern Xiongnu]] - provides the rebellion theater for Zhang Dan's command.
- [[CheNiuChanyu|Che Niu]] - defeated by Zhang Dan and then surrenders.
- [[WusiSouthernXiongnu|Wusi]] - remains active after Zhang Dan's partial success.
- [[Wuhuan|Wuhuan]] - both an ally pool in the revolt and a force pool in Zhang Dan's campaign.
- [[FortifiedAttritionPatience|Fortified attrition patience]] - contrasts Ma Xu's surrender posture with Zhang Dan's later battlefield cleanup.
