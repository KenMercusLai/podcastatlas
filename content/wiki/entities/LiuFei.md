...
## Current Profile
The current wiki profile presents Liu as a product-minded interviewer whose podcast work spans business storytelling, media-form reflection, AI-era creator questions, and platform operations. In the 半拿铁 special, he helps explain podcast production, audience trust, and brand communication. In the 三五环 interviews with [[WuHankun|吴瀚坤]] and [[Chouxiangzai|抽象仔 / 抽象宅]], he moves that product lens into AI filmmaking, actor displacement anxiety, prompt communication, internet expression, traffic, and the question of what creators want to express when tools lower execution barriers.
...
- He can translate platform safety and risk operations into user-facing questions about trust, interruption, and responsibility.
