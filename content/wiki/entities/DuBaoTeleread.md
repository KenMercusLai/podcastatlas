...
## Overview
读报teleread / 独报 is a Chinese podcast show represented in the wiki by fifth-anniversary specials on creator workflow, writing, podcast form, AI use, and long-term independent podcast sustainability, plus regular reading episodes that connect magazine and academic materials to broader questions about judgment, trust, desire, consumption, and identity.
...
- Its workflow treats article selection, English and news writing, and scripts as core expression rather than only background notes.
...
- Its regular episodes connect disparate articles through larger interpretive threads and often preserve tensions rather than resolving them into simple moral verdicts.
...
- Five-year format history: [[zong-di-069-qi-wu-zhounian-taiqing-teji-da-zhubo-vs-xiao-boke-shang-boke-daodi-you-sha-hao-zuo-de-cmsprzpsb3a8701z6ha7w867u]] describes early medium exploration, a phase of sound-production experimentation influenced by audio drama, and a return to steadier regular episodes and planned specials.
- Writing and selection identity: [[zong-di-069-qi-wu-zhounian-taiqing-teji-da-zhubo-vs-xiao-boke-shang-boke-daodi-you-sha-hao-zuo-de-cmsprzpsb3a8701z6ha7w867u]] says the show is deeply concerned with writing, especially English and news writing, while relying on tacit topic-selection judgments rather than a fixed method.
- Voice-centered workflow: [[zong-di-070-qi-wu-zhounian-taiqing-teji-da-zhubo-vs-xiao-boke-xia-ai-daodi-you-sha-haoyong-de-cmswlihjk12g601zlfjov42ht]] says the show's transcript precision is high and that script writing has to sound like the speaker, not generically like a podcast.
- Selective AI use: [[zong-di-070-qi-wu-zhounian-taiqing-teji-da-zhubo-vs-xiao-boke-xia-ai-daodi-you-sha-haoyong-de-cmswlihjk12g601zlfjov42ht]] describes AI recommendations, material search, and show notes as useful support tasks while rejecting AI-written core scripts.
...
- [[PodcastAuthenticityBoundary]] - the show treats voice, reaction, and disclosure as trust boundaries.
- [[IndependentPodcastSustainability]] - the show illustrates how a small podcast balances energy, money, data, schedule, community, and principles.
- [[AICreativeCollaboration]] - AI is useful as bounded assistance but not as the source of the show's core expression.
