...
卫国 / Wey State appears in [[zizhi-tongjian-zhouji-10-yi-jiazu-danwei-you-mayi-chi-daxiang-de-jingshen-1-lq3t7lwpmq1oyb8zmmmn2tywnu8d]] through a 373 BCE notice: Wey attacks [[QiState|齐国]] in the same year that [[YanState|燕国]] defeats Qi at Linghu and [[LuState|鲁国]] occupies Yangguan.

This page uses "Wey" to avoid colliding with [[WeiState|魏国 / Wei State]], a different Warring States power already present in the wiki. The source also records the death of [[WeyShenggong|卫声公]] and the accession of [[WeyChenggong|卫成公]].

[[zizhi-tongjian-zhouji-11-shijie-fengqi-yunyong-2-llzzalowv5vmbvgd6l-jujltkbyf]] revisits the same succession/title territory but places a Wey ruler rendered as [[WeyShenggong|卫声公]] dying in 362 BCE, followed by a successor styled [[WeyChenggong|卫成侯]]. The episode uses [[Shiji|《史记》]] to read the duke-to-marquis change, and the later move toward lord/ruler language, as deliberate low status before stronger neighbors. This creates a chronology/title tension with the earlier Zhouji 10-derived Wey pages.
...
- [[WeyPinghou|卫平侯]] and [[WeySijun|卫嗣君]] - later succession pair in Zhouji 36.
- [[WeakStateStatusDemotion|弱国名分降格]] and [[LowPostureStatecraft|低姿态权宜]] - title-demotion interpretation added by Zhouji 11 part 2.
- [[WeiState|魏国]] - disambiguation counterpart.
