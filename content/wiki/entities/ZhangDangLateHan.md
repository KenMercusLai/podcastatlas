...
tags: [person, late-han, official, western-regions, frontier, dunhuang]
sources:
...
- Local frontier official whose judgment changes after direct exposure to Dunhuang conditions.
- Policy planner who treats the Western Regions as a buffer necessary to Hexi's survival.
- Offers a ranked menu of action rather than a single maximal military demand.
- Links logistics, allied-polity pressure, and fallback population management in one frontier memo.
- Source-bounded figure currently known only through the 123 CE Western Regions debate.
...
- Created Zhang Dang as the Dunhuang administrator whose three-plan memorial anchors the 123 CE Western Regions debate.

## Relationships

- [[ChenZhongLateHan|陈忠]] - court official who evaluates Zhang Dang's memorial and pushes the anti-abandonment line that Emperor An accepts.
- [[BanYongLateHan|班勇]] - commander appointed to Liuzhong after the debate sparked by Zhang Dang's proposal.
- [[HexiFourCommanderiesLateHan|河西四郡]] - strategic region Zhang says cannot stand if the Western Regions are abandoned.
- [[Xiongnu|北匈奴]] - frontier opponent targeted in Zhang Dang's upper plan.
- [[CheshiHouKingdomLateHan|车师后王国]] - Western Regions polity to be pressured from the rear in Zhang Dang's upper plan.
- [[StrategicFrontierAbandonment|弃边失屏]] - concept modeled by Zhang Dang's argument against treating the Western Regions as disposable.
