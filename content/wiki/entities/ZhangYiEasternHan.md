...
tags: [person, eastern-han, scholar-official, education, remonstrance, personnel-selection]
sources:
...
- Eastern Han doctor-scholar visible in a crown-prince education appointment dispute.
- Uses a pointed question to distinguish family interest from realm interest.
- Corrects Liu Xiu directly enough that the emperor recognizes the error.
- Appointed crown-prince taifu after the remonstrance.
- Shares imperial gifts with Huan Rong after the tutor appointments.
...
The transcript writes this figure as 张义. This page is distinct from [[ZhangYiStrategist|张仪]], [[ZhangYiLateHan|张懿]], and the modern [[ZhangYi]] page. The current evidence does not reconstruct Zhang Yi's wider career, works, or later service.
...
- [[LiuXiu|光武帝刘秀]] - ruler whom Zhang Yi corrects and who appoints him taifu.
- [[YinShiEasternHan|阴识]] - kinship candidate whose selection Zhang Yi blocks on public-interest grounds.
- [[HuanRongEasternHan|桓荣]] - fellow crown-prince teacher appointed in the same episode.
- [[CrownPrinceTutorPublicInterest|太子师傅公器化]] - concept directly grounded in Zhang Yi's argument.
- [[OfficialSelectionChannelCompetition|选官方式竞争]] - related broader issue of whether appointments follow status channels or role-fit criteria.
