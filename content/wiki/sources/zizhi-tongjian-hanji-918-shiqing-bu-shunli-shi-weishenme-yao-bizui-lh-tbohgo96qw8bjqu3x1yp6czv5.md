...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, governance, eunuch-politics, communication]
sources: []
date: 2026-08-01
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》918丨事情不顺利时，为什么要闭嘴？ [lh-tBOhgO96qw8bJqu3x1Yp6CZV5].md"
...
- The late notices on [[CaoCao|曹操]] marrying [[LadyBianCaoCao|卞氏]] and becoming yilang are small but useful prehistory for later Cao-family and court-office branches.

## Key Quotes
> "得意时要守住嘴，事情不顺时更要闭紧嘴。" — opening self-governance frame

> "静就是急，慢就是稳。" — restraint and review frame

> "凶竖多耳目，恐事未会，先受其祸。" — Liu He's risk diagnosis before joining the plot

## Connections
- [[AdversitySilenceDiscipline]] — opening concept for withholding speech while facts, incentives, and risk remain unclear.
- [[LethalPlanLeakageRisk]] — the Liu He-Yang Qiu plot shows the same plan-exposure danger before He Jin's later anti-eunuch failure.
- [[LiuHeSituLateHan]] — situ and royal-clan figure persuaded into the plot.
- [[LiuTiaoLateHan]] — Liu He's brother, whose death in the earlier Dou Wu anti-eunuch attempt gives the persuasion an old-grievance charge.
- [[ChenQiuLateHan]] — Yongle shaofu who urges Liu He to act.
- [[LiuNaLateHan]] — shangshu who argues that a senior minister is useless if he does not support a collapsing state.
- [[YangQiuLateHan]] — Weiwei whose household channel leaks the plot.
- [[ChengHuangLateHan]] — eunuch intermediary bribed and threatened into telling Cao Jie.
- [[CaoJieLateHan]] — eunuch powerholder who turns the leaked plan into an accusation.
...
- [[MaternalStatusSuccessionLeverage]] and [[PrivateAccessTalentChannel]] — He-family selection and succession mechanics.

## Contradictions
- No settled contradiction with existing wiki content is recorded.
- Transcript normalization: the source transcript renders the situ as "刘和" and the brother as "刘条"; this page normalizes them to [[LiuHeSituLateHan|刘郃]] and [[LiuTiaoLateHan|刘鯈]] from the public-domain `资治通鉴` context and keeps them distinct from [[LiuHeLateHan|刘和]], the later son of Liu Yu.
- Chronology caution: this episode compresses later He-family honor language into the He-family rise summary, while existing [[WuyangJun|武阳君]] material preserves the title notice separately. The wiki treats the exact timing of those household honors as source-scoped unless a later source requires correction.
