...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, governance, hostage, eunuch-politics, communication]
sources: []
date: 2026-07-31
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》915丨世上没有真正的口误，这话对吗？ [lgXCODJxnAOZvYEgxQUrgZjI5gUs].md"
...
- [[QiaoXuanLateHan|桥玄]]'s youngest son is abducted at his gate, and Qiao refuses ransom even though officials fear harming the hostage.
- Qiao's memorial turns the case into [[HostageRansomDeterrence|hostage-ransom deterrence]]: private ransom payments are treated as incentives for future kidnappers, so the state has to remove the payoff even at terrible immediate cost.
- The episode compares Qiao's case with [[LiuXiu|刘秀]] in 33 CE, when [[YinLihua|阴丽华]]'s mother and brother are taken hostage and the court still chooses attack over payment.
- 179 CE court notices include an earthquake, Yuan Feng's removal as sikong, [[ZhangJiSikongLateHan|张济]]'s appointment as sikong, and a later eclipse.
- [[WangFuLateHan|王甫]] and [[CaoJieLateHan|曹节]] are presented at a pre-destruction power peak, with family members and retainers occupying offices.
...
> "奸臣王甫。" - corpse-label formula after Wang Fu's death

> "不得以财宝赎。" - no-ransom rule as rendered in the episode

## Connections
- [[CommunicationBoundarySetting]] and [[SocialSignalInterpretation]] - the opening reads offhand speech as a relationship signal and boundary cue.
- [[QiaoXuanLateHan]], [[HostageRansomDeterrence]], [[LiuXiu]], and [[YinLihua]] - hostage cases in which public deterrence overrides private rescue.
- [[HighStatusLawEnforcementSignal]] and [[CriminalLawAsPowerLimitation]] - adjacent law/governance frames for credible rule enforcement and its severe costs.
- [[EmperorLingOfHan]], [[ZhangJiSikongLateHan]], and [[CourtFeedbackCollapse]] - court notices and the ruler's role in authorizing arrests without repairing the wider feedback system.
- [[WangFuLateHan]], [[CaoJieLateHan]], [[WangJiLateHan]], [[YangBiao]], [[YangQiuLateHan]], [[DuanJiongLateHan]], and [[WangMengLateHan]] - the episode's core late-Han prosecution sequence.
- [[TenAttendantsLateHan]], [[PalaceAccessMonopoly]], and [[LethalPlanLeakageRisk]] - downstream setting for Cao Jie's rebound and Yang Qiu's later failed anti-eunuch move.
