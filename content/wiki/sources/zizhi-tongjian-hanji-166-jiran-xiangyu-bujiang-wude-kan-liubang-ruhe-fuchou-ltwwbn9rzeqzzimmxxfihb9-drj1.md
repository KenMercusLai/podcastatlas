...
type: source
tags: [podcast, zizhi-tongjian, han, chu-han, liu-bang, xiang-yu, han-xin, honggou]
sources: []
date: 2026-01-21
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》166｜既然项羽不讲武德，看刘邦如何复仇？ [ltwwBn9rzEqZziMmXXfihB9_DrJ1].md"
...
- Liu Bang strengthens the anti-Chu field by making [[YingBu|英布]] Huainan king, accepting cavalry help from northern groups and [[YanState|燕国]], and ordering respectful transport of dead soldiers back home.
...
- [[XiangYu|项羽]] - weakened Chu ruler who accepts Honggou, returns hostages, and withdraws before Liu Bang reverses course.
- [[LuJia|陆贾]] and [[HouGongChuHan|侯公]] - failed and successful Liu Bang-side negotiators.
- [[HonggouSettlement|鸿沟议和]] - boundary agreement behind the later "楚河汉界" memory.
- [[ZhangLiang|张良]] and [[ChenPing|陈平]] - advisers who frame pursuit as the only way to avoid future Chu danger.
- [[LiuTaigong|刘太公]] and [[LuZhi|吕雉]] - hostages returned by Xiang Yu after the settlement.
- [[YingBu|英布]], [[YanState|燕国]], and [[Xiongnu|匈奴]] - alliance and cavalry-support context that shifts the balance toward Liu Bang; the source says northern groups, not a fully specified Xiongnu polity.
- [[TripartiteBalanceStrategy|三分天下式制衡]], [[PowerExitTrap|权力退场困境]], [[RetainerReciprocityEthic|士为知己者死]], and [[GraceDebtLoyaltyPressure|恩赏负债式忠诚压力]] - Han Xin-side concepts closed or sharpened by the refusal.
- [[InstrumentalTruceBreach|工具化议和毁约]], [[LegitimacyIndictmentWarfare|正当性控诉战]], and [[NonMoralPoliticalAnalysis]] - interpretive frames for Liu Bang's agreement, hostage recovery, and breach.
