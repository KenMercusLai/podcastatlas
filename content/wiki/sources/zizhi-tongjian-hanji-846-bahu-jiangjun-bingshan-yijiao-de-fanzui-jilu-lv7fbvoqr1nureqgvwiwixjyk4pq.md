...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, outer-relative-power, political-persecution, court-politics]
sources: []
date: 2026-07-17
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》846丨“跋扈将军”冰山一角的犯罪记录 [lv7fbvoQr1NurEQGVwIwiXJYK4pq].md"
...
- Liang Ji's power is described as a family-state apparatus: seven marquises, three empresses, six palace guiren, two generals-in-chief, and fifty-seven high officials tie the Liang clan to the court.
- Liang controls information and resources around the emperor by placing eyes near palace guards and imperial attendants and by taking first selection of tribute goods before they reach Huan.
- Wu Shu's refusal to protect Liang's harmful retainers and his later execution of those retainers make local law enforcement a direct challenge to Liang's private network.
...
> "跋扈将军" - the title-level label for Liang Ji's remembered overbearing power.

> "用时间来换空间" - the episode's frame for Emperor Huan's constrained delay before acting.

> "冰山一角" - the source's framing of these cases as a partial record rather than the whole Liang problem.

## Connections

- [[LiangJiLateHan|梁冀]] - central powerholder whose crimes and network control define the episode.
- [[WuShuWanMagistrateLateHan|吴树]] - official whose refusal to shield Liang's retainers ends in poisoning.
- [[HaoMengDongjunLateHan|郝猛]] - new Dong Commandery appointee killed after failing to visit Liang first.
- [[YuanZhuRemonstrantLateHan|袁著]] - young remonstrant hunted and beaten to death after warning Liang to reduce power.
- [[HuWuTaiyuanLateHan|胡武]] and [[HaoJieTaiyuanLateHan|郝杰]] - Taiyuan associates whose cases show household extermination and suicide as kin-protection response.
...
- [[CollateralPunishmentAndGuiltByAssociation|牵连与连坐]] - punishment logic visible in the Hu Wu and Geng Cheng family killings.
