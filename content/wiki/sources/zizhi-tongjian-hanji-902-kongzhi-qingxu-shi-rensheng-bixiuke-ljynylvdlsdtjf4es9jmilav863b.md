...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, emotion-control, eunuch-politics, revenge, remonstrance]
sources: []
date: 2026-07-29
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》902丨控制情绪是人生必修课 [ljYNYlVdLSDTjF4ES9jmIlAV863b].md"
source_url: "https://www.xiaoyuzhoufm.com/episode/6a649c62a3fec224d5a329bd"
duration: "761"
last_updated: 2026-08-26
---

# 《资治通鉴·汉纪》902丨控制情绪是人生必修课
...
- The host frames strength as control over the display and timing of emotion, not emotional absence; this becomes [[StrategicEmotionConcealment|strategic emotion concealment]] rather than ordinary self-help.
- An anonymous Zhuque Gate posting accuses [[CaoJieLateHan|曹节]] and [[WangFuLateHan|王甫]] while also condemning senior officials for silence, but [[EmperorLingOfHan|汉灵帝]] responds by ordering pursuit of the accuser.
- [[LiuMengLateHan|刘猛]] does not aggressively search after deciding the accusation is substantially true, so the court removes him and later lets eunuch-side pressure recode his restraint into punishable failure.
- [[DuanJiongLateHan|段熲]]'s appointment as sili xiaowei turns the case into [[AnonymousRemonstranceSuppression|anonymous remonstrance suppression]]: large-scale arrests reach Taixue students and more than a thousand detainees.
...
> "控制情绪" - title frame for the episode's self-command lesson.

> "不要让家族之外的人知道你的想法" - the Godfather-derived concealment example used in the opening.

> "一夕九徙" - the Zizhi Tongjian phrase the episode uses for Li Hao's terror after Su Buwei's failed attack.
...
- Transcript normalization: the source's 段颎/段炯 is linked to the existing canonical [[DuanJiongLateHan|段熲]] page, and 李浩 is treated as the same route as existing [[LiHaoLateHan|李昊]] pending a stronger source-level variant decision.
- The existing [[WangYu|Wang Yu / 汪玉]] page is unrelated to 王寓; this ingest creates [[WangYuLateHan|王寓 / Wang Yu (late Han)]] to avoid route collision.
