...
type: source
tags: [podcast, zizhi-tongjian, western-han, court-politics, workplace, reputation]
sources: []
date: 2026-04-24
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》453｜官场启示录：同事捅你前，必然忍你很久了 [lnrmyJyeP_XheN3Lmzu2_yhtSuxb].md"
...
- Yang Yun is presented as double-sided: he is Sima Qian's grandson, clean in office, and willing to speak directly, but also boastful, cutting, and fond of revealing others' private faults.
- Dai Changle's quick suspicion of Yang Yun depends less on confirmed evidence than on Yang's known behavioral pattern and accumulated resentments.
...
> "矜伐其行能" - the Zizhi Tongjian characterization used to frame Yang Yun's self-display.

> "好发人阴伏" - the source phrase the host uses for Yang Yun's habit of exposing hidden faults.

## Connections

- [[YangYunWesternHan|杨恽]] - the episode adds the earlier Dai Changle disgrace case, Yang's official strengths, and the reputation pattern that makes later danger intelligible.
- [[DaiChangleWesternHan|戴长乐]] - the counter-accuser whose suspicion and report turn Yang's everyday speech into court risk.
- [[AccumulatedEnmityDefaultSuspicion|积怨式默认怀疑]] - created concept for how repeated sharp conduct makes a person the default suspect when a hidden attack occurs.
- [[HanYanshouWesternHan|韩延寿]] and [[PoliticalExecutionOverreach|政治诛杀过度]] - Yang's defense of Han links this episode to the earlier Xuan-era punishment-severity branch.
- [[YuDingguoWesternHan|于定国]] and [[EmperorXuanOfHan|汉宣帝]] - judicial and imperial actors in the demotion outcome.
- [[NarrativeReframingAsPoliticalAttack|叙事改写式政治攻击]] - Dai's report recategorizes remarks and omen talk as disloyal or disorderly speech.
- [[HistoricalReadingAsSurvivalWisdom|读史处世智慧]] - the closing observer-frame turns the case into practical self-scrutiny about speech, motive, and relationship risk.
