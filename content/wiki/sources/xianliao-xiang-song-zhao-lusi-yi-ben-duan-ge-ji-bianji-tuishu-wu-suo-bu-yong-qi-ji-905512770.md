...
type: source
tags: [podcast, literature, poetry, internet-culture, celebrity, publishing]
sources: []
date: 2025-08-30
source_file: "/home/ken/repos/podcastatlas/content/episodes/【闲聊】想送赵露思一本短歌集--编辑推书,无所不用其极！ [905512770].md"
...
- [[TankaEverydayExpression]] matters because it can hold tiny fatigue, resentment, envy, shame, self-mockery, and tenderness without first converting them into a grand argument.
...
- [[InternetMoralTrial]] is distinguished from criticizing power or systems: the hosts argue against turning partial information about an individual into whole-person condemnation.
...
- Public figures are not treated as naturally deserving violence just because they are richer, more visible, or more successful; the source connects celebrity criticism to wider [[CreatorEvaluationPressure]].
...
- [[PoetryAsEmotionalRelease]], [[ReadingAsLifeExperience]], and [[NonInstrumentalLiteraryReading]] - existing reading and poetry branches extended by the episode.
- [[CreativeRiskAvoidanceCulture]], [[CreatorEvaluationPressure]], and [[CommunicationBoundarySetting]] - adjacent internet-culture and expression-boundary branches.

## Contradictions
- No direct contradiction found. The source complements [[182-zhua-yi-ba-feng-xi-xi-lian-gun-dao-niba-li-qu-xie-shi-he-shucai-liao-tongshi-980330792]] by extending poetry from children's expression into adult fatigue and public vulnerability, and it complements [[177-xiaoshihou-de-shu-zenme-jiu-name-haokan-971996036]] by showing how contemporary internet judgment can narrow expression and publishing risk. Claims about Zhao Lusi are kept source-scoped because the episode itself treats the underlying entertainment-news material as incomplete and mediated.
