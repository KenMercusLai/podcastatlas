...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, emperor-xian, warlordism, cao-cao, lu-bu, yanzhou]
sources: []
date: 2026-08-15
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》986丨天欲其亡，必先令其狂 [lvLvu057-tnz3hAL6oodHyDvZvbd].md"
...
- Li Jue's ritual offering to [[DongZhuo|董卓]] and confused court conversation with Emperor Xian show power joined to insecurity, superstition, and degraded judgment.
- Emperor Xian's third mediation attempt depends on an envoy rather than real command capacity; Guo Si accepts, while Li Jue refuses and turns the dispute into an honor contest.
...
- [[DongZhuo|董卓]], [[LyuBu|吕布]], [[ZhangJiLateHan|张济]], [[YangFengLateHan|杨奉]], and [[BaiboArmy|白波军]] - comparison and pressure field invoked in Huangfu Li's warning to Li Jue.
- [[CaoCao|曹操]], [[LyuBu|吕布]], [[XueLanLateHan|薛兰]], [[LiFengLateHan|李封]], [[YanzhouLateHan|兖州]], and [[BattlefieldInformationControl|战场信息控制]] - military recovery branch before Dingtao.
- [[TaoQianLateHan|陶谦]], [[LiuBei|刘备]], [[Xuzhou|徐州]], and [[RootBasePriority|根本根据地优先]] - strategic temptation that the next episode develops.
- [[ProtectorCaptorAmbiguity|护驾与挟持模糊性]], [[MingqiLegitimacy|名器合法性]], [[PoliticalSurvivalFirst|安全第一政治生存]], and [[XingshiqingStrategicAssessment|行势情战略评估]] - concepts extended or set up by the episode.

## Contradictions
- No settled contradiction found.
- Source-scope caution: the episode's "天欲其亡" judgment, Li Jue psychology, and the unnamed closing adviser are preserved as host framing or preview rather than independent motive proof.
