...
type: source
tags: [podcast, zizhi-tongjian, han, chu-han, xiang-yu, mi-xin, regicide, legitimacy]
sources: []
date: 2026-01-14
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》149｜西楚霸王项羽为何弑君（1） [lsQXS2HZu0NGnrpmZskLKQHTYuvw].md"
...
- The killing gives Liu Bang a usable accusation against Xiang Yu and lets him call lords into a large anti-Xiang coalition, turning the attempted removal of symbolic risk into mobilizing proof.
- [[ChenYu|陈馀]] defeats [[ZhangEr|张耳]] at Xiangguo with Qi support, restores [[ZhaoXie|赵歇]] from Dai to Zhao, and receives the Dai kingship in return.
- Chen Yu stays in Zhao to support Zhao Xie rather than immediately returning to Dai, appointing [[XiaShuo|夏说]] to manage Dai affairs on his behalf.
- Zhang Er flees to Liu Bang after defeat. [[GanGong|甘公]] advises him not to return to Xiang Yu but to join Liu Bang, predicting Liu Bang's future victory.
- [[ZhangLiang|张良]] also moves decisively into Liu Bang's camp after [[HanCheng|韩成]] is killed, turning Han restoration disappointment into stronger Han-side strategy.

## Key Quotes
> "义帝究竟因何而死" - the episode's guiding question.

> "成为号召军队的政治旗号" - the source's explanation of why Mi Xin remained dangerous despite lacking direct military control.

## Connections
- [[MiXin|芈心 / 楚怀王]], [[XiangYu|项羽]], [[ChenxianChangsha|郴县]], and [[RestoredRoyalFigureheadLegitimacy|复国王室名义合法性]] - symbolic authority moved from useful figurehead to perceived threat.
- [[HuaiwangAgreement|怀王之约]], [[GuanzhongRegion|关中]], and [[LiuBang|刘邦]] - the old promise that remains a legal-political weapon after Xiang Yu tries to override it.
- [[YingBu|英布]], [[WuRui|吴芮]], and [[GongAo|共敖]] - kings ordered to execute Xiang Yu's command against Yi Emperor Mi Xin.
- [[CoalitionSettlementFailure|联军战后安排失败]] and [[RewardAllocationBacklash|分配反噬]] - the settlement's unresolved grievances now include the murder of the nominal senior ruler.
- [[ChenYu|陈馀]], [[ZhangEr|张耳]], [[ZhaoXie|赵歇]], [[XiaShuo|夏说]], and [[QiState|齐国]] - Zhao-side settlement reversal after the partition.
