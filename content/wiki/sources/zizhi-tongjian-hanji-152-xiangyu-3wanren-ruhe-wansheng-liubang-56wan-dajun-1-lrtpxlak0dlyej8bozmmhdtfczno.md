...
type: source
tags: [podcast, zizhi-tongjian, han, chu-han, pengcheng, liu-bang, xiang-yu, han-xin, command]
sources: []
date: 2026-01-16
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》152｜项羽3万人如何完胜刘邦56万大军（1） [lrtpxLAK0DLyej8bozMmHdtFczno].md"
...
- The host identifies Liu Bang's largest mistake as failing to put [[HanXin|韩信]] in charge of the main army; Han Xin remained in Guanzhong continuing pressure on [[ZhangHanQin|章邯]].
- The later [[Shiji|《史记》]] story in which Han Xin says Liu Bang can command roughly one hundred thousand while Han Xin is "the more, the better" is used as retrospective evidence of their different command ceilings.
...
- The source treats roughly six hundred thousand as near the practical upper bound for one side in ancient Chinese warfare, with [[WangJianQin|王翦]] and Han Xin named as rare commanders able to handle that level.
...
- Liu Bang's flight with [[LiuYing|刘盈]] and [[LuYuanPrincess|鲁元公主]], including pushing the children from the cart under pursuit, is used to show the extreme danger after the collapse.
