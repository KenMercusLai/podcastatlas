...
type: source
tags: [podcast, zizhi-tongjian, han, eastern-han, harem-politics, succession, outer-relative-power, ritual]
sources: []
date: 2026-06-28
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》751丨窦皇后告诉你：女人不狠，地位不稳 [luvqADCtBfuZIT2acKRqifOuR2C6].md"
...
- [[SongGuirenZhangHeLateHan|Song Guiren]]'s son [[LiuQingQingheKing|Liu Qing]] begins as crown prince, while [[LiangGuirenHeLateHan|Liang Guiren]]'s son Liu Zhao is raised by childless [[EmpressDowagerDouHeLateHan|Empress Dou]] as her own.
- Empress Dou's adoptive-mother claim gives Liu Zhao's succession direct political value for her status and the Dou household.
- Empress Dou works through her mother and family to collect Song-family faults, monitor the Song sisters, and turn a request for rabbit meat during illness into a wugu-style curse accusation.
- [[EmperorZhangOfHan|Emperor Zhang]] accepts the accusation, moves Liu Qing out of the crown-prince palace, deposes him as Qinghe king, and establishes Liu Zhao as crown prince.
- The Song sisters are removed from the inner palace, examined by [[CaiLunLateHan|Cai Lun]] as xiaohuangmen, and die by poison; Song Yang is dismissed and sent home.
- Liu Qing survives by avoiding suspicion and remains outwardly close to Liu Zhao, but equal clothing cannot undo the difference between displaced prince and new heir.
- Zhangdi's handling of [[LiuCangDongpingKing|Liu Cang]] shows royal-family affection through farewell gifts, illness reporting, preservation of memorials, and a high-level funeral.
- Zhangdi's travel order against road work, remote welcomes, and entourage service adds an early low-disturbance governance layer before the later burden-aware Zhangdi episodes.

## Key Quotes

> "弱小就是原罪" - the host's interpretation of why Liu Qing and Song Guiren could be attacked with little resistance.

> "做法诅咒" - the accusation category used against Song Guiren after the rabbit-meat request.

> "一切从简" - the practical frame for Zhangdi's travel order against local display and burden.

## Connections

- [[EmpressDowagerDouHeLateHan|窦皇后 / 窦太后]], [[SongGuirenZhangHeLateHan|宋贵人]], [[LiuQingQingheKing|刘庆]], [[EmperorHeOfHan|刘肇]], and [[MaternalStatusSuccessionLeverage|子以母贵式继承杠杆]] - childless empress, foster motherhood, and crown-prince replacement define the core succession field.
