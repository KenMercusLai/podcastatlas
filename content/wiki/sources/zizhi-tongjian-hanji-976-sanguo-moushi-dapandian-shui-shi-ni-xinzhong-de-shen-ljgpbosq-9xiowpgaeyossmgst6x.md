...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, three-kingdoms, adviser, statecraft]
sources: []
date: 2026-08-13
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》976丨三国谋士大盘点，谁是你心中的神？ [ljGPbosQ-9XIoWpgaEyossmgSt6x].md"
...
- [[XunYu|荀彧]] is presented as Cao Cao's chief adviser and a system designer whose work includes legitimacy language, internal administration, resource coordination, and talent referral.
...
- The closing preview introduces the darker adviser logic later developed as [[DarkAdviserCraft|毒士灰度谋略]]: effective advice may mix public ideal language with coercive or morally uncomfortable technique.
- The [[ChenYinke|陈寅恪]] digression adds reading context and a historiographical note, but it supports the episode's broad theme rather than becoming the main late-Han claim.
...
## Connections
- [[AdviserStateArchitecture|谋士政权架构]], [[XunYu|荀彧]], [[CaoCao|曹操]], [[TuntianSystem|屯田制]], [[LegitimacyWindowSeizure|合法性窗口抢占]], and [[TalentAsStateTreasure|以贤臣为宝]] - Cao-side adviser system, legitimacy, logistics, and talent network branch.
- [[ZhugeLiang|诸葛亮]], [[FaZheng|法正]], and [[LiuBei|刘备]] - Liu Bei-side state-system upgrade branch.
- [[YuanShao|袁绍]], [[JuShou|沮授]], [[TianFengLateHan|田丰]], [[XuYouLateHan|许攸]], and [[CourtFeedbackCollapse|君臣反馈失灵]] - adviser abundance failing to become usable decision capacity.
- [[GuoJia|郭嘉]], [[ChengYu|程昱]], and [[XunYu|荀彧]] - Cao-side adviser team invoked by the episode's "cloud platform" metaphor.
- [[ChenYinke|陈寅恪]] - historiographical reading-list and pronunciation digression.
- [[DarkAdviserCraft|毒士灰度谋略]] - next-episode theme previewed by the "poison and honey" metaphor.

## Contradictions
- No settled contradiction is recorded. The episode is a broad thematic commentary, so its strongest labels, Cao-side team metaphor, Xun Yu administrative attributions, and "陈玉" transcript wording are preserved as source-scoped unless supported by narrower narrative sources.
