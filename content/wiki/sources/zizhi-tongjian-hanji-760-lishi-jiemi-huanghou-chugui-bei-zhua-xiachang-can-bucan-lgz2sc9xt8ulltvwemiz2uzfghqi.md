...
type: source
tags: [podcast, zizhi-tongjian, han, eastern-han, court-politics, outer-relative-power, frontier, qiang, xiongnu]
sources: []
date: 2026-06-30
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》760丨历史揭秘：皇后出轨被抓，下场惨不惨？ [lgZ2sC9XT8ULltVWeMiZ2uzFgHQI].md"
...
- The episode treats the dowager's private relationship with Liu Chang as politically explosive because it could alter access, favor, and inner-court power around Dou Xian.
...
- Three Excellencies and Nine Ministers object that Northern Xiongnu has not recently invaded, but [[SongYouEasternHan|Song You]] retreats from signing the memorial while Yuan An and Ren Kui keep resisting.

## Key Quotes

> "以恩信相待" - Deng Xun's principle for converting threatened Hu groups into allies.

> "开府门" - the source's compact image for receiving endangered frontier families.

> "前后上书十次" - the episode's measure of Yuan An and Ren Kui's persistence.

## Connections

- [[DouXianEasternHan|窦宪]], [[EmpressDowagerDouHeLateHan|窦太后]], and [[PunishmentConvertedToCampaignCommand|死罪转军功式任用]] - the murder case becomes a campaign-command path because family power overrides ordinary liability.
- [[LiuChangDuxiangHouEasternHan|都乡侯刘畅]], [[LiuGangEasternHan|刘刚]], [[HanLengEasternHan|韩棱]], and [[HeChangEasternHan|何敞]] - the investigative branch moves from framed brother to capital culprit.
- [[DengXunEasternHan|邓训]], [[MiTangQiangLeader|弥唐]], [[ShaodangQiang|烧当羌]], and [[FrontierTrustThroughProtection|保护换信任式边疆安抚]] - Deng builds frontier authority by protecting vulnerable Hu groups and then using trust for coalition management.
- [[YuanAnEasternHan|袁安]], [[RenKuiEasternHan|任隗]], [[SongYouEasternHan|宋游]], and [[ReputationConstrainedWarRestraint|名声约束下的战争节制]] - the anti-expedition branch adds the first objection layer before later resistance.
- [[OuterRelativeCourtPower|外戚专权与清算]] and [[CourtFeedbackCollapse|君臣反馈失灵]] - the episode shows how dowager kinship can distort punishment, campaign authorization, and ministerial speech.
