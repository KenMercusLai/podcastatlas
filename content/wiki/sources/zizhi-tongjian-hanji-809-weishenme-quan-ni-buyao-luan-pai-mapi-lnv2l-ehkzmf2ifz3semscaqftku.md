...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, court-politics, advice, flattery, scholar-officials]
sources: []
date: 2026-07-10
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》809丨为什么劝你不要乱拍马屁？ [lnv2l-EhKzmF2Ifz3SEMSCaQFTKu].md"
...
- In 129 CE, Shun's coming-of-age edict links disasters to frugality, reduces imperial food, and tells localities not to present treasures; Wen Long's pearl directly contradicts that public signal.
- The host reads Shun's hard youth, deposed-crown-prince experience, and eunuch-backed accession as reasons he needs early authority signals to be legible and enforced.

## Key Quotes

> "盛名之下，其实难副" - Li Gu's warning about reputation exceeding usable performance.

> "不要把自己的格调拉得那么高" - the host's paraphrase of Li Gu's warning against reputation-only purity.

> "这是谄媚" - Shun's judgment on Wen Long's large-pearl tribute.
...
- [[ScholarOfficialPublicDuty|士大夫公共责任]] - concept sharpened by Li Gu's insistence that imperfect conditions do not erase public service obligations.
- [[AdviceFramingUnderHierarchy|等级场景中的进言包装]] - concept extended by the negative signal case where Wen Long misreads Shun's declared frame.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - Huang Qiong's Shangshu performance shows how real institutional familiarity turns reputation into state capacity.
- [[GuiyangCommanderyLateHan|桂阳郡]] - commandery whose administrator presents the large pearl.
- [[Xianbei|鲜卑]] - frontier raiders in the 128 CE instability notices.
- [[SouthernXiongnu|南匈奴]] - frontier polity whose chanyu succession is recorded in the same early-Shun layer.
