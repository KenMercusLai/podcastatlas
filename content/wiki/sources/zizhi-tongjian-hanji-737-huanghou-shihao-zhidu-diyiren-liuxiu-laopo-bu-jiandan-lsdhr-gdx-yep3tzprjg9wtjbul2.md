...
type: source
tags: [podcast, history, eastern-han, zizhi-tongjian, empress, ritual, frontier, xiongnu, diplomacy, local-governance, buddhism, remonstrance]
sources: []
date: 2026-06-26
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》737丨皇后谥号制度第一人，刘秀老婆不简单！ [lsDhr_gdx-yep3TzPrjG9wTJBUl2].md"
...
- Yin Lihua's 光烈 title is presented as the first major empress-posthumous-title precedent, combining her own moral memory with [[LiuXiu|刘秀]]'s 光武 imperial title.
- Northern Xiongnu raids and trade requests coexist, so Mingdi's willingness to open trade is a pacification gamble rather than simple friendship.
...
> "会示弱的女人才是最强大的" - host's interpretive opening on Yin Lihua's long restraint.

> "绝对不跪" - Zheng Zhong's stance when the Northern Xiongnu chanyu demands a kneeling ritual.

> "崇尚黄老之学、膜拜佛教、斋戒三月" - Mingdi's退赎诏 description of Liu Ying's practice.

> "群臣指出的都是自己的罪过" - Mingdi's self-blame after reading confidential criticism.

## Connections

- [[YinLihua|阴丽华]], [[LiuXiu|刘秀]], and [[ImperialConsortPosthumousTitleSystem|皇后谥号制度]] - the opening branch turns consort memory into dynastic posthumous-title practice.
- [[EmperorMingOfHan|汉明帝]], [[NorthernXiongnuLateHan|北匈奴]], [[SouthernXiongnu|南匈奴]], [[ZhengZhongFrontierEasternHan|郑众]], [[DuliaoCampEasternHan|都辽营]], [[XuguDuhouSouthernXiongnu|虚骨都侯]], [[DiplomaticRitualDignity|使节礼节国威]], and [[FrontierRecognitionCredibilityTradeoff|边疆册封信用权衡]] - the frontier branch shows how trade, envoy ritual, and institutional border control interact.
- [[ZongJunEasternHan|宗均]], [[CleanOfficialCapacityGap|清官能吏能力差]], [[RootCausePacification|查因安抚式治理]], and [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - the local-governance branch treats actual capacity as more important than literary or clean reputation.
- [[LiuYingChuKingEasternHan|楚王刘英]], [[WhiteHorseTemple|白马寺]], [[EarlyChineseBuddhismCourtTransmission|早期中国佛教宫廷传播]], and [[InstrumentalizedReligiousPower|宗教权力工具化]] - the religious branch adds an earlier tolerated Buddhist/Huang-Lao layer before later political suspicion.
- [[ImperialSelfCriticismEdict|帝王自责诏]], [[ReceptiveRemonstranceGovernance|纳谏转政策式治理]], and [[CelestialOmenPoliticalResponsibility|天象政治责任]] - the eclipse branch connects omen politics to concrete self-criticism and feedback publication.
