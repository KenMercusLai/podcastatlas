...
type: source
tags: [podcast, zizhi-tongjian, han, late-han, remonstrance, eunuch-politics, political-survival]
sources: []
date: 2026-07-26
...
- The source treats Xie Bi's later demotion, resignation, arrest by [[CaoShaoLateHan|Cao Shao]], torture, and prison death as the cost of direct collision with a powerful faction.
- Yang Ci's snake-omen memorial offers a different route: he says omens reflect the ruler's inner condition, then shifts the critique toward royal authority, harem influence, outer-relative power, and separation of inner and outer domains.
- Yang Ci survives because he neither demands explicit redress for Dou Wu and Chen Fan nor directly condemns the eunuch group, making this a source case for [[ObliqueRemonstranceSelfProtection|迂回进谏自保]] inside [[PoliticalSurvivalFirst|安全第一政治生存]].

## Key Quotes

> "一半君子，一半小人" - the host's shorthand for pairing benevolent intent with hard-edged means.

> "先保住命才能干事" - the episode's survival-first lesson after contrasting Xie Bi and Yang Ci.

> "贸然辞职等于下了牌桌" - workplace analogy for losing future agency by exiting too early.
...
- No settled contradiction with existing wiki pages was found. The source backfills the pre-Hanji-891 court-remonstrance layer and reinforces later pages' emphasis on late-Han eunuch power, court feedback failure, and political survival.
- Transcript normalization: "张宦" is normalized to [[ZhangHuanLateHan|张奂]], "谢毕" to [[XieBiLateHan|谢弼]], "杨次" to [[YangCiLateHan|杨赐]], "曹杰" to [[CaoJieLateHan|曹节]], and "李英" to [[LiYingLateHan|李膺]] because the roles and late-Han context match the established canonical pages.
- Scope caution: the episode's workplace lessons about dealing with "小人" are recorded as source-scoped interpretation, not as a general moral endorsement of manipulation.
