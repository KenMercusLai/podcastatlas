...
sources: []
date: 2026-08-23
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》1024丨勇冠三军吕布，为何始终一事无成？ [lkFuM6S9GIN_VTFrjkxIm9yUkSHJ].md"
...
- The episode links focus with subtraction, using the Daoist line "少则得，多则惑" to argue that disciplined desire gives a person direction while too many aims produce disorder.
- In 198 CE, Lü Bu again connects with Yuan Shu and sends Gao Shun and Zhang Liao to attack Liu Bei at [[PeiCounty|小沛]].
- Cao Cao sends [[XiahouDun|夏侯惇]] to relieve Liu Bei, but Xiahou Dun is defeated; Gao Shun captures Pei and Liu Bei's wife and children.
- [[XunYou|荀攸]] urges Cao Cao to attack Lü Bu before Lü Bu's courage and Yuan Shu's support can form a larger Huai-Si threat.
- Taishan-associated leaders [[ZhangBaLateHan|张霸]], [[SunGuanLateHan|孙观]], [[WuDunLateHan|吴敦]], [[YinLiLateHan|尹礼]], and [[ChangXiLateHan|昌豨]] attach themselves to Lü Bu, increasing the urgency of Cao Cao's move.
- Chen Gong advises Lü Bu to strike Cao Cao while Cao's army is still arriving and tired; Lü Bu refuses, saying he will wait and use the [[SiRiver|泗水]] against Cao Cao.
- After Cao Cao reaches Xiapi, [[ChenDeng|陈登]] leads the vanguard, Lü Bu loses repeated fights, withdraws into the city, and becomes fearful enough to consider surrender after Cao sends a letter.
...
- [[QingYuQuJiu|轻于去就]], [[JiFuBaoYang|饥附饱扬]], [[WarCostTempoDiscipline|战争成本与速决纪律]], [[LongTermAchievementDiscipline|长期成事纪律]], [[LyuBuFactionalBalance|吕布集团派系平衡]], [[CourtFeedbackCollapse|君臣反馈失灵]], [[XingshiqingStrategicAssessment|行势情战略评估]], and [[CredibleForceDisplayDeterrence|可信武力展示威慑]] - conceptual frames for unstable affiliation, supply-timing discipline, self-command, command trust, and prior successful force display.

## Contradictions
- No settled contradiction found. The source qualifies single-cause readings of Lü Bu's fall by moving the failure earlier than the alcohol-ban and water-siege triggers: his initiative is already weakened by rejected advice, abandoned plans, unstable trust, and dependence on Yuan Shu's rescue.
- Source-scope caution: the episode's philosophical frame reads Lü Bu through desire, focus, humility, and mental order; those are interpretive judgments, not independent proof of inner motive.
