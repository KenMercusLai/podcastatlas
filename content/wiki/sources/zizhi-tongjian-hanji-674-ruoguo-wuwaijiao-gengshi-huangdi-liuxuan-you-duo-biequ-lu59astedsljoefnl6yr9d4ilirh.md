...
type: source
tags: [podcast, zizhi-tongjian, eastern-han, gengshi-regime, chimei, xiongnu, diplomacy, military-logistics]
sources: []
date: 2026-06-11
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》674丨弱国无外交！更始皇帝刘玄有多憋屈？ [lu59asTeDslJoEFNL6yR9d4iLIrh].md"
source_url: "https://www.xiaoyuzhoufm.com/episode/6a1c43aaac7bdb080c33b4c9"
duration: "620"
last_updated: 2026-09-02
---

# 《资治通鉴·汉纪》674丨弱国无外交！更始皇帝刘玄有多憋屈？
...
- Liu Xuan still claims restored-Han legitimacy after Wang Mang, but the episode frames his authority as wider in name than in enforceable control.
- Xie Gong's Yecheng force collapses when Liu Xiu sends Wu Han and Cen Peng to seize the city while Xie Gong is away, after which Xie Gong is captured and killed.
- Gongsun Shu defeats Liu Xuan's Hanzhong/Shu expedition through Gongsun Hui at Mianzhu, then calls himself Shu King from Chengdu and receives local and Yi attachments.
- Liu Xuan's Xiongnu mission fails even after sending Liu Sa and Chen Zun with old Han-style seals and returned kin; the chanyu reverses the hierarchy by claiming Han owes Xiongnu respect.
- Chimei commanders split routes in Yingchuan, face troops who want to go home east, and choose a westward Chang'an campaign partly to preserve army cohesion.
- Liu Xiu anticipates that Chimei will break Chang'an, sends Deng Yu west with 20,000 elite troops and authority to choose subcommanders, and reserves Guanzhong for a later exhausted-field move.
- Liu Xiu treats Henei as a strategic rear area against Luoyang and Bingzhou pressure, appointing Kou Xun to stock grain and manufacture weapons while Feng Yi covers Mengjin.
- Wei Xiao protects himself by reporting Wei Cui and Wei Yi's Tianshui-return plot to Liu Xuan, who kills them and appoints Wei Xiao yushi dafu.
- Liu Yong, Qin Feng, and Tian Rong show the eastern theater fragmenting into local title claims, county seizures, and large armed followings.

## Key Quotes

> "弱国无外交" - the episode's title-level frame for Liu Xuan's failed attempt to restore old Han-Xiongnu status order.

> "汉朝应该反过来尊敬匈奴" - the chanyu's status reversal as summarized in the episode.

> "把他比作当年高祖把关中交给萧何" - Liu Xiu's trust comparison for Kou Xun's Henei rear-area role.

## Connections

- [[LiuXuanGengshiEmperor|更始帝刘玄]], [[Xiongnu|匈奴]], and [[CapacityBackedDiplomaticHierarchy|实力支撑的外交名分]] - the source shows old diplomatic hierarchy failing when the Gengshi court cannot make its status claims credible.
