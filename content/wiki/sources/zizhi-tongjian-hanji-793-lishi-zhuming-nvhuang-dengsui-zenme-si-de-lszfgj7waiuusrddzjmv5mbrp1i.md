...
type: source
tags: [podcast, zizhi-tongjian, han, eastern-han, late-han, regency, court-politics, disaster, frontier, remonstrance]
sources: []
date: 2026-07-07
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》793丨历史著名女皇邓绥怎么死的？ [lsZFgj7waiUUsrD_DZjmV5mBRP1I].md"
...
## Key Claims
- Empress Dowager Deng's exact death cause remains unspecified: the episode says she becomes ill in the second month of 121 CE, issues an amnesty, dies on the thirteenth day of the third month, and is buried later that month.
...
## Key Quotes
> "邓太后身体不舒服" - the source's only concrete death-cause language before the later death date.

> "灾变连年" - the episode's compressed description of the crisis background during Deng's regency.

> "政治才能、格局都超过很多男性皇帝" - the host's positive evaluation after acknowledging criticisms of Deng.

## Connections
- [[EmpressDowagerDengLateHan]] - regent whose illness, death, and retrospective governance record are the episode's center.
- [[EmperorAnOfHan]] - ruler whose personal rule begins after Deng's death through personnel restoration and natal-lineage honors.
- [[DuGenLateHan]] - return-power remonstrant who survives execution, hides for fifteen years, and is restored under An.
- [[ChengYishiLateHan]] - second return-power remonstrant restored after Deng's death and appointed shangshulang.
- [[ChenZhongLateHan]] - shangshu whose recommendations of Yin Yi, Du Gen, and Cheng Yishi are accepted at the start of An's personal rule.
- [[MaXianLateHan]] - Protector of Qiang whose Lu Cong execution and Du Chong campaign add an earlier Qiang-front layer.
- [[BanYongLateHan]] - later frontier restorer invoked as the figure who repairs the Western Regions/Silk Road problem after Deng-era failures.
- [[GoguryeoLateHan]] - frontier opponent whose renewed Xuantu and Liaodong attacks remain active during the transition.
- [[YaoGuangLateHan]] - Liaodong administrator named in the Goguryeo response.
- [[FengHuanLateHan]] - Youzhou inspector named in the Goguryeo response.
- [[RegencyUnderCompoundCrisis]] - concept created from Deng's regency being judged under simultaneous disaster, frontier, fiscal, and legitimacy pressure.
- [[CrisisWithdrawalSelfProtection]] - concept sharpened by Du Gen's feigned death, long concealment, and avoidance of implicating old contacts.
- [[QueenMotherRegency]] - broader regency form to which Deng's case belongs.
