...
type: source
tags: [podcast, zizhi-tongjian, han, xiongnu, liu-bang, baideng]
sources: []
date: 2026-01-25
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》177｜被困白登山 刘邦命悬一线 [ljDmXF6beJ8Ju0GmVM9cp48GY0ON].md"
...
- Liu Bang's earlier suspicion of Han Wang Xin becomes self-confirming after the surrender: Han Wang Xin now has little path back to Han and fights in association with Xiongnu.
- Liu Bang initially treats the new Xiongnu opponent cautiously by sending repeated envoys, with [[ChenPing|陈平]] involved in the reconnaissance and diplomatic probing.
- The repeated envoy reports of weak horses, sick livestock, and low morale are the episode's false-signal field; the source presents them as information deliberately released by Modu.
- [[LouJing|刘敬]] reads the asymmetry correctly: an enemy that only displays weakness before a major battle is likely hiding strength and preparing an ambush.
- Liu Bang's decision to punish Liu Jing and continue the advance turns reconnaissance disagreement into command failure.
...
> "四十多万匈奴骑兵包围白登山和平城" — the source's scale marker for the trap.

> "只是围困，也可能把刘邦活活耗死" — the episode's explanation of why the crisis is lethal even without an immediate assault.

## Connections
- [[HanWangXin|韩王信]], [[Mayi|马邑]], [[FrontierVassalContainment|边境迁封式牵制]], and [[DifferentSurnameKingSuspicion|异姓诸侯王猜忌]] - Mayi's surrender becomes the armed breach that follows a frontier-vassal trust failure.
- [[LiuBang|刘邦]], [[LouJing|刘敬 / 楼敬]], [[ChenPing|陈平]], and [[BattlefieldInformationControl|战场信息控制]] - envoys, false weakness, rejected warning, and command judgment before Baideng.
- [[MaoDunChanyu|冒顿单于]], [[Xiongnu|匈奴]], [[NomadicCavalryRaidingAsymmetry|游牧骑兵劫掠不对称]], and [[LureEnemyOutOfPosition|诱敌离位]] - Modu's mobility-based shift from direct fighting to controlled weakness and encirclement.
- [[BaidengEncirclement|白登之围]], [[BattlefieldEncirclementLogistics|战场围困与断粮]], and [[WesternHanDynasty|西汉]] - early Han's frontier crisis as a winter encirclement and regime-level shock.
- [[Shangdang|上党]], [[TaiyuanWarringStates|太原]], and [[Jinyang|晋阳]] - campaign geography between Han Wang Xin's defeat, Han's northward movement, and the Xiongnu-facing frontier.
