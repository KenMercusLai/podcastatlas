...
sources: []
date: 2026-01-15
source_file: "/home/ken/repos/podcastatlas/content/episodes/《资治通鉴·汉纪》150｜陈平为何被称之为成功政治家“样板”？（3） [lhFBm3TWyxHyvoKpHf8hC9ssBlQj].md"
...
- After Lu Zhi dies, Chen Ping joins [[ZhouBo|周勃]] and the Liu-family restoration move against the Lu clan, then helps install [[LiuHeng|刘恒 / Emperor Wen of Han]].
- The episode contrasts Chen Ping with [[ZhangLiang|张良]], [[XiaoHe|萧何]], [[CaoShen|曹参]], and Zhou Bo to clarify that his excellence is adaptability, discretion, and risk control rather than moral charisma or independent institutional command.
...
## Key Quotes
> "智有余，然难以独任" - the source's compact role-boundary judgment on [[ChenPing|陈平]].
...
## Connections
- [[ChenPing|陈平]] - central figure; this source extends him from early resource accumulation and Liu Bang-side appointment into three-court survival.
- [[LiuBang|刘邦]] - ruler who trusts Chen Ping for hidden inducement work while still seeing limits on independent responsibility.
- [[LuZhi|吕雉]], [[WangLingHanMinister|王陵]], and [[ZhouBo|周勃]] - regency and old-minister setting in which Chen Ping avoids being trapped by a losing stance.
- [[LiuHeng|刘恒 / Emperor Wen of Han]] and [[WesternHanDynasty|Western Han]] - post-Lu transition endpoint in the source's account.
- [[ZhangLiang|张良]], [[XiaoHe|萧何]], and [[CaoShen|曹参]] - comparison set for different kinds of founding-minister value.
- [[CovertPoliticalTechnology|阴谋式政治技术]] - already opened in part 2 and here extended to bribe-funded enemy division and secret work.
...
- [[zizhi-tongjian-hanji-150-chenping-weihe-bei-cheng-zhiwei-chenggong-zhengzhijia-yangban-4-lhhprrkjcuzijgndi2uuazaalern|汉纪 150 part 4]] - continuation that adds the White Mount, Fan Kuai, Lu-regency camouflage, and worldly-cultivation episodes.
