...
History and geopolitics center on late-Han collapse, now backfilled by Hanji 904's 173-174 CE disaster, office-churn, eunuch-family access, and Cao Cao career-entry layer, plus Warring States reform, Elizabethan security, Northern Ireland, infrastructure, and technology ecosystems.
...
Work and society claims emphasize implementation and visibility: Hanji 904 adds Cao Cao's access-appraisal appointment path before later reputation and education channels, while AI, labor, social order, and retreat narratives depend on ownership, constraints, standards, and judgment.
