...
## [2026-08-06] ingest | 80.间谍与叛徒：恕我直言，007的故事弱爆了（上）

Added source page for a 蜜獾吃书 episode on Ben Macintyre's 《间谍与叛徒》, Oleg Gordievsky, KGB, MI6, Denmark, Prague Spring, Operation Sunbeam, Operation Pimlico, ideological defection, totalitarian double life, Cold War spycraft, and source protection. Created pages for 《间谍与叛徒》, Ben Macintyre, Oleg Gordievsky, KGB, MI6, Kim Philby, Operation Sunbeam, Operation Pimlico, Ideological Defection, Totalitarian Double Life, Cold War Spycraft, and Spy Source Protection; updated overview, index, 蜜獾吃书, 秦总, Soviet Union, Denmark, United Kingdom, BBC, Prague Spring, Ideological Totalization Risk, Insider Dissent Strategy, Administrative Opacity As Control, and Principled Disobedience. No direct contradiction found; the source extends the wiki's dissent and Soviet branches by adding a covert intelligence case where internal rejection becomes high-risk collaboration with a foreign service.
...
## [2026-08-05] ingest | Bytes: Week in Review - Are we in an AI bubble?

Added source page for a Marketplace Tech Bytes episode with David Kirsch on whether the AI boom is a technology bubble. Created pages for David Kirsch, University of Maryland, Bubbles and Crashes, Tech Bubble Conditions, and AGI Narrative; updated overview, index, Marketplace Tech, Megan McCarty-Corino, AI Equity Valuation Risk, Bubble Necessary Conditions, Statistical Bubble Indicators, Productive Bubble Spillovers, Technology Installation Cycle, Data Center Debt Risk, AI Infrastructure Debt Financing, AI IPO Valuation, ChatGPT, Google, and Anthropic. No direct contradiction found; the source reinforces existing AI-bubble and infrastructure-cycle pages while qualifying them with Kirsch's seven-out-of-eight score, limited pure-play IPO signal, and distinction between AI service dependence and investor return certainty.
...
## [2026-07-06] ingest | 高手怎么用 AI？普通人怎么学 AI？投资人如何投 AI？｜对谈课代表立正

Added source page for a Shizilukou Crossing episode on advanced AI use, agent workflows, context engineering, AI skills, FDE, and AI investment themes. Created supporting entity and concept pages for the major tools, organizations, roles, and AI themes discussed in the source.

## [2026-07-06] ingest | 阿里千问离职余震，在几万人的铁球里如何体面生存

Added source page for a Keji Luandun episode on Lin Junyang's Qwen departure, Alibaba's open-source model strategy, commercial pressure, large-company organization, star talent, and AI-era judgment. Created supporting pages for Qwen, Alibaba, Lin Junyang, DeepSeek, and core organizational concepts; updated existing AI skills, agentic workflow, and context engineering pages.
...
## [2026-07-06] ingest | 为什么公司用不好AI？从焦虑到行动的 3 个关键动作｜对谈百融智能张韶峰

Added source page for a Shizilukou Crossing episode on Bairong Intelligence, Zhang Shaofeng, digital employees, dark-office automation, outcome-based AI pricing, contact-center agents, AI-enabled BPO/professional services, and practical enterprise AI rollout. Created supporting pages for Bairong Intelligence, Zhang Shaofeng, Baijian, Dark Office, Outcome-Based AI Pricing, AI BPO Roll Up, and Contact Center AI; updated overview, index, Shizilukou Crossing, Open Claw, digital employees, business-led AI transformation, service as software, product-led willingness to pay, software payment culture, agent-facing interfaces, agentic workflow, AI commercialization pressure, and AI organization design pages.
...
## [2026-07-07] ingest | EP57 美股动荡，东升西降？这回是走是留

Added source page for a YiLaoYongYi episode on U.S. equity volatility, Trump/Fed policy pressure, retail investor crowding, mega-cap concentration, DeepSeek-driven AI valuation repricing, Tesla as a valuation example, defensive dividend assets, index reentry discipline, Hong Kong tech repricing, and contrarian sentiment indicators. Created supporting entity and concept pages for Donald Trump, Jerome Powell, Goldman Sachs, JPMorgan Chase, Tesla, HSBC, Nasdaq Composite, S&P 500, Hang Seng Tech Index, Xiaomi, Mega-Cap Concentration Risk, Retail Investor Crowding, Defensive Dividend Assets, Index Reentry Discipline, Hong Kong Tech Repricing, and Contrarian Sentiment Indicators; updated overview, index, YiLaoYongYi, LaoMai, Daxiong, Federal Reserve, U.S. Treasury, DeepSeek, Nvidia, Alibaba, Tencent, AI Equity Valuation Risk, Investment Risk Management, Market Regime Shift, Market Mean Reversion, Passive Investing, and U.S. Recession Risk pages.
...
## [2026-07-07] ingest | e.l.f. Cosmetics: Joey Shamah. The Dollar Store Formula That Built a Cosmetics Giant

Added source page for a How I Built This episode on Joey Shamah, Scott Vincent Borba, e.l.f. Cosmetics, one-dollar beauty, media-driven e-commerce, H-E-B retail validation, the Bloomingdale's rumor spike, Target tiering, TSG/TPG transitions, and Joey's post-e.l.f. companies. Created supporting pages for the main people, companies, retailers, investors, and concepts around low price brand perception, retail incrementality, direct-to-consumer cash flow, and accidental virality; updated overview, index, How I Built This, Guy Raz, CPG distribution, retail shelf placement, sales velocity, distribution-led product building, customer pull, product-led willingness to pay, fast product validation, validated learning, founder cash-flow constraint, founder role transition, post-acquisition founder identity, stage-appropriate hiring, startup governance, and financial gravity.
...
## [2026-07-07] ingest | Advice Line with Shazi Visram of Happy Family Organics

Added source page for a How I Built This Advice Line episode on Shazi Visram, Happy Family Organics, Healthy Baby, Freit Barefoot, Sprinkle Bites, Plantamica, proof reuse, AI-mediated product discovery, private-label brand risk, and retail-pilot validation. Created supporting pages for Shazi Visram, Happy Family Organics, Healthy Baby, Freit Barefoot, Sprinkle Bites, Plantamica, Andrew Graff, Thrive Market, Proof Point Reuse, and Private Label Brand Risk; updated overview, index, How I Built This, Guy Raz, CPG distribution, mission-driven customer education, distribution-led product building, customer pull, category creation, local market proof, AI discovery SEO, generative engine optimization, fast product validation, product-led willingness to pay, in-store demos, sales velocity, purpose-driven business, direct-to-consumer cash flow, and founder cash-flow constraint pages.

## [2026-07-07] ingest | 20 个问题，搞懂 OpenClaw：爆红机制、本质变化、创业机会

Added source page for a Shizilukou Crossing episode on OpenClaw's virality, IM entry points, local execution, persistent memory, skills, tool feedback loops, and consumer/enterprise agent opportunities. Created supporting pages for 鸭哥, 豪大, IM Agent Interfaces, and Local Agent Execution; updated overview, index, OpenClaw, Shizilukou Crossing, agent-native software, agent permission boundaries, persistent agent memory, agent harness, human-agent collaboration, AI skills, digital employees, agentic workflow, agent-facing interfaces, proactive agents, outcome-based AI pricing, and AI inference cost structure pages.
...
Added source page for the Drum Tower Acast-feed copy of the Economist Podcasts trailer introducing John Prideaux's Tocqueville Road Trip, which retraces Alexis de Tocqueville's 1831 U.S. journey and uses Democracy in America to ask whether the United States still functions as a democratic idea. Updated Economist Podcasts, Tocqueville Road Trip, Alexis de Tocqueville, John Prideaux, Democracy in America, America as Idea, American Democratic Resilience, United States, overview, and index. No direct contradiction found; the source duplicates the existing Tocqueville Road Trip trailer under a different source URL and reinforces the America-at-250 historical comparison.
...
## [2026-07-09] ingest | No.200 电商三国之群雄逐鹿：腰挂公章、持剑拒签，以及 108 种死法

Added source page for a 半拿铁 episode on China ecommerce failure modes across early B2C/C2C, vertical ecommerce, mother-and-baby, beauty, social fashion, luxury, old retail, cross-border import, fresh grocery, community group buying, and instant retail. Created company pages for JD.com, 8848, EachNet, Joyo/Amazon China, Dangdang, PPG, Vancl, Redbaby, Mia, Beibei, BabyTree, Mecox Lane, Jumei Youpin, Lefeng, Mogujie, Meilishuo, Secoo, Vipshop, Yihaodian, Suning, Gome, Baidu Youa, NetEase Yanxuan, Xiaomi Youpin, NetEase Kaola, Yangmatou, Yiguo, Missfresh, Dingdong Maicai, Pupu Supermarket, Hema, Da Luobo, Xingsheng Youxuan, Duoduo Maicai, Meituan Youxuan, and Taocaicai; created concepts for Chinese Ecommerce Platform History, Ecommerce Platform Failure Modes, Ecommerce Surface Metrics Risk, Vertical Ecommerce Failure Modes, Platform Dependency Risk, Fresh Grocery Ecommerce Economics, Community Group Buying, Instant Retail, and Ecommerce Fulfillment Complexity; updated overview, index, Banlatte, Alibaba, Taobao, Pinduoduo, Meituan, Amazon, NetEase, Xiaohongshu, Startup Governance, Asset-Light Vs Heavy-Asset Models, Inventory Write-Down Risk, Profit And Cash Flow Quality, and Local-Life Platform Dependency. No direct contradiction found; the source qualifies the wiki's platform and consumer-brand branches by showing that traffic, subsidy, valuation, listing, and GMV can coexist with weak cash conversion, inventory pressure, governance conflict, platform-rule exposure, and fulfillment costs.
...
## [2026-07-10] ingest | Stefan Sagmeister: Finally, something good.

Refreshed the existing Long Now source page for Stefan Sagmeister's "Finally, something good." from `/home/ken/repos/podcastatlas/content/episodes/02026-sagmeister-podcast-v2 [02026-sagmeister-podcast-v2].md`. The file matched the already-ingested episode, so no duplicate source page was created; provenance was updated with the podcast export path, audio URL, duration, and a source note. Updated Rebecca Lendl, Lisa K. Solomon, Stefan Sagmeister, Long Now, and index entries to clarify the podcast introduction and Q&A roles. No direct contradiction found; the source continues to support the wiki branch around informed optimism, short-term news bias, progress data visualization, positive journalism, and AI-era design judgment.
...
## [2026-07-12] ingest | 48.开市大吉：第一流的幽默讽刺

Added source page for the 蜜獾吃书 episode on 老舍, 《开市大吉》, humorous satire, theater and cinema etiquette, fake medical authority, childbirth ritual conflict, and workplace renqing order. Created pages for 老舍, 《开市大吉》, 《话剧观众须知二十则》, 《有声电影》, 《抱孙》, 《不成问题的问题》, Lao She Satirical Humanism, Civic Audience Etiquette, Medical Scam Packaging, Birth Ritual Medical Conflict, and Renqing Order; updated overview, index, 蜜獾吃书, and Workplace Hidden Rules. No direct contradiction found; the source complements the healthcare branch by showing medical trust failure before internet platforms and extends the workplace branch with a literary case where informal relationship order can defeat formal competence.
...
3322 nodes, 33801 edges (33801 extracted, 0 inferred).
...
## [2026-07-14] ingest | 156.一个阿富汗女人的来信: 纸上的光，和出版背后的故事

Added source page for the 蜜獾吃书 episode with 有光 editor 安琪 on 哈迪亚·海达里's 《一个阿富汗女人的来信》, Afghan women's first-person writing, protection as control, war's gendered civilian harm, Persian-to-Chinese translation, cross-border royalty support, cover ethics, and editing as cultural project management. Created pages for 哈迪亚·海达里, 《一个阿富汗女人的来信》, 安琪, 有光, 洪蔚琳, 正面连接, Afghanistan, Afghan Women First-Person Writing, War Gendered Civilian Harm, Protection As Control, Literary Publishing As Material Support, Translation Publishing Workflow, and Editor As Cultural Project Manager; updated overview, index, 蜜獾吃书, 秦总, Female Self-Possession, Non-Instrumental Literary Reading, and Cross-Border Fund Transfer Risk. No direct contradiction found; the source extends existing reading and women's-agency branches into a case where literature, witness, publishing logistics, and material author support are tightly connected.

## [2026-07-14] lint | Wiki health check

Ran lint. See lint-report.md for details.

## [2026-07-14] ingest | 71.美妆帝国蝴蝶牌：言情小说家的国货创业往事

Added source page for the 蜜獾吃书 episode on 林玉沁's research into 陈迭仙, 蝴蝶牌, 家庭工业社, 《女子世界》, Republican-era cosmetics, household chemistry, national-goods branding, and vernacular industrialism. Created pages for 陈迭仙, 林玉沁, 蝴蝶牌, 家庭工业社, 《女子世界》, Vernacular Industrialism, and National Goods Branding; updated overview, index, and 蜜獾吃书. No direct contradiction found; uncertain claims around the possible grave and the actor Hu Die endorsement thread are kept source-scoped.
...
## [2026-07-14] ingest | 假期摸鱼更健康

Added source page for the 蜜獾吃书 holiday "摸鱼天窗" episode on Dali life, rest, the show's first half-year, and why stories can build empathy better than abstract argument alone. Created pages for Story-Based Empathy, Restorative Creative Pacing, 郭静龙, 《盛世的崩塌》, 《绿色星球》, Roger Zelazny / 罗杰·泽拉兹尼, 《光明王》 / Lord of Light, Francis Fukuyama / 福山, and 《身份政治》; updated overview, index, 蜜獾吃书, 北明 / 北民, Reading As Life Experience, Non-Instrumental Literary Reading, Classic Reading Complexity, Empathy As Aesthetic Capacity, and Empathy Circle Expansion. No direct contradiction found; future book and author mentions are stored as source-scoped previews rather than full treatments.

## [2026-07-14] ingest | 51.厌世？反人类？童话故事？…格列佛游记可深了去了

Added source page for the 蜜獾吃书 episode on 《格列佛游记》, Jonathan Swift, Lilliput and Brobdingnag scale reversal, Laputa's technical domination, Balnibarbi Academy absurd rationality, Houyhnhnm pure rationality, and the author-character separation needed for Gulliver's final misanthropy. Created pages for 《格列佛游记》, Jonathan Swift, Lemuel Gulliver, Laputa, the Houyhnhnms, George Orwell, Harold Bloom, 洪涛, Thomas Hobbes, Niccolo Machiavelli, Scale Reversal Satire, Technocratic Domination Satire, Pure Rationality Trap, Fixed Human Nature Politics, and Author-Character Separation; updated overview, index, 蜜獾吃书, Adult Satire In Children's Classics, Classic Reading Complexity, Non-Instrumental Literary Reading, and Absurd Rationality. No direct contradiction found; the source qualifies Swift's "anti-human" reputation by reading disgust as satirical warning and moral care rather than a simple doctrine of human hatred.
...
## [2026-07-14] ingest | 55.安徒生童话：海的女儿和不灭的灵魂

Added source page for the 蜜獾吃书 episode on 安徒生童话, 《海的女儿》, children's classics as all-ages literature, satire, death, spiritual aspiration, 叶君健's translation, Disney adaptation debate, and the rejection of "恋爱脑" as a sufficient reading. Created pages for 安徒生 / Hans Christian Andersen, 《海的女儿》 / The Little Mermaid, 叶君健 / Ye Junjian, Adult Fairy-Tale Reading, Fairy-Tale Death And Spirituality, and Adaptation Original-Text Confusion; updated overview, index, 蜜獾吃书, The Walt Disney Company, Classic Reading Complexity, Adult Satire In Children's Classics, Non-Instrumental Literary Reading, and Reading As Life Experience. No direct contradiction found; the source extends the literature branch from Swift/Munchausen childhood-classic rereading into Andersen's fairy-tale sadness, translation, moral agency, and source-text versus adaptation memory.
...
Ran lint after health passed. Health found no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint scanned 3,570 pages and found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-12 with 3,408 nodes and 34,723 edges while the wiki scan found 3,570 pages; they found no hub stubs, two fragile bridges, and no isolated communities, but should be refreshed with `build graph` before treating graph findings as final. Semantic lint via LiteLLM failed because `LLM_MODEL` is not provider-qualified. A local metadata pass also found one missing source slug in `wiki/concepts/DomainExpertAlignment.md`. No `wiki/lint-report.md` file was saved.

## [2026-07-14] ingest | 56.伴生：世界破破烂烂，小动物缝缝补补

Added source page for the 蜜獾吃书 episode on 《伴生》 / Our Symphony with Animals, Aysha Akhtar, companion animals, trauma recovery, disaster evacuation, domestic-violence pet coercion, animal-assisted therapy, animal cruelty, empathy expansion, and animal welfare as public health. Created pages for 《伴生》 / Our Symphony with Animals, Aysha Akhtar / 阿依莎·阿赫塔, Animal Welfare As Public Health, Companion Animal Health, Animal-Assisted Therapy, Pet-Inclusive Disaster Response, Domestic Violence Pet Coercion, Animal Abuse Violence Link, and Empathy Circle Expansion; updated overview, index, 蜜獾吃书, Pet Grief And Care, Disaster Response State Capacity, Alienated Male Violence, and Captive Whale Sanctuary. No direct contradiction found; the source extends animal-related pages from grief and captive-wildlife welfare into companion-animal health, public systems, and violence-prevention norms.
...
## [2026-07-14] ingest | 60.闲聊伟大作家们的八卦（第一弹）

Added source page for the 蜜獾吃书 episode using literary gossip to revisit Wilde, Whitman, Conan Doyle, Tolstoy, Thoreau, Alcott, Woolf, Yeats, Tolkien, and the relation between author lives and canonical works. Created pages for Oscar Wilde, Walt Whitman, Arthur Conan Doyle, Sherlock Holmes, Leo Tolstoy, Sophia Tolstaya, Henry David Thoreau, Louisa May Alcott, Little Women, Virginia Woolf, W. B. Yeats, Golden Dawn, Aleister Crowley, J.R.R. Tolkien, C. S. Lewis, Literary Gossip As Context, Author Myth Deflation, and Occult And Pseudoscience In Literary Modernity; updated overview, index, 蜜獾吃书, 秦总, 北民, Classic Reading Complexity, and Non-Instrumental Literary Reading. No direct contradiction found; the source is explicitly anecdotal, so claims are stored as source-scoped literary-biographical context rather than settled biography.

## [2026-07-14] lint | Wiki health check

Ran lint after health passed. Health found no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint scanned 3,622 pages and found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-12 with 3,408 nodes and 34,723 edges while the wiki scan found 3,622 pages; they found no hub stubs, two fragile bridges, and no isolated communities, but should be refreshed with `build graph` before treating graph findings as final. Semantic lint via LiteLLM failed because `LLM_MODEL` is not provider-qualified and no provider API-key variables are present. A bounded in-session review of the script sample, orphan pages, and fragile-bridge endpoints found no direct contradictions. No `wiki/lint-report.md` file was saved.
...
## [2026-07-14] ingest | 63.我的30+下半程，答案若隐若现

Added source page for the 蜜獾吃书 episode on female midlife, gendered age anxiety, marriage pressure, career self-rescue, information-gap anxiety, the novel 《37》 by 角田光代, and empathy as a gift of age. Created pages for 角田光代 / Mitsuyo Kakuta, 《37》, Gendered Age Anxiety, Midlife As Gift, Information Gap Anxiety, and Empathy As Aesthetic Capacity; updated overview, index, 蜜獾吃书, 北明 / 北民, Xiaohongshu, Female Self-Possession, Career Self-Rescue, Reading As Life Experience, and Empathy Circle Expansion. No direct contradiction found; the source extends the restart-life and reading branches by showing that midlife self-possession includes doubt, ambiguity, and richer understanding rather than a clean escape from social scripts.
...
## [2026-07-14] ingest | 65.龙王之怒：1931年的长江洪水

Added source page for the 蜜獾吃书 episode on 《龙王之怒：1931年长江水灾》 and the 1931 Yangtze flood as disaster history. Created pages for 《龙王之怒：1931年长江水灾》, Yangtze River, Han River, Hankou, Gaoyou, Dongting Lake, Yunmengze, Nationalist Government, China International Famine Relief Commission, Wu Liande, John Hope Simpson, Natural Hazard As Social Disaster, Wetland Adaptation, Flood Control Risk Transfer, Modern Urban Disaster Risk, Famine Entitlement Failure, War-Disaster Compounding, Folk Religion Disaster Politics, Disaster Relief Mismatch, and Disaster Sensory History; updated overview, index, 蜜獾吃书, China, Hubei, Wuhan, 宋子文, Disaster Response State Capacity, Urban Ecology, Environmental Tradeoff Accounting, Climate Adaptation, and Financial Power And State Capacity. No direct contradiction found; mortality, disease, and relief figures are kept as episode claims that need source-book or archival verification before standalone citation.
...
## [2026-07-14] ingest | 107.闲聊伟大导演们的八卦（第一弹）

Added source page for the 蜜獾吃书 episode on director gossip, Chaplin, Hitchcock, Walt Disney, Leni Riefenstahl, and early women film pioneers. Created pages for Charlie Chaplin / 卓别林, Alfred Hitchcock / 希区柯克, Leni Riefenstahl / 莱妮·里芬斯塔尔, Alice Guy-Blache / 艾丽斯·盖-布兰奇, Lois Weber / 洛伊斯·韦伯, Dorothy Arzner / 多罗西·阿兹娜, Ida Lupino / 艾达·卢皮诺, Film Gossip As Context, Director Myth Deflation, Film Set Power And Abuse, Artistic Achievement Moral Accountability, Propaganda Aesthetics, and Early Women Film Pioneers; updated overview, index, 蜜獾吃书, Walt Disney, The Walt Disney Company, Ub Iwerks, Author Myth Deflation, Literary Gossip As Context, Classic Reading Complexity, and Art Dignity Under Political Pressure. No direct contradiction found; severe or uncertain biographical claims are kept as episode-attributed gossip/history frames rather than settled biography.
...
## [2026-07-15] ingest | 183.李商隐和红楼梦：偏僻性乖张，那管世人诽谤！

Added source page for the 蜜獾吃书 episode defending 李商隐 and tracing his relation to 《红楼梦》 through late-Tang political pressure, love poetry, residual lotus, fallen flowers, Daiyu, Xiangling, Baochai, Baoyu, and Zhiyanzhai's 西昆体 comment. Created pages for 李商隐, 《红楼梦》, 曹雪芹, 林黛玉, 贾宝玉, 薛宝钗, 香菱, 脂砚斋, Late Tang Political Poetics, Love Poetry Modernity, Classical Poetic Intertextuality, and 玉溪一脉入红楼; updated overview, index, 蜜獾吃书, Classic Reading Complexity, Non-Instrumental Literary Reading, 索隐式阅读, Interpretation And Overinterpretation, and Author Myth Deflation. No direct contradiction found; the source-scoped Red Chamber intertext claims are stored with evidence-bound caveats where they rely on atmosphere, analogy, or name echo rather than direct quotation.
...
## [2026-07-15] ingest | 180.爱丽丝梦游仙境：世界多荒诞，我也是自己的主宰（下）

Added source page for the 蜜獾吃书 lower-half episode on 《爱丽丝梦游仙境》, Cheshire Cat, the mad tea party, Queen of Hearts, chaotic croquet, Mock Turtle, trial logic, Alice's final self-command, otherworld portals, and Alice's afterlives in later literature, animation, cyberpunk, and science imagery. Created pages for Mad Hatter, March Hare, Dormouse, Queen of Hearts, Mock Turtle, Gryphon, The Little Prince, Hayao Miyazaki, Spirited Away, The Matrix, Peach Blossom Spring, Time-Stasis System, Arbitrary Authority Procedure, and Otherworld Portal Narrative; updated overview, index, 蜜獾吃书, Alice's Adventures in Wonderland, Alice, Cheshire Cat, Lewis Carroll, Flatland, Nonsense Logic, Wonderland Language Games, Dream Logic Narrative, Rule-Shifting Mathematics, Absurd Rationality, Adult Satire In Children's Classics, Children's Literature Complexity, Female Self-Possession, and Classic Reading Complexity. No direct contradiction found; the source complements episode 179 by moving from bodily identity and language play into time, authority, evidence, portals, and Alice's ability to name false power.

## [2026-07-15] lint | Wiki health check

Ran lint after health passed. Deterministic checks scanned 4,065 pages and found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-12 with 3,408 nodes and 34,723 edges, so graph findings may lag the latest wiki pages. The graph pass found no hub stubs, two fragile bridges, and no isolated communities. Semantic lint did not complete because LiteLLM was configured with the unqualified default model `claude-3-5-sonnet-latest` and no provider credentials were present in the environment. Report returned in-session; `wiki/lint-report.md` was not saved.
...
## [2026-07-16] ingest | How much money President Trump and his family have made

Added source page for the Planet Money episode on David Kirkpatrick's nearly $4 billion estimate of Trump-family presidency-linked gains. Created pages for David Kirkpatrick, Fred Wertheimer, Democracy 21, Trump Organization, Mar-a-Lago, Donald Trump Jr., 1789 Capital, American Bitcoin, USD1, Office-Linked Profit Accounting, Presidential Crypto Policy Conflict, Presidential Library Gift Risk, and Emoluments Clause; updated overview, index, NPR, Planet Money, Donald Trump, World Liberty Financial, Jared Kushner, Melania Trump, Truth Social, Trump Media and Technology Group, Political Influence Monetization, Presidential Conflict Of Interest, Stablecoins, Political Brand Licensing, and Presidential Memorial Culture. No direct contradiction found; the source updates the earlier EP77 political-wealth branch by raising the estimate from about $3.4 billion to about $3.8 billion under a related but separately explained conservative accounting method.
...
## [2026-07-18] ingest | Diary of a WNBA negotiator

Added source page for the Planet Money episode on Alicia Clark, the WNBA Players Association, WNBA media-rights growth, player revenue sharing, data-backed bargaining, housing as a labor benefit, and strike leverage. Created pages for the WNBA, WNBA Players Association, Alicia Clark, Brianna Turner, Claudia Goldin, Caitlin Clark, Angel Reese, Sports Labor Revenue Sharing, Sports Collective Bargaining, Data-Backed Labor Bargaining, Strike Threat as BATNA, Women's Sports Business Growth, and Player Housing as Labor Benefit; updated overview, index, NPR, Planet Money, the NBA, Sports Media Rights, Sports Entertainment Flywheel, League Stakeholder Alignment, and Fat League Economics. No direct contradiction found; the source extends existing sports-business pages by showing that athlete-driven media growth can create labor-share conflict when player compensation remains fixed while league revenue expands.
...
## [2026-07-18] ingest | 76.玄怪录：晚唐党争？没耽误宰相写大马猴的故事

Added source page for the 蜜獾吃书 episode on 牛僧儒《玄怪录》 and 《续玄怪录》, with emphasis on 牛李党争, disputed attribution around 《周秦行纪》, 唐传奇 style, fox and dragon repayment, object spirits, religious mixing, water-monkey ambiguity, and 《杜子春》 as a failed immortality test. Created pages for 《玄怪录》, 《续玄怪录》, 牛僧儒, 牛李党争, 李德裕, 李宗闵, 《周秦行纪》, 《杜子春》, 芥川龙之介, Tang Chuanqi, Tang Strange-Tale Repayment Ethics, and Transcendence Against Human Feeling; updated overview, index, 蜜獾吃书, Late Tang Political Poetics, Classic Reading Complexity, Non-Instrumental Literary Reading, Story Motif Transmission, Chinese Folk Religion Layering, Mythic Source Layering, and Interpretation And Overinterpretation. No direct contradiction found; motif comparisons such as water monkey and kappa were kept source-scoped rather than treated as proven transmission.
...
## [2026-07-24] ingest | 117.诅咒兔：怪谈文学也要上桌吃饭

Added source page for a 蜜獾吃书 episode on 郑宝拉《诅咒兔》, 韩江 as Korean-literary context, guaitan literature, genre literary legitimacy, 《头》, the title story, 《伤疤》, 《不受家》, gendered domestic horror, family/capital extraction, revenge, and loneliness after revenge. Created pages for 韩江, 郑宝拉, 《诅咒兔》, Genre Literary Legitimacy, Guaitan Literature, Gendered Domestic Horror, and Post-Revenge Emptiness; updated overview, index, 蜜獾吃书, Weird Fiction, Female Revenge And Political Order, Folklore Trauma Encoding, Folklore As Social Memory, and Menstrual Stigma. No direct contradiction found; the source complements the existing yokai, urban legend, weird fiction, and revenge branches by treating怪谈 as a direct literary form for bodily fear and unrepaired harm.

## [2026-07-24] graph | Knowledge graph rebuilt

5641 nodes, 56841 edges (56841 extracted, 0 inferred).
...
## [2026-07-24] ingest | 114.又到持螯赏菊时，聊聊螃蟹的趣闻史话

Added source page for a 蜜獾吃书 episode on crab culture, dazha-crab naming, crab-catching tools, rice-field pest history, Song literati eating, 《金瓶梅》 and 《红楼梦》 crab banquets, 李琪《讯蟹书》, 黄庭坚's Buddhist food ambivalence, and Buddhist crab-story variants. Created pages for 螃蟹 / Crab, 《金瓶梅》, 黄庭坚, 李琪, 《讯蟹书》, Crab Cultural Symbolism, Animal Moral Projection, and Eating And Killing Moral Ambivalence; updated overview, index, 蜜獾吃书, Festival Food Material History, Material History Narrative, 《红楼梦》, 苏轼, and Story Motif Transmission. No direct contradiction found; the source deepens the existing crab material-history branch into a literary, folkloric, and ethical cluster.
...
Ran lint without saving a report. Semantic lint unavailable because LLM_MODEL is not provider-qualified for LiteLLM.
...
## [2026-07-24] ingest | sp.06 串台｜和李乌鸦＆超哥 high 聊：做读书博主的“守墓心得”

Added source page for a 蜜獾吃书 crossover with 李乌鸦 and 超哥 on book creator work, topic selection, deadline improvisation, platform data, bridge-style reading content, literary-evaluation anxiety, gendered creator confidence, reading as cognitive restoration, and the "books as graves / book creators as grave sweepers" metaphor. Created pages for 文化有限, 果麦文化, 罗辑思维, 《书楼吊堂》, Book Creator Work, Bridge-Style Reading Content, Algorithmic Anger Engagement, Gendered Creator Confidence, Output-Forced Input, Reading As Cognitive Restoration, and Book As Grave Memory Work; updated overview, index, 蜜獾吃书, 秦总, 李乌鸦, 超哥, Reading As Life Experience, Non-Instrumental Literary Reading, Reading As Frame Training, Media Form Constraint, Jargon Boundary Making, Creator Evaluation Pressure, Attention Industrialization, and Female Self-Possession. No direct contradiction found; the source extends the existing meta-reading branch from "why read" into how public reading content is made under creator, medium, audience, and algorithm constraints.
...
## [2026-07-24] ingest | 135.闲聊伟大作家们的八卦（第三弹）

Added source page for the 蜜獾吃书 episode continuing the great-writer gossip series through Mark Twain, H. G. Wells, Jean-Paul Sartre, and Ayn Rand. Created pages for Mark Twain, Adventures of Huckleberry Finn, Nikola Tesla, Alexander Graham Bell, H. G. Wells, The Time Machine, The War of the Worlds, The Invisible Man, Rebecca West, Martha Gellhorn, Amber Reeves, Moura Budberg, Jean-Paul Sartre, Simone de Beauvoir, Being and Nothingness, No Exit, Ayn Rand, Nathaniel Branden, Objectivism, Existentialism, Free Love Practice Gap, Ideological Totalization Risk, and Offensive Humor Speech Space; updated overview, index, 蜜獾吃书, 秦总, 北民, Louisa May Alcott, Ernest Hemingway, Alan Greenspan, Soviet Union, Literary Gossip As Context, Author Myth Deflation, Classic Reading Complexity, Science Fiction Realism, Artistic Achievement Moral Accountability, Secular Happiness Against Ideology, Pure Rationality Trap, and Rational Humility. No direct contradiction found; the source is anecdotal and opinionated, so claims about affairs, politics, wartime conduct, and doctrine are stored as episode-attributed literary-biographical context rather than settled biography.
...
## [2026-07-24] ingest | 148. 王氏之死：断井颓垣上的历史妆镜

Added source page for the 蜜獾吃书 episode on 史景迁《王氏之死》, 郯城 disaster society, 王氏's murder, 黄六鸿, 《福惠全书》, 蒲松龄, 《聊斋志异》, Qing gender law, and fiction as historical evidence. Created pages for 《王氏之死》 / The Death of Woman Wang, 王氏 / Woman Wang, 黄六鸿 / Huang Liuhong, 蒲松龄 / Pu Songling, 郯城 / Tancheng, 《福惠全书》, 《郯城县志》 / Tancheng County Gazetteer, Microhistory From Hostile Archives, and Fiction As Historical Evidence; updated overview, index, 蜜獾吃书, Jonathan Spence, 《聊斋志异》, Qing Gender Legal Order, Qing Female Inheritance Constraint, Female Self-Possession, and Folk Religion Disaster Politics. No direct contradiction found; the source adds a method tension by using fiction as social evidence while keeping legal and archival claims source-grounded.

## [2026-07-24] ingest | 【沙青青x韩钊】石川啄木：我抱持的思想，都是因为缺钱

Added source page for a 蜜獾吃书 episode with 韩钊 and 沙青青 on 石川啄木, 《短歌是我悲伤的玩具》, Donald Keene's 《石川啄木》 biography, short-song form, poverty, debt, Meiji literary hierarchy, friendship support, diary-based self-exposure, and the Great Treason political context. Created pages for 沙青青, Donald Keene, 《石川啄木》 / Takuboku Biography, 金田一京助, 夏目漱石, 森鸥外, 岛崎藤村, 与谢野晶子, 幸德秋水, 大逆事件, 《日本现代文学的起源》, Meiji Intellectual Precarity, Modern Japanese Interior Discovery, Short-Form Emotional Snapshot, and Political Closure As Literary Pressure; updated overview, index, 蜜獾吃书, 秦总, 石川啄木, 《短歌是我悲伤的玩具》, 韩钊, Tanka As Everyday Expression, Poetry As Emotional Release, Literary Publishing As Material Support, Art Dignity Under Political Pressure, Intellectual Responsibility Under Authoritarianism, Literary Gossip As Context, and Author Myth Deflation. No substantive contradiction found; normalized the existing HanZhao display name from 韩昭 to 韩钊 based on the source while preserving the existing page filename.
...
## [2026-07-24] ingest | Can transforming neighborhoods help kids escape poverty?

Added source page for a Planet Money episode on HOPE VI, Richard Allen Homes, Weissina Williams, Raj Chetty's neighborhood-opportunity research, and whether transformed public housing can improve children's adult outcomes. Created pages for Raj Chetty, Matt Steger, Carol Naughton, Weissina Williams, HOPE VI Program, Richard Allen Homes, Cambridge Plaza, Neighborhood Opportunity Revitalization, Mixed-Income Housing, Cross-Class Social Capital, Exposure-Dosage Causality, Public Housing Displacement, and Place-Based Anti-Poverty Policy; updated overview, index, Planet Money, NPR, United States, Neighborhood Opportunity Access, Housing Affordability Supply Mechanics, Weak-Tie Opportunity, and Facebook. No direct contradiction found; the source extends neighborhood-access evidence from moving or renting into better areas toward in-place revitalization, while preserving the major HOPE VI displacement and unit-loss caveat.

## [2026-07-24] lint | Wiki health check

Ran lint after health passed. Health scanned 6,210 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 5,641 nodes and 56,841 edges; the current wiki has 6,210 pages, so graph findings are advisory until `build graph` refreshes it. The graph checks found no hub stubs, five fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` is unset and the default model name lacks a LiteLLM provider prefix. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-07-24] ingest | How to get what Greenland has, with permission
...
## [2026-07-24] ingest | 142. 凯尔特神话故事（第一弹）：德鲁伊会梦见变形羊吗？

Added source page for the 蜜獾吃书 episode introducing Celtic mythology through Danu, the Dagda, the Tuatha De Danann, the Book of Invasions, Tuan's animal reincarnations, druidic knowledge, Fionn, Ossian, animal transformation, and the Celtic otherworld. Created pages for Danu, The Dagda, Tuatha De Danann, Lebor Gabala Erenn, Tuan mac Cairill, Fionn mac Cumhaill, Oisin/Ossian, Celtic Mythology, Druidic Knowledge, Celtic Animal Transformation, and Celtic Otherworld; updated overview, index, 蜜獾吃书, Mythic Source Layering, Myth As Historical Evidence, Story Motif Transmission, Otherworld Portal Narrative, Story-Based Empathy, and J.R.R. Tolkien. No direct contradiction found; the source extends the wiki's mythology branch by treating Celtic material as layered oral, manuscript, Christianized, Romantic, and fantasy-influencing tradition rather than as one pure canon.

## [2026-07-24] lint | Wiki health check

Ran lint after health passed. Health scanned 6,235 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 5,641 nodes and 56,841 edges while the current wiki scan found 6,235 pages, so graph findings are advisory until `build graph` refreshes it. The graph checks found no hub stubs, five fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolved to `claude-3-5-sonnet-latest` without a provider prefix. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-07-24] ingest | 143.遗忘的脑力：记性不好可咋整啊？

Added source page for the 蜜獾吃书 episode on 《遗忘的脑力》, memory anxiety, forgetting as useful brain work, emotional memory, hippocampus/cortex metaphors, review timing, painful-memory rumination, childhood stress, focused/diffuse thinking balance, and sleep, movement, sunlight, music, and phone-use pacing. Created pages for 《遗忘的脑力》, Forgetting As Cognitive Function, Memory Consolidation Windows, Painful Memory Rehearsal Risk, and Focused-Diffuse Thinking Balance; updated overview, index, 蜜獾吃书, Learning How To Learn, Achievement Pressure Mental Health, Complex Trauma Recognition, Attention Industrialization, Reading As Cognitive Restoration, and Restorative Creative Pacing. No direct contradiction found; the source qualifies existing learning, effort, and mental-health pages by treating forgetting, rest, and selective consolidation as necessary rather than treating more memory and more pressure as automatically better.

## [2026-07-24] lint | Wiki health check

Ran lint after health passed. Health scanned 6,241 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 5,641 nodes and 56,841 edges while the current wiki scan found 6,241 pages, so graph findings are advisory until `build graph` refreshes it. The graph checks found no hub stubs, five fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because no provider-qualified `LLM_MODEL` or API key is configured in the environment. Report returned in-session; `wiki/lint-report.md` was not saved.
...
## [2026-07-24] ingest | 187.豌豆公主：高敏和混沌是你真名

Added source page for the 蜜獾吃书 episode rereading 安徒生《豌豆公主》 through true-princess ambiguity, folklore variants, 19th-century class satire, gendered testing, the contrasting punishment in 《猪倌》, high sensitivity, sensory hypersensitivity, comfort legitimacy, and literary ambiguity. Created pages for 《豌豆公主》, 《猪倌》, True Princess Ambiguity, High Sensitivity As Difference, Sensory Hypersensitivity Accommodation, Gendered Fairy-Tale Punishment, and Literary Ambiguity As Complexity; updated overview, index, 蜜獾吃书, Hans Christian Andersen, Adult Fairy-Tale Reading, Adult Satire In Children's Classics, Children's Literature Complexity, Hardship Culture As Education, Self-Feeling Trust, Autism As Human Difference, and Female Self-Possession. No direct contradiction found; the source complements the existing Andersen branch by making one tiny tale carry class satire, bodily sensitivity, gendered punishment, and unresolved literary complexity rather than one stable moral.

## [2026-07-24] lint | Wiki health check

Ran lint after health passed. Health scanned 6,295 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 5,641 nodes and 56,841 edges while the current wiki scan found 6,295 pages, so graph findings are advisory until `build graph` refreshes it. The graph checks found no hub stubs, five fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because no provider-qualified `LLM_MODEL` or API key is configured in the environment. Report returned in-session; `wiki/lint-report.md` was not saved.
...
## [2026-07-24] ingest | Chef vs. Robot

Added source page for a Planet Money episode on a robot wok versus a human Cantonese-style chef in Philadelphia Chinatown, restaurant automation economics, wok hei, staffing pressure, robot cost/throughput, and Daron Acemoglu's displacement/reinstatement frame for automation. Created pages for Kenny Poon, Instafoods, Robby Wokbot, Next Robot, Phuong Hoang Chiang, Ting Wong, Judy Huang, Shola Olunloyo, Daron Acemoglu, Restaurant Automation, Robot Chef Cost-Quality Tradeoff, Wok Hei, Automation Displacement Effect, and Automation Reinstatement Effect; updated overview, index, NPR, Planet Money, MIT, Erika Beras, Restaurant Operational Fragility, Chain Restaurant Standardization, Production Robot Scenario Selection, and Good Jobs For Non-College Workers. No direct contradiction found; the source qualifies restaurant standardization and good-jobs branches by showing how partial automation can reduce owner staffing risk while shifting skill premiums and quality tradeoffs.
...
## [2026-07-25] ingest | What AI fitness apps can and can't do - for now

Added source page for a Marketplace Tech episode with Nicole Nguyen on AI fitness tools, Apple Workout Buddy, Fitbit's AI health coach, Peloton's camera-based form correction, premium fitness subscriptions, hallucination risk, weak accountability, and AI nutrition tracking. Created pages for Nicole Nguyen, Peloton, Apple Workout Buddy, Fitbit AI Health Coach, AI Fitness Coaching, Computer Vision Form Correction, AI Nutrition Tracking, and AI Fitness Accountability Gap; updated overview, index, Marketplace Tech, Apple, Fitbit, and AI Health Management. No direct contradiction found; the source qualifies AI health-management optimism by showing that personal data and computer-vision feedback can improve motivation and personalization without eliminating product errors, cost barriers, or the need for human follow-through.
...
## [2026-07-25] ingest | sp.01 宇宙：卡尔·萨根的星辰大海和人类梦想

Added source page for a 蜜獾吃书 episode on Carl Sagan, 《宇宙》, 《接触》, SETI, the Voyager golden record, nuclear winter, and Sagan's humanistic public-science style. Created pages for 《宇宙》 / Cosmos, 《接触》 / Contact, SETI, Voyager Golden Record, Humanistic Science Communication, Sagan Effect, Nuclear Winter, and Open Extraterrestrial Civilization Imagination; updated overview, index, Carl Sagan, NASA, 蜜獾吃书, Applied Astrobiology, Scientific Skepticism, Rational Humility, Science Optimism And Pseudoscience, Science Communication Disadvantage, Science Fiction Realism, and Science Fiction As Contemporary Science Integration. No direct contradiction found; the source broadens the existing Sagan skepticism branch by showing that evidence discipline, public wonder, anti-nuclear responsibility, and warmer extraterrestrial imagination are part of the same Sagan-shaped worldview.

## [2026-07-25] ingest | News sites are blocking access to Internet Archive's Wayback Machine

Added source page for a Marketplace Tech episode with Andrew Deck of Nieman Lab on news publishers blocking the Wayback Machine because of AI proxy-scraping fears. Created pages for Internet Archive, Wayback Machine, Andrew Deck, Nieman Lab, Mark Graham, Library of Congress, Public Web Archiving, AI Proxy Scraping Risk, Archive Access Tradeoff, Open Web Social Contract Erosion, and Internet History Fragility; updated overview, index, Marketplace Tech, Stephanie Hughes, AI Content Licensing, Open Web Traffic Decline, Digital Preservation, Public Service Journalism, and AI Journalism Trust. No direct contradiction found; the source qualifies AI-content licensing and digital-preservation branches by showing that protecting copyrighted news from possible AI training reuse can also weaken public archives and accountability reporting. The source-specific caveat is that publishers were acting preemptively and did not identify direct evidence that the Wayback Machine had already been used as the proxy-scraping path.

## [2026-07-25] lint | Wiki health check

Ran lint after health passed. Health found no empty/stub files, index drift, or source-log coverage gaps across 6,900 wiki pages. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 6,453 nodes while lint scanned 6,900 pages, so graph findings are advisory until `build graph` refreshes it; they found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolves to `claude-3-5-sonnet-latest` without a provider prefix. A bounded in-session semantic review of recent source pages, orphan pages, fragile-bridge endpoints, and affirmative contradiction markers found no direct unresolved contradictions or stale-summary defects; follow-ups are to reconcile the source-scoped `ProjectGlasswing`/`ProjectGlassfin` naming tension, refresh the graph, and clean the `+-` formatting artifact in `wiki/sources/ali-qianwen-lizhi-yuzhen-zai-jiwanren-de-tieqiu-li-ruhe-timian-shengcun-keji-luandun.md`. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-07-25] ingest | When do tech companies need to be consistently profitable?

Added source page for a Marketplace Tech episode with Stephanie Hughes and Sarah Kunst of Clio Capital on Snap layoffs, cost reductions, path-to-profitability expectations, public-company shareholder accountability, and Arenic Capital Management's activist campaign. Created pages for Snap, Sarah Kunst, Clio Capital, Arenic Capital Management, Michael Lynton, Path To Profitability, and Activist Investor Pressure; updated overview, index, Marketplace Tech, Stephanie Hughes, Snapchat, Amazon, Amazon Web Services, Meta, Mark Zuckerberg, Public Company Transition, Public Market Communication, Shareholder Primacy, and Management Shareholder Alignment Risk. No direct contradiction found; the source expands Snap from the existing Snapchat/social-media-liability branch into a public-company profitability and activist-investor case.

## [2026-07-25] lint | Wiki health check

Ran lint after health passed. Health found no empty/stub files, index drift, or source-log coverage gaps across 6,908 wiki pages. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 6,453 nodes while lint scanned 6,908 pages, so graph findings are advisory until `build graph` refreshes it; they found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolves to `claude-3-5-sonnet-latest` without a provider prefix. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-07-25] ingest | Anti-AI data center sentiment is becoming a political issue

Added source page for a Marketplace Tech episode with Stephanie Hughes and Tony Pippa of the Brookings Institution on data centers becoming a political issue. Created pages for Tony Pippa, Maine, and Data Center Community Consent; updated overview, index, Marketplace Tech, Stephanie Hughes, Brookings Institution, National Conference of State Legislatures, Data Center Backlash, Hyperscale Data Center Moratorium, Data Center Cost Shifting, AI Energy Bottleneck, AI Backlash Politics, AI Metabolic Infrastructure, How We Survive, and Amy Scott. No direct contradiction found; the source extends existing data-center backlash coverage by adding the local-capacity and community-consent frame around bans, elections, resource terms, and long-term benefit bargaining.

## [2026-07-25] ingest | Bytes: Week in Review - Apple's new CEO, Meta's latest AI play, and Roblox's safety updates

Added source page for a Marketplace Tech Bytes episode with Anita Ramaswamy of The Information on Apple succession, Meta employee computer tracking for AI training, and Roblox child-safety settlements. Created pages for Reuters, Matt Kaufman, Alabama, Nevada, West Virginia, Vision Pro, AI Training Data Scarcity, Workplace Behavior Training Data, and Platform Age Estimation; updated overview, index, Marketplace Tech, Apple, Tim Cook, John Ternus, Apple Intelligence, iPhone, Meta, Scale AI, Roblox, Anita Ramaswamy, The Information, How We Survive, Amy Scott, AI Workforce Monitoring, Workplace AI Transparency, Office Surveillance And Privacy, Agent Data, AI Data Infrastructure, Computer Use Agent, AI Plus Terminals, Smartphone AI Hub, Social Media Age-Gate Speech Burden, Social Media Product Liability, State AG Platform Litigation, and Platform Data Regulation. No direct contradiction found; the source updates prior speculative John Ternus succession coverage into a source-attributed announcement and adds privacy/speech tension around age estimation and employee activity captured for agent training.

## [2026-07-25] lint | Wiki health check

Ran lint after health passed. Health found no empty/stub files, index drift, or source-log coverage gaps across 6,922 wiki pages. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolves to `claude-3-5-sonnet-latest` without a provider prefix. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-07-25] lint | Wiki health check

Ran lint after health passed. Health found no empty/stub files, index drift, or source-log coverage gaps across 6,938 wiki pages. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 6,453 nodes while lint scanned 6,938 pages, so graph findings are advisory until `build graph` refreshes it; they found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolves to `claude-3-5-sonnet-latest` without a provider prefix. A bounded in-session semantic review of orphan pages, fragile-bridge endpoints, affirmative contradiction markers, and known lint follow-ups found no direct unresolved contradictions; follow-ups remain to reconcile the source-scoped `ProjectGlasswing`/`ProjectGlassfin` naming tension and clean the `+-` formatting artifact in `wiki/sources/ali-qianwen-lizhi-yuzhen-zai-jiwanren-de-tieqiu-li-ruhe-timian-shengcun-keji-luandun.md`. Report returned in-session; `wiki/lint-report.md` was not saved.
...
## [2026-07-25] ingest | Mushrooms could help curb plastic waste

Added source page for a Marketplace Tech episode on University of Alaska researchers using mushroom mycelium and Fomes fomentarius as a possible biodegradable alternative to polystyrene foam packaging and insulation. Created pages for Anna Holligan, University of Alaska, Filip Amtislavski, Alexandra Ravello, Fomes fomentarius, Wild Source, Chris Sanito, Kodiak Harbour, Mycelium Insulation, Biodegradable Foam Packaging, and Seafood Cold-Chain Packaging; updated overview, index, Marketplace Tech, BBC, Alaska, Amy Scott, How We Survive, American Public Media, Cold-Chain CPG Constraint, Low-Carbon Construction Materials, Environmental Tradeoff Accounting, Economic Climate Tech Adoption, and Climate Startup Commercialization Gap. No direct contradiction found; the source extends the wiki's climate-materials branch by showing that replacing polystyrene requires operational parity on insulation, durability, weight, and shipping cost as well as lower plastic-waste impact.

## [2026-07-25] lint | Wiki health check

Ran lint after health passed. Health found no empty/stub files, index drift, or source-log coverage gaps across 6,974 wiki pages. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 6,453 nodes while lint scanned 6,974 pages, so graph findings are advisory until `build graph` refreshes it; they found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` and provider API-key environment variables are unset, causing the script to fall back to an unqualified `claude-3-5-sonnet-latest` model name. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-07-25] ingest | The year in AI wearables

Added source page for a Marketplace Tech episode with Will Gottsagen of The Atlantic on AI wearables as a 2025 trend. Created pages for Will Gottsagen, The Atlantic, Apple AirPods, Apple Watch, and Oura Ring; updated overview, index, Marketplace Tech, Megan McCarty-Corino, Meta, Meta AI, Ray-Ban smart glasses, Wearable AI Assistant, AI Plus Terminals, Smartphone AI Hub, Edge-Cloud AI Boundary, Ambient AI Interface, AI Assistant Service Entry, Voice Interaction, AI Translation, Assistive AI, Consumer Camera Surveillance, Consent-Based Recording, and Agent Permission Boundaries. No direct contradiction found; the source reinforces the Smartphone AI Hub thesis by showing that AI wearables need to solve latency, connectivity, public awkwardness, privacy, and clear-use-case problems before they can become more than a third-device pitch.

## [2026-07-25] ingest | 06.搜神记： 二十四孝这口锅，干宝不背

Added source page for a 蜜獾吃书 episode rereading 《搜神记》 as a mixed zhiguai archive rather than a narrow filial-piety sermon book. Created pages for 《搜神记》, 干宝, 李寄斩蛇, 《二十四孝》 / Twenty-Four Filial Exemplars, 蒋子文, Zhiguai Archive Value, Strange Tale Moral Pluralism, and Filial Piety Story Afterlife; updated overview, index, 蜜獾吃书, Chinese Folk Religion Layering, Mythic Source Layering, Story Motif Transmission, Classic Reading Complexity, Underworld Bureaucracy, Local Deity Governance, Folk Religion Disaster Politics, Ordinary People Resistance, and Female Self-Possession. No direct contradiction found; the source qualifies later filial-piety moralization by showing that 《搜神记》 also preserves resistance, revenge, abused women leaving constraints, sympathetic nonhuman beings, divine bureaucracy, political jealousy, and unexplained marvels.
...
## [2026-08-04] ingest | The NFL

Added source page for an Acquired episode on the NFL as a league-first media and governance system, tracing violent college-football origins, early professional fragility, Bert Bell's parity design, the AFL threat, Pete Rozelle's pooled TV rights, the Sports Broadcasting Act, NFL Films, the Super Bowl, Monday Night Football, modern streaming, betting, international expansion, player-safety risk, cultural controversy, and private-equity ownership. Created pages for Pete Rozelle, Bert Bell, Lamar Hunt, Al Davis, American Football League, George Halas, Jim Thorpe, Paul Brown, Roone Arledge, Joe Namath, NFL Films, Ed Sabol, Monday Night Football, Super Bowl, ESPN, YouTube TV, NBC, Taylor Swift, Travis Kelce, Colin Kaepernick, League First Operating Model, Sports Broadcasting Act, Live Sports Streaming Transition, Sports Betting Engagement, Football Player Safety Trust Risk, and Private Equity In Sports Ownership; updated overview, index, Acquired, National Football League, Sports Media Rights, Sports Competitive Balance, Sports Labor Revenue Sharing, Broadcast Centralization, Sports Entertainment Flywheel, League Stakeholder Alignment, Fat League Economics, ABC, CBS, Amazon, Netflix, and YouTube. No direct contradiction found; the source extends existing NFL comparison notes into a full case for centralized rights, competitive balance, shared economics, and scarce live attention.

## [2026-08-04] lint | Wiki health check

Ran lint after health passed. Health scanned 7,469 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 6,453 nodes and 65,220 edges while lint scanned 7,469 pages, so graph findings are advisory until `build graph` refreshes it; they found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolved to unqualified `claude-3-5-sonnet-latest`. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-08-04] ingest | Ferrari

Added source page for an Acquired episode on Ferrari as a luxury-motorsport business, tracing Enzo Ferrari, Scuderia Ferrari, Alfa Romeo, Luigi Chinetti, the prancing horse, Pininfarina, Formula One, the failed Ford acquisition, Fiat ownership, Luca di Montezemolo's turnaround, Sergio Marchionne's FCA spinout and IPO, Benedetto Vigna's public-company era, collector economics, the Purosangue, Classiche, Tifosi fandom, and the Ferrari Luce EV question. Created pages for Enzo Ferrari, Scuderia Ferrari, Alfa Romeo, Luigi Chinetti, Francesco Baracca, Pininfarina, Gianni Agnelli, Fiat, Piero Ferrari, Dino Ferrari, Luca di Montezemolo, Sergio Marchionne, Fiat Chrysler Automobiles, Henry Ford II, Ford Motor Company, Exor, John Elkann, Benedetto Vigna, Niki Lauda, Jean Todt, Ross Brawn, Michael Schumacher, Maserati, LoveFrom, Marc Newson, Maranello, Ferrari 166 Barchetta, Ferrari 250, Ferrari F40, Ferrari Icona, Ferrari Purosangue, Ferrari Classiche, Ferrari Luce, Tifosi, Luxury Brand As Sports Team, Racing Heritage Brand Moat, Make-To-Order Luxury Manufacturing, Automotive Collector Economics, Halo Product Strategy, Luxury Community Pyramid, Public Market Luxury Growth Tension, and Functional Alibi; updated overview, index, Acquired, Ferrari, Formula One, Porsche, Jony Ive, Luxury Scarcity Discipline, High-Volume Luxury Operator, Luxury Retail Channel Control, Vertical Integration For Quality Control, Precision Manufacturing As Strategy, Engineering Competition, Sports Entertainment Flywheel, Consumer Brand Moat, and Product Led Willingness To Pay. No direct contradiction found; the source turns Ferrari from an F1 legitimacy/sidebar comparison into a primary case where racing proof, engineered scarcity, bespoke manufacturing, collector services, and broad fandom make a low-volume automaker unusually valuable.
...
## [2026-08-05] ingest | A recycling startup joins the AI boom

Added source page for a Marketplace Tech episode on Redwood Materials using reused EV batteries as power infrastructure for AI data centers, centered on Colin Campbell's explanation of speed-driven AI customers and a 60 MWh / 12 MW Nevada project disconnected from the grid. Created pages for Redwood Materials, Colin Campbell, and Second-Life EV Battery Storage; updated overview, index, Marketplace Tech, Megan McCarty-Corino, Nvidia, Nevada, AI Energy Bottleneck, Data Center Power Bottleneck, Data Center Onsite Power, AI Compute Continuity, Data Center Physical Resilience, AI Metabolic Infrastructure, Strategic AI Infrastructure Dependence, Battery Recycling Loop, How We Survive, and Amy Scott. No direct contradiction found; the source qualifies onsite data-center power by adding battery storage and reuse beside natural gas generation and future fusion rather than replacing those branches.

## [2026-08-05] lint | Wiki health check

Ran lint after health passed. Health scanned 7,567 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolved to unqualified `claude-3-5-sonnet-latest`. Report returned in-session; `wiki/lint-report.md` was not saved.
...
## [2026-08-05] ingest | E227｜美国医疗市场AI争夺战：巨头押注，创业公司能赢吗？

Added source page for a 硅谷101 episode with Zhang Lu and Zhou Yebing on U.S. healthcare AI competition. Created pages for OpenEvidence, ChatGPT Health, ChatGPT for Healthcare, Claude for Healthcare, HealthBench, Zhou Yebing, Fusion Fund, Eli Lilly, JP Morgan Healthcare Conference, Physician Administrative Burden, Healthcare AI Infrastructure, Medical Billing and Coding Automation, HIPAA-Constrained Medical AI, Evidence-Grounded Medical RAG, Vertical Medical Small Models, Health Insurance Denial Workflow, and Federated Medical Data Sharing; updated overview, index, SiliconValley101, Zhang Lu, OpenAI, Anthropic, Microsoft, Nvidia, ChatGPT, Claude, Medical AI Workflow Integration, AI Health Management, Human Judgment Under AI, Medical AI Marketing Risk, U.S. Health Insurance Denial Politics, Hospital Information System, Internet Healthcare, Online Healthcare Regulatory Boundary, Medical Platform Trust Crisis, Medical Literature Search, Personal Health Data, Retrieval-Augmented Generation, AI Verification, and AI Hallucination. No direct contradiction found; the source reinforces doctor-led AI health boundaries while adding the U.S. provider/payment stack, HIPAA constraints, evidence-grounded physician search, and startup-versus-giant healthcare AI competition.
...
## [2026-08-05] ingest | 17.地狱变：众生皆苦，一念入魔

Added source page for a 蜜獾吃书 episode on 芥川龙之介, centered on 《地狱变》 and extended through 《竹林中》, 《罗生门》, 黑泽明《罗生门》, 《蛛丝》, 《河童》, 《鼻子》, and 《小白》. Created pages for the Akutagawa works, 黑泽明, Rashomon Effect, Unreliable Praise Narration, Art As Revenge, Human World As Hell, and Akutagawa Salvation Problem; updated overview, index, 芥川龙之介, 鲁迅, 蜜獾吃书, 秦总, 北明, 十殿阎罗, Afterlife Moral Accounting, Classic Reading Complexity, Moral Suspension In Art Reading, Multi-Perspective Murder Narration, Interpretation And Overinterpretation, and Transcendence Against Human Feeling. No direct contradiction found; the source expands the earlier Akutagawa-as-杜子春-adapter branch into a full author study while keeping the revenge reading of 良秀 source-scoped.

## [2026-08-05] ingest | 23.飞马牌汽车：安全是第一位的！

Added source page for a 蜜獾吃书 episode on 郑渊洁, 《童话大王》, 《训兔记》, and 《飞马牌汽车》. Created pages for 《飞马牌汽车》, 《马王登基》, 《童话大王》, 《训兔记》, 皮皮鲁, 鲁西西, 舒克贝塔, 大灰狼罗克, Safety As Control, Rule Idolatry, Bureaucratic Absurdity Escalation, and Problem Industrialization; updated overview, index, 郑渊洁, 蜜獾吃书, 秦总, 北明, Anti-Authoritarian Education, Children's Literature Complexity, Protection As Control, Bureaucratic Risk Avoidance, Institutional Overcompliance, Arbitrary Authority Procedure, and Absurd Rationality. No direct contradiction found; the source extends the childhood-reading branch into public-institutional satire and qualifies safety/procedure pages by showing how a rule can remain formally correct while becoming harmful in context.

## [2026-08-05] lint | Wiki health check

Ran lint after health passed. Health scanned 7,671 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 6,453 nodes and 65,220 edges while lint scanned 7,671 pages, so graph findings are advisory until `build graph` refreshes it; current graph checks found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolved to unqualified `claude-3-5-sonnet-latest` and no provider/key env vars are available in this shell. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-08-05] ingest | 华为的「韬定律」，是创新还是噱头？｜ Bonus

Added source page for a What's Next｜科技早知道 bonus episode with Zhang Haijun on Huawei's Tau Law. Created pages for Zhang Haijun and Cell-to-Cell Logic Stacking; updated overview, index, What's Next｜科技早知道, Huawei, Tau Law, Semiconductor 3D Stacking, Electronic Design Automation, Advanced Packaging, Moore's Law, Constraint Driven Engineering Strategy, and Synopsys. No direct contradiction found with the existing Keji Luandun Tau Law source; this source reinforces the cautious view while narrowing the implementation caveat around cell-level stacking, EDA readiness, and the limits of reading "381 chips based on Tau Law" as proof of shipped Cell-to-Cell logic stacking.

## [2026-08-05] lint | Wiki health check

Ran lint after health passed. Health scanned 7,674 wiki pages with no empty/stub files, index drift, or source-log coverage gaps. Deterministic lint found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md` and `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used `graph/graph.json` built on 2026-07-24 with 6,453 nodes and 65,220 edges while lint scanned 7,674 pages, so graph findings are advisory until `build graph` refreshes it; current graph checks found no hub stubs, three fragile bridges, and no isolated communities. Semantic lint via LiteLLM failed because `LLM_MODEL` resolved to unqualified `claude-3-5-sonnet-latest`. Report returned in-session; `wiki/lint-report.md` was not saved.

## [2026-08-05] ingest | How online age-gating laws went mainstream this year

Added source page for a Marketplace Tech episode with Megan McCarty-Corino interviewing Drew Harwell of the Washington Post on online age verification becoming mainstream in 2025. Created pages for Drew Harwell, Bluesky, Mississippi, Online Age Verification, Age Verification Compliance Industry, Behavioral Age Inference, and Age Verification Patchwork; updated overview, index, Marketplace Tech, Megan McCarty-Corino, Washington Post, Supreme Court, Texas, United Kingdom, Australia, Apple, Google, OpenAI, Platform Age Estimation, Social Media Age-Gate Speech Burden, Civil Liberties Surveillance Risk, and Platform Data Regulation. No direct contradiction found; the source sharpens the tension between child-safety goals and identity checks, contractor costs, privacy exposure, state patchwork, VPN leakage, false positives, and unresolved platform responsibility.
...
## [2026-08-05] ingest | How convergence will define the tech sector in 2026

Added source page for a Marketplace Tech episode with Amy Webb on convergence as the defining 2026 technology trend. Created pages for Amy Webb, BlueJ, Penn State, University of Pittsburgh, EVO2, AI Convergence, Post-Search Internet, Programmable Matter, and Generative Biology; updated overview, index, Marketplace Tech, ChatGPT, Google DeepMind, Amazon, Nvidia, AI Answer Source Attribution, Search Advertising Decline, Open Web Traffic Decline, Physical AI, Embodied AI, AI For Science, AI Materials Discovery, Automation Displacement Effect, and Production Robot Scenario Selection. No direct contradiction found; the source extends existing AI-search, robotics, and AI-for-science branches by treating AI as a convergence layer across internet economics, labor, materials, energy, medicine, packaging, and biology.
...
## [2026-08-06] ingest | 30.孟子：战国愤青的赤子之心

Added source page for a 蜜獾吃书 episode rereading 孟子 through Warring States politics, renyi, 义利之辨, 仁政, 王道/霸道, 有恒产者有恒心, 民贵君轻, 暴君非君, and 天命即民意. Created pages for 孟子, 《孟子》, 战国时期, 稷下学宫, 梁惠王, 齐宣王, 墨子, 杨朱, 邹国, Early Confucian Resistance Politics, Righteousness Over Profit, Mencian Benevolent Government, Wangdao versus Badao, Constant Property Constant Heart, Mencian People-Based Legitimacy, and Mencian Idealism Limits; updated overview, index, 蜜獾吃书, 孔子, Confucian Ideal Governance, Mandate of Heaven Legitimacy, and Good Intentions Political Limits. No direct contradiction found; the source qualifies the Wang Mang branch by showing early Mencian Confucianism as a ruler-limiting and people-based political resource while also acknowledging the practical failure risk of benevolent conquest.
...
## [2026-08-06] ingest | 165.银发川柳：用幽默面对老年，咱们来写打油诗

Added source page for a 蜜獾吃书 episode on 《银发川柳》, senryu aging humor, embodied old age, hospitals, pets, grandchildren, fraud calls, elder technology exclusion, death-facing jokes, and East Asian respect-for-elders traditions. Created pages for 《银发川柳》 / Silver Senryu, Senryu Aging Humor, Elder Technology Exclusion, and Respect For Elders Tradition; updated overview, index, 蜜獾吃书, 秦总, Japan, China, Mengzi, Confucius, Siri, Embodied Aging, Age-Friendly Infrastructure, Elder Care State Capacity, Filial Piety Laws, Confucian Ideal Governance, Present Moment Against Death, Bodily Taboo Humor, and Controlled Humor With Pain. No direct contradiction found; the source complements existing embodied-aging and filial-law pages by showing that aging can be discussed through public humor while still requiring serious attention to care capacity, technology access, and the difference between elder dignity and hierarchy.
...
Ran health before lint; health scanned 8,098 wiki pages and found no empty/stub files, index drift, or source-log coverage gaps. Lint scanned 8,098 pages and found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md`, `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used existing `graph/graph.json` and found no hub stubs, three fragile bridges, and no isolated communities. Semantic LiteLLM lint failed because `LLM_MODEL` is unset or not provider-qualified; no `wiki/lint-report.md` file was saved.

## [2026-08-06] ingest | 166.悠游长风：温柔的幻想之歌，抚平焦虑的沟壑

Added source page for a 蜜獾吃书 episode on Sarah Pinsker's speculative short-fiction collection 《悠游长风》 / 《悠悠长风》, including 《一段双车道公路》, 《梦宝宝》, 《记忆日》, and the title-story memory project. Created pages for Sarah Pinsker, 《悠游长风》 / 《悠悠长风》, 《一段双车道公路》, 《梦宝宝》, 《记忆日》, Gentle Speculative Ambiguity, Embodied Identity Boundary, Dream Parenthood Ambiguity, Memory Deletion Ethics, and Civilizational Memory Transmission; updated overview, index, 蜜獾吃书, Science Fiction Realism, Non-Instrumental Literary Reading, Literary Ambiguity As Complexity, Embodied Personhood, Dream Logic Narrative, Pain And Moral Responsibility, Trauma Narrative Integration, and Post-Apocalyptic Civilization Preservation. No direct contradiction found; the source extends the wiki's science-fiction branch with a quieter Pinsker mode where unresolved mechanisms make body, longing, trauma, memory, and art more emotionally exact rather than less.
...
## [2026-08-06] ingest | 170.宋太祖之死：烛影斧声，阴谋论中的人性谜团（下）
...
## [2026-08-06] ingest | 78.西方决斗史：出剑吧！为了荣誉！

Added source page for a 蜜獾吃书 episode on Western dueling as judicial ordeal, chivalric tournament, honor culture, proceduralized violence, women duelists, weapon lethality, and U.S. political duels. Created pages for 《西方决斗史》, John Gideon Millingen, Andrew Jackson, Aaron Burr, Alexander Pushkin, Evariste Galois, Richard Brinsley Sheridan, Julie d'Aubigny, Henry II of France, Honor Duel Culture, Judicial Duel, Trial By Ordeal, Proceduralized Violence, Chivalric Tournament Culture, Weapon Technology And Duel Lethality, and Female Duel Agency; updated overview, index, 蜜獾吃书, Napoleon Bonaparte, Alexander Hamilton, Power-Violence Distinction, Private Revenge And Modern Law, and Female Self-Possession. No direct contradiction found; the source qualifies existing law-and-violence pages by showing a historical setting where combat could be treated as formal procedure and reputation repair, while still reinforcing that rule-bound violence cannot reliably replace evidence, courts, or durable public order.

## [2026-08-06] lint | Wiki health check

Ran health before lint; health scanned 8,196 wiki pages and found no empty/stub files, index drift, or source-log coverage gaps. Lint scanned 8,196 pages and found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md`, `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used existing `graph/graph.json` built on 2026-07-24 with 6,453 nodes and 65,220 edges while current lint scanned 8,196 pages; treat graph findings as stale until `build graph` refreshes it. The graph pass found no hub stubs, three fragile bridges, and no isolated communities. Semantic LiteLLM lint failed because `LLM_MODEL` resolved to unqualified `claude-3-5-sonnet-latest` and no provider/key environment variables are set. A bounded fallback scan of orphan pages, fragile-bridge endpoints, explicit contradiction/tension markers, and known lint follow-ups found no hard unresolved contradiction; follow-ups remain to reconcile the source-scoped `ProjectGlasswing`/`ProjectGlassfin` naming tension, refresh the graph, and clean the `+-` formatting artifact in `wiki/sources/ali-qianwen-lizhi-yuzhen-zai-jiwanren-de-tieqiu-li-ruhe-timian-shengcun-keji-luandun.md`. No `wiki/lint-report.md` file was saved.

## [2026-08-06] ingest | 79.各位领导，但凡咱学点博弈论：契约理论如何解释职场管理

Added source page for a 蜜獾吃书 episode on 聂辉华《一切皆契约》, contract theory, game theory, prisoner's dilemma, information asymmetry, signaling, education credential inflation, book price wars, Japanese price-war avoidance, ratchet effects, subjective performance, mixed compensation contracts, equity incentives, CEO pay and luck, motivation crowding out, and Haier 人单合一. Created pages for 聂辉华, 《一切皆契约》, Oliver Hart, Robert Axelrod, Richard Titmuss, Haier Group, Renmin University of China, Contract Theory, Incomplete Contract, Information Asymmetry In Contracts, Prisoner's Dilemma, Tit-For-Tat Cooperation, Signal Design, Education Signal Inflation, Book Price War Signal Trap, Japanese Enterprise Price-War Avoidance, Ratchet Effect In The Workplace, Subjective Performance Incentives, Mixed Incentive Contracts, Equity Incentive Alignment, CEO Pay Luck Skimming, Motivation Crowding Out, 人单合一, and Internal Marketization Limit; updated overview, index, 蜜獾吃书, 秦总, Game Theory, Economic Way Of Thinking, Workplace Incentive Design, Book Publishing Economics, Degree As Trust Credential, Japan, Keiretsu Business Groups, China Corporate Anti-Involution, Alibaba, and Equity Compensation Upside. No direct contradiction found; the source extends existing economics and workplace pages by showing how behavior that looks like laziness, foolishness, flattery, credentialism, or destructive discounting can be produced by contract structure, risk allocation, and signal design.

## [2026-08-06] lint | Wiki health check

Ran health before lint; health scanned 8,221 wiki pages and found no empty/stub files, index drift, or source-log coverage gaps. Lint scanned 8,221 pages and found two orphan pages (`wiki/concepts/DoubtAsIntelligence.md`, `wiki/entities/BobosOatBars.md`), no broken links, no missing entity pages, and no sparse pages. Graph-aware checks used existing `graph/graph.json` built on 2026-07-24 with 6,453 nodes and 65,220 edges while current lint scanned 8,221 pages; treat graph findings as stale until `build graph` refreshes it. The graph pass found no hub stubs, three fragile bridges, and no isolated communities. Semantic LiteLLM lint failed because `LLM_MODEL` resolved to unqualified `claude-3-5-sonnet-latest`. A bounded fallback scan of explicit contradiction/tension markers surfaced tracked source-scoped tensions rather than hard unresolved contradictions: SpaceX IPO/profitability timing, `ProjectGlasswing`/`ProjectGlassfin` naming, several source-local naming notes, one `FigureAI` autonomy claim to verify later, one `Cursor` acquisition claim to verify later, and a `+-` formatting artifact in `wiki/sources/ali-qianwen-lizhi-yuzhen-zai-jiwanren-de-tieqiu-li-ruhe-timian-shengcun-keji-luandun.md`. No `wiki/lint-report.md` file was saved.
...
## [2026-08-06] ingest | Vol.115 全球宏观和资本市场2025展望：短期问题不解决，就没有中期和长期了

Added source page for a 起朱楼宴宾客 macro and capital-market outlook with 大卫翁 and Ricky on China policy easing, short-term demand repair, fiscal transmission, local debt, household consumption, A/H equity barbell strategy, bond-fund return expectations, U.S. mega-cap technology, gold, commodities, oil, and cash optionality. Created pages for China Policy Easing Pivot, Short-Term Demand Before Long-Term Reform, China Fiscal Expansion Channels, New Quality Productive Forces, A/H Share 2025 Barbell, Fact/Future Asset Pricing, Bond Fund Return Expectation Reset, U.S. Mega-Cap Tech Right-Side Trade, and China Narrative Split; updated overview, index, 起朱楼宴宾客, 大卫翁, Ricky, China, People's Bank of China, Donald Trump, Federal Reserve, Nvidia, Household Balance-Sheet Repair, China Local Debt Resolution, Labor-Share Consumption Rebalancing, China Supply-Side Clearing, China Corporate Anti-Involution, Asset Allocation, Defensive Dividend Assets, RMB Exchange Rate Policy, Policy-Driven Market Rally, AH Share Discount Repricing, A-Share Valuation Indicators, Barbell Strategy, Gold Monetary Anchor, Treasury Duration Risk, Mega-Cap Concentration Risk, AI Equity Valuation Risk, Market Regime Shift, Investment Risk Management, and Commodity Price Exposure. No direct contradiction found; the source extends vol.111 and vol.112 by making short-term balance-sheet and demand repair the precondition for medium-term reform, long-term productivity, and durable market confirmation.
...
## [2026-08-06] ingest | 150.“中国如何跳出贫困陷阱”，现代化之路又会走向何方

Added source page for a 起朱楼宴宾客 episode by 大卫翁 reading 洪源远, 李璐, and Dan Wang together on Chinese modernization, poverty-trap escape, weak institutions, directed improvisation, engineering-state process knowledge, and next-stage cultural/service-governance gaps. Created pages for Yuen Yuen Ang, How China Escaped the Poverty Trap, Li Lu, Civilization Modernization Value Investment and China, Song Zheng, Fujian, Zhejiang, Poverty-Trap Modernization, Malthusian Trap, Modernization As Compound Growth, Free-Market Scientific Loop, Imperial Examination Opportunity Equality, Development As Variation System, Weak Institutions Market Building, Directed Improvisation, Local Government Policy Experimentation, Informal Property-Rights Protection, Process Knowledge, Lawyer State, Service-Oriented Local Government, Stranger Trust Sixth Relation, Chinese Modernization Cultural Gap, and Reality-Oriented Social Science Research; updated overview, index, 起朱楼宴宾客, 大卫翁, China, United States, Dan Wang, Breakneck, Engineering State, Shenzhen, Pinduoduo, Mozi, Hubei, Overseas Chinese Mutual Aid Networks, Diaspora Capital Manufacturing Clusters, Build Build Regulate, Macro Research Public Expression, Sell-Side Research Incentives, Local Governance As Care, Boeing, Intel, Beijing-Shanghai High-Speed Railway, and Chinese High-Speed Rail. No direct contradiction found; the source qualifies the existing Engineering State branch by arguing that build capacity and process knowledge remain powerful but no longer sufficient without service governance, stranger trust, cultural renewal, and grounded social-science feedback.
...
## [2026-08-07] ingest | Froggle, Goofstump and the fake AI companies winning hearts online

Added source page for a Marketplace Tech episode on Harris Alterman and Dave Ross's fake AI subway ads, which parody vague AI-company marketing by recombining repeated phrases, polished transit-ad design, and legitimacy cues. Created pages for Harris Alterman, Dave Ross, Fake AI Subway Ads, and AI Marketing Jargon; updated overview, index, Marketplace Tech, AI Slop, and Startup Legitimacy Transfer. No direct contradiction found; the source qualifies AI slop and AI-generated advertising by showing that formulaic AI-era language can be human-made, public-facing, and investor-coded rather than necessarily generated by AI.
...
## [2026-08-07] ingest | EP247 重启人生：当农村中年女性开始“做主播”

Added source page for a Talk三联 episode with 魏茜 and 曾欣 on rural middle-aged women becoming livestreamers, covering familiar-society training, being seen, family resistance, self-earned money, persona switching, platform feedback, compressed modernity, and county platform labor. Created pages for 曾欣 / Zeng Xin, Rural Women Livestreaming, Livestream Persona Labor, Compressed Modernity Gender Transition, Family-Based Emotional Motivation, and County Platform Labor; updated overview, index, Talk三联, 三联生活周刊, 魏茜, Rural Women Public Participation, Female Self-Possession, Platform Feedback Loop, Digital Commerce Literacy, and Family Labor Boundaries. No direct contradiction found; the source qualifies simple empowerment and platform-opportunity narratives by showing that recognition and income can expand women's room to act while household duty, village morality, market saturation, and family approval still shape the outcome.
...
## [2026-08-07] ingest | We almost had a smartphone in the 90s. Why did it fail?

Added source page for a Planet Money episode on General Magic, Sony Magic Link, Tony Fadell, David Epstein, Steve Perlman, and why an early smartphone-like product failed despite elite talent, major partners, and a prescient vision. Created pages for General Magic, Tony Fadell, David Epstein, Steve Perlman, Sony Magic Link, iPod, Nest Thermostat, Constraint-Driven Product Discipline, Clear Customer Definition, Feature Creep, Premature Ecosystem Build, Build vs. Borrow Product Strategy, Brooks's Law, Additive Bias, and Desirable Difficulty; updated overview, index, NPR, Planet Money, Apple, iPhone, Sony, Motorola, Panasonic, AT&T, Steve Jobs, Product Launch Under Constraint, Design Under Constraints, and Parkinson's Law. No direct contradiction found; the source qualifies resource-rich innovation narratives by showing that too much money, time, freedom, talent, and partner complexity can weaken customer focus, deadlines, reuse discipline, and shippable iteration.
