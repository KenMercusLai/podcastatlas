...
[[vol-119-quanshang-yanjiu-baogao-hai-zhide-du-ma-ljpctapo-auonrn4tlqzvzv66qv3]] adds the sell-side support layer. Active managers may still need external market-temperature sensing, company coverage, data, and alternative views from [[BrokerageResearchReports|brokerage research reports]], but the public report is only a partial artifact of that service system.
...
- Buying a fund is framed as shared return and shared risk, so [[PortfolioSuitability]] still matters for the fundholder.
- Vol.119 adds that active management's need for outside sell-side research can persist even as public reports become less useful to ordinary investors.

## Connections
- [[LanXiaokang]] and [[ZhongouFund]] — speaker and institution in the source.
- [[PortfolioSuitability]], [[InvestmentRiskManagement]], and [[DrawdownPsychology]] — investor fit and risk-sharing context.
- [[ValueInvesting]], [[DividendDiscountModel]], and [[StateOwnedEnterpriseSocialValue]] — cash-flow and valuation context.
- [[NewOrderAssetPricing]] and [[MarketRegimeShift]] — reason style labels may need to change.
- [[BrokerageResearchReports]], [[SellSideResearchIncentives]], and [[ResearchReportReadingDiscipline]] — sell-side research layer added by vol.119.
