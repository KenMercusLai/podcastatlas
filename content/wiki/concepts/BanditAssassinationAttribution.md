...
Bandit assassination attribution / 盗贼行刺归因 is the source's caution about terse phrases such as "盗贼杀君." In [[zizhi-tongjian-zhouji-06-weiwenhou-xuan-shui-dang-zaixiang-ne-2-lmfzo4sl9nd5kz3mrxdl1dl9efei]], [[ChuShengWang|楚声王]] is said to be killed by bandits, but the host argues that other historical examples make the phrase politically suspicious rather than self-explanatory.
...
- Assassination records require attention to motive, access, succession, and who benefits.
- Alternative explanations should remain source-bound and probabilistic unless stronger evidence appears.
- The same phrase can carry different evidentiary weight depending on the surrounding record tradition.

## Connections
- [[ChuShengWang|楚声王]] - source's main suspicious death notice.
- [[ZhengWenGong|郑文公]] - comparison case of using bandits.
