...
tags: [idiom, western-han, office, workplace, political-ethics]
sources:
...
五日京兆 / Five-Day Jingzhao is the idiom and office-risk pattern where someone treats an official as functionally finished before formal removal occurs, using expected future loss of power as an excuse for present neglect, contempt, or short-term thinking.
...
- The idiom originates in a superior-subordinate conflict around Zhang Chang's rumored dismissal as Jingzhao Yin.
- "Almost out of office" is not the same as "already without authority"; present office still matters until formal removal.
- The phrase's later meaning includes negligent short-timer behavior and short-sighted lack of long-term planning.
- The source case shows how rumor can change subordinate behavior before institutions have actually changed.
- The case also warns that insulted authority can overreact when formal power is still available.
...
- [[SpeechAsMoralDiagnostic|言语作为德行信号]] - Xu Shun's phrase reveals contempt and judgment failure through speech.
- [[CommandDisciplineAuthority|军法威严]] - related through the need for orders to remain credible before formal authority changes.
- [[PersonalRevengeThroughStatePower|以国力行私仇]] - negative escalation when Zhang uses public power to punish a private slight.
- [[PublicDutyOverPrivateGrievance|对事不对人式公义]] - contrast because Zhang fails to keep public office separate from private anger.
- [[TalentVirtueDistinction|才德之分]] - the episode later asks whether capable office performance can coexist with moral unsuitability.
