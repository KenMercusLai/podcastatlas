...
type: concept
tags: [late-han, governance, imperial-tour, administration]
sources:
...
# 巡幸随从纪律 / Imperial Retinue Discipline

## Definition

Imperial retinue discipline is the administrative problem of keeping a ruler's traveling entourage from turning imperial presence into uncontrolled local extraction, favor-seeking, or appointment disorder.
...
- Imperial touring can turn political presence into practical extraction when a large retinue consumes local labor and funds.
- A moving emperor creates jurisdictional ambiguity: officials need enough status to discipline people traveling under imperial proximity.
- Hu Teng's proposal treats stronger inspection authority as the way to convert local burden into enforceable order.
- Yang Bing's warning shows that tour disorder includes appointment patronage, not only food, transport, and lodging costs.
- This concept is narrower than [[ImperialTourPoliticalTheater|imperial tour political theater]] because it focuses on discipline and administrative containment.
...
The source gives a brief annalistic notice and does not quantify the exact extraction imposed by Huan's tour. It also reports improved discipline after Hu Teng's proposal without proving how durable that discipline was after the journey ended.
...
- [[ImperialTourPoliticalTheater|帝国巡游政治剧场]] - broader pattern of ruler travel as inspection, display, coercion, and legitimacy work.
- [[CourtOfficeCapture|朝廷开府任官失序]] - downstream appointment-disorder pattern that Yang Bing's warning anticipates.
- [[OfficialSelectionChannelCompetition|选官通道竞争]] - broader problem of appointment routes being redirected by power and favor.
- [[PalaceAccessMonopoly|宫廷接触垄断]] - adjacent access condition because traveling with the ruler can create favor and influence opportunities.
- [[UntimelyExtravagance|时绌举赢]] - related burden frame when ruler display or palace needs impose public cost.
