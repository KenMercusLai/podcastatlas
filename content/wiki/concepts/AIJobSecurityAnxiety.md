...
sources:
  ...
  - tech-20260803-0803-mp-tech-pod-128-tech-20260803-0803-mp-tech-pod-128
...
## Definition
AI job security anxiety is worker, student, or professional hesitation caused by the possibility that AI productivity, automation, screening, or role redesign will weaken employment security, career ladders, or the return on effort.
...
- Anxiety can become more manageable when people use AI toward self-directed work, small tools, or human-scale goals rather than only company efficiency demands.

## Evidence
- Worker trust evidence: [[tech-20260803-0803-mp-tech-pod-128-tech-20260803-0803-mp-tech-pod-128]] says employees may hesitate if they fear productivity gains will help employers eliminate or consolidate jobs.
- Incentive-ratchet evidence: [[ep275-token-tongzhang-shidai-shui-hai-neng-bu-ke-tidai-renzai-zhongliu-tebie-cehua-01-lgnagvell4jyvv7eejrcgno2xjsr]] warns that good AI users can become overloaded if new capability becomes an unrewarded baseline.
- Graduate evidence: [[brave-new-whirl-turkeys-opposition-overhaul-6a69c7766043035f89eb097f]] links Gen Z labor-market anxiety to AI-assisted mass applications, AI screening, and weakened first-job certainty.
- Student-planning evidence: [[151-17sui-bei-2026-nian-icml-shoulu-lunwen-de-xiao-shaonian-wo-bet-kaixin-kaixin-kaixin-lgs-qedm2hdrxrfkgnsphg4i5h5u]] shows AI job anxiety appearing before career choice when students question long professional training paths.
- Design-profession evidence: [[anyway-195-anyway-195]] adds the UI/UX version, where the speakers worry that AI will reduce designer headcount needs and make model quality more central than interface craft.
...
- [[AINativeWorker]] - worker label whose value depends on trust, incentives, and advancement rules.
- [[ManagerialAIFluencyGap]] - management-side blocker behind worker uncertainty.
- [[EntryLevelAICareerLadderRisk]] - early-career mechanism behind graduate and student anxiety.
- [[AIProductivityRatchet]] - overload mechanism when AI productivity raises expectations without reward.
- [[AIUXDesignValueCompression]] - UI/UX-specific professional anxiety added by the Anyway.FM source.
- [[HumanScaleAIUse]] - response frame where AI is judged by whether it improves life and work for the user.
- [[AIWashingLayoffAttribution]] - attribution concept separating AI-caused displacement from AI-branded restructuring.
