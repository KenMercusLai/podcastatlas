...
type: concept
tags: [military-strategy, deception, morale, warring-states, late-han]
sources:
...
Deceptive surrender lull is the military-deception pattern in which surrender, peace, or compliance signals make the receiving side lower vigilance before a surprise attack or decisive maneuver.
...
- [[FireOxNightRaid|火牛阵夜袭]] - attack made possible by Tian Dan's false-surrender lull.
- [[BattlefieldInformationControl|战场信息控制]] - broader frame for controlling what the enemy believes about timing and intent.
- [[AssassinationAccessCredential|刺杀接近凭证]] - adjacent pattern where surrender or envoy posture creates physical access rather than army-wide complacency.
- [[PoliticalSurrenderCascade|招降示范级联]] - contrasting pattern where surrender is made credible and useful rather than deceptive.
- [[PunitiveSurrenderDeterrence|杀降纳降反噬]] - warning that mishandling surrender can harden future resistance.
- [[DuanJiongLateHan|段熲]] - late-Han commander whose 169 CE judgment adds the counter-deception side.
