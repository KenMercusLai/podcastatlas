...
tags: [omens, court-politics, personnel, chinese-history]
sources:
...
The case also shows the strategy's limit. [[HanAidi|汉哀帝]] ignores the warning, completes the [[FuTaihouWesternHan|傅太后]] title settlement, and lets Zhu Bo and Zhao Xuan act against [[ShiDanWesternHan|施丹]]. Omen language can authorize criticism, but it does not guarantee conversion into personnel correction.

## Key Claims

- Reported anomalies can become immediate evidence in appointment disputes.
- The method works by translating uncertain events into concrete office-fit claims.
- The physical cause of the anomaly can become secondary once the court accepts the omen frame as politically legible.
- Personnel attacks through omen language can be more acceptable than blunt factional accusation, but they remain easy for rulers to ignore.
- The strategy exposes a distinction between tactical competence and office suitability: a forceful actor may be effective in one role and dangerous in a coordinating role.
...
- [[OmenCodedRemonstrance|天象灾异包装式进谏]] - broader indirect-warning strategy that includes but is not limited to personnel attacks.
- [[CelestialOmenPoliticalResponsibility|天象政治责任]] - responsibility logic that makes Heaven-sign readings politically usable.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - failure condition that encourages coded criticism and also explains why the warning may not convert into action.
- [[OfficeSequencePowerReallocation|官职序列重组式权力再分配]] - related personnel-power field because Zhu Bo's rise depends on office redesign.
- [[ZhuBoWesternHan|朱博]] - central target whose temperament is judged through the omen.
- [[LiXunWesternHan|李寻]] - interpreter who identifies the sign as "鼓妖."
- [[YangXiong|扬雄]] - remonstrant who turns the omen into a specific office-fit critique.
