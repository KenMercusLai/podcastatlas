...
## Definition
Stress response recovery is the source-scoped frame that stress outcomes depend not only on the stressor, but on appraisal, body activation, recovery, coping resources, and whether the stress response remains switched on longer than needed.
...
- Recovery emphasis - [[control-stress-for-healthy-eating-metabolism-aging-dr-elissa-epel-scim4455888803]] repeatedly says life will always contain stressors, making response and recovery central.
...
- [[AutonomicStressTraining]] - body-based stress-training neighbor.
- [[ThreatChallengeStressReappraisal]] - appraisal branch that changes stress physiology.
- [[BrainBodyEmotionMapping]] - mechanism neighbor for linking body state and emotion.
