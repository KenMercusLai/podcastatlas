...
## Definition
Energy balance accounting is the episode's frame that calories remain the basic energy ledger for weight change, while real-world intake, absorption, expenditure, appetite, fluid shifts, and adherence make that ledger difficult to observe precisely.
...
- [[SustainableHealthOptimization]] - routine frame that keeps measurement useful without perfectionism.
- [[ProteinBodyCompositionLever]] - macronutrient branch where satiety, thermic effect, and lean mass modify practical calorie management.
- [[FoodPleasureEngineering]] - food-environment branch explaining why intake can rise without deliberate overfeeding.
- [[SleepAsDailyHealthAccount]] - recovery and state-management neighbor that can affect appetite, training, and consistency.
- [[FertilityEnergyAvailability]] - adjacent concept where calorie availability and body composition matter for reproductive function.
