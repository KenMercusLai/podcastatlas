...
type: concept
tags: [military-finance, court-politics, late-han, eunuchs, warfare]
sources:
...
# 军费通道利益驱动 / Campaign Finance Access Incentive

## Definition

Campaign finance access incentive is the pattern in which a large military campaign creates fund flows, appointments, rewards, and decision points that become attractive to actors with privileged access to the ruler or treasury. The concept explains why a court faction might favor or smooth a costly campaign even when the source does not prove direct embezzlement by named individuals.
...
- Large suppression campaigns create concentrated flows of military funding, rewards, and appointments.
- Actors with ruler or treasury access can influence which military plans receive approval and resources.
- A hard-line campaign can become politically easier when it aligns with access-holder incentives, not only when it is strategically superior.
- The pattern can exist as institutional pressure even without source-level proof of named embezzlement.
- It connects frontier warfare to inner-court access politics by treating military budgets as governable and contestable channels.
...
- [[PalaceAccessMonopoly|宫廷接触垄断]] - supplies the access mechanism by which inner-court actors can influence ruler-facing military decisions.
- [[WarCostTempoDiscipline|战争成本与速决纪律]] - adjacent strategic frame for the supply and cost pressure created by campaigns.
- [[InnerCourtAccessBrokerageRisk|内廷通道攀附风险]] - related risk where palace channels turn access into brokerage power.
- [[ImperialPrivateTreasuryExtraction|帝王私库进奉盘剥]] - adjacent finance pattern involving palace-side extraction and private treasury channels.
- [[RootCausePacification|查因安抚式治理]] - contrasting governance frame that asks whether military spending solves or worsens frontier causes.
- [[DuanJiongLateHan|段熲]] - case actor whose hard-line campaign and reward sequence make the incentive visible.
