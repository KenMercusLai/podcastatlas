...
tags: [taxation, rebellion, governance, xin-dynasty, state-capacity]
sources:
...
财政压榨叛乱螺旋 / fiscal extraction rebellion spiral is the governance failure in which a state answers crisis by increasing extraction from already stressed people, converting fiscal need into flight, death, banditry, and still deeper insecurity.
...
- Extraction can be administratively rational from the center while socially destructive at the edge.
- Military and frontier campaigns can convert into domestic rebellion pressure when their costs are pushed onto households and local officials.
- Rewarding officials for finding new taxable capacity can bias the state toward harsher extraction.
- When taxation and labor demands exceed survival capacity, flight and banditry become responses to governance rather than mere criminality.
- The spiral worsens feedback quality because success is measured by reported revenue opportunities rather than social stability.
- The concept should be used only where a source links fiscal pressure to mass disorder, not for any unpopular tax.
...
This concept is currently grounded in two late-Xin source notes. It does not claim all taxation produces rebellion, nor does it quantify the exact causal share of tax relative to drought, famine, corvee, local administration, frontier pressure, or rebel organization. The strongest claim is narrower: when extraction increases under acute livelihood stress, fiscal policy can become a rebellion accelerator.
...
- [[WangMangReforms|王莽改制]] - policy field whose fiscal and administrative ambitions frame the late-Xin pressure.
- [[CrisisPriorityMisalignment|危机优先级错置]] - upstream sequencing failure because wrong-priority campaigns can create new extraction pressure.
- [[SuppressedRootCauseReporting|根因上报压制]] - related failure when the court refuses to hear burden-based explanations of revolt.
- [[RootCausePacification|查因安抚式治理]] - contrasting governance method that asks why disorder forms before choosing force.
- [[OfficialArmyPredationBackfire|官军扰民反噬]] - adjacent pattern where state suppression itself makes civilians fear the state.
- [[PunitiveCurrencyEnforcementBackfire|惩罚性货币执法反噬]] - neighboring late-Xin case where economic control turns into forced labor and social damage.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - broader information failure that lets destructive policy look administratively successful.
