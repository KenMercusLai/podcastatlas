...
## Key Claims
- The episode keeps 性恶论 source-scoped and introductory rather than treating it as a complete account of Xunzi's ethics.
- Its political implication is that ritual and law are active ordering tools, not decorative norms.
- The contrast with Mencius helps distinguish Xunzi's route to [[ConfucianIdealGovernance|儒家理想治理]] from Mencian benevolent-government language.
- In the episode's statecraft branch, human-nature pessimism reinforces [[XunzianWangbaThreePaths|荀子王霸三分法]]: rulers need order and trust because desire, fear, and expedient calculation can pull states apart.
- Qinji 101-2 adds the crisis-pressure side: [[DisasterCivilizationRetreat|disaster]] can expose survival instincts when ordinary civilized restraints thin out.

## Connections
- [[Xunzi|荀子]] and [[XunziText|《荀子》]] - thinker and text associated with the theory.
- [[Mengzi|孟子 / Mencius]] and [[MenciusText|《孟子》]] - contrast point named by the source.
- [[ConfucianIdealGovernance|儒家理想治理]] and [[WangdaoVsBadao|王道 versus 霸道]] - broader Confucian political frames.
- [[LegalistRulerTechnique|法家君术]] - adjacent but distinct rule-through-order frame in the wiki.
- [[HumanNaturePlasticity|人性可变性]] and [[DisasterCivilizationRetreat|灾变中的文明退场]] - Qinji 101-2 transformation and crisis extension.
