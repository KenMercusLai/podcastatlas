...
[[123-renxing-shiyan-dangxin-ni-ziji-779479569]] adds the social-psychology version. The episode argues that experiments matter because ordinary intuition can accept hindsight stories, partisan perceptions, stereotype-shaped memory, and confidence in one's own objectivity as if they were direct knowledge.

[[dont-hate-the-replicator-hate-the-game]] adds a social-science reproducibility version. The skeptical object is not only an extraordinary public claim but also the polished published paper: readers need code, data, [[ReplicationPackage|replication packages]], and [[RobustnessChecks]] to test whether a result survives more than one analytical path.
...
- [[ScientificSelfCorrection]], [[AppealToIgnorance]], [[GarageDragonTest]], and [[OccamsRazor]] - tools and method neighbors.
- [[UFOConspiracyCulture]], [[AlienAbductionNarrative]], and [[CropCircleDebunking]] - cases that need skepticism without contempt.
- [[RationalHumility]] and [[ObservationBeforeInference]] - existing wiki concepts extended by the source.
