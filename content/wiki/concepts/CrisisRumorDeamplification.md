...
tags: [rumor, crisis-management, governance, court-politics]
sources:
...
危机谣言降幅治理 / crisis rumor de-amplification is the governance pattern where a ruler or official refuses to give unverified public panic an official command form, because state action can turn rumor into confirmation and make the crowd danger worse.
...
- Public fear can become a crisis multiplier when official action appears to confirm an unverified rumor.
- Crisis leadership requires judging the effect of a command, not only the apparent severity of the reported danger.
- A politically powerful person's proposal can draw conformity from other officials even when its informational basis is weak.
- De-amplification succeeds when the ruler can pause, test the claim, and avoid converting rumor into public mandate.
- The official who restrains panic may gain authority by showing steadiness under social pressure.
...
The current concept rests on one Western Han source. It should not be generalized into anti-evacuation advice: if danger is verified or probability is high, public movement may be necessary. The point is narrower: commands issued before evidence can intensify panic when the crowd reads official action as proof that the worst rumor is true.
...
- [[RumorErosionOfTrust|谣言侵蚀信任]] - broader rumor-risk model, while this concept focuses on state-command amplification during public panic.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - contrast because Wang Shang's dissent prevents the court from following a powerful but weakly grounded proposal.
- [[DisasterResponseStateCapacity|灾害应对国家能力]] - related capacity field for distinguishing verified disaster response from rumor-driven movement.
- [[WangShangWesternHan|王商]] - official whose judgment anchors the case.
- [[WangFengWesternHan|王凤]] - powerholder whose proposed response would have magnified panic.
