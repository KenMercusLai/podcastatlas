...
tags: [governance, court-politics, outer-relative-power, appointments, accountability]
sources:
...
Outer-relative command appointment risk is the court-governance problem created when imperial in-laws or maternal relatives receive heavy offices or military commands. The risk is not only that relatives may perform badly; it is that punishment, favoritism, subordinate reporting, and public law become entangled with kinship.
...
The concept therefore separates merit from structural risk. A relative can succeed in the field and still make the accountability environment less clean, especially when the system depends on officials willing to report, command, and evaluate without anticipating protected-family consequences.

## Key Claims

- The danger of heavy in-law appointment is a law-versus-kinship dilemma, not merely presumed incompetence.
- Granting wealth or title to relatives is structurally different from giving them military or administrative command.
...
- The concept is a narrow appointment-risk branch within the broader field of outer-relative power.
...
The source does not show Ma Fang failing in battle; on the contrary, it reports major victories and surrender. It also does not prove that Ma Fang ordered Geng Gong's impeachment. The concept should therefore be kept structural: kinship command creates incentives and expectations that can distort accountability even when the relative is militarily capable.
...
- [[OuterRelativeCourtPower]] - broader field of imperial in-law access, regency, favor, and later purges.
- [[RuleOverKinshipPower]] - normative relationship because public law must remain stronger than family protection.
- [[CourtFeedbackCollapse]] - adjacent failure mode when officials anticipate protected power instead of reporting openly.
