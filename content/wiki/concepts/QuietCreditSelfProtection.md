...
tags: [court-politics, workplace, credit, risk, western-han]
sources:
...
不显功式自保 / Quiet Credit Self-Protection is a role-bound strategy where a person contributes to major decisions while deliberately avoiding public ownership of the credit, so the superior's authority remains intact and peer jealousy is reduced.
...
- Credit visibility can be a political risk when advice occurs through private access to a superior.
- Preserving the superior's visible authority can be part of loyal service, not only self-erasure.
- Peer jealousy rises when hidden influence becomes visible without a formal mandate.
- Withdrawal or surprise can function as credit-management theater in high-risk hierarchy.
- The strategy is safest when paired with real competence and role performance, not with avoidance of responsibility.
...
The source does not prove every instance of Zhang's illness or surprise was staged; it presents the pattern as the host's synthesis of court behavior. The concept should not be generalized into hiding all work. It applies where private influence, superior authority, and peer suspicion make public credit more dangerous than useful.
...
- [[ZhangAnshiWesternHan]] - direct entity case for the pattern.
- [[PublicRecommendationPrivateFavorBoundary]] - adjacent role-bound service concept in the same episode.
- [[RewardFitnessRisk]] - related because credit and reward can become dangerous when they outrun visible role fit.
- [[WorkplaceRoleClarityBoundary]] - broader workplace boundary around staying aligned with decision authority.
- [[PowerExitTrap]] - broader political risk field where visible accumulated merit can become threatening.
