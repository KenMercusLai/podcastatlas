...
tags: [communication, court-politics, information-control, late-han, remonstrance]
sources:
...
Confidential remonstrance leakage / 密奏泄露风险 is the failure mode where a private official advice channel loses confidentiality before the ruler can protect, evaluate, or act on it, turning correction into political evidence against the speaker.
...
- Confidentiality can be part of the advice itself when the content names protected interests.
- A ruler who hears frank correction but cannot protect the channel may teach future officials to stay silent.
- A leak can transform procedural mishandling into a loyalty or reverence offense when the speaker is already politically exposed.
- Inner-court observers can convert a private memorial into actionable intelligence for the criticized faction.
- Loyal advice can fail at the protection and aftermath stage even when the substance is politically serious.
- Remonstrance leakage is adjacent to plan leakage, but the exposed asset is the speaker's accusation and trust relationship rather than an executable operation.
...
- [[ShiDanWesternHan|施丹]] - Western Han official whose leaked sealed memorial grounds the reverence-punishment branch.
- [[CaiYong|蔡邕]] - late-Han official whose confidential memorial grounds the faction-intelligence branch.
- [[PalaceAccessMonopoly|宫廷接触垄断]] - structural relationship because inner-court access can expose supposedly private communication.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - feedback relationship because rulers who cannot protect private advice weaken future correction.
- [[LethalPlanLeakageRisk|致命计划泄露风险]] - adjacent secrecy concept where the exposed material is an intended operation rather than remonstrance.
- [[ProtectiveRemonstranceSequencing|护身符式进言]] - related speech-risk management when advice must be timed and protected.
