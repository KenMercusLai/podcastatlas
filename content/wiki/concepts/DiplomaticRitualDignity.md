...
tags: [diplomacy, ritual, frontier, dignity, eastern-han]
sources:
...
使节礼节国威 / diplomatic ritual dignity is the statecraft pattern where an envoy's bodily ritual posture, especially before a rival or hostile ruler, becomes a public signal of the sending state's status, resolve, and hierarchy.

## Current Synthesis

Hanji 738 grounds the concept through [[ZhengZhongFrontierEasternHan|Zheng Zhong]]'s refusal to be sent back to [[NorthernXiongnuLateHan|Northern Xiongnu]]. Zheng does not frame the danger as ordinary personal hardship. He argues that if he carries a Han tally and is forced to kowtow before the chanyu, the ritual act will not remain private; it will be read as damage to Han prestige.
...
The concept is therefore narrower than general etiquette. It applies when ritual form is likely to be consumed by a hostile audience as evidence of interstate hierarchy. Zheng's later rehabilitation also shows the recognition problem: a ruler may first see refusal as disobedience until independent testimony confirms that the envoy was defending state dignity.
...
- Coerced-kowtow risk: [[zizhi-tongjian-hanji-738-ta-pinsi-baoquan-dahan-qijie-weihe-canzao-mengyuan-lrvc1f6fv2h66q0plecihmfmdvxu|Hanji 738]] says Zheng Zhong had previously been surrounded and denied food because he refused to kowtow to the Northern Xiongnu chanyu.
...
The concept does not say every diplomatic compromise or ritual concession is dishonorable. It is source-bounded to a hostile frontier context where Northern Xiongnu tribute and raiding coexist, and where a coerced bow by a Han envoy could be used as public evidence of chanyu superiority. Future sources should distinguish this from ordinary protocol, face-saving hierarchy, or negotiated parity.

## What Changed

- Created the concept from Zheng Zhong's Hanji 738 refusal to let envoy ritual become a hostile prestige signal.

## Related Concepts

- [[ZhengZhongFrontierEasternHan|郑众]] - source actor whose refusal defines the pattern.
- [[PowerEtiquetteReading|权力礼仪细读]] - broader reading method for extracting power relations from ritual, titles, posture, and address.
