...
tags: [statecraft, alliance, escalation, frontier, risk]
sources:
...
Dangerous ally invitation risk / 引强援反噬风险 is the pattern where a weaker or pressured actor invites a powerful outsider to solve an immediate enemy problem, but the outsider's independent force, incentives, and ambition make the inviter's own position less secure.
...
- A strong outsider's incentives remain independent even when the inviter supplies hospitality, marriage ties, or shared enemies.
- Solving a current enemy problem can import a larger security problem into the inviter's own political field.
- Alliance value should be judged by control, exit, and post-victory behavior, not only by immediate military usefulness.
- The outsider may use the alliance to rebuild strength, coerce surrounding states, or pursue a private enemy.
- External-force crises can destroy one actor while creating upward mobility for another actor that supplies timely protection or service.
...
- [[Kangju|康居]] - inviter whose anti-Wusun strategy supplies the current case.
- [[ZhizhiChanyu|郅支单于]] - powerful outsider whose alliance value carries reversal risk.
- [[Wusun|乌孙]] - immediate target that makes the invitation attractive to Kangju.
- [[ExternalTroopInvitationRisk|外兵入京升级风险]] - adjacent court-politics version where borrowed outside force transforms the original dispute.
- [[ProxyConflictSpoilerRisk|Proxy Conflict Spoiler Risk]] - adjacent pattern where a third actor's incentives disturb the sponsor's intended conflict design.
- [[QinXiangGong|秦襄公]] - crisis beneficiary in the episode's Western Zhou comparison.
