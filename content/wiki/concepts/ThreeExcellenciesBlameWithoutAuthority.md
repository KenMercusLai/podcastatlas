...
tags: [governance, court-politics, late-han, accountability, bureaucracy]
sources:
...
Three Excellencies blame without authority / 三公无权背责 is the late Eastern Han pattern where nominally senior ministers carry disaster-accountability and dismissal risk even after practical decision power has shifted to Shangshu, outer-relative, favorite, and eunuch channels.
...
- Formal rank can survive after practical decision power has shifted elsewhere.
- Disaster and rebellion politics can assign blame to visible officeholders even when they lack control over the relevant decisions.
- Zhongchang Tong frames the mismatch as a dynasty-level structural disease after power leaves the Three Excellencies for Shangshu and inner-court actors.
- Chen Zhong frames the same mismatch as an An-era administrative warning about confidential affairs, selection, punishments, rewards, and legal decisions.
- Accountability detached from authority protects the real decision channel and weakens institutional correction.
- The pattern links personnel corruption and frontier disorder because protected channels can appoint greedy border officials while formal ministers take public blame.
...
- [[ZhongchangTongLateHan|仲长统]] - political critic whose `Changyan` supplies the dynasty-level diagnosis.
- [[ChenZhongLateHan|陈忠]] - official whose memorial supplies the An-era administrative diagnosis.
- [[EmperorAnOfHan|汉安帝]] - ruler whose court leaves the mismatch unresolved.
- [[ShangshuTaiImperialAccess|尚书台近侍权力]] - adjacent concept for document-office and imperial-access power.
- [[CourtOfficeCapture|朝廷职官俘获]] - broader capture frame that includes hollowing out formal offices.
- [[AccountabilitySinks|责任汇流槽]] - related accountability pattern where blame collects away from actual control.
- [[PalaceEnvoyLocalExtraction|宫使扰民式地方抽取]] - same-source case of burden flowing outward from protected court channels.
