...
tags: [ritual, administration, eastern-han, memory, succession]
sources:
  - zizhi-tongjian-hanji-733-1-lishi-suo-yiwang-de-diwang-zhishi-mingjun-liuzhuang-lor7vhzzpwz1rv9tijksogukjqvr
last_updated: 2026-08-31
---

# 宗庙记忆中的行政汇报 / Dynastic Memory Reporting Ritual

## Definition

Dynastic memory reporting ritual is a governance pattern in which routine local administrative reporting is staged before an ancestral or founding imperial presence, turning data about the realm into a ritual performance of accountability to dynastic memory.
...
- The ritual binds succession legitimacy to information about actual local conditions.
- Guangwu's ancestral presence is made administratively active rather than merely commemorative.
- Reporting grain prices and hardship turns economic distress into material appropriate for dynastic memory.
- The scene bridges affective mourning, filial reverence, and bureaucratic accountability.
- The source presents the rite as a durable system, but the wiki currently has only one direct source layer for the practice.
...
- The current page rests on a single source note and does not yet document how long the reporting rite lasted in practice.
- The source does not provide the full ritual manual or administrative forms behind the Yuanling procedure.
- The concept should be kept distinct from generic ancestral worship; its defining feature is administrative reporting before dynastic memory.
...
- [[RitualAffectiveOrder]] - parent pattern linking ritual form, affect, and governance.
- [[LiAsPoliticalOrder]] - broader ritual-order frame that includes but is not limited to reporting before ancestral memory.
- [[ImperialTeacherHonorRitual]] - parallel early-Mingdi use of personal reverence to authorize public order.
- [[ImperialSelfCriticismEdict]] - related accountability form where imperial legitimacy is tied to public acknowledgement of conditions.
