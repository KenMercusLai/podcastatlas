...
tags: [leadership, governance, organization-politics, authority, western-han]
sources:
...
New-leader first-move authority signal / 新领导第一把火式权力宣示 is the pattern where a newly installed ruler or manager makes an early visible change to announce who now controls the order, with the outcome depending on target selection, justification, cost, and resistance.
...
- Early visible action can establish authority by contrasting the new leader with the previous order.
- The chosen target matters more than the mere intensity of the action.
- A defensible first move usually combines normative justification, manageable opposition, and measurable effect.
- First moves are risky because they can become symbolic power use rather than real institutional repair.
- Organizational scale increases caution requirements because apparently narrow actions can create wider costs.
- Public-facing projects become suspect when they are pursued for face or personal political capital rather than grounded need.
...
The source is a management reading of a short historical passage rather than a full institutional history of Western Han music administration. It does not prove that Aidi's Yuefu policy was sufficient, durable, or socially harmless. The concept should therefore be used for early authority signaling and target selection, not as a general endorsement of symbolic cuts, layoffs, cultural regulation, or anti-entertainment policy.
...
- [[FaceProjectGovernance|面子工程式治理]] - negative adjacent pattern where visibility and prestige outrun practical governance.
- [[LiAsPoliticalOrder|礼制政治秩序]] - broader role-and-order frame that can make visible action politically legible.
- [[GoodIntentionsPoliticalLimits|Good Intentions Political Limits]] - caution that a justified or sincere action can still fail politically.
- [[OuterRelativeCourtPower|外戚专权与清算]] - court-power background that makes Aidi avoid an immediate direct fight with consort-family blocs.
- [[TransitionFitOverMerit|过渡期适任优先于功劳]] - related succession frame where early stability may matter more than maximal reform energy.
