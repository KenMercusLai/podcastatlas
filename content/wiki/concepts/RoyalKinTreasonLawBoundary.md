...
tags: [royal-family, treason, law, governance, eastern-han]
sources:
...
The concept is not modern equality before law. It preserves a court-centered distinction: royal closeness changes reporting, deference, succession handling, and the ruler's emotional burden, but the official judgment still has to treat rebellious intent or mandate disturbance as a dynastic threat.
...
- Officials can answer family pressure by defining the realm as inherited public trust, not private household property.
- Ruler mercy may delay or soften punishment, but repeated rebellion-linked behavior narrows that space.
...
- [[FanTiaoEasternHan|樊鯈]] - official who states the dynastic public-trust argument.
- [[RebelMandateManufacture|起义天命制造]] - related risk form because Liu Yang's royal-kin threat works through fabricated chen-style claim-making.
- [[KinshipProtocolBoundary|亲情名分边界]] - related court-family boundary where affection remains safe only inside public form.
- [[RoyalFiefDiscipline|王国相整肃]] - later fief-governance analogue where royal status must be forced back under public order.
- [[TreasonAccusationTrap|谋反指控陷阱]] - adjacent risk pattern because rebellion language can activate ruler-security logic.
