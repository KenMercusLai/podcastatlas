...
tags: [strategy, warfare, pre-qin-history, warring-states, eastern-han]
sources:
...
Encircling Wei to rescue Zhao / 围魏救赵 is a pressure-displacement strategy: instead of rescuing the endangered point directly, a commander attacks what the aggressor must protect, forcing the aggressor to leave its chosen battlefield or accept loss elsewhere.

## Current Synthesis

The current evidence presents the strategy as a reusable but execution-sensitive pattern. [[zizhi-tongjian-zhouji-15-jiu-bu-chun-yinfa-de-shijie-dazhan-li-iojxthq8komhlhyumho3yvtem|Zhouji 15]] supplies the setup before the classic execution: [[WeiState|魏国]] surrounds [[Handan|邯郸]] after [[LiangHuiWang|魏惠王]] reads [[ChuState|楚国]]'s attack on [[LuState|鲁国]] as a distraction, while [[Jingshe|景舍]] and the coming [[TianJi|田忌]] / [[SunBin|孙膑]] branch show that multiple rescue options are in play.

[[zizhi-tongjian-zhouji-16-sunbin-pangjuan-enyuan-jiuge-guiling-zhi-zhan-lryhzkc1-xsvfjhvicu8yxa9d2jr|Zhouji 16]] gives the canonical [[GuilingBattle|桂陵之战]] logic. Sun Bin rejects direct rescue of Zhao at Handan and tells Tian Ji to attack [[Daliang|大梁]] instead. The move works because Wei cannot ignore its own core point, so the rescuer changes the tempo and place of decision.
...
- The relevant target is not always the place where the ally is suffering.
- The strategy depends on reading what the enemy cannot politically or militarily ignore.
- Attacking a must-save point can convert rescue from reactive reinforcement into tempo control.
- The pattern repeats across scales, from Warring States interstate war to late-Han and Eastern Han campaign situations.
- Timing matters: a delayed or mis-sequenced indirect strike can become an ordinary failed relief operation.
- Successful use requires commanders to follow the displacement logic instead of reverting to the emotionally obvious rescue route.
...
- [[LureEnemyOutOfPosition]] - related because both patterns make the opponent move away from its preferred battlefield.
- [[TianJiHorseRacing]] - parallel Sun Bin pattern that accepts local asymmetry to win the larger contest.
- [[DelayedRescueStatecraft]] - timing relationship because rescue may be intentionally delayed before the indirect pressure point is struck.
- [[ForcedMarchOperationalRisk]] - downstream risk when the enemy is forced to abandon one front and rush toward another.
- [[BattlefieldFeintAndLure]] - adjacent tactical pattern because false movement can either support pressure displacement or, as Dong Xian shows, punish a direct rescuer.
- [[GaiYanEasternHan]] - negative execution case: his direct Lanling rescue fails where Liu Xiu had advised a Tan pressure strike.
- [[DongXianEasternHan]] - opponent who exploits Gai Yan's direct rescue by feigning retreat and retaking Lanling.
