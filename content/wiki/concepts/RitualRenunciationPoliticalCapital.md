...
tags: [eastern-han, succession, reputation, ritual, office]
sources:
...
礼让辞封式政治资本 / Ritual renunciation as political capital is the pattern where refusing a hereditary title, office, or material inheritance can be read as Confucian yielding and converted into public reputation, imperial favor, or later office, even when the refusal strains ordinary legal succession.
...
- Refusing a hereditary benefit can produce moral reputation when observers read it as ritual yielding rather than evasion.
- The same act can violate succession order because titles and fiefs are public legal institutions, not private property alone.
- A court intermediary can convert a legally suspicious act into an imperial exception by choosing the right normative frame.
- The payoff can be material and career-related: reputation may open office paths even when the act was staged as refusal.
- Exceptional handling needs a precedent boundary, because repeated private refusals would weaken ordinary succession rules.
...
- [[MoralReputationPoliticalCapital|道德名望政治资本]] - broader category because Liu Kai turns visible virtue into usable political advantage.
- [[LiAsPoliticalOrder|礼制政治秩序]] - institutional boundary because succession law and ritual order make the refusal politically risky.
- [[OfficialSelectionChannelCompetition|选官通道竞争]] - adjacent office-access field because reputation can supplement formal routes into service.
- [[PublicHumilityReputationTest|公开谦逊声誉测试]] - neighboring reputation pattern where visible lowering of self produces status judgment.
- [[ReclusionAuthenticityAssessment|真隐士与伪隐士辨别]] - comparison because both ask whether withdrawal is principled or reputation-seeking.
- [[PunishmentPersonalResponsibilityLimit|刑罚个人责任边界]] - later Liu Kai legal concept that shows the same official arguing within bounded institutional rules.
