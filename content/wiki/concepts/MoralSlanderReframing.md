...
type: concept
tags: [rhetoric, reputation, court-politics, chu-han, talent]
sources: [zizhi-tongjian-hanji-154-diangu-chenping-daosao-lingyou-yinqing-li-c6ezwfpejcvbrpzojg-xv2ge8]
...
The concept differs from simply ignoring wrongdoing. The episode accepts that the money issue needs an explanation and that moral defects can matter. Its narrower lesson is that a baseless, intimate accusation can trap the target in endless self-proof, so the target may need to return the decision-maker to evidence, role, and value.

## Key Claims
- A moral smear can work by moving attention from role value to unverifiable private scandal.
...
- [[ZhouBo|周勃]], [[GuanYing|灌婴]], and [[VeteranMeritCliqueSupervision|功臣旧将监督]] - source of the accusation and organizational setting.
- [[TalentVirtueDistinction|才德之分]] and [[UseStrengthsOverFaults|用人取长弃短]] - adjacent personnel-judgment frames.
- [[RumorErosionOfTrust|谣言侵蚀信任]] - broader trust-decay concept that this episode qualifies by showing a rumor that fails to remove the target.
- [[ChenPingBrother|陈平兄]], [[ChenPingSisterInLaw|陈平嫂]], and [[Shiji|《史记》]] - family evidence used in the source's source-critical argument.
