...
The concept sits beside [[FederalResearchFundingPoliticalRisk]] but changes the emphasis. Existing wiki material tracks how grant cuts and political targeting can damage research capacity; Emanuel's source argues that cutting research institutions weakens the [[UnitedStates|United States]] in the strategic competition itself.
...
## Connections
- [[RahmEmanuel|Rahm Emanuel]], [[UnitedStates]], [[China]], and [[NationalInstitutesOfHealth|National Institutes of Health]] - source actors and institutional context.
- [[FederalResearchFundingPoliticalRisk]], [[AIForScience]], [[StrategicIndustrialPolicy]], and [[AlliedEconomicBlocAgainstChina]] - adjacent research and strategy concepts.
- [[UniversityOpportunityDensity]], [[PragmaticImmigrationCompromise]], and [[EducationWorkforcePipeline]] - talent, immigration, and education links.
- [[PredictionMarketPublicGoodClaim]], [[Kalshi]], and [[Polymarket]] - adjacent prediction-market branch that the source uses as a proposed revenue base.
