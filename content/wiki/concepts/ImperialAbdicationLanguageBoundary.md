...
type: concept
tags: [succession, legitimacy, court-politics, ritual-language]
sources:
...
禅让话语边界 / imperial abdication language boundary is the political limit around language that suggests a ruler may transfer the realm outside ordinary dynastic succession, especially when Yao-Shun abdication precedent is invoked around a favorite or office-holder.
...
- Yao-Shun abdication precedent is politically explosive when applied to a ruler's favorite rather than to abstract moral antiquity.
- Succession language differs from ordinary praise because it suggests who may inherit or receive the realm.
- "The emperor cannot joke" is a governance claim: ruler speech can create precedent, expectation, fear, or opportunistic response.
- The boundary is dynastic as well as personal because Wang Hong grounds his objection in Gaozu's line rather than in Aidi's mood.
- Office and succession language can interact when a favorite already holds high office, military authority, and family reward.
...
- [[ClassicalAllusionPoliticalRiskReading|典故化政治风险识读]] - reading practice that detects this boundary before explicit ruler speech.
- [[MingqiLegitimacy|名器合法性]] - broader symbolic-order concept because succession wording changes public legitimacy.
- [[PrivateFavorAppointmentErosion|私恩任官侵蚀]] - related appointment-order problem when a favorite's high office makes abdication language more credible.
- [[ControllableChildAccession|可控幼主继位]] - later succession mechanism showing another way dynastic transfer language and control intersect.
