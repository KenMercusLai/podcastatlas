...
type: concept
tags: [law, politics, reputation, late-han, governance]
sources:
...
# Prestige-Constrained Political Prosecution / 名望约束下的政治追诉
...
- Weak evidence becomes more dangerous when the case is visibly tied to court control rather than ordinary law.
- Release does not necessarily mean reconciliation; it can be a managed retreat from execution while preserving demotion, intimidation, or office removal.
- Elite protest and professional enforcement advice can transform severity into a legitimacy cost.
...
## Related Concepts
- [[PeopleBasedPoliticalSecurity|民心型政治安全]] - public confidence is the legitimacy cost that makes weak evidence dangerous.
- [[LegalTruthEvidenceGap|法律真相与证据差距]] - evidence uncertainty is the legal mechanism through which reputation becomes protective.
- [[PoliticalShowTrial]] - contrast case where political punishment is less effectively constrained by proof or public trust.
- [[MingqiLegitimacy|名器合法性]] - court titles and public authority make politically motivated prosecutions more visible.
- [[ReputationConstrainedTalentProtection]] - adjacent reputation mechanism where public value protects useful talent from blunt coercion.
