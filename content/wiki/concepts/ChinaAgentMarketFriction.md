...
China agent market friction is the set of platform, data-access, regulatory, and payment obstacles that can make AI-agent products harder to operate and commercialize in China. In [[weishenme-manus-bixu-chuhai-liaoliao-guochan-da-moxing-de-wenkesheng-kunjing-keji-luandun]], the hosts use [[Manus]] to argue that domestic agents face a difficult environment: many useful workflows live inside closed super-apps, app platforms may resist being automated, and users may be less willing to pay for standalone agent services.
...
- [[AgentFacingInterfaces]] — desired but strategically contested interface layer.
