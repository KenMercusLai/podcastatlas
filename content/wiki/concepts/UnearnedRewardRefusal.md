...
type: concept
tags: [ethics, governance, titles, late-han, confucianism]
sources:
...
Unearned reward refusal / 非道所得不居 is the practice of declining wealth, office, title, food revenue, or public honor when the reward is not grounded in the proper path. The concept treats refusal as a way to preserve dignity, reputation, and institutional legitimacy, not as anti-benefit asceticism.
...
- A reward can be materially valuable yet politically or morally harmful if it lacks proper grounding.
- Refusal can protect reputation when honor exceeds visible public merit.
- Title, land, and food revenue require stronger legitimacy than private gratitude.
- The same logic applies both to advice before acceptance and to repeated refusal after a reward is offered.
- The concept overlaps with righteousness over profit because dignity and rightness outrank wealth and status.
- The concept overlaps with merit-based reward because rightful acceptance depends on whether the reward tracks public contribution.
...
- [[RighteousnessOverProfit|义利之辨]] - ethical ordering that makes rightness prior to wealth and status.
- [[MeritBasedRewardPunishment|因功赏罚]] - governance standard that asks whether reward tracks visible public contribution.
- [[MingqiLegitimacy|名器合法性]] - institutional-symbolic frame for titles, ranks, and honors that need rightful public meaning.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - adjacent prudential frame because excessive reward can become future danger.
- [[ReputationListPersecutionTarget|名望榜单迫害目标化]] - related exposure-risk pattern where public distinction can become politically dangerous.
