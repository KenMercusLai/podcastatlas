...
type: concept
tags: [law, ritual, ethics, late-han, party-prohibition]
sources:
...
Prison ritual legitimacy refusal / 冤狱仪式合法性拒绝 is the pattern where an accused person refuses a prison or court ritual because performing it would imply that the procedure is morally valid, useful, or capable of correcting injustice when the case itself is unjust.
...
- Ritual can become morally compromised when it asks the innocent to validate an unjust process.
- Refusal can defend the purpose of ritual by rejecting empty performance under coercion.
- Fan Pang's logic separates genuine justice from ritualized pleading for procedural mercy.
- A single refusal can reset collective conduct when others recognize the same legitimacy problem.
- The pattern is distinct from rejecting law altogether; it rejects a ritual that cannot cure a distorted legal process.
...
The concept does not treat all ritual as empty or politically suspect. It is source-bounded to a prison scene where the accused understand the case as unjust and politically driven. Fan Pang's refusal protects ritual meaning by refusing its misuse; later sources still preserve him as a figure of moral seriousness rather than procedural nihilism.
...
- [[DeathFacingResponsibility|赴死式责任承担]] - neighboring pattern where actors accept danger rather than transfer or disguise responsibility.
- [[LiAsPoliticalOrder|礼作为政治秩序]] - broader ritual-order concept qualified by Fan Pang's refusal of ritual misuse.
- [[ConfucianIdealGovernance|儒家理想治理]] - related moral-governance standard that requires justice rather than empty form.
- [[RitualAffectiveOrder|礼感秩序]] - adjacent idea that ritual must carry real affective and moral order to function.
