...
Military merit rank system / 军功爵制 is the status mechanism [[zizhi-tongjian-zhouji-13-gongsunyang-keke-bianfa-re-shashen-1-lgmjapc2eecefbdshnpenzfcv6ga]] highlights inside [[ShangYangReforms|商鞅变法]]. The episode says rank, office access, land, servants, clothing, implements, and honor should correspond to merit, especially merit won by killing enemies on the battlefield.

The system matters because it converts war performance into social hierarchy. Old aristocrats and royal kin can no longer rely only on lineage if they do not fight; common soldiers can gain a path upward if they deliver military results. In the source's reading, this is both an engine of [[QinState|秦国]] strength and a reason reforms create dangerous losers.

[[zizhi-tongjian-zhouji-15-jiu-bu-chun-yinfa-de-shijie-dazhan-li-iojxthq8komhlhyumho3yvtem]] uses the Qin-Wei fighting around Yuanli and [[Shaoliang|少梁]] to explain the formula behind the system: cutting off an enemy head brings one rank of title. The episode uses that detail to show why Qin battlefield incentives are not just ideology but a concrete status pipeline for soldiers.
...
[[zizhi-tongjian-qinji-106-jingren-faxian-xinlingjun-de-feizhengchang-siwang-lsj3kd2tb4tqtuvhwvsdwkh-h5el]] adds a disaster-finance contrast. During the 243 BCE "蝗、疫" crisis, the episode says Qin lets ordinary people provide one thousand dan of grain in exchange for 公士, the lowest rank in the twenty-rank order. This is not battlefield merit, so the page keeps it as [[RankSaleDisasterFinance|鬻爵赈灾融资]]: a sign that the rank system could also become a fiscal instrument under stress.
...
- 汉纪 148-1 adds selective inheritance: Liu Bang's army can use Qin-style military law and incentive architecture while fighting the Qin commanders who survived into the Three Qin settlement.

## Connections
- [[ShangYang|公孙鞅 / 商鞅]] and [[QinXiaogong|秦孝公]] - reformer and ruler.
- [[ShangYangReforms]] - broader policy package containing the system.
- [[QinState|秦国]], [[WeiState|魏国]], [[Shaoliang|少梁]], and [[QinEastwardPressure|秦国东进压力]] - Zhouji 15 battlefield explanation of the head-for-rank formula.
...
- [[zizhi-tongjian-hanji-148-1-hanxin-yupan-le-zhanghan-de-yupan-lodhpuxpossjno87gorjkfrtitbe|汉纪 148-1]], [[HanInheritsQinSystem|汉承秦制]], [[HanXin|韩信]], and [[LiuBang|刘邦]] - Qin-style military law as transferable command infrastructure in the Three Qin campaign.
