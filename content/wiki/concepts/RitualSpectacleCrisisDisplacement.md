...
tags: [governance, ritual, propaganda, legitimacy, xin-dynasty]
sources:
...
仪式奇观式危机转移 / ritual spectacle crisis displacement is the legitimacy failure in which a ruler answers material crisis with calendars, titles, omens, music, immortality claims, ceremonies, or technical marvels that project order while leaving the underlying disorder unrepaired.
...
- Ritual and calendrical order can become evasive when used to cover unresolved fiscal, military, or livelihood crisis.
- Spectacle may reassure the court image of control while increasing public alienation if burdens continue rising.
- Miraculous or implausible technical recruitment can function as reputation management rather than usable capacity building.
- The failure is not ritual per se; it is ritual replacing diagnosis, sequencing, and burden reduction.
- The pattern becomes more dangerous when it pairs with new extraction to fund the display or its associated campaigns.
...
This concept does not say ritual, calendrics, music, or technical experimentation are always empty. The source's claim is contextual: the displays become displacement because they occur while Wang Mang is increasing extraction and ignoring a sharper crisis-priority warning. The exact language of the edict and the named technical claimants remain source-scoped.
...
- [[TerminalMandateSelfDeception|末路天命自我催眠]] - later Wang Mang endpoint where sacred language persists after collapse.
- [[PoliticalImageMaintenance|政治形象维护]] - broader image-management frame that this concept narrows to ritual and marvel display under crisis.
- [[AuspiciousOmenPolitics|祥瑞政治]] - legitimacy background for treating signs and cosmic order as political resources.
- [[CrisisPriorityMisalignment|危机优先级错置]] - companion failure because spectacle displaces the internal-crisis sequence.
- [[FangshiFraudAndAuthority|方士欺诈与权力依附]] - neighboring pattern when miracle claimants and power mutually exploit each other.
