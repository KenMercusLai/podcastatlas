...
tags: [warfare, logistics, frontier, xiongnu, xin-dynasty]
sources:
...
Steppe expedition logistics / 草原远征后勤 is the campaign-capacity problem of sending large agrarian-state armies into dry, cold, mobile frontier terrain where food, water, fodder, disease risk, transport animals, speed, and terrain exposure can defeat the plan before battle does.
...
- Large frontier force size can increase risk when assembly time, provisioning, and transport capacity do not match the plan.
- Border commanderies cannot automatically supply mass armies; interior logistics must arrive on time.
- Transport animals are a strategic dependency and can fail when water and fodder conditions are wrong.
- Climate, bedding, fuel, and disease risk convert season into baggage and medical burden.
- Carrying more supplies can reduce the light mobile forces needed to catch a steppe opponent.
- Difficult terrain turns a long marching column into a target for front-and-rear attacks.
- A limited rapid strike may be less costly than continuing to wait for an overlarge expedition plan.
...
The concept is based on Yan You's critique of a proposed Xin expedition, not a complete measurement of all steppe campaigns. It should be applied to cases where the source shows supply, season, animal transport, disease, tempo, and terrain constraints, rather than to every cavalry or frontier action. The episode's force numbers and detailed logistics estimates remain source-scoped.
...
- [[SeasonalWarLogistics|战争季节后勤]] - season, climate, and provisioning are core constraints in the expedition frame.
- [[WarCostTempoDiscipline|战争成本与速决纪律]] - rapid or delayed action must be evaluated by cost and support conditions.
- [[OverextendedFrontierExpedition|边境远征过度]] - steppe logistics explain one mechanism of frontier overextension.
- [[NomadicCavalryRaidingAsymmetry|游牧骑兵劫掠不对称]] - mobile enemy withdrawal makes slow supplied armies vulnerable.
- [[FrontierStrategyCostTypology|边疆战略成本分型]] - higher-level strategic ranking that asks whether expedition cost fits the objective.
- [[UnsupportedFrontierIntervention|无支撑边疆干预]] - political frontier manipulation becomes riskier when military follow-through is logistically weak.
