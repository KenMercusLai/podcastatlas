...
tags: [history, china, ritual, legitimacy]
sources:
...
Dynastic memory severance / 王朝记忆切割 is the political use of titles, temples, clothing, calendars, burial space, and sacrificial hierarchy to detach a person or institution from an older dynasty and relocate them inside a new regime's memory order.
...
- Memory severance works by changing ritual categories, not only by issuing political claims.
- A new regime can preserve a predecessor-linked figure's prestige while cutting that figure away from the predecessor's dynastic order.
- Resistance can occur through retained ritual practice when open opposition is impossible.
- Burial and shrine design can both honor and subordinate, making posthumous treatment a political settlement rather than a private family matter.
- The pattern overlaps with legitimacy backfire: the same dowager status that helped Wang Mang rise becomes evidence of the violence required to detach Xin from Han.
...
This is a source-scoped concept from one episode, not a claim that every dynastic transition uses the same ritual method. The source's strongest evidence concerns Wang Zhengjun's title, temple, palace, clothing, calendar, burial, and shrine treatment. The host's counterfactual judgment that Wang Zhengjun's longevity doomed Western Han is preserved as interpretation, not settled causal proof.
...
- [[DynasticLegitimacyBackfire|王朝合法性回旋镖]] - broader legitimacy mechanism that makes Wang Zhengjun's Han-linked prestige useful and dangerous to Xin.
- [[LiAsPoliticalOrder|礼制政治秩序]] - ritual-order concept explaining why temples, dress, dates, and tablets carry political meaning.
- [[ImperialBurialLegitimacy|帝后合葬名分]] - adjacent posthumous-status concept focused on burial and sacrificial recognition.
- [[RitualAffectiveOrder|仪式感秩序生成]] - adjacent concept for how ritual practice generates emotional and political order.
