...
type: concept
tags: [governance, famine-relief, local-administration, state-capacity, late-han]
sources:
...
担责开仓式救民 / Risk-Bearing Relief Governance is the crisis-administration pattern where an official releases public reserves to save people under urgent famine or displacement pressure, accepts personal legal or career risk, and later depends on superior recognition to turn emergency action into legitimate governance.
...
- Emergency relief tests whether public stores serve living people before procedural self-protection.
- Personal risk is part of the pattern because the official acts before certainty of legal or bureaucratic approval.
- Credibility matters: Han Shao can take the risk because he is already known as a worthy official.
- Superior support determines whether the same act becomes recognized governance or punishable irregularity.
- The pattern connects famine relief, refugee protection, and local legitimacy rather than treating them as separate tasks.
- Risk-bearing relief remains dangerous if generalized without urgency, accountability, and after-action recognition.
...
The concept currently rests on one strong case, so it should not be generalized as blanket permission to bypass rules. Grain reserves can be misused, and emergency relief still requires urgency, public purpose, accountability, and superior review. The source also does not provide accounting details after the granary release.
...
- [[HanShaoLateHan|韩韶]] - primary person case for risk-bearing relief.
- [[HumaneLocalGovernance|仁厚地方治理]] - broader local-governance pattern extended by emergency grain release.
- [[DisasterResponseStateCapacity|灾害响应型国家能力]] - risk-bearing relief is one local mechanism of disaster and refugee response.
- [[FamineEntitlementFailure|饥荒权利失败]] - the pattern responds to households losing practical access to food despite public stores existing.
- [[PeopleBasedPoliticalSecurity|民心型政治安全]] - saving displaced households converts state capacity into public trust.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - relief depends on placing a credible official in the crisis office.
