...
tags: [culture, scholarship, reception, historiography]
sources:
...
Delayed canonical recognition / 延迟经典化 names the pattern in which a work or thinker is undervalued by contemporaries because visible status markers are weak, but later readers recognize durable intellectual or cultural value.
...
- Contemporary status markers can distort recognition of intellectual value.
- Low office, low salary, ordinary appearance, and quiet conduct can make major work socially invisible.
- Later transmission depends on durable textual depth, not only author celebrity.
- Huan Tan's defense of Yang Xiong frames delayed recognition as a recurrent reception problem, not a one-off accident.
- The concept connects biography, scholarship, and historiography because a person's public rank and posthumous textual life can diverge sharply.
...
- [[HistoriographicalPresentism|史评当代性]] - both concepts ask how later readers and political contexts reshape evaluation.
- [[MotiveBasedTalentEvaluation|动机导向的才干评价]] - Yang Xiong's later evaluative voice now receives a matching reception concept about how he himself is evaluated.
- [[TalentVirtueDistinction|才德之分]] - adjacent frame separating visible ability, moral worth, and recognized status.
