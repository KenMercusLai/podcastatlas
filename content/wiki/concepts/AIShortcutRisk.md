...
The risk is not that AI should be absent from education. [[AIAsTutor]] can personalize help, and [[LearningExperienceDesign]] can use AI to diagnose where a student is stuck, encourage them, and choose the next strategy. The danger appears when the tool closes the loop for the student before they have done enough reasoning to build [[SelfDirectedLearning]].
