...
tags: [governance, command, crisis-management, talent, xin-dynasty]
sources:
...
Key operator removal risk / 关键执行者移除风险 is the crisis-management failure in which a ruler or organization removes the person currently holding together a dangerous field because that person's competence, autonomy, or credit has become politically uncomfortable.
...
- Removing a crisis operator can undo an accumulated local trust and deterrence position that is not visible in a title chart.
- Competence can become politically threatening when the ruler cares more about credit and autonomy than outcome.
- Replacement risk is highest when the operator combines field information, local authority, and a working plan.
- Central recall can preserve hierarchy on paper while destroying the field arrangement that made the crisis manageable.
- The concept applies beyond battlefield succession because crisis operators may hold together logistics, reporting, civilian trust, and local defense.
...
The source does not prove Tian Kuang would have permanently settled Qingzhou, Xuzhou, or Qi. It supports the narrower claim that he was the one demonstrated working operator in the episode and that his removal coincided with renewed field collapse. Exact succession mechanics and the replacement official's identity remain source-scoped.
...
- [[BattlefieldCommanderReplacementRisk|阵前换将风险]] - adjacent command-removal pattern focused more directly on battlefield commanders.
- [[FieldDiscretionPacification|便宜行事式招抚]] - related because a useful crisis operator may have gained effectiveness by acting beyond routine authorization.
- [[CommandAuthorityBottleneck|将权掣肘]] - contrast because removal can recreate the bottleneck after someone has bypassed it.
- [[TianKuangXinOfficial|田邝]] - source actor whose recall grounds the concept.
- [[WangMang|王莽]] - ruler whose suspicion triggers the removal.
- [[XinDynasty|新朝]] - regime whose late crisis supplies the case.
