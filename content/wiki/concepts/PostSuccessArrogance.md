...
## Definition
Post-success arrogance / 得势后的骄傲 is the failure pattern where victory, office, status, or resource advantage makes an actor less able to hear correction, preserve proportion, protect relationships, recruit talent, or read changed conditions.
...
## Key Claims
- Success is an information and character test because correction feels less necessary to the successful actor.
...
- [[XingshiqingStrategicAssessment|行势情战略评估]] - arrogance blocks condition-sensitive reading of logistics, geography, timing, and rivals.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - success can damage the channels that would correct a ruler.
- [[TalentAttractionThroughRespect|礼贤下士式人才吸附]] - respectful reception is the talent-channel inverse of Cao Cao's Zhang Song failure.
- [[DiscreetBenefactionDignity|沉默施恩的尊严保护]] - merit display can turn contribution into relational pressure.
- [[AntiUsurpationCoalitionPressure|讨逆同盟压力]] - title overreach shows how arrogance can create organized opposition.
