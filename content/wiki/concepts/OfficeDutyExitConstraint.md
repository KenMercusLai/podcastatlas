...
type: concept
tags: [governance, bureaucracy, late-han, office, exit]
sources:
...
Office duty exit constraint / 任官责任退出受限 is the governance pattern where an official cannot easily leave or avoid a post because the court treats his ability, office obligation, and crisis usefulness as public assets rather than private preferences.
...
- Exit friction can be imposed by office responsibility, not only by money, prestige, or private fear.
- A court may reject illness claims or ignore self-created violations when it believes the official is still needed.
- Crisis dependence makes competent officials less free to retreat, because their absence has visible public costs.
- Avoidance tactics can become legible to other officials, who may refuse to validate them.
- The constraint is ethically mixed: it can preserve state capacity, but it can also bind individuals to dangerous or unwanted roles.
...
The concept should not be generalized into a claim that resignation is impossible in all ancient offices. The current evidence is one late-Han episode, and it is tied to scarce frontier competence, famine administration, and military emergency. It also does not decide whether Huangfu Gui's attempted exit was cowardice, prudence, fatigue, or strategic self-protection; the source only makes the failed exit tactic visible.
...
- [[CareerExitFriction]] - modern-work analogue where pay, status, and identity make leaving difficult.
- [[BureaucraticRiskAvoidance]] - adjacent behavior in which officials try to avoid exposure, blame, or dangerous responsibility.
- [[ScholarOfficialPublicDuty]] - ethical counterweight that treats office as responsibility to the public rather than only personal safety.
- [[CrisisDutyContinuity]] - broader pattern where crisis conditions make role continuity more important than ordinary preference.
- [[PoliticalSurvivalFirst]] - contrasting survival logic that may justify withdrawal, silence, or low posture under danger.
