...
The concept does not say people always lie. It says sincere perception and memory can still be unreliable, especially under fear, suggestion, trauma, social pressure, or [[MemoryContaminationRisk]].

[[91-liewu-sailemu-1692-cong-yizheng-kaishi-714732018]] adds a legal-historical negative case through [[SpectralEvidence]] in the [[SalemWitchTrials|塞勒姆猎巫]]. The source shows what happens when testimony about visions, invisible attacks, and courtroom suffering is granted institutional force without independent proof.

[[113-henglieta-yu-nachang-jiang-renleixue-songshang-shenpanxi-de-moushaan-756562827]] adds a trial-level caution from the [[HenriettaSchmerler]] case. The episode treats witness statements, a confession, recantation, language understanding, and a supposed "horse-riding taboo" as claims that need corroboration and context, especially when testimony can be shaped by fear, translation, legal strategy, or [[VictimBlamingAsInstitutionalDefense]].

[[121-jijian-fayi-jianshi-shouce-yiqie-fanzui-jieyou-henji-775064343]] adds a forensic-science version. The episode says memory is not a camera and uses [[CSIEffect]] to explain why physical evidence is rightly valued, while also warning that [[ForensicScience|forensic science]] itself requires interpretation. The rule becomes: prefer evidence that can be checked, but do not pretend that every check produces certainty.
...
- [[AlienAbductionNarrative]] - main story type where testimony is discussed.
- [[ScientificSkepticism]] and [[ObservationBeforeInference]] - method frame.
- [[PseudoscienceFraudVulnerability]] - emotional conditions that make testimony and authority persuasive.
