...
type: concept
tags: [governance, law, registry, late-han, party-prohibition]
sources:
...
Registry-based political exclusion / 登记造册式政治禁锢 is the pattern where a state converts released or unexecuted political suspects into a durable administrative list that blocks future office, status, or mobility.
...
- Amnesty can end immediate punishment while preserving a durable political blacklist.
- A registry lowers the future enforcement cost because disqualification no longer depends on rearguing the original case.
- Office exclusion can punish political identity without execution, exile, or ordinary criminal sentence.
- Registry-based exclusion is especially powerful when tied to reputation networks, because listed names remain visible to both allies and enemies.
- The pattern helps explain why Fan Pang's post-release conduct remains cautious even after formal release.
...
- [[PartyProhibitionKinshipExpansion|党锢亲属牵连扩大]] - later and broader Party Prohibition liability field.
- [[PartyBanCrisisAmnesty|党锢危机赦免]] - later crisis-driven repair that should be read against earlier exclusion.
- [[ReputationListPersecutionTarget|名望榜单迫害目标化]] - reputation-list visibility that can feed later targeting.
- [[CollateralPunishmentAndGuiltByAssociation]] - broader spillover and continuing-punishment frame.
- [[AccusationQuotaRefusal|诬陷指标拒绝]] - local refusal pattern that matters because registry submission has durable consequences.
- [[FanPangLateHan|范滂]] - released party figure whose post-release conduct shows the registry field's practical risk.
