...
type: concept
tags: [governance, remonstrance, court-politics, late-han, petition]
sources:
...
The concept does not say that all blunt petitions fail or that the legal content of Kou Rong's appeal is false. It applies where the petition's audience is a ruler who controls review, where the petitioner is already politically unsafe, and where analogy or resentment can be heard as disrespect. Other wiki concepts such as [[DeathDefyingRemonstrance|赴死式直谏]] preserve cases where high-risk speech can work when it gives the ruler a public reason to change.
...
- [[DeathDefyingRemonstrance|赴死式直谏]] - neighboring pattern where dangerous speech can succeed if it moves the ruler from rage to public consequence.
- [[AllusiveRemonstrance|隐语进谏]] - contrasting tactic that uses indirection to reduce ruler-facing offense.
- [[PardonWithoutExoneration|赦免不等于昭雪]] - adjacent problem where release or mercy does not settle factual innocence.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - institutional setting in which correction reaches power as offense or accusation.
- [[PalaceAccessMonopoly|宫廷接触垄断]] - access structure that makes direct petitioning more desperate and dangerous.
- [[KouRongLateHan|寇荣]] - source case whose appeal grounds the concept.
