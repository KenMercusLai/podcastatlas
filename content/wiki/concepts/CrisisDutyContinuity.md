...
type: concept
tags: [governance, duty, late-han, court-politics, workplace]
sources:
...
# Crisis Duty Continuity / 危局职守连续性

## Definition

Crisis duty continuity / 危局职守连续性 is the rule-of-role pattern where officials are expected to keep public duties operating through death, succession, mourning, uncertainty, and personal risk rather than treating the gap as permission to disappear.
...
- Succession gaps and mourning periods create a temptation to avoid visible responsibility because the political field is unsettled.
- Illness or leave claims can function as bureaucratic risk avoidance when they are used to evade a dangerous duty window.
- Role-based duty can outlast the living presence of the superior; the office and state still require action.
- Moral rebuke can restore administrative order when formal coercion has not yet stabilized the transition.
- The concept is narrower than generic loyalty: it concerns concrete public work during a live institutional discontinuity.
...
- [[BureaucraticRiskAvoidance|bureaucratic risk avoidance]] - contrasting incentive pattern where actors protect themselves by avoiding accountable action.
- [[LiAsPoliticalOrder|礼制政治秩序]] - role-order foundation that makes duty persist after a ruler's death.
- [[ScholarOfficialPublicDuty|士大夫公共责任]] - broader ethical frame for officials whose work remains answerable to public need.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - competing survival logic that may justify withdrawal when duty becomes personally lethal.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - institutional failure mode that makes honest duty and visible work more dangerous.
