...
type: concept
tags: [political-survival, advice, court-politics, risk, late-han]
sources:
...
进言不纳后的抽身 / counsel exit after nonresponse is the disciplined choice to withdraw after advice has been delivered, ignored, and made politically risky to repeat. It differs from never speaking: the adviser first makes the warning legible, then leaves when continued presence is unlikely to change the decision and may create danger.
...
- Exit after ignored advice presupposes that advice has actually been delivered in a recognizable form.
- Nonresponse can be a signal that the decision field is closed even without explicit punishment.
- Continuing to press a ruler or patron after nonresponse can convert useful counsel into personal danger.
- Withdrawal can preserve independence and reduce exposure when the adviser lacks enforcement power.
- The tactic is narrower than general reclusion because it follows a specific failed counsel attempt.
- It remains context-dependent; leaving too early can abandon a still-movable situation.
...
- [[CrisisWithdrawalSelfProtection|危局抽身自保]] - broader withdrawal discipline that this concept narrows to the post-counsel moment.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - wider survival frame that includes exit, silence, compromise, and risk reduction.
- [[AdviceFramingUnderHierarchy|等级场景中的进言包装]] - upstream design of counsel before deciding whether nonresponse means exit.
- [[OmenCodedRemonstrance|天象灾异包装式进谏]] - speech method Yuan Hong uses before withdrawing.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - failure condition that makes continued advice less likely to convert into policy.
- [[XingshiqingStrategicAssessment|行势情战略评估]] - broader condition-reading logic behind the timing of withdrawal.
