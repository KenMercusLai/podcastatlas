...
tags: [qin, late-han, fiscal-policy, disaster-response, office-sale]
sources:
...
鬻爵赈灾融资 / Rank Sale Disaster Finance is an emergency fiscal pattern where the state converts rank, status, or court-adjacent identity into money, grain, or other resources during disaster, war, frontier pressure, or revenue exhaustion.
...
- Rank sale turns status into a fiscal asset when ordinary taxes, requisitions, and transport systems are too strained or too slow.
- Disaster finance and war finance overlap because famine, epidemic, rebellion, and frontier campaigns drain the same state capacity.
- The Eastern Han pattern begins earlier than the 161 CE Huan-era layer in the current wiki, appearing under Deng's regency in 109 CE.
...
- Repetition shifts the practice from emergency finance toward appointment legitimacy damage.
...
The source set does not prove that every purchaser received governing authority. Some categories are status, guard, or court-adjacent identities rather than full administrative office. The strongest current claim is that emergency finance monetizes public honor and access; the office-sale legitimacy claim becomes stronger only when repeated monetization touches actual appointment channels.
...
- [[OfficialSalaryExtractionRisk]] - parallel fiscal measure where budget relief creates extraction incentives among underpaid officials.
- [[OfficeSaleLegitimacyDamage]] - later-stage risk when monetized status or rank becomes real appointment-channel corruption.
- [[RegencyUnderCompoundCrisis]] - crisis environment that makes rank sale politically and fiscally thinkable.
- [[StrategicFrontierAbandonment]] - frontier-cost dilemma that helps explain why emergency fiscal tools become attractive.
- [[AppointmentQualityAsStateCapacity]] - personnel-quality frame threatened when rank, status, or office access can be purchased.
