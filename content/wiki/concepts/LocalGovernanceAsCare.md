...
tags: [governance, care, public-health, infrastructure, china, eastern-han]
sources:
...
Local governance as care / 地方治理作为照护 is the view that local public authority is judged by whether it reduces everyday vulnerability at the scale of bodies, households, villages, and practical infrastructure, not only by fiscal output, formal order, or visible administrative severity.

## Current Synthesis

The concept now spans four cases: scholar-official service, village self-organization, modern service-oriented government, and an Eastern Han county-administration standard. Across them, good local governance appears as concrete maintenance: water, roads, schools, medicine, childcare, meeting practice, commons revenue, business and welfare services, and non-harassing official conduct.
...
- Good local governance is visible in low-level maintenance and burden reduction before it is visible in ideology.
- Care can be embodied by an official, distributed through village organization, or institutionalized as service and feedback capacity.
- Infrastructure, public health, schooling, childcare, and poverty relief belong to governance when households cannot solve them alone.
- Low-disturbance administration is part of care because people experience government through frequency of harassment, punishment, fees, and compulsory burden.
- Modernization raises the standard from mobilizing growth to providing routine services that citizens and businesses can actually use.
- Cultural memory often preserves beautiful places or admirable figures while undercounting the administrative labor that made them livable.
...
- [[ServiceOrientedLocalGovernment|服务型地方政府]] - modern institutional version of care through services, welfare, business environment, and feedback.
- [[ScholarOfficialPublicDuty|士大夫公共职责]] - role ethic behind the Su Shi local-service case.
- [[DisasterResponseStateCapacity|灾害响应国家能力]] - adjacent capacity when local care becomes emergency protection.
- [[VillageSelfGovernance|村庄自治]] - collective rural mechanism for making care decisions and rules locally usable.
- [[RuralInfrastructureTransition|乡村基础设施转型]] - material precondition that turns isolation into everyday access.
- [[DirectedImprovisation|有方向的即兴]] - center-local experimentation frame that helps explain modern local service upgrading.
- [[FertilityBurdenReliefPolicy|生育负担减免政策]] - related burden-reduction pattern focused on household reproduction costs.
