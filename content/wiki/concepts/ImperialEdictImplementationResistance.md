...
tags: [governance, bureaucracy, imperial-china, implementation, western-han]
sources:
...
诏令执行阻抗 / imperial edict implementation resistance is the gap between a ruler's formal command and bureaucratic execution when officials answer the order procedurally while preserving the underlying workload, incentive, or power structure.
...
- A ruler's order can fail without visible defiance when officials satisfy form and avoid the real change.
- Implementation capacity matters: complex reforms need teams, expertise, time, and institutional follow-through.
- Bureaucratic interests matter: reforms that reduce official discretion invite quiet resistance.
- Small adjustments can function as a compliance theater that protects the status quo.
- The pattern is especially likely when a command targets the administrative apparatus's own authority.
...
- [[LegalComplexityDiscretionPower|法律繁密与裁量权力]] - specific incentive mechanism inside the legal-reform case.
- [[BureaucraticRiskAvoidance]] - related implementation failure where officials protect themselves through process.
- [[BureaucraticWorkloadControl]] - adjacent because workload and procedural saturation can defeat reform.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - neighboring failure when formal channels no longer produce corrective action.
- [[HanChengdi|汉成帝]] - ruler whose legal edict grounds the case.
