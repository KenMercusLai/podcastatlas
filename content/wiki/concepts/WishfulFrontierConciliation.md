...
tags: [frontier, governance, qiang, trust, appeasement, eastern-han]
sources:
...
一厢情愿式边疆怀柔 / wishful frontier conciliation is a pacification failure pattern in which an official substitutes goodwill, speed, or credit-seeking for grounded assessment of the other side's incentives, trustworthiness, and local conditions.
...
- Conciliation fails when it treats visible goodwill as sufficient evidence of reciprocal trust.
- A frontier official can create new vulnerability by exposing envoys or escorts before the other side's incentives are tested.
- The difference between credible pacification and wishful conciliation lies in accumulated legitimacy, information, and enforceable boundaries.
- Speed and credit-seeking can distort risk assessment, especially when an official wants to prove superiority over a predecessor.
- Failed conciliation can make later military or punitive action more likely because trust has been further damaged.
...
The source gives a strong host judgment about Nie Shang's motives, including impatience and desire for credit. Those motive claims remain source-scoped. The concept also should not be used as an argument against all soft frontier policy; it applies when soft posture is not backed by credible knowledge, leverage, and reciprocal incentives.
...
- [[RootCausePacification|查因安抚式治理]] - contrast because durable pacification requires real causes and trust conditions to be addressed.
- [[GoodIntentionsPoliticalLimits|善意的政治边界]] - related limit showing that good intentions do not remove political risk.
- [[LightTouchFrontierGovernance|宽简边疆治理]] - contrast because low-pressure governance can work when it matches local conditions and experience.
- [[DeceptiveSurrenderLull|诈降松懈陷阱]] - neighboring pattern where apparent compliance or friendliness creates exposure.
- [[ForceBackedSurrenderPersuasion|武力背书式劝降]] - contrast because persuasion may need credible coercive backing to hold.
