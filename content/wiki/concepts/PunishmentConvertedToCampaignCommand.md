...
tags: [court-politics, military-command, accountability, eastern-han]
sources:
...
死罪转军功式任用 / punishment converted to campaign command is the court-politics pattern where a severe legal or moral liability is redirected into military service, letting a protected actor seek public merit instead of ordinary punishment.
...
- Protected actors can turn liability into opportunity when kinship or factional power controls the punishment decision.
- Campaign command can become an alternative to legal punishment when the court needs or accepts a public-merit route.
- The conversion does not eliminate moral contradiction; it relocates judgment from criminal accountability to military outcome.
- Later battlefield success can obscure the original case unless source notes keep the pre-campaign liability visible.
- The pattern depends on court power, not only on the accused actor's courage or ability.
...
- [[OuterRelativeCourtPower|外戚专权与清算]] - structural relationship because dowager kinship makes the conversion possible.
- [[DouXianEasternHan|窦宪]] - source actor whose liability becomes campaign command.
- [[LiuChangDuxiangHouEasternHan|都乡侯刘畅]] - murder victim whose case creates the liability.
- [[NorthernXiongnuLateHan|北匈奴]] - campaign target through which punishment is redirected.
- [[ReputationConstrainedWarRestraint|名声约束下的战争节制]] - contrast because officials object that the campaign lacks a fresh state justification.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - related failure because court speech and investigation operate under kinship pressure.
