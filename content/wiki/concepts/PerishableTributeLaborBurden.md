...
tags: [tribute, labor, logistics, eastern-han, governance, food]
sources:
...
鲜贡劳役负担 / Perishable Tribute Labor Burden is the governance pattern where elite demand for fresh, fragile goods forces high-speed relay logistics, shifting private pleasure or ritual supply into dangerous public labor.
...
- Fresh tribute can be more coercive than durable tribute because speed, spoilage, and distance compress labor into dangerous relay systems.
- A delicacy becomes a governance problem when the supply chain harms commoners and local transport workers.
- Effective remonstrance can reframe pleasure and prestige as public cost.
- Court restraint matters most when it changes receiving rules, not only when it praises frugality in the abstract.
- The same receiving-rule logic can appear before a source gives detailed logistics evidence, as Liu Xiu's rare-food refusal shows.
- The source supports a bounded logistics-burden concept, not a general theory of all tribute.
...
- [[SeasonalRitualConsumptionRestraint|时令礼法式饮食约束]] - adjacent fresh-food restraint where timing and ritual propriety limit elite consumption.
- [[ReceptiveRemonstranceGovernance|纳谏转政策式治理]] - related correction pattern because stopping elite consumption often depends on advice or rule change reaching the center.
- [[UntimelyExtravagance|时绌举赢]] - broader warning against costly display when public conditions make luxury politically damaging.
- [[LocalGovernanceAsCare|地方治理即照护]] - related public-duty frame because transporters' survival becomes a legitimate reason to change central consumption.
- [[CourtDemandDrivenPapermaking|宫廷需求驱动造纸]] - contrast case in the same episode where court demand produces useful material innovation rather than harmful logistics.
