...
The concept should not be used to blame relatives for a person's failure or to make family approval a universal requirement. Its practical value is narrower: large life projects draw on shared time, money, emotional permission, childcare, household stability, and trust, so unaddressed family opposition can become a real condition of failure even when the project is individually chosen.
...
## Connections
- [[RelationalFateNetwork|关系命运网络]] - broader relationship-fate model.
- [[FamilySupportedAspiration|家庭承托的愿望]] - existing aspiration-and-family support concept.
