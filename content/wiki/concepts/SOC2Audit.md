...
SOC 2 audit is the software-company trust and security audit pattern explained by [[ChristinaCacioppo]] in [[tsr-s5-christinac-v2audio-tsr-s5-christinac-v2audio]]. In her description, a company defines what its IT, security, and operating practices are supposed to be doing, and an auditor asks for evidence that those practices are actually being followed.
...
- [[ManualComplianceMVP]], [[ComplianceAutomation]], [[SaaSTrustMoat]], and [[TrustAsBusinessAsset]] - adjacent trust and compliance concepts.
