...
- Numerical superiority only becomes strategic advantage when command can convert it into time, supply pressure, and operational patience.
...
- [[FixedCampSiegeEngineering|营垒攻防工程]] - battlefield-pressure pattern that follows when Yuan rejects attritional patience and the camps harden.
