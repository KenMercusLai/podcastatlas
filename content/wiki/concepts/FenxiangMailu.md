...
type: concept
tags: [late-han, household, death, family, three-kingdoms]
...
## Key Claims
- Deathbed distribution can preserve household utility rather than converting goods into burial prestige.
- The source reads Cao Cao's instruction as a pragmatic answer to the surviving women's livelihood risk.
- The permissive remarriage note is source-scoped: it is the host's highlighted contrast with more coercive death-bound loyalty expectations.

## Connections
- [[CaoCao|曹操]] - actor whose final arrangement grounds the concept.
- [[LadyDingCaoCao|丁夫人]] and [[LadyBianCaoCao|卞夫人]] - household figures named in the same source.
- [[CaoAng|曹昂]] - Wancheng death linking Cao Cao's family branch to the episode's opening.
- [[CrisisFirstMilitaryDiscipline|临危先务军纪]] - separate crisis-order concept from the same source.
