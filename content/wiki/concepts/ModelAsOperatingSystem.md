...
- The OS analogy is strongest when models support extensible applications and agents rather than only single chat sessions.
- [[ClaudeCode]] and [[Codex]] make the thesis more concrete because coding agents turn model capability into executable changes in software systems.
- The strongest model may not capture all value if context, user memory, tools, runtime, permissions, and workflow data live in [[AgentHarness]] products.
...
- [[ClaudeCode]], [[Codex]], [[Gemini]], and [[Manus]] — product surfaces that make model capability feel operating-system-like.
- [[AgentHarness]], [[ModelHarnessCoEvolution]], [[AgenticEconomy]], and [[AgentFacingInterfaces]] — layers that may sit around or above the model.
