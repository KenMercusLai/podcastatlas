...
type: concept
tags: [self-protection, prudence, late-han, moral-judgment, court-politics]
sources:
...
审慎含混式自保 / Prudent Ambiguity Self-Protection is the survival pattern of deliberately avoiding sharp public moral sorting or forceful correction when the political environment makes blunt distinction and action personally dangerous, structurally sensitive, or practically uncertain.
...
- Ambiguity can be a deliberate survival practice rather than ignorance or cowardice.
- Public right-wrong clarity is morally forceful but can create enemies in a politically dangerous environment.
- Family status, office, and backing change how much moral bluntness a person can safely display.
- Apparent softness can be position-aware caution when forceful correction would trigger ruler, kinship, or factional anxiety.
- Prudence is strongest when it preserves judgment internally while moderating public expression.
- The pattern becomes ethically weak when self-protection turns into indifference to right and wrong.
...
- [[PoliticalSurvivalFirst|安全第一政治生存]] - broader survival frame that this concept narrows to public moral ambiguity.
- [[LiangShangLateHan|梁商]] - officeholding case where non-adoption of reform advice is interpreted as possible prudent self-protection.
- [[LiGuLateHan|李固]] - reform-counsel foil whose clear advice tests the limit of Liang Shang's caution.
- [[BlameAbsorbingResponsibility|揽过式责任承担]] - same episode's contrasting form of survival through accepting visible fault.
- [[ObliqueRemonstranceSelfProtection|曲谏式自保]] - neighboring indirect-speech pattern for surviving dangerous political criticism.
- [[CrisisWithdrawalSelfProtection|乱世退避自保]] - broader withdrawal pattern when direct involvement becomes too dangerous.
- [[ZhongJinLateHan|钟瑾]] - source case for modest, self-protective ambiguity.
- [[ZhongHaoYingchuanLateHan|钟皓]] - mentor figure who articulates the survival logic.
- [[LiYingLateHan|李膺]] - moral-clarity foil who invokes Mencian right-wrong judgment.
- [[Mengzi|孟子 / Mencius]] - classical reference point for the right-wrong heart at issue.
