...
type: concept
tags: [imperial-power, marriage, coercion, late-han]
sources:
...
Coerced Imperial Marriage / 强制赐婚 is the pattern in which a ruler's marriage preference becomes command pressure, overriding the subject's consent, existing obligations, or ordinary social boundary.
...
- Coerced imperial marriage turns palace favor into pressure because the ruler's desire carries command force.
- The victim may face a bad choice between dishonoring an existing obligation and resisting the ruler.
- The harm can be fatal even without formal execution, because private refusal under imperial pressure becomes socially and politically unbearable.
- A contrasting case of ruler restraint shows that the boundary failure is not inevitable in imperial marriage politics.
- The Song Hong case shows the boundary positively: the ruler can make the other party's existing obligation legible, then stop.
...
- [[MarriageRitualOrthodoxy|婚姻礼制正统]] - adjacent marriage-order frame concerned with ritual legitimacy rather than personal coercion.
- [[SongHongEasternHan|宋弘]] - non-coercive contrast case whose refusal Liu Xiu accepts.
- [[HuyangPrincessEasternHan|湖阳公主]] - royal marriage-interest figure in the Song Hong contrast.
- [[MingqiLegitimacy|名器合法性]] - explains why official titles, ranks, and honors can carry coercive institutional weight.
- [[CoercedImperialReplacement|胁迫式废立]] - dynastic-scale title coercion that parallels marriage coercion at a different institutional level.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - broader condition in which subjects cannot safely correct or refuse ruler pressure.
