...
tags: [statecraft, western-han, mausoleum, migration, household-registration, elite-control]
sources:
...
陵县式豪强迁徙 / mausoleum-county elite relocation is the Western Han practice of moving wealthy Guandong households and senior officials' families to imperial mausoleum settlements near the capital, turning royal burial geography into population concentration, elite supervision, and status redistribution.
...
- Mausoleum counties convert imperial burial zones into administrative and demographic instruments.
- The policy strengthens the capital region while reducing the independent base of Guandong magnates.
- Relocation can be desirable to some upwardly mobile families even when old wealthy families resist it.
- Chen Tang's Changlingyi proposal is a mixed-motive case: public centralization and fiscal rationale coexist with private family household-status benefit.
- The policy's legitimacy problem is real because coerced households may lose ancestral, property, and local-network continuity.
...
- [[GuanzhongEliteRelocation|关中豪强迁徙]] - earlier capital-region relocation logic that mausoleum counties institutionalize.
- [[StrongTrunkWeakBranchCentralization|强干弱枝式集权]] - centralization rationale behind moving powerful households toward the trunk.
- [[HouseholdOccupationControl|户籍与职业管控]] - registration system that makes mausoleum-county residence valuable.
- [[PublicReasonPrivateMotive|公开理由与私下动机错位]] - mixed-motive pattern visible in Chen Tang's memorial.
- [[WesternHanLimitLandAndSlaves|西汉限田限奴改革]] - adjacent late-Western-Han attempt to address powerful-household accumulation.
