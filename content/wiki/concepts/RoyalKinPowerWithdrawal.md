...
tags: [governance, royal-family, self-protection, court-politics, eastern-han]
sources:
...
宗室退权自保 / royal kin power withdrawal is the survival pattern where an imperial relative voluntarily lowers formal power, capital exposure, or governing proximity before affection and reputation become suspicious to the ruler.
...
The concept therefore names a negotiated lowering of exposure. The royal kinsman reduces the practical danger of central power while preserving loyalty, dignity, and the ruler's face. It differs from later crisis hiding because the court is still functioning and the withdrawal works through formal status rather than disappearance.

## Key Claims

- A royal relative's closeness to the ruler can become dangerous when office, reputation, and kinship reinforce each other.
- Safe withdrawal lowers practical exposure without publicly accusing the ruler or rejecting the dynasty.
- The tactic works best when the actor frames exit as loyal restraint rather than grievance or ambition.
- The ruler can preserve affection and hierarchy by allowing distance while retaining honor, title, gifts, or staff support.
- The pattern is distinct from desperate flight: it is a formal, negotiated move inside court order.
...
- [[LiuCangDongpingKing|东平王刘苍]] - source case whose voluntary return grounds the concept.
- [[KinshipProtocolBoundary|亲情名分边界]] - broader relationship because withdrawal restores distance between brotherly affection and sovereign-subject order.
- [[PowerExitTrap|权力退场困境]] - contrast relationship because Liu Cang exits before power loss becomes a post-victory suspicion trap.
- [[CrisisWithdrawalSelfProtection|危局抽身自保]] - contrast relationship because later crisis withdrawal relies on hiding or lowered visibility after danger matures.
- [[SelfDeprecatingPoliticalSurvival|自污式政治自保]] - adjacent royal-kin tactic that lowers reputation rather than formal office exposure.
