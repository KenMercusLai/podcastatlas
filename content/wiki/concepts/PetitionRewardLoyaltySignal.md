...
tags: [court-politics, petition, reward, wang-mang, legitimacy]
sources:
...
巧奏取封式忠诚信号 / petition-reward loyalty signal is the pattern where political actors use denunciatory or flattering memorials to turn danger into favor, and the regime rewards the speech act as proof of loyalty.
...
- Petitionary loyalty can function as a survival strategy after a failed rebellion implicates relatives or associates.
- The political value of the memorial lies in praising the ruler and helping define the rebel as morally polluted.
- Rewarding denunciatory petitions encourages speech-based competition for favor.
- Public satire can record the gap between merit in combat and merit in court language.
- The concept is a court-reward mechanism, not proof that the petitioner sincerely believes every claim made.
...
This source supplies a vivid single case, not a general statistical pattern. It does not settle Zhang Song or Liu Jia's private motives, nor does it prove that all Wang Mang-era rewards worked this way. The concept should remain tied to petitionary behavior and reward signaling, not generic flattery.
...
- [[FirstAntiWangMangRising|刘氏反莽第一枪]] - triggering event that creates the petitionary survival problem.
- [[RebellionJustifiedPowerExpansion|以叛乱反证加权]] - adjacent regime-side use of the same failed rebellion.
- [[MingqiLegitimacy|名器合法性]] - reward titles make the petition materially valuable.
- [[MoralizedWarPretext|道德化战争借口]] - related use of moral language to legitimize punishment or opposition.
- [[LegitimacyAnxietyAdministrativeParalysis|篡位焦虑式行政瘫痪]] - later Wang Mang pattern where legitimacy anxiety shapes official behavior.
