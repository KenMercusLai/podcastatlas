...
tags: [governance, court-politics, late-han, local-administration, extraction]
sources:
...
Palace envoy local extraction / 宫使扰民式地方抽取 is the pattern where a mission tied to imperial or palace proximity causes local officials to over-mobilize roads, stations, supplies, gifts, and labor because the envoy's preferences are treated as dangerous extensions of ruler will.
...
Chen Zhong's warning makes the mechanism political. If the emperor does not correct excessive reception of an emissary, local society will infer imperial approval; guessed palace intent becomes enough to mobilize labor and goods.

## Key Claims

- Palace proximity can create practical coercion even without a clear written command.
- Local officials may over-comply with emissaries because failing to honor them looks politically dangerous.
- Ritual or travel missions can become fiscal, labor, and supply extraction during disasters.
- The burden lands on commoners through road work, station preparation, goods, gifts, and corvee.
- Correcting the pattern requires ruler-side clarification, because non-correction is read as approval.
...
- Created the concept from Chen Zhong's critique of Bo Rong's Ganling-capital mission burden.

## Related Concepts

- [[BoRongLateHan|伯荣]] - named emissary whose passage grounds the pattern.
- [[EmperorAnOfHan|汉安帝]] - ruler whose non-correction lets palace mission burden persist.
