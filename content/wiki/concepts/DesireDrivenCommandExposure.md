...
## Definition
Desire-driven command exposure / 私欲驱动的统帅暴露 is the pattern where a powerholder's sexual or private desire alters the security field around command, household access, subordinate trust, or local control. The concept does not treat desire as a complete cause by itself; exposure emerges when desire makes an actor misread danger, insult a newly dependent party, lower guard, or walk into a trap.
...
- The exposure is usually compound: desire works with status insult, threat perception, guard weakness, access control, or ritual timing.
- At Wancheng, Cao Cao's taking of Lady Zou becomes dangerous because it occurs inside a fragile surrender and is followed by subordinate-poaching fear and a leaked killing plan.
- In Danyang, Gui Lan's desire makes him misread Lady Xu's staged compliance and enter the controlled space where revenge actors are hidden.
- The cost often falls on surrounding subordinates and kin: Dian Wei, Cao Ang, and Cao Anmin die in the Wancheng case, while Gui Lan's misread enables Dai Yuan's wider faction to be destroyed.
- The concept should not reduce women in these stories to temptations; Lady Zou is part of a household-status insult, while Lady Xu is the strategist who weaponizes the aggressor's desire.
...
## Related Concepts
- [[StatusInsultDefectionCascade|名分羞辱触发叛变]] - explains the Wancheng surrender-status trigger adjacent to desire.
- [[AlcoholAsPowerCatalyst|酒作为权力催化剂]] - names the enabling tactic that disables Dian Wei in the Wancheng case.
- [[FemaleRevengeAndPoliticalOrder|女性复仇与政治秩序]] - overlaps with Lady Xu's use of enemy desire to restore rather than rupture order.
- [[RetainerRevengeMobilization|臣下复仇动员]] - supplies the loyalist mobilization layer in the Danyang case.
