...
The concept extends [[BubbleFinancingStructure]]. A public equity bubble reprices continuously and visibly. A private-market bubble can be smoothed by infrequent marks, fund discretion, limited disclosure, wealth-management distribution, insurer or pension exposure, and delayed credit recognition. That opacity can postpone panic, but it also means the first visible break may look abrupt.
