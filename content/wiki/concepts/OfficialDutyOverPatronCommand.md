...
type: concept
tags: [loyalty, office, patronage, late-han, yizhou]
sources:
...
# 守职胜私命 / Official Duty Over Patron Command
...
- Office-duty rhetoric can separate service to a superior from obedience to an unrighteous command.
- Classical precedent can make refusal persuasive rather than merely disobedient.
...
- [[GraceDebtLoyaltyPressure|恩义债式忠诚压力]] - contrast because patron favor creates pressure, while Cheng Ji refuses to let that pressure authorize disloyal action.
- [[RumorErosionOfTrust|流言侵蚀信任]] - related pressure source because suspicion and slander can push actors toward preemptive betrayal.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - contrast because Pang Xi's safety-first instinct is checked by a loyalty-duty frame.
- [[TitleRealityRestraint|名实相符式名号节制]] - parallel restraint pattern where actors refuse an available escalation because the added form would create danger.
