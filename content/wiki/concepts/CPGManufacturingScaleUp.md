...
[[madegood-salma-and-nima-fotovat-lost-their-first-business-they-grew-their-next-one-into-a-snack-giant-cf5715bf-e9e0-45e0-a8a9-1256a7a4ed0d]] adds a different version through [[MadeGood]] and [[RiversideNaturalFoods]]. The Fotovat family already had manufacturing knowledge from co-packing and [[TasteOfNature]], so the scale-up problem was not learning whether food could be made at all; it was financing a new factory, proving allergen-free process control, meeting retailer packaging demands, and preserving safety as volume grew.

[[bobbie-laura-modi-how-a-baby-formula-startup-took-market-share-from-two-industry-giants-4488842b-74d3-40ed-8776-5831c5934e69]] adds the [[InfantFormula|infant formula]] version through [[Bobbie]]. Here scale-up depends on FDA-compliant production, long lead times, qualified suppliers, scarce contract manufacturing through [[Perrigo]], and eventually owned capacity through [[NaturesOne]]. The source shows that customer pull can be dangerous when replenishment takes months and existing subscribers depend on uninterrupted supply.
...
- Owning part of the operation can be rational when no partner can handle a critical step, but it increases [[FounderCashFlowConstraint]] and operational risk.
- Scale-up is connected to [[SalesVelocity]]: retailers cannot support the product if manufacturing cannot keep shelves stocked.
...
- [[MadeGood]], [[RiversideNaturalFoods]], [[NimaFotovat]], [[SalmaFotovat]], and [[TasteOfNature]] - owned-manufacturing and allergen-free snack case.
- [[PackagingAsProductExperience]] - packaging can become a required manufacturing capability rather than a cosmetic choice.
- [[CPGDistribution]], [[DirectToConsumerCashFlow]], [[RetailShelfPlacement]], and [[SalesVelocity]] - distribution and channel mechanics affected by manufacturing.
- [[VerticalIntegrationForQualityControl]], [[SchoolSafeCPGPositioning]], and [[RetailerResponsiveManufacturing]] - concepts sharpened by the MadeGood source.
- [[CommodityPriceExposure]] - input costs and supplier changes can force manufacturing and formulation changes.
