...
tags: [history, china, western-han, inequality, reform, political-economy]
sources:
...
Western Han land and slave caps / 西汉限田限奴改革 is the late-Western-Han reform attempt to cap landholding and enslaved dependents by status in response to inequality, land concentration, and the social pressure of a large population on limited productive capacity.
...
- The reform is framed as a response to late-Western-Han inequality and land concentration rather than as an isolated policy whim.
- Dong Zhongshu supplies the older diagnosis: unrestricted land transfer after the Qin settlement enables rich-poor polarization.
- Shi Dan's renewed proposal makes anti-concentration policy an Aidi-era court agenda.
- Kong Guang and He Wu's plan translates the diagnosis into status-specific caps and a three-year implementation window.
- The policy's quick effect on land and enslaved-person prices shows that markets expected real redistribution pressure.
- Suspension reveals the political limit of reforms that directly damage elite property interests.
...
The source supports the reform's intent, design, market reaction, and suspension, but not its full statutory text or any measurable implementation outcome. It also relies on the host's larger "dynastic old age" framing; the episode does not compare alternative explanations for late-Western-Han fiscal and social stress in detail.
...
- [[GoodIntentionsPoliticalLimits|Good Intentions Political Limits]] - broader pattern where approved reforms fail against entrenched interests.
- [[CriminalLawAfterLivelihoodCollapse|刑罚无法修复民生崩塌]] - later Aidi-era livelihood diagnosis that follows from unresolved social pressure.
- [[AffordabilityDrivenSocialism|可负担性驱动的社会主义]] - distant comparative frame for anti-concentration and redistribution pressure.
- [[WesternHanDynasty|西汉]] - dynastic setting of the reform attempt.
