...
[[e144-jiaoyi-de-yishu-bu-yuce-tongji-youshi-fensan-hongli-suiji-bodong-llbhc5wemintlslfwrtx4qdxts-0]] adds the [[NoPredictionTrading]] version: when the trader does not expect any single signal to be right, small initial exposure and broad participation become the mechanism that turns losses into feedback rather than portfolio damage.
...
- In public-fund [[ValueInvesting]], single-position exposure also reflects business durability, pessimistic-case return, holder liquidity, and whether the manager can explain the position during underperformance.
...
- [[InvestmentRiskManagement]] — broader portfolio discipline that includes sizing, leverage, diversification, and behavior.
- [[Pyramiding]] and [[AveragingDown]] — contrasting ways to change exposure after entry.
- [[TrendFollowing]] — framework where sizing can expand only after market confirmation.
- [[NoPredictionTrading]] — frame where sizing keeps repeated signals survivable.
