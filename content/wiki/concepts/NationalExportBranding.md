...
National export branding is the shared origin-story strategy in [[how-to-beat-the-resource-curse-in-norway-summer-school]]. The salmon campaign did not only sell fish; it sold [[Norway]] as a source of cold water, fjords, ice, freshness, and purity so that Japanese consumers could reinterpret raw salmon as safe and desirable.
...
- Origin branding can solve trust and unfamiliarity problems that price alone cannot solve.
- National branding can create shared value for many firms, making it vulnerable to the [[FreeRiderProblem]] unless coordinated.
- Episode 144 adds that national export branding can be implicit: a brand may strengthen country image even when the product does not use patriotic language or explicit national symbols.

## Connections
- [[Norway]], [[Japan]], and [[SalmonSushiMarketCreation]] - source case.
