...
tags: [frontier, tuntian, security, military-agriculture, eastern-han]
sources:
...
屯田贴近引发安全困境 / Tuntian proximity security dilemma is the frontier pattern in which military-agricultural settlement intended to secure supply and control instead alarms neighboring groups when placed too close to them, encouraging defensive alliance or resistance.
...
- Military-agricultural settlement can function as a threat signal as well as a supply tool.
- Physical proximity matters because frontier groups infer intent from where farms and garrisons are placed.
- A move meant to improve control can unintentionally unify otherwise separate neighboring groups.
- Reversing the placement can reduce fear without abandoning the broader tuntian system.
- Tuntian policy must be judged by local perception, not administrative logic alone.
...
- [[TuntianSystem|屯田制度]] - broader institution whose local placement can create either security or alarm.
- [[YiwuGarrisonLateHan|伊吾屯田]] - positive restoration case contrasted with the Huangzhong proximity failure.
- [[FrontierCommanderyRestoration|边郡恢复治理]] - related settlement-restoration logic that also depends on geography and perception.
- [[FrontierConscriptionBackfire|边疆征发反噬]] - adjacent pattern where frontier extraction intended to strengthen control produces resistance.
- [[RecognitionBackedFrontierDiplomacy|承认背书式边疆外交]] - complementary frontier strategy that manages local order through legitimacy and recognition rather than proximity pressure alone.
