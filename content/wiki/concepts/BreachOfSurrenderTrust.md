...
tags: [frontier, trust, surrender, coercion, eastern-han]
sources:
...
受降失信 / breach of surrender trust is the frontier-governance failure where an authority accepts, invites, or uses surrender contact and then kills or betrays the surrendering side, producing a tactical gain that damages later credibility.
...
- Surrender contact carries a credibility obligation even in a violent frontier setting.
- The same obligation applies to surrendered cities and submitted civilians, not only to frontier envoys or banquet guests.
- Betraying surrender can produce revenge, casualties, and short-term intimidation without producing durable settlement.
- Bad-faith settlement can make former rival groups cooperate because trust in the state falls below trust among themselves.
- Imperial condemnation can mark the breach, but without recorded sanction it does not by itself prove full institutional repair.
- Later pacification must account for earlier breaches; trust-building begins from a damaged baseline.
- This concept is distinct from false surrender by rebels: the breach here is committed by the receiving authority.
...
- [[ZhangYuEasternHan|张于 / Zhang Yu]] - source official whose banquet killing creates the breach case.
- [[WuHanEasternHan|吴汉]] - victorious Chengdu commander whose post-surrender violence creates the city-scale breach case.
- [[LiuXiu|刘秀]] - ruler whose rebuke marks surrendered officials and civilians as protected from plunder.
- [[GongsunShuEasternHan|公孙述]] - defeated ruler whose household and clan are destroyed after Yan Cen's surrender.
- [[YanCenEasternHan|颜岑]] - surrendering commander whose clan destruction demonstrates the breach.
- [[MiWuQiangLeader|迷雾 / Mi Wu]] - surrendering leader killed in the breach.
- [[MiTangQiangLeader|弥唐]] - successor whose coalition-building shows the bad-faith aftereffect.
- [[SurrenderAsCivilianProtectionTradeoff|献城保民权衡]] - related because the Chengdu case shows surrender's protection aim can fail when the receiver violates trust.
- [[FrontierTrustThroughProtection|保护换信任式边疆安抚]] - contrast because Deng Xun repairs trust by protecting threatened groups.
- [[PunitiveSurrenderDeterrence|惩罚投降威慑]] - adjacent concept about how harsh treatment of surrender affects later incentives.
- [[RootCausePacification|查因安抚式治理]] - related diagnostic frame because later policy must explain why groups rebel.
- [[WishfulFrontierConciliation|一厢情愿式边疆怀柔]] - contrast because trust cannot be rebuilt by soft posture alone after bad faith.
