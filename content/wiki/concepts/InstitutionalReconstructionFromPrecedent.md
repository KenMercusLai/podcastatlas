...
tags: [statecraft, institutions, administration, eastern-han, knowledge]
sources:
...
Institutional reconstruction from precedent / 旧制文献恢复式制度重建 is the state-building pattern where a new or recovering regime rebuilds administrative capacity by finding scattered records, recovering earlier laws and policies, and turning inherited precedent back into usable procedure.
...
- Regime recovery depends on administrative memory, not only battlefield success.
- Scattered documents can become state capacity when someone can identify, organize, and apply them.
- Precedent is useful when it is selected and adapted, not merely copied.
- Specialized institutional knowledge can make one official unusually valuable in a thin postwar court.
- The pattern links local preservation and central reconstruction: an official who kept one commandery ordered can help rebuild wider procedure.
- Institutional reconstruction can also work as visible legitimacy, when restored offices, documents, and official appearance persuade elites that a regime can govern.
...
- [[HouBaEasternHan|侯霸]] - official whose work grounds the concept.
- [[LiuXiu|光武帝刘秀]] - ruler whose court adopts Hou Ba's recovered policies.
- [[LiuXuanGengshiEmperor|更始帝刘玄]] - nominal restored-Han ruler whose Luoyang delegation gives Liu Xiu a stage for visible procedure.
- [[InstitutionalKnowledgeTransfer|制度知识转移]] - broader knowledge-transfer frame for preserving governing know-how.
- [[SingleAuthorInstitutionalCodification|单人负责式制度编纂]] - adjacent pattern where accountable compilation turns precedent into usable rules.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - related because reconstruction depends on matching specialized officials to institutional gaps.
- [[BuilderCenteredInstitutions|建设者中心制度]] - broader institutional design frame where systems preserve and transmit practical work.
