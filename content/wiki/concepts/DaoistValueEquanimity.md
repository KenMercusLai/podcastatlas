...
type: concept
tags: [daoism, ethics, self-cultivation]
sources:
...
## Key Claims
- The source treats life and death as a qi-gathering and qi-dispersing cycle.
- It links equanimity to observing sameness: value pairs lose final separateness when viewed from the Way.
- Right/wrong, noble/low, and honor/disgrace are presented as human value terms that shift with conditions.
- The practical result is steadiness even amid extreme change, disorder, or threat.
- Confucius is shown learning that different forms can all follow natural nature when they change according to their own pattern.
...
- [[DaoistNaturalWuwei|道家自然无为]] - conduct-side companion emphasizing non-forcing and natural change.
- [[TemperateDrinkingSelfControl|节制饮酒与自我控制]] - separate Confucian restraint frame where self-command governs appetite rather than value-pair dissolution.
- [[PresentMomentAgainstDeath]] - adjacent mortality frame focused on life attachment rather than Daoist qi-return equanimity.
