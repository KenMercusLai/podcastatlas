...
sources:
  ...
  - 148-wangshi-zhisi-duanjing-tuiyuan-shang-de-lishi-zhuangjing-892588934
...
## Definition
Fiction as historical evidence is the guarded method of using fictional works as evidence of social imagination, memory, fear, norms, and reception history without treating them as direct transcripts of events.

## Current Synthesis
The current synthesis has two stable uses. For social history, fiction can illuminate pressures that official records flatten: [[LiaozhaiZhiyi|《聊斋志异》]] helps reconstruct fear, gender constraint, war trauma, and fantasy around Qing local society, while [[JinPingMei|《金瓶梅》]] preserves Ming-style urban everyday texture. For Three Kingdoms material, fiction is mainly a reception-history boundary: [[RomanceOfTheThreeKingdoms|《三国演义》]] can explain why scenes are memorable, but chronicle-source reading controls event attribution and formal claims.

## Key Claims
- Fiction can preserve fears, norms, fantasies, social texture, and moral tensions that official records often omit.
- Fiction is weakest when used as direct proof that a specific event happened as narrated.
- Three Kingdoms novelized memory is valuable as reception history but must be checked against [[ZizhiTongjian|《资治通鉴》]], [[Sanguozhi|《三国志》]], and other source traditions before assigning acts or motives.
- Fiction becomes stronger as historical evidence when it is bounded by place, law, administrative records, material conditions, and recurring social patterns.
...
Fiction can easily be overread. A vivid scene may reveal what later readers wanted a hero, official, woman, ghost, household, or city to mean without proving the scene happened. The method therefore needs explicit source boundaries: fiction may carry reception history, atmosphere, fantasy, fear, and social possibility, but event claims still require comparison with non-fictional source traditions and material constraints.
...
## Related Concepts
- [[ThreeKingdomsStruggleStrategyReading|三国斗争策略读法]] - companion frame for reading Three Kingdoms through source-grounded actor logic.
- [[MicrohistoryFromHostileArchives]] - method neighbor for reconstructing marginal lives from hostile or partial records.
- [[UrbanEverydayFiction]] - narrower use of fiction for everyday material and social texture.
- [[StrangeTaleSocialCritique]] - Liaozhai-specific branch where strange plots reveal war, office, exam, and human-cruelty pressures.
- [[InterpretationAndOverinterpretation]] - cautionary boundary against turning suggestive literary evidence into unrestricted claims.
