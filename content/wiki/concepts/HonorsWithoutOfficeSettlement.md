...
tags: [statecraft, founding, merit, military-control, eastern-han, centralization]
sources:
...
Honors without office settlement / 受爵不受官式功臣安置 is a post-founding power-transfer pattern where a ruler preserves meritorious actors' rank, income, ceremony, and limited access while removing or sharply reducing their direct military and administrative authority.
...
- Founding merit becomes dangerous after unification when wartime command networks no longer match a centralized civilian order.
- Titles, fiefs, ceremony, and limited court access can compensate for the loss of direct command or office power.
- Voluntary surrender of seals is politically effective only when the actor retains enough honor to make retreat non-disgracing.
- The settlement depends on ruler trust and restraint as well as minister prudence; Liu Xiu controls power but does not frame the commanders as enemies.
- New affiliates such as Dou Rong require a different balance because excessive withdrawal can signal fear, insecurity, or unstable integration.
...
This concept does not claim that honor always substitutes for real authority or that all founding coalitions can be demobilized peacefully. The episode's explanation depends on Liu Xiu's personal trust relationships, the elite and literate background of many commanders, the death or illness of some major generals by 37 CE, and the fact that the state still had enough resources to reward status materially. It also remains source-scoped that none of the Yuntai Twenty-Eight Generals suffered political persecution.
...
- [[PowerCompletionRetreat|功成退让]] - individual-level counterpart where a high-merit actor reduces visible command after the task is complete.
- [[PostRestorationMeritThreat|复国功臣威胁化]] - risk field that honors-without-office settlement tries to defuse.
- [[CupWineDisarmsGenerals|杯酒释兵权]] - later Song comparison in which wealth, land, and honor replace command power.
- [[FoundingCommanderSuspicionManagement|建国将领消疑]] - earlier-stage trust work that makes postwar withdrawal less explosive.
- [[MeritBasedRewardPunishment|因功赏罚]] - broader reward logic that gives the settlement material credibility.
