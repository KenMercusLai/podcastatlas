...
type: concept
tags: [history, strategy, reading, three-kingdoms, statecraft]
...
- The Three Kingdoms arc is useful because it shows conflict as a system of repeated decisions, not only a sequence of dramatic victories.
- A durable strategy reading must track internal and external opponents at the same time.
- Friend-enemy categories can change, so a static hero/villain frame is too weak for the period.
- Historical-source reading and literary-memory reading should be separated before they are compared.
- The concept should become stronger only as later episodes add grounded cases from [[CaoCao|曹操]], [[LiuBei|刘备]], [[ZhugeLiang|诸葛亮]], [[YuanShao|袁绍]], and other actors.
...
- [[AdviserStateArchitecture|谋士政权架构]], [[PoliticalSurvivalFirst|安全第一政治生存]], and [[XingshiqingStrategicAssessment|行势情战略评估]] - adjacent strategic frames already developed in late-Han pages.
