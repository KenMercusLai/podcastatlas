...
tags: [late-han, court-politics, documents, corruption, extraction]
sources:
...
伪诏营私 / Forged Edict Private Extraction is the court-politics failure in which insiders simulate imperial authorization to requisition public resources, labor, or compliance for private benefit.
...
- Forged imperial authorization can convert public stores, labor, and construction capacity into private assets without open policy approval.
- Document form matters because state offices respond to command credentials before they can verify political truth.
- Extraction through forged orders creates an immediate exposure problem for the insiders who benefited from them.
- Evidence gathering can increase danger to the investigator when the forged-order group controls access, interpretation, or slander channels near the ruler.
- The concept differs from ordinary private-treasury or palace-construction extraction because the key mechanism is simulated authorization by non-ruler insiders.
...
- [[ForgedEdictSuccessionCoup|伪诏继位政变]] - related document-authority capture, but aimed at succession and coercive elimination rather than private construction.
- [[PalaceConstructionFeeExtraction|修宫钱转嫁盘剥]] - adjacent construction-burden concept where costs are transferred through finance and office channels rather than forged orders.
- [[ImperialPrivateTreasuryExtraction|帝王私库进奉盘剥]] - adjacent public-private extraction concept centered on imperial private stores and office sale.
- [[PalaceAccessMonopoly|宫廷接触垄断]] - access condition that helps insiders control whether forged-order evidence reaches the ruler.
- [[DirectRemonstranceCriminalization|直谏入罪]] - downstream speech-risk pattern when correction against the extraction becomes punishable.
- [[OmenCodedRemonstrance|天象灾异包装式进谏]] - rhetorical strategy Yang Zhen uses to attack the insiders before the documentary case is presented.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - broader information failure that lets evidence against insiders turn into danger for the investigator.
