...
tags: [court-politics, risk, remonstrance, western-han]
sources:
...
政治风险预防 / political risk prevention is the court-governance pattern where early restraint, removal of combustible conditions, and uncomfortable warnings are valued before a crisis becomes rebellion, punishment, or emergency rescue.
...
- Prevention can be politically less visible than crisis rescue, even when it would have avoided greater loss.
- Court warnings about elite arrogance should be evaluated before they can be proven by rebellion.
- Reward systems can misread contribution by honoring those who respond to disaster while ignoring those who tried to remove its causes.
- The "曲突徙薪" pattern applies to political households as well as physical fire risk: relocate combustibles before sparks appear.
...
The source does not prove that Xuan could have fully prevented the Huo collapse by following Xu Fu alone. It shows a political lesson about recognizing preventive advice, not a complete counterfactual reconstruction of how specific restraint measures would have worked.
...
- [[HuoFamilyPurgeAfterHuoGuang]] - concrete crisis whose preventability is debated through Xu Fu's warning.
- [[BureaucraticRiskAvoidance]] - adjacent risk logic where officials avoid exposure rather than surface danger early.
- [[PoliticalExecutionOverreach]] - downstream danger when ignored risk is later handled through severe punishment.
- [[RewardFitnessRisk]] - related reward-allocation problem where honor may fail to match true contribution.
- [[CourtFeedbackCollapse]] - broader failure mode when warnings do not reach or move the ruler in time.
