...
type: concept
tags: [logistics, supply-chain, operations, startups]
...
- [[LogisticsWorkflowAutomation]] - task and workflow layer inside the broader coordination problem.
- [[LogisticsCrisisResponse]] - crisis mode when coordination breaks under shocks.
- [[CustomerPull]], [[OperationalPainFounderInsight]], [[MarketplaceFrictionReduction]], and [[SupplyChainSovereignty]] - adjacent startup and supply-chain concepts.
