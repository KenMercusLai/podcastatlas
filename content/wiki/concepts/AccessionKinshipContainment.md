...
tags: [succession, royal-family, eastern-han, court-politics, risk-management]
sources:
...
继位亲族安抚与隔离 / Accession Kinship Containment is the transition pattern in which a new ruler handles vulnerable royal relatives through sequencing, reassurance, privacy, distance, and ritual order before suspicion becomes open punishment.
...
- Succession risk often concentrates around displaced heirs, displaced maternal lines, and ambitious brothers.
- A loyal report from a vulnerable kinsman can be more stabilizing than immediate accusation.
- Privacy can contain family danger when public exposure would harden factions or humiliate a royal branch.
- Reassurance and sequencing can coexist with suspicion; they are tools for reducing combustible proximity.
- Ritual order and kinship containment work together during accession because both make hierarchy legible.
...
- [[KinshipProtocolBoundary|亲情名分边界]] - broader frame for when family role must be bounded by court order.
- [[RoyalKinTreasonLawBoundary|宗室谋逆法度边界]] - later Liu Jing escalation where kinship no longer prevents treason-law judgment.
- [[PrivateRetainerNetworkRisk|私人宾客网络风险]] - adjacent risk pattern because informal networks can turn proximity to royal kin into accusation material.
- [[SuccessionAuthorityConsolidation|继位权威巩固]] - wider succession frame, though this concept focuses on family containment rather than general authority building.
- [[ImperialDeathConcealment|帝王之死隐匿]] - contrast case where succession security is managed through hiding the death rather than openly repairing order.
