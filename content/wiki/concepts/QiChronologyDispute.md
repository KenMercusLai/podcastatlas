...
Qi Wei Wang chronology dispute / 齐威王编年争议 is the specific [[ChronicleChronologyDrift|编年错位]] case around [[QiWeiwang|齐威王]]. [[zizhi-tongjian-zhouji-10-yi-jiazu-danwei-you-mayi-chi-daxiang-de-jingshen-2-lmnqfjmydygqnfec6xhzpixralvi]] first flags the problem by saying the received annalistic placement of Qi Wei Wang's Zhou-court visit and official-audit story is too early for the surrounding Tian-family Qi sequence.

[[zizhi-tongjian-zhouji-08-yidai-mingjiang-wuqi-cansi-3-ltca-ikuzo9ej7a0lfrgwv2-wulb]] adds an earlier background warning for that same Tian-family sequence. Before the Qi Wei Wang problem appears, the episode already says the post-[[TianHe|田和]] line involving [[TianYan|田衍]], [[TianQiHuanGong|田武 / 田氏齐桓公]], and [[GongziXiQi|公子喜]] is muddled enough to require explicit source-scoped handling.

[[zizhi-tongjian-zhouji-14-qiweiwang-buming-zeyi-yiming-jingren-lrs6rbifyiqrojxg0mccpg7sf9rv]] sharpens the dispute. The host says early [[QiState|齐国]] records available to [[SimaQian|司马迁]] were especially thin, that [[Shiji|《史记》]] and [[ZizhiTongjian|《资治通鉴》]] inherited serious errors in Tian Qi succession, and that Qi Wei Wang's accession was probably placed twenty-one years too early. In that correction, 357 BCE becomes the accession year and 356 BCE the first regnal year.

The same source gives a concrete impossibility test: a 370 BCE visit to [[ZhouLiewang|周烈王]] cannot be literal if Zhou Lie Wang had already died. If the event happened, the Zhou ruler would have to be [[ZhouXianwang|周显王]], and the wiki should mark that as the source's correction rather than silently rewriting every received notice.
