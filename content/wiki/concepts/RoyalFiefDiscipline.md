...
tags: [royal-family, governance, law-enforcement, local-government, eastern-han]
sources:
...
王国相整肃 / Royal fief discipline is the governance pattern in which the central court uses a kingdom minister or equivalent appointee to force a royal fief back under public law, ritual hierarchy, and administrative order.
...
- Royal status can become a local-governance risk when rank shields misconduct.
- A kingdom minister can use ritual protocol to reset the hierarchy before enforcing law.
- Fief discipline requires punishing abusive actors and repairing wrongful imprisonment.
- Correct appointment quality matters because a weak appointee would likely amplify royal impunity.
- Successful correction changes behavior without needing to abolish the fief itself.
...
This concept is currently one successful Hejian case, not a universal model for all royal fiefs. The episode does not provide a full institutional history of kingdom ministers, nor does it prove that protocol-first discipline always works. It shows a strong example of fief correction when appointment fit, visible hierarchy, and local enforcement align.
...
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - broader concept because the fief is repaired by choosing the right official for a hard post.
- [[HighStatusLawEnforcementSignal|高位者执法信号]] - adjacent pattern where disciplining a high-status actor communicates law's reach.
- [[MinisterialDignityProtection|九卿体面保护]] - related public-office status protection in Shun-era institutional repair.
- [[CourtCoreRectification|朝廷心腹整顿]] - central-court repair frame that complements local fief correction.
- [[SameSurnameKingEnfeoffment|同姓王分封]] - broader royal-fief institution that can create governance exposure.
