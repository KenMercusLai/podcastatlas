...
- Phone-side file management depends on [[OSLevelContext]] because important work material lives across chat apps, files, calendar, screenshots, notes, and cross-device sync.
- It overlaps with [[PersistentAgentMemory]] when useful files, meetings, and user decisions become durable personal context.
...
- [[OSLevelContext]], [[PersistentAgentMemory]], and [[ContextEngineering]] — memory and context mechanisms.
