...
tags: [technology, papermaking, eastern-han, court, materials]
sources:
...
宫廷需求驱动造纸 / Court-Demand-Driven Papermaking is the source-bounded pattern where a palace demand for lighter, cheaper, more usable writing and painting material, combined with workshop authority and imperial patronage, produces a material-process improvement that can spread beyond the court.
...
The concept's current judgment is narrow. It does not settle the full invention history of paper. It captures the mechanism visible in this source: court demand, material economy, workshop experimentation, presentation to the ruler, and patronage-backed diffusion.

## Key Claims

- Technical improvement can be driven by elite demand for usable writing and painting materials, not only by abstract curiosity.
- Court workshop roles can convert demand into experimentation because they join access, resources, and production authority.
- Low-cost inputs matter because they turn a writing material from a luxury or cumbersome medium into something easier to spread.
- Imperial praise and palace trust help a process become socially visible and reproducible.
- The source supports "improvement and diffusion" more safely than invention from nothing.
...
- [[FemaleCourtEducationEasternHan|东汉宫廷女性教育]] - adjacent court-learning context that helps explain demand for written materials.
- [[PerishableTributeLaborBurden|鲜贡劳役负担]] - contrast case where court demand produces harmful logistics rather than useful material innovation.
- [[SeasonalRitualConsumptionRestraint|时令礼法式饮食约束]] - adjacent pattern of restraining court material demand through ritual and burden concerns.
- [[Taixue|太学]] - written-learning institution appearing in the same source, though the episode does not directly connect Cai Lun's paper to Taixue reform.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - adjacent governance frame because Cai Lun's office fit helps turn material skill into state-recognized output.
- [[OfficialLearningMonopoly|学在王官式知识垄断]] - distant knowledge-institution contrast for how court-controlled material and learning channels can shape written culture.
