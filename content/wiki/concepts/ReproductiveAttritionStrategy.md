...
type: concept
tags: [warfare, population, livestock, attrition, frontier]
sources:
...
Reproductive attrition strategy / 繁衍打击战略 is a source-scoped warfare frame in which violence is timed to damage an opponent's future population or livestock capacity, not only its current soldiers or supplies.
...
- Attrition can target future capacity rather than only present battlefield strength.
- Pregnancy and livestock breeding make spring a strategically and morally loaded campaign season.
- A campaign can be militarily effective precisely because it harms noncombatant and reproductive systems.
- The concept explains strategic cruelty without making that cruelty legitimate or complete as a historical explanation.
...
The concept is currently grounded in one source's interpretation of a specific Tongjian phrase and should not be generalized without more evidence. It does not claim that Han Wudi's Xiongnu policy was only reproductive attrition, nor does it supply a modern legal classification. It does mark the episode's moral point: a strategically rational attack can still be brutally directed at future civilian and livelihood capacity.
...
- [[SeasonalWarLogistics|战争季节后勤]] - provides the campaign-calendar frame that makes spring reproductive timing strategically salient.
- [[WarGenderedCivilianHarm|战争中的性别化平民伤害]] - adjacent harm frame for pregnancy and forced flight under violence.
- [[NomadicCavalryRaidingAsymmetry|游牧骑兵劫掠不对称]] - frontier context in which Han Wudi's spring pressure responds to mobile raiding capacity.
- [[WarCostTempoDiscipline|战争成本与速决纪律]] - broader attrition and logistics frame for destroying an opponent's capacity.
- [[AnimalReproductiveStrategies|动物繁殖策略]] - biological reproduction frame linked by livestock breeding disruption.
