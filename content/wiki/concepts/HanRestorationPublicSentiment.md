...
tags: [legitimacy, restoration, xin-dynasty, eastern-han]
sources:
...
汉室人心回归 / Han restoration public sentiment is the late-Xin legitimacy pattern in which opposition to [[WangMang|王莽]] becomes politically usable because people and elites remember Han rule as preferable to Xin's disorder.
...
- Restoration legitimacy depends on remembered comparison, not only formal genealogy.
- Public sentiment can make a regime's officers reconsider loyalty before final defeat.
- A former dynasty's memory becomes stronger when the current regime fails at protection and food security.
- The concept explains why Han-lineage banners in later episodes become politically legible.
...
The source supports Feng Yan's political diagnosis, not a measurement of all public opinion. Later Gengshi and Chimei episodes also show that invoking Han does not automatically produce durable order: restored-Han figureheads can be weak, factional, or hollow. This concept should therefore be used as an enabling condition for restoration politics, not proof that every Han claimant is effective.
...
- [[RestoredRoyalFigureheadLegitimacy|复国王室名义合法性]] - title mechanism that later turns Han sentiment into claimant selection.
- [[DynasticLegitimacyBackfire|王朝合法性回旋镖]] - upstream legitimacy frame because sacred Han memory can turn against Wang Mang.
- [[PeopleBasedPoliticalSecurity|民心型政治安全]] - broader support-and-security frame.
- [[FengYanEasternHan|冯衍]] - source actor who articulates the diagnosis.
- [[LiuXiu|刘秀]] - later restoration founder whose rise becomes legible inside this public-sentiment field.
