...
tags: [political-violence, honor, mobilization, pre-qin-history, warring-states]
sources:
...
# Retainer Revenge Mobilization / 臣下复仇动员

## Definition
Retainer revenge mobilization / 臣下复仇动员 is the pattern where loyalty to a killed ruler, patron, or commander turns into organized violence by followers. It differs from solitary revenge because the decisive step is mobilization: shame, duty, household pressure, or a surviving insider converts scattered loyalty into a temporary fighting group.
...
- Public pledge and covert ambush are different tactical forms of the same mobilization mechanism.
- The mobilized group changes political facts by removing the immediate killer or conspirator rather than merely expressing grief.
- The effectiveness of revenge depends on an organizer who can convert loyalty into timing, target selection, and group discipline.
- The concept remains bounded to crisis politics and does not make private vengeance a general legal norm.

## Evidence
**Public shame-to-oath mobilization**
...
## Related Concepts
- [[RetainerReciprocityEthic|士为知己者死]] - supplies the honor logic that can motivate followers.
- [[PoliticalAssassinationEthics]] - adjacent violence frame where unlawful killing is evaluated against political breakdown.
- [[FemaleRevengeAndPoliticalOrder|女性复仇与政治秩序]] - overlaps where Lady Xu directs loyalist revenge.
- [[DesireDrivenCommandExposure|私欲驱动的统帅暴露]] - explains why Gui Lan enters the trap that retainer mobilization executes.
