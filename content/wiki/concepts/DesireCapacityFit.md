...
type: concept
tags: [mental-health, psychology, life-design, anxiety, self-regulation]
sources:
...
# Desire-Capacity Fit / 欲望与能力匹配

## Definition
Desire-capacity fit / 欲望与能力匹配 is the episode's closing life-regulation principle that psychological steadiness often requires lowering, narrowing, or recalibrating desires so they match actual ability, personality, family conditions, role obligations, and life stage.

## Current Synthesis
The original source frames "安定此心" as a fit problem rather than a slogan about optimism. [[JiangTaoPsychiatrist|江涛]] argues that people under intense competition, shrinking opportunity, information overload, family expectation, and achievement comparison can harm themselves when desire, capacity, and social reality are badly mismatched.

This is not an anti-effort concept. The episode allows striving, responsibility, and role duty, especially for middle-aged adults supporting elders and children. The boundary is self-damage: a goal may need to be escaped, lowered, delayed, or redesigned when it outruns the person's health, temperament, resources, and current life conditions.

The Western Han diplomacy case adds a statecraft analogy. [[WangGenWesternHan|王根]] wants the fame of acquiring Xiongnu land, and [[XiahouFanWesternHan|夏侯藩]] wants or accepts the chance to perform a high-stakes mission, but neither the deniable probe nor the envoy's judgment matches the demand's risk. [[zizhi-tongjian-hanji-554-chengnianren-de-dingji-zilv-kezhi-yuwang-lo3brdufkiaks3mfsqsruxprqdcn|汉纪 554]] uses "知足不辱，知止不殆" to extend the concept from clinical/life design into political conduct: desire becomes costly when the person or institution lacks strength, timing, authorization clarity, and a stopping point.
...
- Fit variables - [[shidai-zhenghou-yu-anding-cixin-lphaw0qek8ibr0jt44yygou6akql]] says desire should match ability, character, growth, development, family environment, and role.
- Escape boundary - [[shidai-zhenghou-yu-anding-cixin-lphaw0qek8ibr0jt44yygou6akql]] says escaping is not shameful when anxiety, depression, or compulsion are tied to goals set too high or imposed by others.
...
- Political desire boundary - [[zizhi-tongjian-hanji-554-chengnianren-de-dingji-zilv-kezhi-yuwang-lo3brdufkiaks3mfsqsruxprqdcn|汉纪 554]] uses Wang Gen's fame temptation and Xiahou Fan's mishandled land-demand mission to show desire outrunning capacity, authorization boundary, and judgment.

## Counterevidence & Qualifications
Lowering desire can become harmful if it is used to excuse coercion, deprivation, learned helplessness, untreated illness, discrimination, or institutional abandonment. The sources' useful boundary is fit and self-protection, not telling people to accept every constraint as natural. 汉纪 554 also does not prove that all territorial or career ambition is wrong; its narrower claim is that ambition without capacity, proportion, and a stopping point can turn opportunity into humiliation.

## What Changed
- Added 汉纪 554's historical analogy: a Xiongnu land-demand probe shows desire for fame and gain outrunning capacity, role boundary, and diplomatic judgment.
...
## Related Concepts
- [[AchievementPressureMentalHealth]] - achievement systems can make desire-capacity mismatch clinically risky.
- [[CapabilityGapSelfDiagnosis]] - practical distinction between confidence, skill, time, and emotional-capacity gaps.
- [[SpiritualFreedomUnderConstraint]] - adjacent frame for preserving inner life under limits.
- [[ControllableLifeAnchors]] - concrete anchors that can stabilize life when large goals are uncertain.
- [[LowDesireDefensiveContraction]] - nearby risk where low desire may become shutdown rather than fit.
