...
tags: [court-politics, accusation, reputation, late-han, retaliation]
sources:
...
Anonymous slander retaliation / 匿名诬告式报复 is the pattern where injured interests answer correction, cleanup, or office loss by using anonymous accusation to recode a public action as private ambition, factional danger, or moral hypocrisy.
...
The concept is narrower than all slander. Its mechanism is anonymous retaliation after a concrete loss of access, position, or protection, and its danger lies in moving attention from the correction's merits to the reformer's alleged hidden motive, network, or threat.

## Key Claims

- Anonymous accusation can let demoted or displaced actors retaliate while hiding personal interest.
- Palace-proximity actors can use anonymous accusation after losing access, even when formal correction has initially succeeded.
- Slander is more potent when it matches an overmighty powerholder's preexisting dissatisfaction.
- A cleanup campaign can be recoded as faction-building if the accusers shift attention from irregular appointments to the reformer's supposed network.
- Emotional and ritual accusations can make an institutional actor look morally illegitimate even when the disputed policy has public-order reasons.
- The frame works through [[CourtFeedbackCollapse|court feedback collapse]] when accusation reaches power more easily than the corrected misconduct does.
...
- [[RetaliatoryPoliticalTerror|报复性政治恐怖]] - downstream coercive pattern when retaliation becomes imprisonment, killing, display, or family liability.
- [[MoralReputationPoliticalCapital|道德名望政治资本]] - resource that makes Li Gu valuable but also worth discrediting.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - information failure that lets accusation outrun correction.
- [[PalaceProximityPower|宫廷近侍权力]] - access environment that makes Song E's removal and counterattack politically consequential.
- [[TreasonAccusationTrap|谋反指控陷阱]] - harsher related pattern where association is recoded as security threat.
- [[OuterRelativeCourtPower|外戚专权与清算]] - power environment that makes Liang Ji's dissatisfaction a useful destination for the smear.
