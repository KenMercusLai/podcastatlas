...
Loyalty-collateral dilemma names cases where a morally charged choice around loyalty, duty, family, refuge, or honor shifts danger onto people who are not the primary decisionmaker.
...
- The dilemma arises when a loyal, filial, sheltering, or honor-preserving choice makes third parties bear real punishment or death risk.
- Coercive actors weaponize family, locality, and host networks when they cannot persuade the primary target directly.
- Self-sacrifice can remove a person from a forced exchange, but it does not make the surrounding violence morally simple.
...
- [[FugitiveShelterCollateralRisk|收留逃亡者的牵连风险]] - subtype focused on refuge, hospitality, and political pursuit.
- [[AristocraticHonorOverLife|贵族名誉高于生命]] - adjacent honor frame where reputation can outrank survival.
- [[RetainerReciprocityEthic|士为知己者死]] - related loyalty code that can generate repayment pressure.
