...
type: concept
tags: [statecraft, pacification, legitimacy, late-han, governance]
sources:
  - zizhi-tongjian-hanji-1051-ta-weihe-bei-chengzuo-shi-zui-you-nengli-de-yangzhou-cishi-ltquwyzzq-sqibj33bpbu3qyvz2h
knowledge_schema: synthesis-v1
last_updated: 2026-08-29
---

# 弱势名分安抚 / Weak-Position Pacification
...
- Avoiding early battle can be an active strategy when the appointed actor does not yet possess enough coercive capacity.
- Local armed groups are easier to absorb when obedience is framed through office, tribute, and partial autonomy instead of humiliation.
- Livelihood repair and education make submission feel beneficial rather than merely compelled.
- Defensive preparation still matters; pacification fails if reassurance is not eventually backed by durable capacity.
- The pattern is source-bounded and should not be generalized as a universal alternative to military force.
...
## What Changed
- Added a focused concept for Liu Fu's combination of weak formal legitimacy, reassurance, economic recovery, and delayed defensive hardening.

## Related Concepts
- [[MingqiLegitimacy|Mingqi Legitimacy]] - supplies the formal title side of the pattern.
- [[StrategicDefectorIncorporation|Strategic Defector Incorporation]] - overlaps in turning dangerous outsiders into insiders.
- [[NewlyAttachedRegionLeniency|Newly Attached Region Leniency]] - overlaps in using leniency to stabilize newly attached communities.
- [[ForceBackedSurrenderPersuasion|Force-Backed Surrender Persuasion]] - contrasts because military pressure is already present in that pattern.
- [[PeopleBasedPoliticalSecurity|People-Based Political Security]] - explains why livelihood and safety convert authority into attachment.
- [[RootBasePriority|Root-Base Priority]] - connects the pacification sequence to durable base-building.
