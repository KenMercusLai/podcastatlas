...
type: concept
tags: [politics, workplace, survival, late-han, strategy]
...
The source keeps the moral cost visible. Moderation can preserve life, office, and later agency, but it can also look like rank-protection, conflict avoidance, or lack of direct remonstrance. That is why the concept sits between [[StrategicEmotionConcealment|情绪不外露的战略纪律]], [[WorldlyPoliticalCultivation|入世政治修行]], and [[MachiavellianRealism]] rather than becoming a blanket praise of smoothness.

## Key Claims

- Long office survival can be an ability when the court is unstable, factional, and punishment-prone.
- Non-offense works only when paired with real institutional competence; mere softness would not explain repeated recall.
- Emotional restraint matters because visible anger exposes intention and narrows the actor's room to maneuver.
- The same behavior can be read as prudence by survival logic and as moral weakness by remonstrance logic.
- The episode's workplace extension is source-scoped: it translates late-Han court survival into organizational judgment without claiming that every workplace requires court-style tactics.
...
- [[WorldlyPoliticalCultivation|入世政治修行]], [[CovertPoliticalTechnology|阴谋式政治技术]], and [[MachiavellianRealism]] - adjacent frames for remaining inside morally uncomfortable power fields.
