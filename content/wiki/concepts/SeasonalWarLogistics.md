...
type: concept
tags: [warfare, logistics, agriculture, frontier, seasonality]
sources:
...
Seasonal war logistics / 战争季节后勤 is the strategy frame in which campaign timing follows production calendars: harvest, winter stores, pasture-fed horse strength, pregnancy, and livestock breeding change when war is possible and what damage it causes.
...
- War timing is shaped by harvest and storage calendars as much as by immediate battlefield opportunity.
- Autumn raids can exploit both enemy grain availability and raider horse strength.
- Winter provisioning can turn autumn violence into a survival and logistics strategy.
- Spring campaigns can harm future capacity when they hit pregnancy and livestock breeding cycles.
- Logistics language such as armies returning when grain runs out is a strategic explanation, not only a campaign detail.
...
- [[NomadicCavalryRaidingAsymmetry|游牧骑兵劫掠不对称]] - seasonality explains when mobile raiders have their strongest material advantage.
- [[WarCostTempoDiscipline|战争成本与速决纪律]] - logistics tempo is the broader cost frame in which seasonal campaigning sits.
- [[ReproductiveAttritionStrategy|繁衍打击战略]] - spring pregnancy and livestock-breeding pressure is the harshest branch of seasonal timing.
- [[FarmingWarStatecraft|农战国家治理]] - agricultural production cycles supply the fixed calendar that war must respect or exploit.
- [[WartimeAgriculturalLaborCollapse|战时农业劳动力崩塌]] - adjacent risk where campaign demands damage farming capacity.
- [[AnimalReproductiveStrategies|动物繁殖策略]] - biological reproduction frame linked by livestock breeding season.
