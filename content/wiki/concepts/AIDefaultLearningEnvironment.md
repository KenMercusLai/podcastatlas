...
- EP9 shows the K-12 version before that normalization was settled: bans and detectors arise because students can already reach AI through ordinary devices and services.
...
- [[JosephStrader]], [[TeacherAILiteracy]], [[TeacherAIAugmentation]], and [[AIAcademicIntegrity]] - early K-12 ChatGPT branch added by Data Science With Sam EP9.
- [[AIShortcutRisk]] and [[FirstDraftThinking]] - risks that remain when AI is always available.
- [[AIUniversityAssessmentReform]] - assessment response to the default-environment shift.
