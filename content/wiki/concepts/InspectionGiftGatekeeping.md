...
type: concept
tags: [court-politics, patronage, inspection, risk, late-han]
...
This concept sits between [[PalaceAccessMonopoly|宫廷接触垄断]] and [[BattlefieldCommanderReplacementRisk|阵前换将风险]]. Access monopoly explains why Zuo Feng's report has force; commander-replacement risk explains the military damage that follows when a ruler answers palace anxiety by replacing a front-line commander near victory.

## Key Claims

- A court inspector can become a gatekeeper when the ruler trusts the inspector's report more than the front-line commander's record.
- Gift refusal can be recoded as disrespect or noncooperation if the inspection channel is already corrupt or personalized.
- The concept does not recommend bribery; it names the risk that upright conduct alone may not manage a captured information route.
- A bad inspection report can trigger military consequences, including recall, punishment, or replacement command.
- The pattern is sharper when the inspected actor holds troops and the ruler is already suspicious of concentrated military power.
