...
# Land-For-Peace Exhaustion Trap / 抱薪救火式割地求和

Land-for-peace exhaustion trap / 抱薪救火式割地求和 is the pattern [[zizhi-tongjian-zhouji-83-zhuhou-bailan-jing-chengle-jingdian-ji-zhong-ji-ljp7nbqnrctr5mw6i9u982abmx-1]] builds from [[SuDai|苏代]]'s warning to [[WeiAnxiWang|魏安釐王]]. After [[HuayangBattle|华阳之战]], [[DuanGanzi|段干子]] proposes ceding Nanyang-area land to [[QinState|秦国]] for peace. Su Dai replies that using land to serve Qin is like carrying firewood to put out a fire: the fire stops only when the firewood runs out.

The concept does not deny that a defeated state may need a settlement. Its warning is about repeated concession as a strategy. If the stronger state's appetite is structural and the weaker state's land is finite, each short-term peace can make the next demand easier and the defending state smaller.
