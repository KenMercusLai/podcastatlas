...
tags: [frontier, rebellion, official-abuse, qiang, eastern-han]
sources:
...
边吏侵害引发反叛螺旋 / Frontier Official Abuse Rebellion Spiral is the pattern where abuse, destructive handling, or poor cross-cultural communication by local frontier officials turns household injury, group fear, or conscription anxiety into collective violence and rebellion as surrounding groups decide that remaining passive is unsafe.
...
Together the sources make panic the central mechanism. This page should stay narrower than [[RootCausePacification|Root-Cause Pacification]]. It does not prescribe the repair path. It names the escalation mechanism by which a frontier state creates rebellion pressure when local power violates households, exploits settled groups, destroys homes, or answers fallout through pursuit rather than trusted adjudication.

## Key Claims

- Frontier disorder can begin with concrete official abuse or destructive local handling rather than with a preexisting ethnic war plan.
- Household violation or settled-group exploitation becomes politically explosive when the abusive actor represents state authority.
- Official pursuit after a first killing can widen fear from one household to a whole local group.
- Interception, home destruction, and distant-service fear can turn conscription management into rebellion pressure.
- Language, custom, and information gaps make official abuse harder to detect and correct before escalation.
- Panic can convert a defensive calculation into collective rebellion before the center fully understands the cause chain.
- The mechanism complicates simple ethnic-oppression explanations without denying that unequal frontier power is part of the background.
...
- [[RootCausePacification]] - repair-oriented contrast that begins by diagnosing why frontier or local populations rebel.
- [[FrontierConscriptionBackfire]] - adjacent failure where military extraction from fragile frontier groups creates new unrest.
- [[CoerciveFrontierRelocationBackfire]] - adjacent Qiang-frontier failure where state protection policy creates enemy manpower.
- [[LightTouchFrontierGovernance]] - related preventive frame because Ban Biao's diagnosis emphasizes observation, communication, and local fit before coercion.
- [[PeopleBasedPoliticalSecurity]] - broader frame for how loss of trust and protection becomes practical insecurity.
- [[InvestigationDrivenRebellionEscalation]] - related escalation mechanism where inquiry or pursuit makes suspected actors choose rebellion as self-protection.
- [[LocalEliteSecurityPanic]] - analogous panic pattern among local elites rather than frontier tribes.
- [[FrontierCommandCollapse]] - downstream military-governance failure that can follow unresolved frontier disorder.
