---
title: "Political Marriage Alliance Depreciation / 政治婚姻联盟折价"
type: concept
knowledge_schema: synthesis-v1
tags: [marriage, alliance, court-politics, succession, eastern-han, harem-politics]
sources:
...
- [[MaternalStatusSuccessionLeverage|子以母贵式继承杠杆]] - downstream succession mechanism because Guo's status first supports and later destabilizes Liu Qiang's heir security.
- [[CrownPrinceVoluntaryWithdrawal|太子主动辞位自保]] - later response to the heir vulnerability created by the depreciated marriage alliance.
- [[PalaceMarriageFamilyMobility|宫廷婚姻家族跃升]] - adjacent palace route where marriage or harem status lifts a family into political power.
- [[PowerBasedAllianceRepricing|权力基础改变后的联盟重估]] - broader alliance logic in which a relationship's value changes after the power base changes.
- [[MarriageAllianceWarExposure|婚姻联盟战争暴露]] - related risk when marital ties carry strategic exposure rather than private stability.
- [[AffectionDrivenSuccessionRisk|宠爱驱动的立储风险]] - contrast because affection helps explain the preference but does not alone explain when the change becomes possible.
