...
[[tech-20260311-0311-mp-tech-pod-128-tech-20260311-0311-mp-tech-pod-128]] adds the journalism-craft version through [[ThePlainDealer|the Plain Dealer]]. [[WillaRemus]] reports that some staff disliked AI taking away writing and doubted it would do the job well, while some editors argued that reporting and writing are separable skills. The backlash here is about authorship, craft, and cost-cutting risk as much as about visual or stylistic quality.
...
- In journalism, AI backlash can come from workers losing the writing part of a reporting job, not only from audiences noticing lower-quality output.
...
- [[AIContentProvenance]], [[AIContentDevaluation]], and [[AIBacklashPolitics]] - adjacent trust and backlash frames.
- [[TheWaltDisneyCompany]], [[OpenAI]], and [[IPOwnership]] - synthetic character and entertainment-rights context.
- [[HumanJudgmentUnderAI]] - broader responsibility frame for deciding acceptable AI use.
