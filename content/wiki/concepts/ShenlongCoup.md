...
The Shenlong Coup is the 705 political rupture in this wiki's current source base that forces [[WuZetian|武则天]] to withdraw and restores [[TangZhongzong|李显]] to the throne, reshaping [[ShangguanWaner|上官婉儿]]'s patronage environment.
...
- The coup marks the transition from Wu Zetian's rule to Tang Zhongzong's restored court in the current source.
- Shangguan Wan'er survives the transition because her document work remains valuable.
- The restoration does not end Wu-family influence; it shifts the arena into alliances involving Wu Sansi and Empress Wei.
- The coup creates a new vulnerability for people whose power had depended on the Wu side.
- The episode treats the coup as a precursor to later factional instability, not as a stable settlement.
...
This page does not reconstruct the coup's full participant list, causes, or institutional consequences. It records only the event's function inside the Shangguan Wan'er episode.
...
- [[TanglongCoup|唐隆之变]] - later coup that closes the same episode's factional sequence.
- [[CourtFactionalSurvival|宫廷派系生存]] - survival pattern intensified by the coup's incomplete settlement.
- [[HistoricalFemaleRoleModelCaution|历史女性榜样化警惕]] - interpretive caution because the transition preserves danger behind visible rank.
