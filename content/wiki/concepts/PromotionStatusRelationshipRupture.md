...
Promotion-status relationship rupture is the pattern where a close peer relationship becomes unstable after one person rises in rank, wealth, or authority, because the change turns a familiar equal into a painful comparison object and a practical power threat.
...
- Promotion changes both emotional meaning and practical incentives: friendship now coexists with evaluation, dependence, and possible command.
...
- [[EnvyContemptComparison]] - psychological mechanism behind upward comparison and satisfaction at a fallen rival.
- [[WorkplaceRelationshipBoundaries]] - practical boundary frame for separating friend, peer, rival, and superior roles.
- [[JealousyDeescalationByRivalProtection]] - contrast where protecting a rival prevents jealousy from becoming factional hostility.
