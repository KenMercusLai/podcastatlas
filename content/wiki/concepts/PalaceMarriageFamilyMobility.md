...
tags: [han, eastern-han, marriage, harem-politics, family-strategy, social-mobility, outer-relative-power]
sources:
...
The concept should therefore be read as a pre-power mechanism. It explains how a family enters the outer-relative field, not what it inevitably does after entering it. Later succession control, hidden deaths, and purges belong to [[OuterRelativeCourtPower|outer-relative court power]], while this concept names the earlier conversion of household preparation into palace access and status mobility.

## Key Claims

- Palace marriage can function as a family mobility route when harem rank changes the status of the woman's natal household.
- Beauty or eligibility is only an entry condition; family preparation, court selection, imperial affection, and higher political approval all have to align.
- The route is more difficult when empress positions are already dominated by established high-status families.
- Harem entry becomes public politics once it creates outer-relative status, succession incentives, and future access to offices or palace guards.
- The concept does not imply that family mobility is stable or benign; the same route can later expose the family to purge and succession backlash.
...
This concept is currently grounded in one podcast source and should not be generalized into a complete Eastern Han marriage system. The episode's modern marriage opening is a source-scoped framing device, not a universal theory of marriage choice. The source also does not prove Yan Chang's private motives beyond the host's interpretation, nor does it reconstruct the full palace-selection institution. Later sources are needed before treating this as a recurrent, named Han-dynasty mechanism.
...
- [[OuterRelativeCourtPower|外戚专权与清算]] - downstream family-power structure that can follow once palace marriage creates natal-family status.
- [[ImperialMarriageInspection|皇室婚前身体检视]] - later imperial-spouse selection pattern concerned with bodily eligibility and palace command.
