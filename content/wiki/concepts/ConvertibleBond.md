...
## Connections
- [[AssetAllocation]] - portfolio role for a hybrid debt/equity instrument.
- [[PortfolioSuitability]] and [[InvestmentWorldviewFit]] - why the same tool may fit one investor and not another.
- [[InvestmentRiskManagement]] and [[BehavioralInvestingBiases]] - sizing, review, and hindsight-bias context.
- [[RealEstateInvestmentTrust]] - contrast case that shaped the host's later sell-down and residual-position discipline.
- [[OptionContractMechanics]] - contrast with options as a less suitable time-pressured tool in the source.
