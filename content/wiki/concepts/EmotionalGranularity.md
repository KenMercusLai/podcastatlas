...
type: concept
tags: [emotion, psychology, regulation, self-awareness]
sources:
...
## Definition
Emotional granularity is the ability to differentiate one's own emotional states at a fine enough level that regulation can target the actual state rather than a vague global feeling.

## Current Synthesis
In the Adolphs episode, granularity sits between emotion science and practical regulation. People do not need a perfect word for every feeling, but they do need usable concepts that let them notice whether a state is anger, sadness, anxiety, awe, gratitude, panic, or some mixture. Granularity matters because emotion is necessary for decision and motivation; the goal is not to mute emotion but to understand the state early enough to choose a better response.
...
- Language boundary - [[neuroscience-of-emotions-tools-for-improving-emotion-regulation-dr-ralph-adolphs-scim1222961716]] says language can help but a person can work with a concept even without a precise word.
- Regulation link - [[neuroscience-of-emotions-tools-for-improving-emotion-regulation-dr-ralph-adolphs-scim1222961716]] connects monitoring and differentiating emotion to better regulation.
- Bodily-resolution extension - [[movement-practice-to-strengthen-your-mind-body-connection-ido-portal-scim2496765743]] has Portal extend granularity from the body to emotional, conceptual, social, and spatial schemas.
...
- [[CognitiveReappraisalEarlyIntervention]] - intervention branch that depends on noticing the state early.
- [[LearnableEmotionalIntelligence]] - adjacent claim that emotional self-awareness can change with practice.
- [[SocialEmotionInferenceLimits]] - outward-facing counterpart around reading other people's emotions.
- [[ReactionChoiceFrame]] - response-choice neighbor where naming a state can preserve action space.
