...
- The Wugu Incident functions as a succession-memory background whose terminal layers now include command-legitimacy breakdown, Chang'an fighting, Liu Ju's flight, failed rescue possibility, suicide, family killings, and Liu Bingyi's preservation; Hanji 386-2 shows that edicts, tallies, cavalry orders, prison releases, and the North Army decide whether Liu Ju can plausibly act as crown prince rather than rebel.
