...
tags: [institutions, law, memory, withdrawal, xin-dynasty]
sources:
...
制度记忆隐匿保存 / institutional memory concealment is the practice of preserving texts, procedures, ritual timing, or legal knowledge privately when public service under a new order would expose the actor or legitimize the rupture.
...
- Institutional memory can survive through private custody when public institutions are captured or renamed.
- Concealment can express loyalty without becoming a performative challenge that endangers the household.
- Ritual dates and legal texts are not symbolic trivia; they carry procedural continuity across regime rupture.
- Withdrawal becomes politically meaningful when it preserves usable knowledge rather than merely avoiding risk.
- The tactic is narrow: it protects memory, not immediate public power.
...
- [[CrisisWithdrawalSelfProtection|危局抽身自保]] - broader withdrawal discipline within which memory preservation can occur.
- [[PrincipledOfficeRefusal|原则性拒仕]] - related refusal pattern because Chen Xian's withdrawal avoids legitimizing Wang Mang's order.
- [[InstitutionalReconstructionFromPrecedent|旧制文献恢复式制度重建]] - downstream reconstruction form that depends on preserved texts and procedures.
- [[CalendarReformLegitimacy|历法改革合法性]] - related because ritual timing becomes a legitimacy marker under regime change.
- [[WangMangReforms|王莽改制]] - rupture field that makes old institutional memory vulnerable.
