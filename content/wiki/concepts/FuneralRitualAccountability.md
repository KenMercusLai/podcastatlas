...
tags: [court-politics, ritual, accountability, western-han]
sources:
...
丧葬礼制责任 / funeral ritual accountability is the pattern where the handling of a royal or elite funeral becomes a test of office duty, political respect, public-resource use, and dynastic memory rather than a merely private ceremony.
...
- Funeral ritual can function as public state order because it expresses rank, memory, and institutional respect.
- Mishandled burial can become an office-duty failure charged to senior ministers.
- Ritual accountability can be uneven: visible punishment may coexist with later promotion or continued use of the same official.
- Public-resource use matters because hurried ceremony funded through taxes can make disrespect and administrative failure appear together.
- The concept is adjacent to broader 礼 order but narrower: it focuses on death, burial, and responsibility after status-bearing people die.
...
- [[LiAsPoliticalOrder|礼制政治秩序]] - broader ritual-order concept in which funeral status is one form of role memory.
- [[QiongchengTaihouWesternHan|邛成太后]] - status-bearing figure whose funeral grounds the concept.
- [[XueXuanWesternHan|薛宣]] - dismissed official who shows ritual failure becoming office accountability.
- [[ZhaiFangjinWesternHan|翟方进]] - punished but promoted official who qualifies simple accountability readings.
- [[OfficeSequencePowerReallocation|官职序列重组式权力再分配]] - adjacent personnel-field concept because ritual blame can alter office sequence.
