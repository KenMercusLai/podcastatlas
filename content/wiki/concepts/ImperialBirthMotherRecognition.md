...
tags: [eastern-han, ritual, succession, harem-politics, kinship]
sources:
...
皇帝生母名分追认 / imperial birth-mother recognition is the posthumous ritual and political process by which a ruler restores status to the woman who bore him when her maternity had been hidden, suppressed, or left below the rank expected by imperial custom.
...
The concept also has a comparative boundary through [[SongGuirenZhangHeLateHan|Song Guiren]]. [[LiuQingQingheKing|Qinghe King Liu Qing]] receives seasonal sacrifices for Song after the Liang case, but he hesitates to request a shrine because that might look like equating Song with Liang's emperor-birth-mother rank. Birth-mother recognition therefore creates a hierarchy of maternal repair, not a flat rule that every wronged consort receives identical honors.

## Key Claims

- Imperial maternity is a public status question, not only a biological fact, because it affects title, burial, sacrifice, and maternal-kin treatment.
- Hidden or suppressed maternity requires a reporting channel before it can become court-recognized truth.
- Recognition can include multiple linked acts: posthumous title, reburial, paternal honor, family recall, and title grants.
- Maternal repair below the emperor's own birth mother may take narrower forms, such as seasonal sacrifices rather than shrine or title parity.
- Birth-mother recognition can strengthen a maternal clan, creating later outer-relative risk even when the initial repair is justified.
...
- [[StraightRedressWithoutRevenge|以直报怨式平反]] - broader ethical settlement in which birth-mother recognition is one repair mechanism.
- [[PosthumousNamePolitics|谥号政治]] - naming counterpart because Liang's posthumous elevation changes public memory.
- [[ImperialBurialLegitimacy|帝后合葬名分]] - burial-order counterpart because recognition is partly spatial and ritual.
- [[LiAsPoliticalOrder|礼制政治秩序]] - role-order frame because mother, adoptive mother, ruler, and deceased emperor positions must remain legible.
- [[OuterRelativeRecurrence|外戚轮回]] - consequence pattern because recognized maternity can promote a natal clan.
