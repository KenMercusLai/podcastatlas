...
- [[InstitutionalTrustAIAdoption]] - trust layer that cognitive diversity can expose before rollout.
- [[AIAdoptionBehavioralSignals]] - metrics that should be designed with diverse user input.
