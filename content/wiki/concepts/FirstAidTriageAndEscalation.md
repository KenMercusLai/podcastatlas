...
type: concept
tags: [health, emergency-response, first-aid, medical-literacy]
sources:
...
## Current Synthesis
The sources make triage the center of first aid. The practical order is not “do every technique quickly,” but identify scene danger, check the person's state, call 120 early, give nearby people concrete tasks, and choose only the action that fits the event.
...
## Evidence
- Emergency decision order: [[vol-222-aoye-xintiao-kuangbiao-shi-cusi-qianzhao-aed-hui-dian-cuo-huoren-dai-ni-bikai-zhiming-changshi-shijie-jijiu-ri-teji-lnemogq8gb9o3e2835jvtfx3emiy]] repeatedly emphasizes judging first, calling for help, and then intervening according to the condition.
...
- [[ChestPainEmergencyEscalation]] - chest-pain warning-sign branch inside first-aid escalation.
- [[AcuteSportsInjuryEscalation]] - orthopedic and sports-trauma branch inside first-aid escalation.
- [[AcuteWoundBurnFirstAid]] - household trauma and burn branch inside first-aid escalation.
- [[MedicationSelfCombinationRisk]] - medication-risk branch where self-treatment can worsen an acute event.
- [[SeizureFirstAidBoundary]] - convulsion-response branch that warns against folk interventions.
