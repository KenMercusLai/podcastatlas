...
tags: [eastern-han, court-politics, outer-relatives, kinship, institutional-decay]
sources:
...
The concept is narrower than [[OuterRelativeCourtPower|outer-relative court power]]. That broader page tracks mature institutional capture across later Yan and Liang branches. Outer-relative recurrence names the cyclical transition point: the morally necessary settlement that seeds a future version of the problem it has just answered.

## Key Claims

- A maternal clan can be both a victimized group needing redress and a future power bloc needing restraint.
- Court repair through titles, recall, and favor changes the family's structural position, not only its honor.
- The cycle does not make the original grievance false; it shows that justice and institutional risk can coexist.
- Gratitude and kinship access can convert posthumous redress into durable political opportunity.
- The pattern is a prelude to mature outer-relative court power, not identical to full office capture.
...
- [[OuterRelativeCourtPower|外戚专权与清算]] - broader mature-power pattern that this concept precedes.
- [[ImperialBirthMotherRecognition|皇帝生母名分追认]] - repair mechanism that can elevate a maternal clan.
- [[StraightRedressWithoutRevenge|以直报怨式平反]] - ethical settlement that creates the Liang-family promotion context.
- [[DengFamilyAnEraLateHan|邓氏]] - later comparison for how maternal or marital kinship requires restraint after elevation.
- [[LiangJiLateHan|梁冀]] - later Liang-family powerholder whose mature dominance is foreshadowed by the source's warning.
