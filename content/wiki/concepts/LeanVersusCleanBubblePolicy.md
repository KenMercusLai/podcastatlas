...
The source stresses that policy stakes depend on transmission channels. A price crash is more dangerous when it runs through borrowing, defaults, bank losses, reduced lending, and worker layoffs. That is why the housing bubble becomes the severe comparison case, while a possible AI bubble is treated as uncertain: direct bank borrowing appears less central, but private-credit and infrastructure-finance exposure remain open questions.

## Key Claims
- Knowing that an asset may be overvalued does not automatically settle what policymakers should do.
- Leaning against a bubble risks choking off real innovation or acting on a false signal.
...
- [[StatisticalBubbleIndicators]] and [[MarketEfficiency]] - uncertainty around whether policymakers can identify a bubble early enough.
