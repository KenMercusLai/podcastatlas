...
The mechanism is layered endorsement. [[HeYongLateHan|何颙]] gives early praise, [[QiaoXuanLateHan|桥玄]] supplies a senior elder's recognition and sends Cao Cao to [[XuShao|许劭]], and Xu Shao's月旦品 culture converts a reluctant judgment into a circulated label: "治世之能臣，乱世之奸雄." Cao Cao's killing of [[JianShuoLateHan|蹇硕]]'s uncle as Luoyang north commandant adds a conduct signal that counters the inherited eunuch association through [[CaoTengLateHan|曹腾]] and [[CaoSong|曹嵩]].

This differs from [[CharismaticPoliticalPerformance|造势型政治表演]], where a person imposes future status through embodied performance before resources exist. It also differs from [[MoralReputationPoliticalCapital|道德名望政治资本]], where visible virtue itself becomes capital. Here the key resource is recognized evaluation: a trusted opinion maker's words make an ambiguous person socially readable.
...
- [[StatusFilteredTalentMisrecognition|门第筛选式人才误判]] - adjacent issue where elite judgment can block or certify talent.
- [[CharismaticPoliticalPerformance|造势型政治表演]], [[MoralReputationPoliticalCapital|道德名望政治资本]], and [[PrestigeBasedCoalitionLeadership|名望型联盟领导]] - related reputation and status concepts.
