...
tags: [governance, bureaucracy, information, state-capacity, xin-dynasty]
sources:
...
密控式行政瓶颈 / secrecy-driven administrative bottleneck is the governance failure in which a ruler protects authority by routing money, documents, decisions, and confidential information through trusted insiders, but the secrecy and personal approval loops slow or block ordinary administration.
...
- Centralized secrecy can protect a ruler from perceived elite capture while weakening ordinary office function.
- Confidential-channel control becomes dangerous when the same insiders can filter, delay, or block information.
- Personal approval requirements create a capacity ceiling: the ruler's time becomes the system's throughput limit.
- Administrative backlog can create material harm even before a regime visibly collapses in battle or revolt.
- The pattern is distinct from ordinary workload; it is workload made worse by distrust and hidden information channels.
...
The source does not prove that every eunuch or close attendant acted corruptly, nor does it show that normal officials would have processed all matters well. The bounded claim is institutional: secrecy, distrust, and personal approval loops made late-Xin administration slower and less informative at the same time.
...
- [[CommandAuthorityBottleneck|将权掣肘]] - military analogue where field commanders hold responsibility without usable decision rights.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - broader failure where information reaches power poorly or is not converted into repair.
- [[CrisisInformationBlockade|危机信息封锁]] - neighboring information failure focused on blocked crisis knowledge.
- [[SuppressedRootCauseReporting|根因上报压制]] - later late-Xin form where causal explanations become politically forbidden.
- [[PersonDependentGovernanceFragility]] - broader risk when a system depends on one person's attention and judgment.
- [[WangMang|王莽]] - ruler whose secrecy and approval loops ground the case.
