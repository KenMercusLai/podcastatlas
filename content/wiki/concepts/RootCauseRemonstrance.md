...
tags: [remonstrance, governance, advice, court-politics, late-han]
sources:
...
The concept begins as a method-goal fit problem. Shun is not shown as doing nothing: he grants amnesty and personally prays for rain. Zhou Ju's criticism is that those acts remain on the surface if the court continues extravagance, harem expansion, and uncorrected policy. The remonstrance therefore treats ritual posture as insufficient when governing causes remain active.
...
- A leader's effort can be real and still misdirected if it works on symbols rather than causes.
- Disaster-framed remonstrance can convert a ritual occasion into a policy diagnosis.
- The useful move is not only saying "this is wrong" but naming the cause layer and the corrective acts.
- Root-cause remonstrance can preserve hierarchy by treating the superior as capable of repair rather than only guilty.
- The concept should stay tied to evidence of both diagnosis and proposed remedy, not just any complaint about bad outcomes.
- A benevolent measure can still be shallow if it produces gratitude without changing the structures that generate disorder.
...
- [[OmenCodedRemonstrance|天象灾异包装式进谏]] - neighboring strategy where disaster or omen language carries political criticism.
- [[AdviceFramingUnderHierarchy|等级场景中的进言包装]] - related communication pattern because root-cause criticism still needs an acceptance path.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - failure mode root-cause remonstrance tries to prevent by converting warning into correction.
- [[WangJiWesternHan|王吉]] - Western Han case who frames amnesty and tax relief as insufficient without ritual, frugality, and personnel reform.
- [[HereditaryOfficePrivilege|任子式官职特权]] - personnel cause Wang Ji names as part of root repair.
- [[RootCausePacification|查因安抚式治理]] - governance counterpart that diagnoses rebellion causes before choosing pacification tools.
- [[NaturalDisasterPoliticalOmen|自然灾害政治征兆]] - broader historiographical frame for interpreting destructive events as political warning.
- [[EmperorShunOfHan|汉顺帝]] - ruler case whose ritual response becomes the target of Zhou Ju's diagnosis.
