...
tags: [strategy, communication, boundaries, deterrence, risk]
sources:
  - zizhi-tongjian-hanji-766-lishi-jiaogei-ni-weishenme-yao-guyi-fa-piqi-lrs-mguyfmnxe970hdwjvmevl8oc
last_updated: 2026-08-30
---

# 策略性发怒威慑 / Strategic Anger Deterrence

## Definition

Strategic Anger Deterrence is the use of visible, bounded anger to make a threat publicly legible and raise the cost of quiet retaliation. It is not uncontrolled rage; it is a signaling move that turns private intimidation into attributed evidence.
...
- Strategic anger is useful when silence would let an intimidator control attribution.
- The tactic works by making a threat public, traceable, and reputationally expensive.
- Its force depends on boundedness: the target and reason must be clear.
- It is most relevant under asymmetric power, where direct coercive defense is unavailable.
- The tactic can deter retaliation without guaranteeing safety.
- It overlaps with whistleblower evidence discipline because the speaker precommits to how harm should be interpreted.
...
- [[CommunicationBoundarySetting|Communication Boundary Setting]] - strategic anger is a high-intensity boundary signal.
- [[PsychologicalBoundaryProtection|Psychological Boundary Protection]] - strategic anger protects the boundary by refusing quiet intimidation.
- [[ClothCladAngerPersuasion|Cloth-Clad Anger Persuasion]] - contrasts lower-status anger used to shift ruler perception with anger used to deter retaliation.
- [[WhistleblowerEvidenceDiscipline|Whistleblower Evidence Discipline]] - shares the logic of preserving attribution before harm occurs.
- [[DeathFacingResponsibility|Death-Facing Responsibility]] - relates through willingness to accept personal risk for a public duty.
- [[CourtFeedbackCollapse|Court Feedback Collapse]] - strategic anger becomes necessary when normal feedback channels are intimidated or blocked.
