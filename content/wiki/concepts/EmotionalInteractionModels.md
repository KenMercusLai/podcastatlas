...
- The episode distinguishes high-level decisions about what the robot should do from low-level action generation about how to execute the behavior.
- [[Shibo]] says companionship is not simple pleasing: a robot can appear sad, withdraw, stomp, turn away, or become less proactive toward a person who repeatedly mistreats it.
- [[FamilyWorldSimulator]] data is used to train and evaluate these interactions before enough real household data is available.
