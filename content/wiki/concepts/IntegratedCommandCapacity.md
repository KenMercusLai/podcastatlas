...
type: concept
tags: [strategy, command, military, late-han, cao-cao]
...
The episode then connects this early maneuver to later Cao-side patterns already present in the wiki: absorbing [[QingzhouSoldiers|青州兵]], using [[TuntianSystem|屯田制]], building adviser depth through [[XunYu|荀彧]], [[GuoJia|郭嘉]], [[XunYou|荀攸]], and [[ChengYu|程昱]], and keeping campaigns tied to resource and legitimacy systems through [[AdviserStateArchitecture|谋士政权架构]]. The claim remains source-scoped because the source is interpretive and praise-heavy, but it gives the wiki a useful positive counterpart to failure-mode concepts such as [[DesireDrivenCommandExposure|私欲驱动的统帅暴露]].
...
- [[CaoCao|曹操]], [[NeihuangBattleLateHan|内黄之战]], [[DongWuyangLateHan|东武阳]], and [[YuDuLateHan|于毒]] - source case.
- [[EncirclingWeiToRescueZhao|围魏救赵]], [[BattlefieldInformationControl|战场信息控制]], and [[XingshiqingStrategicAssessment|行势情战略评估]] - adjacent strategy frames.
- [[QingzhouSoldiers|青州兵]], [[TuntianSystem|屯田制]], [[DefeatedPopulationConversion|降众资源化]], and [[RootBasePriority|根本根据地优先]] - resource and base-building extensions.
- [[XunYu|荀彧]], [[GuoJia|郭嘉]], [[XunYou|荀攸]], [[ChengYu|程昱]], and [[AdviserStateArchitecture|谋士政权架构]] - adviser-depth extension.
