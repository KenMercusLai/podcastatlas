...
tags: [administration, governance, names, legibility, xin-dynasty]
sources:
...
Administrative renaming overreach / 行政改名过度 is the governance failure in which rulers repeatedly rename offices, places, divisions, or fiefs to express ideological order or auspicious intent, but create operational confusion for officials and commoners.
...
- Administrative names can be instruments of ideology, not only neutral labels.
- Renaming becomes overreach when symbolic improvement increases practical confusion.
- A reform can weaken state legibility when offices and jurisdictions change faster than users can learn them.
- Auspicious language may reveal ruler hopes while doing little to solve material disorder.
- Repeated renaming fits the broader Wang Mang pattern of archaizing reform outrunning implementation capacity.
- Early renaming can also function as post-usurpation recoding: replacing old names makes a new regime look institutionally settled before practical legitimacy is secure.
...
- [[WangMangReforms|王莽改制]] - larger reform field where archaizing language and state control outrun practical capacity.
- [[PostUsurpationLegitimacyConsolidation|篡位后合法性整合]] - earlier consolidation field where renaming helps make a new regime appear complete.
- [[QinAdministrativeStandardization|秦行政标准化]] - contrast because standardization can increase legibility when implementation is stable.
- [[AdministrativeOpacityAsControl|行政不透明作为控制]] - adjacent failure where the state becomes less legible to its own users.
- [[LegitimacyAnxietyAdministrativeParalysis|篡位焦虑式行政瘫痪]] - related Xin pattern where legitimacy pressure deforms administration.
- [[RitualSpectacleCrisisDisplacement|仪式奇观式危机转移]] - related because symbolic order can substitute for repair under crisis.
