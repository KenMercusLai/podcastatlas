...
[[130-zhang-yueguang-chuangye-liangnian-shouci-fangtan-miaoya-bushi-ai-native-chanpin-liucheng-dao-shangxiawen-sheji-one-way-door-he-yinv-youxi]] adds the product-design version through [[ZhangYueguang]]. He argues that [[AINativeProductDesign]] moves from designing deterministic user flows toward defining what context, examples, constraints, and quality boundaries the model needs before the user interface can be settled.
...
[[dushu-jiushi-zai-du-yige-ren-de-f-li4qt9zs2bss4tklnj3yg9y-quo1]] adds a reading and knowledge-ecology version. Bookshelves, whiteboards, linked notes, conversation history, and the user's own AI all become context for seeing and reshaping ideas. [[PersonalKnowledgeEcology]] makes the context bidirectional: it helps AI understand the user, but it also helps the user notice their own [[XFFXFramework]] and decide what should be read or delegated.

[[140-dui-yao-shunyu-de-4-xiaoshi-fangtan-qing-yunxu-wo-xiao-feng-yixia-zai-anthropic-he-gemini-xun-moxing-jishu-yuce-yingxiongzhuyi-yi-guoqu-ll7qiciwwgfssorhr4yy-uuqae8h]] adds the training-side version through [[LongHorizonAI]]. [[YaoShunyu]] argues that useful agents should be trained in finite context but used as if context were effectively much longer through interaction, selective forgetting, retrieval, and compression. This moves context engineering from user workflow into model behavior and post-training design.

[[135-he-ziran-xuanze-chuangshiren-tristan-liao-elys-saibo-fenshen-linghun-context-de-huoqu-yu-liudong-he-ai-shejiao-wangluo-ltwegwvo7grn-v-rft0txlmqmcty]] adds the AI-social-network version through [[Elys]]. [[Tristan]] argues that context becomes valuable when it can flow between [[CyberAvatars]] inside [[AISocialNetworks]], letting agents do pre-interaction and filtering before handing valuable connections to real people. This shifts context engineering from private prompt quality toward networked [[SubjectivityAsAIAsset]] and [[ContextFlywheel]] design.

[[yige-ai-chuangshiren-de-xurongxin-zhuang-he-yumei-zhidian-duitan-invoko-ai-chuangshiren-mengqi-lsi79o-z19zplvmqdbpzzneogpk3f]] adds the internal-company workflow version through [[InvokoAI]]. [[Mengqi]] says an internal growth skill worked better than an external 2B product partly because the team had full context: target users, outreach details, pricing, negotiation state, content checks, communication history, and acceptance criteria lived inside the team's own process.
...
- E238 adds that context is necessary but insufficient for reliable agents; execution environments, feedback, permissions, and repair loops move the problem into [[HarnessEngineering]].

## Connections
- [[ContentEngineering]], [[AIAnswerEvaluation]], and [[VoiceInteraction]] — E245's media-facing example and conversation-quality branch.
...
- [[ZhangYueguang]], [[AINativeProductDesign]], [[Miaoya]], and [[Docky]] — product-design case distinguishing AI-powered products from AI-native products.
...
- [[AIAssistedReading]], [[PersonalKnowledgeEcology]], and [[ReadingAsFrameTraining]] — reading and note-context extension added by the Mianji reading source.
- [[YaoShunyu]], [[LongHorizonAI]], [[MLCoding]], and [[FrontierModelScaling]] — finite-training and long-use context extension added by episode 140.
- [[Elys]], [[AISocialNetworks]], [[CyberAvatars]], [[ContextFlywheel]], and [[SubjectivityAsAIAsset]] — AI-social-network context extension added by episode 135.
- [[InvokoAI]], [[Mengqi]], [[AISkills]], and [[VerticalAgentSaaSification]] — internal growth workflow and context-completeness case added by the 42章经 episode.
- [[Creo]], [[HarnessEngineering]], [[AgentHarness]], and [[AIFirstOrganization]] — E238's boundary between context engineering and dynamic production harnesses.
