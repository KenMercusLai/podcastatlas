...
## Definition
Reconstructive memory is the view that remembering is an active rebuilding of past experience from traces, schemas, attention, emotion, context, and later information rather than a literal recording replay.

## Current Synthesis
The Castel episode treats memory errors as normal evidence about how memory works. Everyday failures such as misdrawing the Apple logo, overlooking a fire extinguisher, forgetting whom a story was told to, or relying on a photo all show that exposure and storage are different from attention and usable recall.
...
- Noticing boundary - [[how-to-improve-your-memory-cognitive-function-at-any-age-dr-alan-castel-scim5781519002]] uses the Apple logo and fire-extinguisher examples to separate seeing from encoding.
...
- [[MemoryContaminationRisk]] - failure mode where later suggestion or identification reshapes recalled experience.
- [[ProspectiveMemory]] - future-action memory that depends on constructed plans and cues.
