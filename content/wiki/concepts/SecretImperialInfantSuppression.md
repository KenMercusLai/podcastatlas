...
tags: [succession, court-politics, western-han, palace, violence]
sources:
...
秘密皇子压制 / secret imperial infant suppression is the succession-violence pattern where an inconvenient royal birth is hidden, the mother and attendants are isolated or silenced, and the child's identity or survival is removed from ordinary court verification.
...
- A hidden imperial birth can become a succession threat even before the child has any active political role.
- Suppression depends on information control: sex, parentage, custody, and survival are all made hard to verify.
- Mothers and attendants are structurally vulnerable because they are the witnesses who can preserve the child's identity.
- Written orders and palace custody chains can make coercion look administratively regular.
- Sealed evidence and secret burial can hide a death while still creating new witnesses who complicate the concealment story.
- A loyal official's appeal to preserve royal bloodline may slow the process but not necessarily save the child.
- Later historiography must keep the suppression narrative together with evidence skepticism when the case is politically useful and testimony-heavy.
...
- [[PoliticalCaseEvidenceSkepticism|政治案件证据怀疑]] - needed because the case is politically useful and mediated through later testimony.
- [[PalaceAccusationVerification|宫廷指控核验]] - procedural neighbor for checking palace accusations before punishment and narrative hardening.
- [[GenderedConsortScapegoating|红颜祸水式替罪叙事]] - later historiographical risk when heir loss is collapsed into favored-woman blame.
- [[DynasticHeirLossShock]] - broader succession risk created when royal children disappear or die.
- [[DynasticLegitimacyBackfire|王朝合法性回旋镖]] - legitimacy field that makes hidden or missing heirs politically explosive.
