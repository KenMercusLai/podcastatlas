...
tags: [diplomacy, routes, geography, information-control, ancient-history]
sources:
...
Intermediary Route Gatekeeping / 中介路线门控 is a pattern where a middle actor controls contact between distant parties by shaping route knowledge, risk perception, or passage feasibility, even without openly forbidding travel.
...
- Route control can work through information and risk framing rather than physical interception.
- Intermediary polities can shape what distant courts know about each other even when both sides might benefit from contact.
- Gan Ying's mission shows how a failed arrival can still create durable geographical knowledge.
- The gatekeeping effect remains meaningful even when the intermediary's statement may be partly true.
- Historical route narratives need geography, incentive, and source-position analysis before being read as personal courage or cowardice.
...
The current evidence is a single podcast source summarizing and interpreting received historical material. Parthian officials may have exaggerated, but dangerous sea travel was not inherently implausible. The concept should not be used as proof of bad faith unless later sources add evidence of deliberate obstruction.
...
- [[IntermediarySpeechPressure]] - related mechanism where an intermediary shapes decisions through framed communication.
- [[BattlefieldInformationControl]] - adjacent information-control pattern, but in a military setting rather than long-distance diplomacy.
- [[StrategicFrontierAbandonment]] - route and corridor value matter when distant frontier commitments are being priced.
- [[InformationAsymmetricPacification]] - shared concern with actors exploiting uneven information, though in local pacification rather than transregional travel.
