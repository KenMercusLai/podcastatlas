...
Ritualized command appointment / 仪式化拜将留才 is the leadership mechanism in [[zizhi-tongjian-hanji-146-qiannian-jingdian-xiaohe-yuexia-zhui-hanxin-lq0oc3vqr-tsr0r-iwztifxeezl|汉纪 146]]. After [[HanXin|韩信]] flees [[Nanzheng|南郑]], [[XiaoHe|萧何]] chases him back and tells [[LiuBang|刘邦]] that ordinary generals are easy to find, but Han Xin is "国士无双."

The mechanism has two parts. First, recognition must match strategic ambition: if Liu Bang only wants to remain king in [[Hanzhong|汉中]], Han Xin is unnecessary; if he wants to contest all under Heaven, Han Xin becomes central. Second, recognition must become public authority. Xiao He rejects Liu Bang's casual plan to summon Han Xin into the tent and insists on bathing, fasting, choosing a date, building a platform, and formally appointing him as commander.

The concept differs from generic respect for talent. [[TalentAttractionThroughRespect|礼贤下士式人才吸附]] can bring people toward a ruler, and [[TalentReferralQuality|荐才层级质量]] asks whether the recommender has identified the right person. Ritualized command appointment asks whether the organization can convert private recognition into visible rank, authority, and retention before the talent leaves.
...
- 汉纪 147 adds that ceremony is validated by downstream strategic output: public authority lets the appointee define the campaign rather than merely receive orders.

## Connections
- [[HanXin|韩信]], [[XiaoHe|萧何]], and [[LiuBang|刘邦]] - source case.
- [[Nanzheng|南郑]], [[Hanzhong|汉中]], [[BaShu|巴蜀]], and [[GuanzhongRegion|关中]] - base and future campaign geography.
...
- [[HanzhongDui|汉中对]], [[ThreeQinContainment|三秦压制]], and [[GuanzhongRegion|关中]] - immediate strategic payoff in 汉纪 147.
