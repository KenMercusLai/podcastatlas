...
type: concept
tags: [ethics, politics, late-han, loyalty, risk]
sources:
...
Death-facing responsibility / 赴死式责任承担 is the pattern where an actor treats loyalty, guilt, or duty after political defeat as requiring acceptance of lethal risk, even when flight, concealment, or silence is available.
...
- Death-facing responsibility appears after defeat, when the actor can still choose between exposure and self-protection.
- The action can be self-surrender, burial, mourning, hiding a survivor, or preserving a household secret.
- It is not equivalent to direct remonstrance because it may involve no new policy argument to the ruler.
- The pattern often creates collateral danger for helpers and family members, so its moral force is mixed with real risk transfer.
- Survival-first reasoning remains a serious counterposition; the concept names the choice to accept lethal exposure, not an automatic best practice.
- Because hostile institutions can reward the victors, responsibility under risk does not imply that history will distribute just outcomes.
...
- The current concept rests on one late-Han source note and should be broadened only through additional cases.
- Not every exposed death counts as responsibility; the pattern requires a recognizable duty, a real alternative, and acceptance of the risk attached to that duty.
- Survival can also serve responsibility in other settings, especially when flight preserves future repair capacity.
- Zhu Zhen and Hu Teng show that heroic loyalty can transfer danger to households and helpers, so the concept should not flatten collateral risk into simple praise.
...
- [[DeathDefyingRemonstrance]] - overlapping but narrower pattern where lethal risk is accepted through corrective speech to power.
- [[PoliticalSurvivalFirst]] - competing strategy that preserves life and future agency before moral exposure.
- [[LoyaltyCollateralDilemma]] - ethical problem created when loyal protection endangers family members, hosts, or helpers.
- [[RetainerReciprocityEthic]] - patron-subordinate obligation that helps explain Hu Teng's conduct toward Dou Wu.
- [[CrisisWithdrawalSelfProtection]] - adjacent survival pattern that chooses withdrawal instead of exposed loyalty.
- [[MoralDesertPoliticalOutcomeGap]] - wider frame explaining why courageous responsibility does not guarantee just political outcomes.
