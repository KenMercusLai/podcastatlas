...
The episode explicitly connects this pattern to [[IntermittentReinforcement]]. Like a variable reward loop, the painful relationship becomes harder to leave when the person keeps waiting for the rare good moment. In this context, criticizing the victim as "恋爱脑" or weak misses the mechanism: the [[FawnResponse|fawn response]] has already trained the person to take responsibility for the harmful other's needs.
...
- [[IntermittentReinforcement]] - reward-pattern mechanism that explains why rare tenderness can deepen attachment.
