...
tags: [han, eastern-han, marriage, harem-politics, gender, body-politics]
sources:
...
- Imperial marriage inspection turns a prospective spouse's body and voice into court-assessed eligibility criteria.
- The procedure depends on palace command and hierarchy, so shame or reluctance does not stop it.
- The inspection is distinct from modern medical or public-health marriage checks because its core logic is status, selection, and control.
- Body eligibility does not guarantee a functioning marriage: Liang Ying's inspected entrance still leads to cold relations, harem conflict, childlessness, and isolation.
- The concept belongs with outer-relative and harem politics because marriage selection can carry family power into the imperial household.
...
This concept is currently grounded in one source note and should not be generalized into a complete history of ancient Chinese marriage medicine or imperial consort selection. The episode's claim that Liang Ying is China's first textually recorded inspected empress is preserved as source-scoped. The supplied source note also does not give the original quoted classical passage for every inspection detail, so the concept should remain tied to this episode until stronger textual evidence is added.
...
- [[OuterRelativeCourtPower|外戚专权与清算]] - family-power setting in which empress marriage becomes political structure.
- [[ImperialPrivateDesireGovernanceRisk|帝王私欲治理风险]] - adjacent problem where imperial private relations produce public consequences.
- [[PalaceFavoriteProtectionFragility|宫廷宠幸保护脆弱性]] - related Huan harem pattern where title, affection, and protection fail to align.
- [[RelationshipSelectionAgency|择人与环境选择]] - modern contrast frame around partner choice and life-shaping relationships.
- [[CoercedImperialMarriage|强制赐婚]] - another imperial-marriage pattern where command pressure overrides ordinary consent.
- [[MarriageRitualOrthodoxy|婚姻礼法正当性]] - adjacent marriage-order frame concerned with procedure and legitimacy.
