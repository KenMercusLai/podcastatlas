...
tags: [governance, education, succession, personnel-selection, kinship, eastern-han]
sources:
...
太子师傅公器化 / crown-prince tutor public interest is the principle that the heir's education is a state office serving the realm, not a private family appointment serving the crown prince's maternal relatives.
...
The concept is a personnel-selection boundary. It does not deny that relatives can be capable; it says the default test for heir education must be role fitness and public accountability rather than kinship convenience.
...
- Public-interest selection can preserve the court's legitimacy before succession by separating education from outer-relative advantage.
- Imperial gifts to teachers can honor learning when they follow a role-fit decision rather than a family-favor decision.
...
- [[ZhangYiEasternHan|张义]] - source figure who states the public-interest criterion.
- [[YinShiEasternHan|阴识]] - kinship candidate whose selection triggers the criterion.
- [[HuanRongEasternHan|桓荣]] - fellow crown-prince teacher whose appointment and reward show learning honored after role-fit selection.
