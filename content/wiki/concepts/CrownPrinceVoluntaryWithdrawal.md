...
tags: [succession, court-politics, royal-family, eastern-han, risk-management]
sources:
...
太子主动辞位自保 / Crown-prince voluntary withdrawal is the succession-risk pattern where an established heir repeatedly asks to leave the heir position and retire to a fief because remaining crown prince has become more dangerous than yielding the claim.
...
- Crown-prince status can become a liability when the maternal line supporting the heir loses standing.
- Repeated resignation can convert a likely displacement into a lower-violence settlement with moral language attached.
- The outgoing heir gains survival value, but the ruler also gains political cover for replacing an established successor.
- Voluntary withdrawal does not erase the institutional problem if the original heir has no grave fault.
- The settlement remains dependent on later family handling; Liu Qiang's loyal conduct and Mingdi's later kindness help keep grievance from becoming open conflict.
...
The concept is currently grounded in one source note and should not be generalized into a common succession rule. The source presents Liu Qiang's withdrawal as protective and morally legible, but it does not prove his private motive directly. It also keeps the institutional objection alive: a peaceful withdrawal can reduce violence while still normalizing dangerous heir replacement.
...
- [[MaternalStatusSuccessionLeverage|子以母贵式继承杠杆]] - upstream mechanism because Guo Shengtong's loss of status changes Liu Qiang's heir security.
- [[AccessionKinshipContainment|继位亲族安抚与隔离]] - downstream problem because displaced-heir grievance reappears at Mingdi's accession.
- [[RitualRenunciationPoliticalCapital|礼让辞封式政治资本]] - comparison for morally legible refusal of hereditary status, though Liu Qiang's crown-prince case is higher stakes.
- [[FavoriteDrivenHeirDisplacement|宠幸驱动的废嫡立庶]] - contrast because Liu Qiang cooperates with displacement pressure instead of being only passively replaced.
- [[KinshipProtocolBoundary|亲情名分边界]] - shared issue because family affection, heir hierarchy, and political distance have to be kept in workable form.
