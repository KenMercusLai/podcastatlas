...
tags: [court-politics, military-strategy, incentives, frontier, late-han]
sources:
...
军功归属错置 / command credit misattribution is the failure mode where campaign credit and blame are assigned from visible timing or final surrender reports rather than from the underlying plan, incentives, and sequence of action.
...
- Visible battlefield success can hide whether a commander followed the agreed plan.
- Personal penalty risk can push a cooperating commander to prioritize individual credit over campaign synchronization.
- A central court that sees only arrival order or surrender recipient can misread operational responsibility.
- Misattribution damages state capacity because it punishes the planner and rewards the timetable breaker.
- The pattern requires evidence of both the prior plan and the later reporting distortion; ordinary disagreement over merit is not enough.
...
- [[MeritBasedRewardPunishment|因功赏罚]] - broader reward-and-punishment standard that fails when credit is assigned to the wrong action.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - related institutional failure because the center's information does not preserve field reality.
- [[BattlefieldInformationControl|战场信息控制]] - adjacent military-information domain, though this case concerns internal reporting more than enemy deception.
- [[PoliticalCreditAppropriation|Political Credit Appropriation]] - contrast because credit is captured by a cooperating actor rather than reframed as ruler virtue.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - consequence field because punishing effective commanders weakens later governance and command selection.
