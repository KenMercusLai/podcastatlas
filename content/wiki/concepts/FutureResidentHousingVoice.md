...
# Future Resident Housing Voice

Future resident housing voice is [[DarylFairweather]]'s political-economy frame in [[live-anthropic-co-founder-on-ai-and-jobs]]: local housing decisions are often controlled by current residents, especially homeowners, while would-be residents, children, and future generations need homes but do not vote in today's neighborhood meetings.

The concept extends [[HousingAffordabilitySupplyMechanics]] by adding a representation problem. Housing scarcity is not only an engineering or construction issue; it is also produced when the people who benefit from more housing are absent from the process that decides whether homes can be built.
...
- [[HousingAffordabilitySupplyMechanics]] - broader supply frame.
- [[HousingRestrictionBackfire]] - adjacent rule-backfire concept.
