...
tags: [military-finance, corruption, late-han, warfare, logistics]
sources:
...
## Key Claims
- War spending can become a private extraction channel when pay, provisions, and accounting are weakly supervised.
- Theft from soldiers reduces actual combat capacity because armies need food, pay, and trust before tactics matter.
- Bribery lets corrupt commanders turn campaign funds into political protection.
- High cost alone does not prove state effort if the spending is captured before it becomes field capacity.
...
## Related Concepts
- [[CampaignFinanceAccessIncentive|军费通道利益驱动]] - broader access and incentive frame that can exist without proof of direct theft.
- [[BudgetedFrontierSuppression|预算化边疆清剿]] - contrasting military-planning frame where cost is made court-legible rather than stolen.
- [[FrontierAuxiliarySupplyFailure|边兵粮饷供应失灵]] - adjacent failure where unpaid or unfed auxiliaries become security risk.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - higher-level failure when corruption and its battlefield consequences do not produce reliable correction.
- [[LiangBingLateHan|梁并]] - contrasting frontier official whose trust-based surrender repairs the damaged field.
