...
tags: [legitimacy, regency, crisis, wang-mang]
sources:
...
以叛乱反证加权 / rebellion-justified power expansion is the pattern where a failed challenge to a powerholder is interpreted by that powerholder's court as evidence that the powerholder needs more formal authority, not less.
...
- Failed rebellion can be reframed as proof that a regent needs more authority to stabilize the realm.
- The mechanism depends on court interpretation, not on the rebel's original intent.
- Title language can move practical control closer to sovereignty before formal accession.
- Palace-space naming helps institutionalize temporary or acting power as a visible order.
- The pattern can reverse the meaning of resistance: the anti-usurper act accelerates the usurper's legitimacy project.
...
The source does not prove that Liu Chong's rebellion was staged by Wang Mang or that power expansion depended only on this event. It shows that Wang Mang's camp could use the event rhetorically inside an already advancing title project. The precise legal difference between "摄皇帝" and "假皇帝" remains source-scoped in this page.
...
- [[FirstAntiWangMangRising|刘氏反莽第一枪]] - triggering resistance event whose meaning is reversed by the court.
- [[MingqiLegitimacy|名器合法性]] - title and naming order through which practical power is formalized.
- [[PostUsurpationLegitimacyConsolidation|篡位后合法性整合]] - later consolidation field that follows this pre-accession title inflation.
- [[ControllableChildAccession|可控幼主继位]] - succession setup that leaves Wang Mang governing through a child heir while title authority grows.
- [[CrisisOpportunityConversion|危机机会转化]] - broader pattern where a crisis is turned into strategic advantage.
