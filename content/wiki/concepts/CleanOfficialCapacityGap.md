...
tags: [governance, personnel, capacity, eastern-han, official-selection]
sources:
...
清官能吏能力差 / clean official capacity gap is the governance problem where officials who are literarily polished or personally clean may still lack the practical ability to handle disorder, fraud, bandits, burdens, and local grievances.
...
- Literary skill can mask weak judgment or become a tool for deceptive reporting.
- Personal cleanliness does not guarantee competence under disorder.
- Effective office-holding requires diagnosis of causes, not only a reputation for virtue.
- Clean governance becomes capacity only when paired with personnel cleanup, burden reduction, and practical enforcement.
- Rulers weaken appointment quality when they select for polish or self-presentation instead of demonstrated governing ability.
...
The concept does not deny the value of clean officials or literate administration. It only rejects treating those traits as sufficient proxies for capacity. Later sources should test whether similar warnings apply to court scholars, local magistrates, military commanders, or anti-corruption officials under different pressure.
...
- [[ZongJunEasternHan|宗均]] - source actor whose warning defines the concept.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - broader governance frame because poor office fit weakens state capacity.
- [[RootCausePacification|查因安抚式治理]] - positive adjacent pattern because capable officials diagnose causes beneath visible disorder.
- [[MeritBasedRewardPunishment|因功赏罚]] - related personnel standard because actual service should matter more than reputation signals.
- [[OfficeFitOverRoteCleverness|适任胜过机巧]] - adjacent concept because cleverness or polish is not the same as office fit.
