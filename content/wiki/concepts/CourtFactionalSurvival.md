...
tags: [court-politics, factional-politics, survival-strategy, tang-dynasty]
sources:
...
Court factional survival is the practice of preserving safety and rank inside a volatile court by converting intimacy, document work, patronage, and fallback alliances into protection across shifting power centers.
...
- In volatile courts, personal relationships and official document work can become survival infrastructure.
- Factional survival often depends on reading succession momentum before it becomes public certainty.
- Hedging across factions can preserve options during uncertainty but create fatal ambiguity after a decisive coup.
- Gendered reputation intensifies the risk when intimacy is one of the available channels of access.
- Administrative competence does not guarantee safety when legitimacy politics turns binary.
...
The concept currently rests on one compact Tang episode. It should not be treated as a universal court-politics law without comparison to other cases. The source also blends historical narrative with interpretive judgment, so precise motives and causal weights should stay source-scoped.
...
- [[HistoricalFemaleRoleModelCaution|历史女性榜样化警惕]] - interpretive warning that explains why survival brilliance should not be romanticized.
- [[FemalePowerCenterPoliticalCapacity|权力中心女性政治能力]] - broader frame for women's agency near state power under risk.
- [[ShenlongCoup|神龙政变]] - transition that creates the need for renewed factional positioning.
- [[TanglongCoup|唐隆之变]] - decisive rupture where hedging fails.
- [[CourtWomenHistoriography|宫廷女性史学]] - related because document access and palace memory shape later interpretation.
