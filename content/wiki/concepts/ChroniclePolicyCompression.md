...
type: concept
tags: [historiography, institutions, governance, zizhi-tongjian]
sources:
...
Chronicle policy compression / 政策制度记载压缩 is the historiographical problem where a chronicle records a major institutional or policy change in a terse notice, leaving later readers with clear event placement but weak information about mechanism, implementation, and consequence.
...
- This concept should not be used to claim that all chronicle writing ignores institutions. It identifies a specific evidence pattern where one source preserves a decision but not enough mechanism.
- The host's contrast between people-centered and system-centered historical writing is preserved as source-scoped interpretation.
- The concept should prompt supplementary-source seeking rather than speculative reconstruction.
