...
type: concept
tags: [late-han, institutions, official-selection, governance]
sources: [zizhi-tongjian-hanji-906-lihai-de-ren-weishenme-xiangshou-chongtu-lvc3wedrifdzdu-yv1qhocl8uss2]
...
The concept is distinct from [[OfficialSelectionChannelCompetition|选官通道竞争]]. Selection-channel competition asks which route gets to feed appointments; Sanhu Law appointment constraint asks when exclusion rules, seniority rules, or conflict-avoidance rules become so broad that they prevent appointment at all. It also complements [[LocalOfficialTenureStability|地方官任期稳定]]: a local post needs both someone suitable enough to hold it and enough time for performance to be tested.
...
- [[OfficialSelectionChannelCompetition|选官通道竞争]], [[LocalOfficialTenureStability|地方官任期稳定]], and [[TalentAsStateTreasure|以贤臣为宝]] - adjacent personnel-capacity concepts.
- [[MeritBasedRewardPunishment|因功赏罚]] and [[CourtFeedbackCollapse|君臣反馈失灵]] - Sima Guang's broader framework for why regulation cannot substitute for fair use of people.
