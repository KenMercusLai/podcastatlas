...
type: concept
tags: [education, mentorship, talent, late-han, ethics]
sources:
...
Moral mentorship as talent cultivation / 人师型人才成全 is the teacher model where the mentor forms conduct and judgment, not only transfers knowledge. It joins careful reading of ordinary behavior, recognition of latent capacity, character testing, corrective trust after failure, encouragement toward study, and the teacher's own ability to accept limits and counsel.
...
- A teacher-model forms judgment and conduct, not only knowledge acquisition.
- Latent capacity can appear in ordinary behavior before credentials, rank, or occupation make it visible.
- Unplanned etiquette, topic choice, and family allocation can become character evidence when read carefully.
- Tests matter when they reveal steadiness under loss, pressure, or humiliation.
- Corrective mentorship treats fault as serious but not always final.
- A mentor's credibility depends partly on self-command, including knowing when office or public repair exceeds one's power.
- Talent judgment remains conditional and fallible when later conduct fails to sustain promise.
...
- [[SituationalCharacterTests|五观识人法]] - adjacent character-reading method that judges people through behavior under changing conditions.
- [[EliteEndorsementReputationMaking|名士背书式造势]] - adjacent reputation mechanism that explains how Guo Tai's mentor authority becomes publicly legible.
- [[TalentAttractionThroughRespect|礼贤下士式人才吸附]] - related talent ecology where respect makes worthy people willing to approach.
- [[HumaneLocalGovernance|仁厚地方治理]] - adjacent non-punitive correction pattern in official rather than teacher settings.
- [[QingyiReputationPressure|清议声誉压力]] - downstream reputation field that can amplify a recognized person's public standing.
- [[CrisisWithdrawalSelfProtection|危局抽身自保]] - boundary concept for Guo Tai's refusal to mistake teaching for saving a collapsing order.
- [[EmptyReputationRealityGap|空誉违实]] - qualification showing why talent recognition must remain tied to later conduct.
