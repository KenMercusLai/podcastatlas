...
tags: [late-han, punishment, humiliation, hair, status]
sources:
...
The concept sits beside broader hair politics but remains narrower. [[HairAsPoliticalIdentity|Hair As Political Identity]] covers hair as allegiance, rebellion, religion, or identity; punitive hair-removal humiliation names the coercive punishment branch where the point is degradation of the punished person's status.

## Key Claims

- Hair-removal punishment works because hair is a visible, socially meaningful part of the body rather than a private injury.
- In an honor-based elite setting, shaving can damage family dignity and public reputation even when it is less physically violent than mutilating punishments.
- The punishment can be politically useful because it marks the target before the community that grants status.
- When applied to scholar-officials, the humiliation attacks the credibility and composure that help sustain儒者 authority.
- The concept should be distinguished from voluntary hair practice, religious tonsure, fashion, or identity-signaling hair politics.
...
- [[HairAsPoliticalIdentity|Hair As Political Identity]] - broader field where hair carries public allegiance, identity, or degradation signals.
- [[RitualizedMinisterHumiliation|礼节化臣属羞辱]] - neighboring status-humiliation pattern using body presentation and court hierarchy.
- [[GreatCourageUnderHumiliation|忍辱大勇]] - contrastive concept where endured humiliation preserves future agency rather than simply degrading the target.
- [[PunishmentTheoryTradeoff|Punishment Theory Tradeoff]] - wider question of how punishment balances deterrence, retribution, order, and moral harm.
- [[HistoricalBodyConcept|Historical Body Concept]] - body-history frame that helps explain why hair can carry family, ritual, and political meaning.
