...
- [[AIComputePriceRisk]] - price and utilization volatility that can break financing assumptions.
- [[DataCenterDebtRisk]] - project-level risk if financed compute is underused.
- [[SupplierFinancing]] - vendor-credit structure that can either support productive assets or inflate demand.
- [[AIRevenueLegibility]] - independent customer revenue is the main test for underwriting quality.
- [[ProductiveBubbleSpillovers]] - qualification that financed booms can still leave useful infrastructure or innovations.
