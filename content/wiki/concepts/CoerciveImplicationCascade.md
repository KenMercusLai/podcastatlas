...
tags: [law, coercion, court-politics, evidence, eastern-han]
sources:
...
- Coercive implication cascades begin when fear makes accusation expansion politically safer than evidentiary restraint.
- Torture corrupts testimony because suspects can reduce immediate pain by naming others.
- Loyalty signaling worsens the failure: officials can prove zeal by treating more people as conspirators.
- Repair requires evidence tests outside the confession chain, such as appearance knowledge, concrete conduct, file review, or politically protected counsel.
- Partial correction after a cascade does not erase damage; it releases some people while leaving death, exile, and stigma already produced.
- Treason language is especially dangerous because rulers and officials can treat doubt as disloyalty.
...
- [[LiuYingChuKingEasternHan|刘英]] - case origin whose accusation and suicide begin the current cascade.
- [[YuYanEasternHan|虞延]] - early official casualty whose disbelief and suicide mark the case's opening pressure.
- [[CoercedConfessionTrap]] - adjacent coercion mechanism where confession becomes a product of custody and pain rather than reliable testimony.
- [[TreasonAccusationTrap]] - related high-stakes accusation field that makes evidentiary doubt politically dangerous.
- [[PalaceAccusationVerification]] - repair contrast because verification narrows accusation before punishment expands.
- [[CourtFeedbackCollapse]] - broader information failure where officials privately know injustice but fear correction.
- [[ReceptiveRemonstranceGovernance]] - partial repair path when warning and review change releases or commutations.
- [[LegalTruthEvidenceGap]] - wider legal principle that unsupported suspicion should not decide punishment.
