...
tags: [governance, bureaucracy, legitimacy, xin-dynasty, wang-mang]
sources:
...
篡位焦虑式行政瘫痪 / legitimacy-anxiety administrative paralysis is the governance failure in which a ruler who gained power through usurpation or personal seizure becomes so focused on preventing imitation that ordinary officials avoid initiative, decisions pile up, and supervision turns into procedural pressure rather than repair.
...
- A ruler who seized authority may become especially sensitive to rumors, omens, and subordinate initiative because each can look like the beginning of another seizure.
- Personal rule can weaken administration when every uncertain matter is made politically risky.
- Ritualized ordering and inspection can expand while concrete case handling and local governance deteriorate.
- Officials under high blame risk often prefer procedural obedience and inaction to problem-solving.
- The failure differs from mere laziness: avoidance is a rational response to a punitive and suspicious center.
...
This source does not prove Wang Mang's inner psychology independently; it provides the episode's interpretation of how usurpation memory shaped his conduct. The concept should be applied where legitimacy anxiety demonstrably changes administrative incentives, not to every centralized or ritual-heavy government.
...
- [[SecrecyDrivenAdministrativeBottleneck|密控式行政瓶颈]] - later adjacent Xin pattern where distrust routes decisions through hidden channels and personal approval loops.
- [[BureaucraticRiskAvoidance]] - broader organizational incentive pattern where avoiding blame can outrank solving the problem.
- [[DynasticLegitimacyBackfire|王朝合法性回旋镖]] - legitimacy background because Wang Mang's own route to power makes imitation threatening.
- [[RitualSpectacleCrisisDisplacement|仪式奇观式危机转移]] - related failure where ritual order projects control while practical disorder remains.
- [[InstitutionalOvercompliance]] - neighboring compliance pattern when officials follow rules past the point of useful judgment.
- [[WangMang|王莽]] - ruler whose 15 CE Xin court supplies the source case.
