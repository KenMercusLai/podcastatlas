...
tags: [western-han, ritual-politics, court-politics, status]
sources:
...
Banquet seating status politics is the mechanism where seating order at a formal meal becomes a public status declaration, so changing or accepting a seat can affirm, deny, or humiliate a contested political rank.
...
This case also shows why apparently minor protocol decisions can reorder personnel. Aidi lets Wang Mang withdraw while preserving honors, appoints [[ShiDanWesternHan|施丹]] as Da Sima, and does not let [[FuXiWesternHan|傅喜]] fill the role despite court support because Fu Taihou does not trust a kinsman who resists her line.

## Key Claims

- Formal seating can convert private or household status desire into a public rank claim.
- A seat beside a supreme dowager can imply equality or near-equality even before a title formula is formally settled.
- Correcting a seating arrangement can be interpreted as ritual defense by one side and political humiliation by another.
- Protocol conflict can become an office-changing event when it exposes which kinship group the ruler must appease.
- Banquet order belongs to broader [[LiAsPoliticalOrder|礼制政治秩序]] because spatial placement makes hierarchy legible.
...
- [[LiAsPoliticalOrder|礼制政治秩序]] - broader frame in which visible ritual arrangement preserves hierarchy.
- [[OuterRelativeCourtPower|外戚专权与清算]] - related pressure field because Fu Taihou's status demand is tied to consort-side power.
- [[BureaucraticAdverseSelection|官场逆淘汰]] - later personnel ecology anticipated by the episode's Fu Xi sidelining.
- [[ImperialConsortPosthumousTitleSystem|帝王后妃追尊体系]] - adjacent title-order field that the banquet visually previews.
