...
[[DirtyWorkDelegationStatecraft|脏活委托式君术 / dirty-work delegation statecraft]] is the pattern where a ruler or top leader uses morally compromised, pliable, or reputation-light agents to carry out coercive, gray-zone, flattering, or blame-bearing tasks that the center wants done but cannot openly own.
...
The episode's workplace translation is not that employees should become villains. It argues that leadership choices often reflect hidden demand: a person may be used because they solve a private, emotional, operational, or reputational problem, not because they are more virtuous. Mature judgment therefore asks what role a person is serving before reducing the situation to good people versus bad people.
...
- Loyal or virtuous actors may be less usable when they refuse gray tasks, keep principled distance, or threaten the ruler's security needs.
...
- [[UseStrengthsOverFaults]] - adjacent personnel logic where flaws may be tolerated only when role fit and limits are clear.
- [[BlameAbsorbingResponsibility]] - related responsibility pattern where visible fault can be carried by someone other than the leader.
- [[CourtTransitionBlameManagement]] - downstream pattern where removing a once-useful agent can manage public anger and regime legitimacy.
