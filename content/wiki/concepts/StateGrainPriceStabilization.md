...
tags: [economic-governance, grain-policy, price-stabilization]
sources:
...
State grain price stabilization / 国家粮价平准 is the governance logic of using public procurement, storage, and release of staple grain to reduce harmful price swings for both producers and consumers.
...
- Staple-food governance must consider both sides of price movement: cheap grain can injure producers, dear grain can injure consumers.
- Public storage makes price stabilization more than a price decree; the state needs physical grain to buy, hold, and release.
- Procurement geography matters because nearer purchases can lower transport labor and supply friction.
- The policy is partly fiscal and partly social: it manages official supply, famine risk, farmer income, and consumer access together.
...
- [[ChangpingGranarySystem]] - specific Western Han institution used as the current source case.
- [[PriceSignalResourceSteering]] - broader price-guided allocation concept that helps describe timed buying and selling.
- [[CommodityPriceExposure]] - contrast concept for unbuffered price volatility.
