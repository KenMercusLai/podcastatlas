...
This creates a practical split. Visitors may prefer "real" village ritual over theater versions, but making ritual visible to visitors can also change what is staged, timed, explained, or suppressed. The source's Yongning case therefore extends [[HeritageTourismCommercialization]] by asking whether the practice remains locally necessary after it becomes publicly consumable.

## Key Claims
- Heritage display can preserve visibility while weakening ritual function if key local mechanisms are removed.
- Tourism demand often values authenticity, but visitor attention can pressure locals to make ritual more legible, photogenic, or scheduled.
...
- [[LongTermPlaceOperation]] - place-operation version of slow, locally sustainable opening.
- [[ChineseFolkReligionLayering]] and [[LocalDeityGovernance]] - belief and local authority context.
