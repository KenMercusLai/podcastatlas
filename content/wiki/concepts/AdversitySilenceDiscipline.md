...
[[AdversitySilenceDiscipline|Adversity silence discipline]] is the Hanji 918 frame for deliberately reducing speech when events are adverse, unclear, or politically dangerous. It does not mean surrendering judgment; it means withholding complaint, argument, and uncontrolled disclosure until the situation can be reviewed and the next move can be chosen.
...
- [[PoliticalSurvivalFirst]] — silence preserves room to act when premature speech creates only exposure.
- [[CourtFeedbackCollapse]] — captured court environments make unbounded speech more dangerous because channels are monitored or recoded.
