...
tags: [governance, court-politics, royal-family, patronage, self-protection, eastern-han]
sources:
...
私人宾客网络风险 / private retainer network risk is the court-politics danger that private guest recruitment by princes, crown princes, or other high-status households can be read as faction-building, succession pressure, violent capacity, or disloyal association once suspicion rises.
...
The concept complements [[PrivateAccessTalentChannel|private access talent channel]] but looks from the other side. Access channels can surface talent, yet in an imperial household setting they can also create suspicion before any proven conspiracy exists.

## Key Claims

- Private recruitment by crown princes or royal princes is politically sensitive because it can look like faction formation or succession preparation.
- Guest networks can create real coercive capacity, not only reputational risk, when retainers are mobilized for private violence.
- Association risk is delayed: a tie may become incriminating only after a patron, intermediary, or related household falls.
- Punished-family or fallen-family background makes princely guest access especially easy to read as rebellion risk.
- Legal and protocol refusal can be practical self-protection when made before the network forms.
- Territorial distance, including sending princes back to fiefs, becomes a state response when guest networks have already become dangerous.
...
- [[MaYuanEasternHan|马援]] - warning figure who sees the prince-guest disaster before it arrives.
- [[WangSuEasternHan|王肃]] - source case whose princely-house access becomes accusation evidence.
- [[LiuLiShouguangMarquisEasternHan|寿光侯刘李]] - source case where guests are mobilized for private killing.
- [[LiuFuPeiKingEasternHan|沛王刘辅]] - royal prince whose favor relationship becomes politically exposed after guest-backed violence.
- [[ZhengZhongFrontierEasternHan|郑众]] - later source case whose refusal prevents implication.
- [[LiangSongLinxiangMarquis|梁松]] - intermediary and later fallen patron whose guests are implicated.
- [[PrivateAccessTalentChannel|私人进身通道]] - contrast relationship because access can surface talent or create dangerous factional proximity.
- [[KinshipProtocolBoundary|亲情名分边界]] - broader royal-family boundary concept that includes territorial distance and residence limits.
- [[RoyalKinTreasonLawBoundary|宗室谋逆法度边界]] - downstream royal-household risk where suspicion becomes a treason-law problem.
