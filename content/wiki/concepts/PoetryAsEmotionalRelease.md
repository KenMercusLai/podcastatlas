...
- Short-form release can be fragmentary rather than therapeutic: the value may be that a feeling is caught accurately, not that it is healed.

## Connections
- [[ChildPoeticExpression]] - child-language source of the emotional material.
- [[PoetryEducationAsPlay]] - relaxed method that makes hard feelings writable.
- [[AntiAuthoritarianEducation]] - poetry's permission for children not to be merely obedient.
