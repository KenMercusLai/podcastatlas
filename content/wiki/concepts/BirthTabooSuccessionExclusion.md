...
type: concept
tags: [family, succession, ritual, pre-qin-history, warring-states]
...
Birth taboo succession exclusion / 出生日禁忌与继承排斥 is the household-power pattern [[zizhi-tongjian-zhouji-40-5-yue-chusheng-de-haizi-re-shui-la-ll9e-thidxl5cqoacfrbz-ygw8-t]] introduces through [[Mengchangjun|孟尝君 / 田文]]. Before Tian Wen can become a famous Warring States figure, the episode presents him as a child whom [[TianYing|田婴]] does not want raised.
...
## Connections
- [[Mengchangjun|孟尝君 / 田文]] - source case.
- [[TianYing|田婴]] - father whose household power produces the exclusion.
- [[QiState|齐国]] and [[TianFamilyReplacementOfQi|田氏代齐]] - broader state and lineage setting.
- [[SuccessionNonDesignationRisk]], [[AutocraticSuccession]], and [[RitualSuccessionCrisis]] - adjacent succession-risk concepts.
