...
tags: [court-politics, power, merit, pre-qin-history, warring-states, late-han]
sources:
...
Post-restoration merit threat / 复国功臣威胁化 is the pattern where the person or group that saves, restores, or re-enthrones a political order becomes dangerous after victory because their visible credit, follower loyalty, reward rank, or internal leverage can compete with the restored authority.

## Current Synthesis

The original bounded case comes from Tian Dan after the recovery of [[QiState|齐国]]. [[zizhi-tongjian-zhouji-81-lishi-zaoqi-pua-jishi-lu-1-ljxbn4gznuohegzyee0-tudi9z-y|Zhouji 81 part 1]] shows [[TianDan|田单]] restoring lost cities, escorting [[QiXiangWang|齐襄王]] back to [[Linzi|临淄]], becoming chancellor, and retaining visible public trust. The same facts that make Tian Dan useful also make him frightening: mercy toward an old man can be read as buying hearts, recommending [[DiaoBo|刁伯]] can be read as building a network, and foreign respect for a recommended envoy can be read as shadow authority.
...
- Ruler-minister credit imbalance: [[zizhi-tongjian-zhouji-81-lishi-zaoqi-pua-jishi-lu-1-ljxbn4gznuohegzyee0-tudi9z-y|Zhouji 81 part 1]] shows Tian Dan's recovery of Qi and return of Qi Xiang Wang creating merit that exceeds normal office credit.
- Popular-care suspicion: [[zizhi-tongjian-zhouji-81-lishi-zaoqi-pua-jishi-lu-1-ljxbn4gznuohegzyee0-tudi9z-y|Zhouji 81 part 1]] shows Tian Dan's mercy toward an old man being reframed as buying hearts.
...
- Lethal Gengshi version: [[zizhi-tongjian-hanji-665-ta-busi-liuxiu-ye-nandang-huangdi-liauc3k3omnzqu09dqicxifjxy1t|汉纪 665]] says Liu Yan's prestige after Kunyang alarms Liu Xuan's court, and Zhu Wei and Li Yi urge Liu Xuan to bind and kill him quickly.
- Merit-bloc version: [[zizhi-tongjian-hanji-804-gei-ni-tang-de-ren-bu-yiding-shi-guiren-lqongdqg-hgetoegpylv-os86buh|汉纪 804]] shows Sun Cheng, Wang Kang, Wang Guo, and Miao Guang turning a successful restoration into a reward-ranking and list-manipulation problem.
- Mitigation through honors without office: [[zizhi-tongjian-hanji-715-shishang-zui-zhihui-de-yici-duoquan-loqkawl247maw9fn-nomaw5gzkgu|汉纪 715]] shows Liu Xiu recovering military authority after unification while rewarding meritorious commanders with title, fiefs, special access, and public honor.
- New-affiliate qualification: [[zizhi-tongjian-hanji-715-shishang-zui-zhihui-de-yici-duoquan-loqkawl247maw9fn-nomaw5gzkgu|汉纪 715]] shows [[DouRongEasternHan|Dou Rong]] trying to resign because high status above old followers creates exposure, while Liu Xiu keeps him integrated.

## Counterevidence & Qualifications

The concept does not claim that all restorers are eliminated or that rulers always act out of simple jealousy. Zhouji 81 shows suspicion, corrective remonstrance, and later self-censorship rather than a single linear purge. 汉纪 665 is the lethal branch, but its minor court actors and Liu Ji pretext remain source-scoped. 汉纪 804 shows Sun Cheng tolerating Wang Kang and Miao Guang rather than punishing them, so the late-Han branch is about managed internal risk more than immediate destruction. 汉纪 715 shows a comparatively stable settlement, but that result depends on Liu Xiu's trust relationships, material rewards, and the commanders' willingness to withdraw; it should not be generalized into a universal peaceful solution. The concept remains distinct from [[CoupCreditAllocationRisk|宫变功劳分配风险]], which is the narrower list-and-reward mechanism inside a coup merit group.

## What Changed

- Added 汉纪 665 as the lethal early-Gengshi branch where Liu Yan's visible restoration merit becomes execution risk.
- Added 汉纪 715 as a successful mitigation case in which Liu Xiu defuses founding-merit danger through honors, fiefs, and command withdrawal.
...
- [[CoupCreditAllocationRisk|宫变功劳分配风险]] - narrower mechanism where the reward list itself creates hierarchy, exposure, and leverage.
- [[PoliticalCreditAppropriation|善行君恩化]] - mitigation tactic that absorbs a subordinate's visible virtue into ruler authority.
- [[RitualizedMinisterHumiliation|礼节化臣属羞辱]] - hierarchy-restoring pressure that can follow overlarge ministerial credit.
- [[TreasonAccusationTrap|谋反指控陷阱]] - accusation pattern that turns merit, networks, and foreign respect into rebellion evidence.
