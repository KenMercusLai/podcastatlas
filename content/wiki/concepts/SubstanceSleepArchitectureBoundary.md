...
type: concept
tags: [sleep, alcohol, cannabis, health, medical-boundary]
sources:
...
## Definition
Substance sleep architecture boundary is the distinction between using alcohol or THC to become sedated and achieving sleep architecture that remains restorative across non-REM, slow-wave, and REM stages.

## Current Synthesis
The evidence does not deny that alcohol or THC can make some people fall asleep or stay asleep. Its claim is narrower and more important for the wiki: sleep onset is not the same as sleep quality. The sleep-toolkit source says sleep architecture after alcohol or THC is suboptimal compared with sleep without those substances, so routine reliance can hide a sleep-quality cost behind short-term sedation.
...
- Architecture boundary - [[essentials-sleep-toolkit-for-optimizing-sleep-sleep-wake-timing-scim6408620468]] says sleep architecture after alcohol or THC is suboptimal compared with sleep without them.
...
- [[SleepStageFunctionalArchitecture]] - stage-specific architecture affected by substances.
- [[SleepAsDailyHealthAccount]] - broader sleep-health account affected by substance-altered sleep.
- [[MemoryConsolidationWindows]] - learning branch that can be weakened when sleep architecture is disrupted.
- [[REMEmotionalMemorySeparation]] - REM branch that alcohol may disrupt.
