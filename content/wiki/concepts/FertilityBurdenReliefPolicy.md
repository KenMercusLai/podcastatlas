...
tags: [population-policy, fertility, state-capacity, eastern-han, governance]
sources:
...
生育负担减免政策 / fertility burden relief policy is the governance pattern where the state encourages childbirth by reducing the short-term economic burden on pregnant women, parents, or households, because population is treated as future tax base, labor supply, and military capacity.
...
- Premodern fertility policy can be state-capacity policy when rulers treat people as future fiscal, labor, and military resources.
- Relief can target pregnancy and early household burden, not only a post-birth reward.
- Grain support, tax exemption, and labor exemption work by lowering immediate family cost rather than by changing cultural preferences alone.
- The same mechanism can recur across dynasties while its exact rules remain source-specific.
- Fertility relief differs from coercive population control because its main lever in this source is material burden reduction.
...
- [[EmperorZhangOfHan|汉章帝]] - ruler whose 85 CE order creates the current bounded case.
- [[LocalGovernanceAsCare|地方治理作为照护]] - related because both patterns make household conditions visible as state responsibility.
- [[MalthusianTrap|Malthusian pressure]] - broader demographic-economic backdrop for why population and subsistence capacity matter in premodern governance.
- [[FertilitySubsidyLimits|生育补贴边界]] - modern comparison for why financial support can reduce burdens without guaranteeing fertility reversal.
- [[JapaneseFertilitySupportSystem|日本生育育儿支持体系]] - later welfare-state fertility-support system that should not be merged with this premodern mechanism.
