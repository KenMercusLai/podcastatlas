...
type: concept
tags: [memory, learning, cognition, study]
sources:
...
## Evidence
- Early timing heuristic - [[143-yiwang-de-naoli-jixing-buhao-ke-zha-zheng-a-869667634]] uses the Ebbinghaus forgetting curve to emphasize review in the first tens of minutes and first 24 hours.
- Selection and forgetting - [[143-yiwang-de-naoli-jixing-buhao-ke-zha-zheng-a-869667634]] frames memory as selective, emotional, repeated, sleep-influenced, and balanced by healthy forgetting.
- Sleep-cycle mechanism - [[yong-ai-rang-women-bianbenle-ma-s10e25-a6b360da-07f7-4d9e-ab1b-64a7130e9254]] links slow-wave sleep to hippocampal-cortical transfer and REM sleep to synaptic reinforcement.
- AI-learning boundary - [[yong-ai-rang-women-bianbenle-ma-s10e25-a6b360da-07f7-4d9e-ab1b-64a7130e9254]] argues that outsourcing search, recall, organization, and expression can remove practice needed for durable learning.
- Retrieval practice - [[your-top-health-questions-answered-scim2882548864]] presents self-testing, recall struggle, errors, correction, and later sleep or deep rest as central memory supports.
- Post-learning arousal tag - [[essentials-understand-improve-memory-using-science-based-tools-scim6024056343]] presents late-session, immediate-post-session, or roughly 5-to-15-minute post-learning adrenaline elevation as a possible way to strengthen retention.
- Acute versus chronic stress - [[essentials-understand-improve-memory-using-science-based-tools-scim6024056343]] distinguishes a sharp arousal increase from a calmer baseline from chronically elevated stress chemistry that can impair learning and health.
...
- [[SelfTestingMemoryPractice]] - Q&A branch centered on recall, mistakes, and correction.
- [[PostLearningArousalTagging]] - adrenaline-timing branch for tagging selected material soon after learning.
- [[DesirableDifficulty]] - learning principle where effortful retrieval can improve later transfer.
- [[LearningHowToLearn]] - broader study-method frame.
- [[FocusedDiffuseThinkingBalance]] - attention-rest alternation that supports integration.
- [[SleepAsDailyHealthAccount]] - sleep account that supplies biological recovery for consolidation.
- [[SleepStageFunctionalArchitecture]] - stage-specific architecture behind sleep consolidation.
