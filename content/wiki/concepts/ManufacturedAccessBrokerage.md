...
type: concept
tags: [patronage, court-politics, corruption, social-capital, late-han]
...
The episode's warning is practical rather than merely moral. Fake access may work long enough to produce office, but it does not produce the competence required by the office. Meng Tuo's later failure at [[ShuleKingdom|疏勒]] makes the brokerage a case of [[CourtOfficeCapture|朝廷开府任官失序]]: appointment authority moves through access performance while military ability remains untested.

## Key Claims

- A public deference signal can make bystanders believe an access relationship exists even before it does.
- Manufactured access turns other people's desire for brokerage into the broker's capital.
- Passing extracted gifts upward can convert an initially staged connection into real favor from the target powerholder.
- The mechanism can obtain office without proving role competence, creating downstream operational risk.
- The source's workplace lesson links the pattern to the danger of treating "connections" as a substitute for [[ExchangeableCapability|可交换能力]].
...
- [[PalaceAccessMonopoly|宫廷接触垄断]] - wider condition that makes access to Zhang Rang valuable enough to counterfeit.
