...
[[tech-20260106-0106-mp-tech-pod-128-tech-20260106-0106-mp-tech-pod-128]] adds [[AmyWebb]]'s forecast-oriented layer. The source treats embodied AI as part of [[AIConvergence]], with robots moving closer to everyday infrastructure through contextual physical understanding, warehouse package handling, and Nvidia-backed robotics systems rather than through near-term home "robot butlers."

[[tech-20260807-0807-mp-tech-pod-128-tech-20260807-0807-mp-tech-pod-128]] adds a data-labor layer through [[JoannaStern]]. The episode shows embodied AI depending on [[HouseholdRobotTrainingData]] from humans filming chores, where visible hand movement, everyday objects, and ordinary service work become training material before robots can reliably generate their own household experience.
...
[[147-he-mayi-lingbo-shenyujun-liao-jiqiren-yuansheng-jichu-moxing-danao-he-benti-de-guanxi-yuxunlian-yu-shuju-scale-up-laoshi-tangxiaoou-luxtyuafi-2onim15fw6lpypo2ga]] adds [[AntLingbo|蚂蚁灵波]] and [[ShenYujun|沈宇军]] as a robot-native foundation-model route. The source argues that embodied AI needs [[EmbodiedNativeFoundationModels]] designed around sensor noise, depth, spatial contactability, video time, action, and cross-embodiment data, while [[RobotDataScaleUp]] remains the missing condition for a robot GPT-1 moment.

[[173-duihua-yao-song-shenjian-dongfang-kongjian-zaichufa-tiancai-shaonian-shinian-hou-1-173-1]] adds [[YaoSong]] and [[StridingAI]] as a scene-grounded, full-stack physical-intelligence route. Yao agrees that model route matters, but argues that deployable embodied AI also needs scenario partners, remote systems, hardware design, software, cloud operation, data collection, and commercial milestones to move together.

[[ai-bu-zhi-bi-zhishang-waic-he-kimi-k3-toulule-shenme-xin-jingzheng-1]] adds the [[WAIC]] exhibition caution. The hosts say embodied-intelligence displays did not look dramatically more autonomous than the prior year, and relay a source-scoped attendee estimate that many companies in the embodied hall were still using teleoperation while only a small number showed autonomous task planning. The same source notes stronger domestic component substitution, so the synthesis is that supply-chain progress can move faster than general robot autonomy.
...
- Cross-embodiment robot-brain companies such as [[AntLingbo]], where value depends on a reusable model layer, real-machine and first-person data, many robot configurations, and the ability to turn physical-world feedback into model improvement.
- Full-stack physical-intelligence companies such as [[StridingAI]], where value depends on scenario access, vertical integration, honest autonomy demos, and technical milestones that can become paid service in retail or manufacturing scenes.
- WAIC-style embodied-intelligence exhibitors, where commercialization depends on separating component localization and polished demos from autonomous planning, real deployment, and customer value.
- Paid chore-footage collection, where commercialization depends on turning human first-person demonstrations into usable robot policy data without confusing the data marketplace with household robot readiness.
...
- [[AntLingbo]], [[ShenYujun]], [[EmbodiedNativeFoundationModels]], and [[RobotDataScaleUp]] — robot-native brain and data-scale route added by episode 147.
- [[YaoSong]], [[StridingAI]], [[PhysicalIntelligenceSystemStack]], [[MilestoneCommercialization]], and [[RobotDemoAuthenticity]] — full-stack physical-intelligence route added by episode 173.
- [[WAIC]], [[AIDemoDeploymentGap]], [[RobotTeleoperationAndRemoteTakeover]], and [[RobotDemoAuthenticity]] — exhibition-autonomy caution added by Keji Luandun.
- [[JoannaStern]], [[HouseholdRobotTrainingData]], [[AITrainerLabor]], and [[RobotDataScaleUp]] - human-recorded chore-data branch added by Marketplace Tech.
