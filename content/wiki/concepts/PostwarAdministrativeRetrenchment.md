...
tags: [governance, bureaucracy, postwar, eastern-han, state-capacity]
sources:
...
战后行政裁并 / postwar administrative retrenchment is the governance pattern of reducing counties, kingdoms, and official posts after war or population loss has made the inherited administrative footprint too large for the people it claims to serve.
...
- Administrative scale can become misaligned when postwar population loss leaves too many counties and official posts.
- Retrenchment needs local verification, because the unit of decision is whether a county or fief still supports separate senior administration.
- Cutting offices can reduce bureaucratic overhead, but it also concentrates more responsibility in the remaining officials.
- Retrenchment is incomplete without tenure stability, since fewer officials still need enough time to govern and be judged.
- The concept is a state-capacity repair only when office reduction serves public welfare rather than private extraction or symbolic austerity.
...
- [[LocalOfficialTenureStability|地方官任期稳定]] - complementary mechanism because remaining officials need enough time to show real results.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - retrenchment depends on assigning suitable officials to larger or consolidated responsibilities.
- [[PostwarReturnAndVeteranRelief|战后复员安民]] - adjacent postwar repair pattern focused on returning people and discharged soldiers rather than cutting offices.
- [[TemporaryFrontierRetrenchment|临时边防收缩]] - related retrenchment pattern where withdrawal preserves people and capacity under constrained conditions.
- [[AdministrativeStateDismantling|Administrative State Dismantling]] - contrast case because this concept concerns postwar scale alignment, not ideological control of modern agencies.
