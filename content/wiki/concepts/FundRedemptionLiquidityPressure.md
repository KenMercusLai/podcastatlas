...
Fund redemption liquidity pressure is the investment paradox in [[vol-126-gongmu-jijin-hai-zhide-mai-ma-lojrz1qctaqzkc2rg0lqokos-o6v]]: fund companies and fundholders are formally aligned around return, but open-ended redemption rights can make their time horizons diverge. The source's shorthand is that funds are often easy to sell when they are hard to manage, and easier to manage when investors no longer want to buy.

[[166-putongren-neng-cong-jigou-touzizhe-shenshang-xuedao-shenme-chuantai-touzi-abc-lpg8zl95kbvjvxsjr8cpb8ogkeg6]] adds the institutional-cost version. [[DavidWeng|大卫翁]] explains that large subscriptions and redemptions can force public-fund managers to reserve cash or adjust trades, making holder liquidity behavior a drag on investment efficiency.
...
- [[InvestmentLiquidityTradeoff]], [[FundLiabilityMatching]], and [[InvestmentRiskManagement]] - liquidity and risk-management concepts.
