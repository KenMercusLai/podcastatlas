...
type: concept
tags: [court-politics, reward, power, late-han, governance]
sources:
...
Unbounded elite reward demand / 受宠权臣的无餍封赏 is the court-politics pattern where an already overprivileged powerholder treats further honors as insufficient because reward expectation has detached from public merit, restraint, and ordinary satisfaction.
...
- Reward can lose its settling function when a powerholder's reference point is unlimited privilege rather than public merit.
- Ministerial restraint can reduce the reward package without correcting the underlying dependence on the powerholder.
- Exceptional etiquette and access are politically meaningful rewards, not secondary decoration after land or households.
- Dissatisfaction after extraordinary reward exposes a governance risk: the recipient now treats the state as owing recognition beyond defensible merit.
- The pattern differs from strategic greed performance because the appetite increases danger instead of making the actor look harmless.
...
- [[OuterRelativeCourtPower|外戚专权与清算]] - institutional setting in which Liang's kinship power makes extraordinary reward politically possible.
- [[MeritBasedRewardPunishment|因功赏罚]] - contrast principle because Liang's reward appetite is not grounded in visible public merit.
- [[RewardAllocationBacklash|分配反噬]] - related reward failure where distribution creates resentment; here the failure is the recipient's unbounded reference point.
- [[GreedPersonaSelfProtection|贪财人设式自保]] - contrast because performed greed can sometimes reduce perceived threat, while Liang's greed increases it.
- [[ImperialPrivateDesireGovernanceRisk|帝王私欲治理风险]] - adjacent risk where ruler-side desire or favor turns private appetite into public-order damage.
