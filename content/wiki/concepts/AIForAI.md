...
AI for AI is the source's umbrella for using AI to improve AI research, model design, training, and experimentation. In [[149-qinli-zhongmei-new-labs-ziben-kuangchao-he-qinghua-liuziming-liao-ai-for-ai-jizhi-kejieshixing-he-max-tegmark-lm33q4n6w8tzcd2fxdbuk9unc2xv]], [[LiuZiming|Liu Ziming]] treats it as the natural successor to AI for coding, but argues that research is much less structured than code because there is no GitHub-like corpus of complete experiment reasoning.
...
- [[OPHISResearchWorkflow]] is Liu's proposed first step for making research legible enough to train on.
...
- [[RecursiveSelfImprovement]] — stronger self-improvement loop that AI for AI may eventually feed.
