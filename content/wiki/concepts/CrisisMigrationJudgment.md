...
type: concept
tags: [statecraft, survival, migration, late-han, family]
...
This concept differs from [[EliteRelocationControl|豪杰迁徙控制]] and [[GuanzhongEliteRelocation|关中豪强迁徙]]. Those pages describe state-driven relocation to control or strengthen a region. Crisis migration judgment describes a non-state actor's own decision to move people, records, ritual objects, and family risk toward a safer or more usable political field.

## Key Claims

- Survival migration can be strategic judgment when the actor reads military geography and political shelter before danger is locally obvious.
- Family and clan responsibility can make a camp choice more consequential than ordinary career selection.
- Attachment to home place becomes risky when the underlying security conditions have already changed.
- The concept ties personal movement to [[XingshiqingStrategicAssessment|行势情战略评估]]: geography, timing, actor intention, and future protection all matter.
