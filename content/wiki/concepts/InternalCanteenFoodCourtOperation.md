...
## Key Claims
- Institutional canteens may fit food-court operators better than mature malls because demand is recurring and bounded.
- The model shifts the sales problem from footfall attraction to service reliability, compliance, and client relationship management.
- Enterprise and school canteens may value variety and management more than social-media scenes.
- The format is adjacent to hawker-centre shared infrastructure but governed by institutional contracts rather than open retail traffic.

## Connections
- [[FoodRepublic]], [[HawkerCentre]], and [[FoodCourtSecondLandlord]] - source model and capability lineage.
- [[MallFoodCourtDecline]] and [[CommercialRealEstateFoodserviceGap]] - reason the operator seeks new settings.
- [[ChainRestaurantStandardization]], [[RestaurantOperationalFragility]], and [[WorkplaceIncentiveDesign]] - operations and institutional-use contexts.
