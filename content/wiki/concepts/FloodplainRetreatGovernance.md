...
tags: [flood, hydraulic-governance, land-use, environmental-history, western-han]
sources:
...
[[FloodplainRetreatGovernance|洪泛区退让治理 / floodplain retreat governance]] is the governance pattern where authorities reduce flood risk by moving settlement and economic use out of river space rather than trying to hold every floodplain through ever-higher defenses.
...
- Floodplain retreat treats some land as river space rather than as safely recoverable human property.
- The strategy is hardest politically because it makes immediate losses visible while the avoided disasters remain future-facing.
- Repeated levee repair can become a lower policy when it preserves the land-use pattern that created the risk.
- Productive silt and floodplain fertility can lure communities back into exposure after quiet periods.
- Retreat governance needs fiscal and moral accounting because relocation protects the future by imposing costs on present residents.
- The concept is compatible with canals and sluices when those works reduce pressure rather than intensify the fight for land.
...
This concept currently rests on one source note and should not be generalized into a universal rule that retreat is always better than defense. The source does not settle the full feasibility, compensation mechanism, social legitimacy, or ecological consequences of Jia Rang's upper policy. It also preserves a middle strategy, suggesting that canalized diversion and irrigation can be useful when the full retreat strategy is unavailable.
...
- [[JiaRangWesternHan|贾让]] - named Western Han proposer whose upper policy defines the concept.
- [[YellowRiver|黄河]] - river whose floodplain conflict supplies the core case.
- [[FloodControlRiskTransfer]] - related risk-allocation pattern that Jia Rang identifies in competitive levee building.
- [[BianquHydraulicGovernance]] - complementary hydraulic-governance concept focused on expensive technical repair and construction under state capacity.
- [[WetlandAdaptation]] - adjacent environmental frame for living with water instead of treating all overflow as enemy territory.
- [[EnvironmentalTradeoffAccounting]] - broader cost-location frame for visible relocation losses and avoided future disasters.
