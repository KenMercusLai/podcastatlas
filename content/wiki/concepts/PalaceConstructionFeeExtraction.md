...
type: concept
tags: [late-han, corruption, taxation, court, office-sale]
...
- Court construction can become an extraction device when prestige projects are financed through surcharges, requisitions, and inspection manipulation rather than ordinary capacity.
- Intermediaries can profit even when the project itself stalls, because material rejection, underpricing, transport losses, and local resale all create side payments and forced losses.
- Appointment fees turn office into a debt position: administrators enter with costs they can recover only by taxing, fining, or otherwise exploiting the people.
- Clean officials are not merely personally disadvantaged; they become structurally incompatible with offices that presume fee recovery through extraction.
- The ruler may partially respond to extreme moral shock, as Emperor Ling does after Sima Zhi's memorial, without repairing the deeper appointment and palace-finance machinery.
- The pattern helps explain why post-Yellow-Turban disorder persists: public burden, court extraction, and armed local proliferation reinforce each other.
...
- [[OfficeSaleLegitimacyDamage|买官名节损耗]], [[CourtOfficeCapture|朝廷开府任官失序]], and [[MingqiLegitimacy|名器合法性]] - adjacent office-order and legitimacy concepts.
- [[UntimelyExtravagance|时绌举赢]], [[CourtFeedbackCollapse|君臣反馈失灵]], [[DeathDefyingRemonstrance|赴死式直谏]], and [[PeopleBasedPoliticalSecurity|民心政治安全]] - burden, feedback, and public-security frame.
