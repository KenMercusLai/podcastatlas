...
## Key Claims
- Coerced surrender can look brittle if it leaves no room for moral dissent.
- A loyal refusal can strengthen the victor's image when it is visibly tolerated rather than punished.
- The value of the refuser is symbolic more than military: Han Heng matters because his conduct makes Cao Cao's tolerance legible.
- Sparing the refuser helps separate the new hierarchy from the betrayer's coercion.
...
- [[MoralReputationPoliticalCapital|道德名望政治资本]] - related mechanism because Han Heng's moral posture becomes politically valuable.
- [[PoliticalSurrenderCascade|招降示范级联]] - broader surrender pattern that can be strengthened or weakened by how dissenters are treated.
- [[ForceBackedSurrenderPersuasion|武力背书式劝降]] - contrasting mechanism where coercion pushes surrender before legitimacy optics are settled.
- [[PeopleBasedPoliticalSecurity|民心型政治安全]] - related outcome because tolerating loyalty can reduce resentment after conquest.
