...
type: concept
tags: [strategy, court-politics, workplace, late-han, relationships]
sources:
...
Power-structure targeting / 权力结构定向求援 is the strategy of solving a blocked institutional problem by identifying the actor whose role, access, relationship, or legitimacy can actually change the decision, while accounting for timing, risk transfer, and who will bear the cost of intervention.
...
- Not all relationships are equally useful in a crisis; leverage depends on position, access, credibility, and decision proximity.
- Public protest can be morally expressive while still being weaker than a targeted channel when the decision-maker is insulated.
- A blocked case often requires changing who carries the argument, not only sharpening the argument itself.
- Effective intercession may be low-visibility: the connector can matter even when another actor signs the memorial.
- Timing and collateral risk constrain intervention; acting through others is not ethical if it merely transfers danger to people who cannot realistically change the outcome.
- Power-structure targeting remains ethically qualified because it can solve rescue problems but can also become access manipulation in other contexts.
...
This concept does not claim that only elite relationships matter or that public action is useless. It names source-bounded patterns where open pleading has become dangerous, a better-positioned intercessor can still move the case, and action must not merely displace risk. The same mechanism can become morally ambiguous when used for private brokerage, nepotism, accusation access, or blame transfer rather than rescue.
...
- [[InfanticideCustomCorrection|杀婴风俗纠偏]] - Jia Biao's local-governance branch, showing moral enforcement alongside strategic timing.
- [[PalaceProximityPower|宫廷近身权力]] - adjacent access mechanism where daily closeness shapes decisions before formal control is visible.
- [[PalaceAccessMonopoly|宫廷接触垄断]] - higher-risk version where controlled access becomes a durable political choke point.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - survival frame that explains why actors may prefer indirect, low-exposure channels.
- [[ObliqueRemonstranceSelfProtection|迂回进谏自保]] - speech-strategy neighbor that changes the angle of correction to reduce retaliation risk.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - failure condition that makes targeted channel selection more important because ordinary correction no longer converts into action.
