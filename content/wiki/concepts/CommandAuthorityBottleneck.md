...
tags: [military, state-capacity, command, bureaucracy]
sources:
...
将权掣肘 / command authority bottleneck is the military failure mode in which the center sends commanders into a fast-moving field while withholding the discretion, symbols of authority, or decision rights needed for timely action.
...
- Withheld symbols or decision rights can make a general formally responsible but operationally weak.
...
- [[YanYouXinGeneral|严尤]] - source actor who articulates the bottleneck.
- [[TianKuangXinOfficial|田邝]] - source actor whose unauthorized mobilization temporarily bypasses the bottleneck.
- [[XinDynasty|新朝]] - regime whose anti-rebel command design illustrates the pattern.
- [[KeyOperatorRemovalRisk|关键执行者移除风险]] - related failure when a successful field bypass is destroyed by recall.
