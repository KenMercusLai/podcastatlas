...
sources: [vol-114-ai-de-2025-he-deepseek-men-de-weilai-duitan-fudan-zhangqi-jiaoshou-lhvhnvqtvuv4ln-cckcpedgldolo, tsr-ycoffsite-jakeheller-audioonly-v1final-tsr-ycoffsite-jakeheller-audioonly-v1final, 263-sora-si-le-adobe-die-le-meitu-he-qu-he-cong-lgjmyveooc8wpzr0yviggvzvdyfs, yige-ai-chuangshiren-de-xurongxin-zhuang-he-yumei-zhidian-duitan-invoko-ai-chuangshiren-mengqi-lsi79o-z19zplvmqdbpzzneogpk3f]
...
[[tsr-ycoffsite-jakeheller-audioonly-v1final-tsr-ycoffsite-jakeheller-audioonly-v1final]] adds a legal-workflow case through [[Casetext]] and [[CoCounsel|Co-Counsel]]. [[JakeHeller]] says the breakthrough was not simply that [[GPT4|GPT-4]] wrote better text, but that the company could test it against legal research, document review, contract drafting, and other customer-requested workflows. That makes the product a [[FrontierModelInflectionPivot]] example where domain context and customer memory turned a frontier model into a vertical product.

[[vol-114-ai-de-2025-he-deepseek-men-de-weilai-duitan-fudan-zhangqi-jiaoshou-lhvhnvqtvuv4ln-cckcpedgldolo]] adds [[ScenarioSpecificAI]] as a sharper unit of analysis. [[ZhangQi|张奇]] says AI's core is the scene rather than the broad industry: [[Cursor]] is strong because it is optimized for coding, [[Perplexity]] is strong because it is optimized for search, and even one domain may require different products for beginners and experts.
...
- [[Casetext]], [[CoCounsel|Co-Counsel]], [[JakeHeller]], and [[HumanInTheLoopLegalAI]] - legal workflow AI case added by The Social Radars.
- [[ScenarioSpecificAI]], [[ZhangQi|张奇]], [[Cursor]], [[Perplexity]], and [[ModelWorkflowFit]] — vol.114's scene-first product lesson.
