...
tags: [court-politics, power, alliance, succession, late-han]
sources:
...
Power monopoly backfire / 一家独大式权力反噬 is the court-politics pattern where a winning faction tries to keep all rewards, offices, and security for itself after a transition, but by excluding allies and threatening remaining powerholders it turns a short-term victory into a wider counter-coalition risk.
...
The concept is related to alliance fragility but narrower. It names the moment after a faction has already won a transition and chooses monopoly over settlement. The result is not only moral criticism; it is strategic exposure, because threatened survivors can become more willing to gamble on reversal.

## Key Claims

- A transition winner can create new enemies by treating every old ally or adjacent powerholder as a disposable threat.
- Monopoly is especially risky when the winning faction concentrates offices inside one household or kin group.
- Purging former collaborators signals to remaining actors that compliance may not protect them.
- A controllable child ruler can help a faction monopolize power but also makes the private-control motive more visible.
- The pattern turns a short-term succession victory into a broader counter-mobilization risk.
...
- [[OuterRelativeCourtPower|外戚专权与清算]] - broader kin-power structure in which the Yan-family monopoly attempt belongs.
- [[SuccessionLegitimacyPurge|继位合法性清洗]] - cleanup mechanism that can express monopoly after accession.
- [[ControllableChildAccession|可控幼主继位]] - succession method that makes behind-the-throne control easier for a monopoly-seeking faction.
- [[InterestStructuredAllianceFragility|利益结构式联盟脆弱性]] - broader alliance mechanism where shared interests dissolve once payoffs change.
- [[PalaceCoupSymbolControl|宫廷政变中的符印与门户控制]] - downstream operational route by which threatened actors can reverse a monopoly attempt.
