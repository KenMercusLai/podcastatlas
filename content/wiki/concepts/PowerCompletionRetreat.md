...
tags: [statecraft, merit, self-protection, eastern-han, founding]
sources:
...
- [[MeritConcealmentSelfProtection|藏功避祸]] - adjacent practice of reducing displayed merit to avoid harm.
- [[FoundingCommanderSuspicionManagement|建国将领消疑]] - earlier-stage trust pattern that makes continued command politically possible.
- [[HonorsWithoutOfficeSettlement|受爵不受官式功臣安置]] - ruler-side settlement that preserves honor while removing command authority.
