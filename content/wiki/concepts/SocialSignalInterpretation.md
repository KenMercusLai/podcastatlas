...
## Connections
- [[Maidisen]] — narrator whose missed signals define the source case.
- [[CommunicationBoundarySetting]] — interpreting signals still has to respect consent, comfort, and context.
- [[WorkplaceHiddenRules]] — workplace social signals are another class of implicit norms.
- [[HumanJudgmentUnderAI]] — adjacent idea that situated judgment cannot be reduced to a static checklist.
