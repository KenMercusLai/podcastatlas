...
tags: [governance, personnel, western-han, leadership]
sources:
...
Effect-measured personnel selection is the governance principle that senior appointments should test whether a candidate actually handles affairs well, rather than relying only on reputation, family background, moral image, or factional convenience.
...
The episode's modern-management reading extends this beyond Han court offices: leaders who select only by image or factional utility may miss the quiet operators who prevent problems and solve actual work.

## Key Claims

- Reputation is useful evidence but not enough for high office.
- Family standing and moral image need to be tested against actual administrative results.
- Quiet problem-prevention can be a strong personnel signal even when it produces little spectacle.
- Recommendation quality improves when it names the candidate's concrete handling of affairs.
- The principle is especially important for offices where failure creates broad public or frontier risk.
...
The concept is based on one episode's personnel-reading and should not erase other selection criteria. Reputation, virtue, family trust, and political acceptability can still matter; the claim is that they should not substitute for evidence of actual work capacity when office risk is high.
...
- [[UseStrengthsOverFaults|用人取长弃短]] - related talent-selection frame that emphasizes proportionate judgment of flaws.
- [[TalentVirtueDistinction|才德之分]] - broader distinction between ability and moral direction.
- [[MeritBasedRewardPunishment|因功赏罚]] - adjacent principle requiring visible reward or appointment standards to follow real service.
- [[PreventiveFrontierGovernance|治未病式边疆治理]] - frontier case where practical effect is visible as prevented crisis.
