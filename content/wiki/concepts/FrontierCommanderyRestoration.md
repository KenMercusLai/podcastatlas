...
tags: [frontier, governance, commanderies, state-capacity, eastern-han]
sources:
...
边郡恢复治理 / Frontier commandery restoration is the strategy of reoccupying and administratively restoring abandoned frontier commanderies when their land, logistics, and defensive position make abandonment more costly than repair.
...
- Restoration can begin as a security-and-recognition argument before offices, walls, and return migration are implemented.
- Restoring a frontier commandery can be cheaper and safer than leaving strategic terrain empty.
- Restoration can depend on a protected frontier settlement or alliance that makes civilian return survivable.
- Repair requires wall work, return migration, and food support as well as formal administrative decision.
- Land fertility, pasture, irrigation, transport, and defense have to be judged together.
- Abandoned commanderies can expose core zones such as Chang'an and imperial tombs.
- The policy requires people to return, not only a paper restoration of offices.
...
- [[TuntianSystem|屯田制度]] - adjacent settlement-logistics tool often paired with frontier restoration.
- [[LiuXiu|光武帝刘秀]] - ruler whose regret over earlier relocation leads to border resident return, wall repair, and grain support.
- [[GengGuoEasternHan|耿国]] - adviser who links Southern Xiongnu acceptance to future border-commandery restoration.
- [[HuhanyeChanyuBi|呼韩邪单于比]] - submitted claimant whose bloc becomes the security premise for restoration.
- [[SouthernXiongnu|南匈奴]] - protected frontier partner whose settlement helps make northern border restoration possible.
- [[FrontierTrustThroughProtection|保护换信任式边疆安抚]] - upstream protection pattern that can create conditions for civilian return.
- [[TuntianProximitySecurityDilemma|屯田贴近引发安全困境]] - contrasting risk where settlement placement creates threat perception.
- [[TaxationStabilityTradeoff|税赋与地方稳定权衡]] - related frontier governance tradeoff where administrative gains can trigger higher stability costs.
- [[FrontierConscriptionBackfire|边疆征发反噬]] - adjacent overextraction risk at the frontier.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - Shun accepts the restoration because an official's specific diagnosis matches the frontier problem.
