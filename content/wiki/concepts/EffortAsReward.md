...
## Definition
Effort as reward is the episode's motivation principle that the effort process itself can become rewarding, making persistence less dependent on external prizes, praise, final outcomes, or stacked dopamine inputs.
...
- External rewards can reduce later intrinsic motivation for an activity that was already valued.
...
- [[MotivationRewardEffortCalculation]] - action-selection frame that weighs reward against effort.
- [[DopaminePeakTroughBaseline]] - dopamine dynamics explaining why outcome-only rewards and stacking can backfire.
