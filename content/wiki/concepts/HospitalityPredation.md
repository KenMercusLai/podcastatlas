...
type: concept
tags: [trust, betrayal, violence, late-han, risk]
...
Hospitality predation extends [[TrustAsMoralRisk]] and [[PoliticalSurvivalFirst|安全第一政治生存]] into a darker boundary condition. Trust can be politically necessary, but the receiving side must ask whether the guest is inside any shared constraint strong enough to make reciprocity plausible.

## Key Claims
- Reception creates access, and access can be weaponized by actors who do not observe ordinary reciprocal limits.
- Repeated betrayal is stronger evidence than a single suspicious act; Ze Rong's pattern spans three hosts or partners.
- Moral performance and social dependence do not prove trustworthiness when behavior shows no constraint.
