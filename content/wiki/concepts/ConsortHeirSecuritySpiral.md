...
tags: [court-politics, succession, palace-scandal, western-han]
sources:
...
Consort heir security spiral / 后宫子嗣安全螺旋 is the pattern where a favored consort's status depends on producing or controlling heirs, making childlessness, rival pregnancies, ruler indulgence, and palace silence escalate into political danger.
...
- Childlessness can make a favored consort's formal status fragile even after promotion to empress or zhaoyi.
- A rival pregnancy can threaten not only affection but family rank, future protection, and factional access.
- Ruler indulgence can turn private misconduct into a court-wide silence problem.
- Alleged sexual misconduct and alleged reproductive violence need different evidence standards; scandalous narration should not substitute for verification.
- The pattern can later feed gendered blame narratives when succession fails.
...
- [[GenderedConsortScapegoating|红颜祸水式替罪叙事]] - later memory risk when succession failure is collapsed onto favored women.
- [[PalaceAccusationVerification|宫廷指控核验]] - evidence discipline needed when palace accusations involve hidden conduct and coercive power.
- [[PoliticalCaseEvidenceSkepticism|政治案件证据怀疑]] - later Zhao-sister materials require source criticism rather than simple scandal repetition.
- [[SecretImperialInfantSuppression|秘密皇子压制]] - later alleged mechanism for removing inconvenient heirs.
- [[PalaceMarriageFamilyMobility|后宫婚姻式家族跃迁]] - related status path because consort rank can become family mobility.
