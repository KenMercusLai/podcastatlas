...
[[119-anlesi-xianchang-zhengyin-shengming-ruci-zhengui-770771087]] adds the explicit policy and clinical version. The episode refuses to decide that pain relief automatically justifies euthanasia or that moral concern automatically requires endurance; instead, it follows cases where unbearable pain, dementia fear, psychiatric suffering, doctor responsibility, family grief, and possible treatment recovery all stay in conflict.
...
- Assisted-death cases add that pain can be real and unbearable while still requiring questions about prognosis, competence, alternatives, social pressure, and who takes responsibility for the final act.

## Connections
- [[CanticleForLeibowitz|《莱博维茨的赞歌》 / A Canticle for Leibowitz]] - source case.
- [[CivilizationalSelfDestructionCycle]] - war and nuclear catastrophe create the suffering under debate.
...
- [[EndOfLifeAutonomyAndDignity]], [[AssistedDeathClinicalResponsibility]], and [[EuthanasiaUncertaintyStance]] - explicit assisted-death extension from episode 119.
