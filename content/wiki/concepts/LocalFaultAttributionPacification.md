...
tags: [statecraft, local-governance, rebellion, eastern-han, pacification]
sources:
...
Local fault attribution pacification / 归咎安抚式平叛 is a pacification pattern where a commander identifies a local official's misconduct or failure as the immediate cause of revolt, punishes that official, and reassures the community instead of treating all rebels as targets for immediate assault.
...
- Not every local revolt should be read first as a military target.
- A commander's first diagnostic question can be whether state agents caused the immediate disorder.
- Punishing the responsible official can make reassurance credible.
- Refusing premature attack can preserve people, property, and future obedience.
- This pattern still relies on authority and coercive capacity; it is not passive tolerance of rebellion.
...
This is a one-source concept and should not be generalized into a rule that all revolts are caused by local officials or can be settled without force. The Gexian case works because Wu Han has enough authority to punish the acting county head and enough military credibility that restraint is not read as weakness.
...
- [[WuHanEasternHan|吴汉]] - commander whose Gexian decision grounds the pattern.
- [[RootCausePacification|查因安抚式治理]] - broader diagnostic pacification frame where causes of disorder guide response.
- [[HumaneLocalGovernance|仁厚地方治理]] - adjacent local-governance pattern where restraint and credibility restore order.
- [[LocalGovernanceAsCare|地方治理即照料]] - related because administrative response is treated as civic repair, not only enforcement.
- [[NoSmallMattersInGovernance|治无小乱无大]] - related because local-official failure can become public disorder.
