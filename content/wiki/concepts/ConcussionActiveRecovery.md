...
## Definition
Concussion active recovery is the source's head-injury frame that medical evaluation, reduced metabolic strain, and staged return to activity have replaced prolonged dark-room rest as the default recovery model.

## Current Synthesis
Wood treats significant head injury as a medical-evaluation problem first. Scans, red-flag assessment, and clinician guidance come before supplements or return-to-play decisions. Once acute danger is addressed, the episode emphasizes avoiding additional metabolic stress and reintroducing activity below symptom-worsening thresholds.
...
- Metabolic-strain boundary - [[accelerate-learning-increase-cognitive-capacity-dr-tommy-wood-scim4201272551]] warns about hyperthermia, alcohol, high refined carbohydrate load, and caffeine caution after injury.
...
- [[ContextDependentBiomedicalInterventions]] - evidence-quality neighbor for intervention claims.
- [[BrainHealthNutrientSufficiency]] - nutrition and supplement branch that requires extra caution after injury.
