...
## Key Claims
- Captured goods can function as evidence when the enemy audience doubts verbal reports about a commander or relief force.
- Official symbols such as seals, staffs, and axes are especially powerful because they represent command legitimacy as well as material loss.
- Personal clothing and belongings add a bodily, immediate signal that the absent commander has fled rather than merely repositioned.
- Spoils proof works best after an expected rescue has failed, when defenders are already dependent on outside hope.
...
- [[BattlefieldEncirclementLogistics|战场围困与断粮]] - siege and encirclement pressure that makes proof of outside failure matter.
- [[ReturningArmyInterdictionRisk|归师勿遏式追击风险]] - upstream judgment that identifies when Yuan Shang's relief force can be attacked.
- [[PoliticalSurrenderCascade|招降示范级联]] - adjacent morale pattern where visible outcomes alter later surrender decisions.
- [[YeLateHan|邺城]] - campaign setting where the spoils proof is directed at remaining defenders.
