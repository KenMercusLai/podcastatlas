...
type: concept
tags: [ethics, self-cultivation, duty, late-han, governance]
sources:
...
尽责问心无愧 / Conscience Through Duty is the source-scoped ethic that a person should judge life and office by honest self-knowledge, effort, and fulfilled responsibility rather than by guaranteed success, status, or comfort.
...
- Conscience is tied to clear self-knowledge rather than inflated fantasy about one's resources or capacity.
- Effort matters because durable focus can exceed the default drift of people who stop learning.
- The ethic does not promise victory; it asks whether the actor did what responsibility required under known constraints.
- Public duty can make conscience costly when the action threatens powerful interests.
- Zhu Mu's case turns the idea from private motivation into an officeholding problem.
...
- [[ScholarOfficialPublicDuty|士大夫公共责任]] - public-office version of fulfilling responsibility despite cost.
- [[GoodIntentionsPoliticalLimits|Good Intentions Political Limits]] - qualification that moral correctness may not move a hostile institution.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - neighboring survival frame that can conflict with pure duty performance.
- [[PublicDutyOverPrivateGrievance|对事不对人式公义]] - related discipline of letting public obligation govern action.
- [[DeathDefyingRemonstrance|赴死式直谏]] - more extreme speech-risk form of conscience-driven duty.
