...
揣摩 / Chuaimo technique is the persuader method [[zizhi-tongjian-zhouji-30-suqin-de-kaigua-rensheng-lkmn-fruukdxgkddx7zb4lc3o9bw]] says [[SuQin|苏秦]] reaches after deep reading [[YinfuJing|《阴符》]]. The episode explains it as a double reading: one must understand the external political situation and also read the listener's motives, fears, and likely response.

The concept belongs inside [[ZonghengjiaDiplomacy|纵横家外交]] rather than ordinary book learning. Su Qin's later itinerary shows why: even after gaining the method, he fails with [[ZhouXianwang|周显王]], [[YingSi|秦惠文王]], and [[ZhaoState|赵国]] before finding the right match between argument, audience, and state interest in [[YanState|燕国]].

The episode also links chuaimo to [[Guiguzi|鬼谷子]] because the received Guiguzi text contains chapters titled "揣" and "摩." Here the point is not simply that Guiguzi taught Su Qin, but that effective persuasion requires calibration between a state's objective position and a ruler's subjective sense of danger.
...
- In 汉纪 158, chuaimo becomes defection persuasion: the envoy reads delay, fear, body language, and the arrival of a rival envoy to decide when to switch from argument to commitment pressure.
...
- [[SuiHe|随何]], [[YingBu|英布]], [[JiujiangChuHan|九江国]], [[InterestReframingPersuasion|利益重构式说服]], and [[IrreversibleDefectionBinding|断路式策反绑定]] - 汉纪 158 delay-reading, reaction-reading, and forced public commitment.
