...
type: concept
tags: [ai, companions, grief, authenticity, relationships]
sources:
...
## Key Claims
- Authenticity is not binary: a companion can be fake as representation while real as emotional experience.
- This makes consent and provenance important, but not sufficient; users may still respond strongly even when they know the system is synthetic.
...
- Emotional-authenticity split: [[suanli-kuangxiangqu-wo-zai-ai-gongchang-de-qiyu-lorijulltfhttspka22jnn4qjf-i]] asks whether the simulated voice being fake cancels the reality of the user's tears.
...
- [[DigitalMemorialization]] - memory and consent context for generated representations of absent people.
- [[AIFriendProducts]] - product category where companion authenticity becomes practically relevant.
- [[AICompanionAttentionRisk]] - risk that emotional realism and availability become attention capture.
- [[SycophanticAICompanionRisk]] - risk that always-validating companions distort relationship expectations.
- [[HumanConnectionUnderAI]] - broader question of how human connection changes when AI can provide convincing emotional response.
- [[RelationshipTechnologyEthics]] - intimate-relationship branch added by the perfect AI partner scenario.
