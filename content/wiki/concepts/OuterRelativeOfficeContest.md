...
tags: [western-han, court-politics, outer-relatives, succession]
sources:
...
Outer-relative office contest is the succession-crisis mechanism where ministers try to prevent imperial in-laws from controlling a top military or administrative office by recommending non-outer-relative balancing candidates, but the attempt can fail when senior dowager authority and majority court opinion favor the kin bloc.
...
The concept therefore captures both insight and exposure. Correctly diagnosing outer-relative risk does not protect the diagnosticians if the new power center wins; the failed balancing attempt becomes a remembered act of resistance.

## Key Claims

- A succession vacancy makes top-office control especially consequential because new ruler selection and administrative channels are still fluid.
- Ministers may diagnose outer-relative dominance by analogy to earlier consort-kin precedents.
- Mutual recommendation can be a procedural balancing strategy rather than a direct coup attempt.
- Senior dowager authority can override balancing proposals when the favored candidate is her kin.
- Failed balancing can become later exposure because it records who resisted the new center before it consolidated.
...
- [[OuterRelativeCourtPower|外戚专权与清算]] - broader danger field that He Wu and Gongsun Lu are trying to prevent.
- [[SuccessionLegitimacyPurge|继位合法性清洗]] - downstream cleanup risk after the office contest is lost.
- [[ControllableChildAccession|可控幼主继位]] - related because top-office control shapes who can manage the new child heir.
- [[DelegatedRegencyCapture|摄政委权式权力俘获]] - later mechanism by which Wang Mang converts senior authority into routine control.
