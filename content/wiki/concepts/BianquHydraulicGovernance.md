...
tags: [governance, hydraulic-engineering, public-works, state-capacity, eastern-han]
sources:
...
[[BianquHydraulicGovernance|汴渠水利治理 / Bianqu hydraulic governance]] is the state-capacity pattern where a court converts chronic river and canal disorder into public order through technically directed water policy, including expensive works, canals, sluices, embankments, and sometimes retreat from land that should remain river space.
...
- Hydraulic governance succeeds only when technical design, labor mobilization, fiscal capacity, and political timing line up.
- Hydraulic governance may require retreat from floodplain land before construction can solve the right problem.
- Deferred public works can be prudent when society is too exhausted to carry the burden.
- Prosperity can turn a chronic infrastructure problem from impossible into governable.
- Water-control success is still a tradeoff because saving fees within a project does not erase large public cost, and levee repair can become lower policy when it protects a land-use pattern that keeps reproducing flood risk.
- Inspection and visible completion help make infrastructure legible as rule, not only as engineering.
- The concept is about productive water control, distinct from using water as a siege weapon.
...
- [[JiaRangWesternHan|贾让]] - Western Han policy thinker whose three strategies add the retreat-versus-repair hierarchy.
- [[FloodplainRetreatGovernance|洪泛区退让治理]] - complementary upper-policy frame where giving river space outranks repeated embankment repair.
- [[WangJingBianquEasternHan|王景]] - named technical executor of the later Bianqu project.
- [[FloodControlRiskTransfer]] - related risk-allocation pattern visible in competitive levee building.
- [[InfrastructureLaborBurden]] - shared constraint because visible infrastructure depends on hidden labor and operating strain.
- [[InfeasiblePublicWorksCancellation|不可行公共工程叫停]] - contrast concept where canceling a canal project is the capacity-preserving choice.
- [[DisasterResponseStateCapacity]] - broader state-capacity frame for turning hazard response into timely material protection.
- [[AppointmentQualityAsStateCapacity|任官适任性国家能力]] - related personnel frame because the project depends on choosing officials with the right technical fit.
- [[HydraulicSiegeWarfare|水攻围城]] - contrast use of water control as coercive battlefield pressure rather than productive public works.
