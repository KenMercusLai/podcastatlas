...
tags: [politics, statecraft, risk, timing, han]
sources:
...
Tactical delay risk transfer / 延时转责式政治化解 is a political maneuver that turns a dangerous immediate act into a defensible slower process, preserving obedience in form while preventing irreversible exposure until the authority structure or facts change.
...
- In lethal or purge-prone politics, delaying an irreversible act can preserve agency without open defiance.
- The tactic works only when delay has an operational wrapper, such as custody, transport, mission travel, or reporting.
- Risk is transferred away from the subordinate's immediate hands and back toward higher authority, changed timing, or altered public facts.
- The maneuver can protect life, office, or reputation by preventing premature finality.
- Delay becomes irresponsible when it lacks a concrete process or when the actor merely avoids duty without changing the risk structure.
...
The concept should not be generalized into a blanket defense of delay. Both evidence cases involve concrete administrative form and a real risk diagnosis. Simple procrastination, refusal to decide, or delay that leaves others exposed without changing the risk structure does not meet the pattern.
...
- [[PoliticalSurvivalFirst|安全第一政治生存]] - broader survival discipline behind both Chen Ping and Li He's timing choices.
- [[OuterRoundInnerSquareConduct|外圆内方式处世]] - related conduct pattern because Li He preserves inner judgment through flexible outward action.
- [[PatronSuccessionExposure|靠山更替暴露风险]] - adjacent danger where timing changes the meaning of association.
- [[PowerExitTrap|权力退场困境]] - related field where acting too early can trap an actor under a fading power.
- [[CovertPoliticalTechnology|阴谋式政治技术]] - neighboring Chen Ping frame for non-obvious political operations.
