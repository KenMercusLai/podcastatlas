---
title: "女性起义称王 / Female Rebel Sovereignty"
type: concept
knowledge_schema: synthesis-v1
tags: [statecraft, rebellion, gender, sovereignty, eastern-han, jiaozhi]
sources:
...
Female rebel sovereignty / 女性起义称王 is the pattern where a woman in a frontier or local crisis moves beyond protest, household leadership, or symbolic grievance and claims ruler-level political authority through rebellion.
...
- The concept requires an explicit ruler-level claim, not only female participation in rebellion.
- Zheng Ce's case combines gender exceptionality with frontier administrative breakdown.
- Zheng Er's role keeps the event sister-led even though Zheng Ce is the named sovereign.
- The claim depends on coalition response from multiple southern regions, not only Miling grievance.
- Suppression by Ma Yuan limits the political durability of the sovereignty claim without erasing its significance.
...
- Created the concept from the Zheng Ce/Zheng Er branch.
- Bounded the claim to ruler-level rebellion rather than general female political influence.

## Related Concepts

- [[ZhengCeJiaozhi|征侧]] - primary current case of a woman claiming kingship through revolt.
