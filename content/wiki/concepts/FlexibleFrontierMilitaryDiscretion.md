...
tags: [frontier, military, governance, eastern-han, state-capacity]
sources:
...
弹性边防军法 / flexible frontier military discretion is the governing pattern where a ruler keeps frontier discipline but allows commanders and local officials to adjust defense, pursuit, and punishment to troop capacity and enemy conditions instead of applying severe delay law mechanically.
...
- Frontier law can become counterproductive when commanders fear punishment more than they read terrain, troop strength, or enemy movement.
- Capacity-aware defense is treated as legitimate when troops are insufficient.
- Pursuit distance should follow enemy conditions rather than a fixed rule applied without context.
- The concept keeps discipline and flexibility together; it is not a permission structure for passivity.
- It complements local judgment cases such as Ma Yuan's refusal to close gates or mobilize troops after an unfounded Qiang alarm.
...
The source does not prove a formal law code revision or a general abolition of military punishment. It supports a narrower edict-level principle: border officials should not let fear of "逗留法" produce tactically unsound pursuit or unnecessary mobilization.
...
- [[LiuXiu|光武帝刘秀]] - ruler whose edict anchors the concept.
- [[MaYuanEasternHan|马援]] - local frontier commander whose Wudu judgment shows the same practical discretion at commandery level.
- [[HorsehideBurialResolve|马革裹尸式边将生死观]] - complementary ethos because courage still needs disciplined judgment.
- [[CapacityBoundFrontierCommitment|能力约束下的边疆承诺]] - broader frontier principle that state promises and military actions must fit actual capacity.
- [[FieldDiscretionPacification|临场裁量式安抚]] - related discretionary pattern where field actors resolve order without mechanical adherence to formal procedure.
