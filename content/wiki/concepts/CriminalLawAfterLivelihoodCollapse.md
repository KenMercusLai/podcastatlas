...
tags: [law, governance, livelihood, punishment, western-han]
sources:
...
- [[PopularSufferingGovernanceDiagnostic|民困治理诊断]] - upstream diagnosis that identifies why punishment alone cannot work.
- [[CriminalLawAsPowerLimitation|刑法作为权力限制]] - broader legal frame that treats punishment power as needing restraint.
- [[PenalSeverityExecutionTradeoff|刑法轻重与执行困境]] - adjacent punishment-design problem.
- [[FiscalExtractionRebellionSpiral|财政压榨叛乱螺旋]] - later pattern where extraction turns pressure into flight and armed disorder.
