...
宫廷宠幸自持 / Palace Favor Self-Restraint is the pattern where a favored inner-court figure preserves value and safety by refusing excessive intimacy signals, offering corrective counsel, and managing rivalry so favor does not become public impropriety or zero-sum isolation.
...
- [[PowerEtiquetteReading|权力礼仪细读]] - method for reading carriage-sharing refusal as political etiquette rather than only private emotion.
- [[MotiveBasedFalseAccusationDefense|动机反证式辩诬]] - later Ban Jieyu defensive pattern after palace favor turns into accusation exposure.
