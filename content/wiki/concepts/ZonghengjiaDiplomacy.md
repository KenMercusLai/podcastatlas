...
纵横家外交 / Zonghengjia diplomacy is the coming Warring States mode that [[zizhi-tongjian-zhouji-28-hanzhaohou-de-kuaile-ni-xiangxiang-budao-ln2tbxniz4kvwogbwp32exmdokz8]] says [[ZizhiTongjian|《资治通鉴》]] is preparing through the arrival of [[SuQin|苏秦]] and [[ZhangYiStrategist|张仪]]. The concept names a shift in narrative weight: persuasion, alliance design, threat framing, and status rhetoric start to matter as much as terse succession and battle notices.

[[zizhi-tongjian-zhouji-29-suqin-lizhi-shuangwen-zhishi-gaibian-mingyun-lrf5cqvoriyep2lkbozju-lyjaxv]] develops the threshold while keeping the chronology doubtful. In the chronicle's placement, Su Qin appears as leader of [[HezongAlliance|合纵]] and as "six-state minister"; the host questions whether such coordination could happen suddenly in the source's 333 BCE setting. The concept therefore includes both the diplomatic phenomenon and the need to separate later legendary drama from exact annalistic placement.
...
[[zizhi-tongjian-zhouji-33-lishi-diyi-shuangwen-nanzhujiao-suqin-lvebjyhvzctjgaevwwoddpvg9nr0]] adds the afterlife of that diplomacy. Su Qin's speeches become idioms, his alliance success becomes a [[QianjuHougongReversal|前倨后恭]] social-mobility scene, and the claimed fifteen-year Qin pause at [[HanguPass|函谷关]] becomes a source-critical test. Zonghengjia diplomacy therefore travels into language and reputation, not only treaties.

[[zizhi-tongjian-zhouji-34-qinguo-zongli-ruhe-wanzhuan-liuguo-lsenzwp0kr5wscb0btvuzmkibriq]] shifts the center from Su Qin's hezong success to Qin-side disruption and Zhang Yi's rise. [[GongsunYan|犀首公孙衍]] helps fracture the alliance environment, while [[ZhangYiStrategist|张仪]] uses [[StrategicConcessionDiplomacy|欲擒故纵式让利外交]] around [[PuyangWarringStates|蒲阳]] and [[Shangjun|上郡]] to make Qin's pressure look like generosity before it becomes territorial gain.
...
[[zizhi-tongjian-zhouji-51-chuhuaiwang-qin-xiao-er-kan-jiujiu-ruhe-mie-le-ni-ltfkdlivomnvux5xodh2rlfqf6ac]] adds the court-capture and after-action version. Zhang Yi's success depends partly on prior bribery and the exclusion of [[QuYuan|屈原]], so persuasion is supported by control over which advisers can reach the ruler. After the deception is exposed, the same diplomatic field continues through Chu Huaiwang's angry war, [[DanyangBattle|丹阳之战]], and [[LantianBattle|蓝田之战]], showing that zonghengjia work includes managing the target's response after humiliation.

[[zizhi-tongjian-zhouji-53-qinhuiwang-yong-zhangyi-huan-dipi-lvmo2cwbafcg2gnxliuo18fewimk]] adds the hostage-court survival version. Zhang Yi's craft includes a prepared relationship with a Chu favorite who can reach [[ZhengXiu|郑袖]], a palace incentive frame around [[Shangyong|上庸]], and a post-release speech that reorders [[ChuHuaiwang|楚怀王]]'s choices through Qin, Han, Wei, Ba-Shu, and Wuguan pressure. The episode therefore makes zonghengjia diplomacy social and physical as well as rhetorical: the persuader must survive the room before his argument can work.

[[zizhi-tongjian-zhouji-54-wo-zun-ni-shi-wang-ni-dang-wo-shi-pi-lvhcz0ban9frlmwshd9vch-q7-ie]] adds the serial-roadshow version. Zhang Yi moves from [[HanState|韩国]] to [[QiState|齐国]], [[ZhaoState|赵国]], and [[YanState|燕国]], changing the same Qin-facing argument by audience: Han hears its weakness, Qi hears its isolation, and Zhao first hears praise before the threat map closes around it. The episode also shows that diplomatic craft does not end with successful persuasion, because [[YingSi|秦惠文王]]'s death exposes Zhang Yi to [[PatronSuccessionExposure|靠山更替暴露风险]].

[[zizhi-tongjian-zhouji-55-zhangyi-tongshi-guiren-qinhuiwang-lsclfbwn06fgzooipf5up9sdkedy]] adds the labor-and-exit version. The host's route calculation turns Zhang Yi's 311 BCE mission into months of physical travel through multiple courts, intelligence settings, and ruler-specific audiences. The same episode also shows that zonghengjia success has an afterlife: once the patron dies, Zhang Yi must use [[SelfPreservationAsStateStrategy|以自保包装国策]] and disclosed-plot logic to secure a final court.
...
- Zhouji 51 adds that zonghengjia success includes shaping which advisers are allowed near the ruler before the decisive persuasion arrives, and managing the target's response after humiliation.
- Zhouji 53 adds that zonghengjia craft includes hostile-court survival: backchannels, palace incentives, envoy norms, and geography can be as important as the formal speech.
...
- [[QuYuan|屈原]], [[QuGai|屈匄]], [[DanyangBattle|丹阳之战]], [[LantianBattle|蓝田之战]], and [[AngerDrivenWarDecision|忿兵决策]] - Zhouji 51 court-capture and anger-war consequence branch.
- [[ZhengXiu|郑袖]], [[Qianzhong|黔中]], [[Shangyong|上庸]], [[CourtBackchannelSurvival|宫廷后门自救]], [[MinisterAsExchangeableAsset|可交换功臣]], and [[EnvoyKillingTaboo|不斩来使]] - Zhouji 53 survival and land-person exchange branch.
