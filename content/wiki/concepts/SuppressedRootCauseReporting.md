...
tags: [governance, crisis, information, rebellion, xin-dynasty]
sources:
...
Suppressed root-cause reporting / 根因上报压制 is the governance failure in which a ruler forbids or punishes explanations that connect disorder to policy, poverty, official abuse, or administrative failure, forcing officials to report only morally convenient causes.
...
- A ruler can destroy crisis feedback by criminalizing the causal explanation that would make repair possible.
- Moralizing rebellion as pure wickedness can protect ruler legitimacy while worsening the field problem.
- Once officials learn that root-cause reporting is dangerous, underreporting and flattery become rational.
- Suppression of root-cause reporting blocks pacification because hunger, trust, and local abuse cannot be repaired if they cannot be named.
- The pattern often pairs with scapegoating: one official can be punished while the structural diagnosis is rejected.
...
The concept does not claim all rebels in the source were harmless or only hungry. The episode also describes armed expansion, defeats of official forces, looting, and growing disorder. The bounded claim is that Wang Mang's refusal to hear poverty, official failure, and underreporting as causes made policy repair less likely.
...
- [[RootCausePacification|查因安抚式治理]] - contrast because root-cause pacification depends on naming the causes this pattern suppresses.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - broader feedback failure into which the pattern fits.
- [[CrisisInformationBlockade|危机信息封锁]] - related information failure, though here the ruler actively forbids a causal frame rather than only being shielded from facts.
- [[WangMang|王莽]] - source ruler who criminalizes hunger-based explanations.
- [[GongsunLuXinOfficial|公孙禄]] - diagnostic actor punished for naming internal causes.
