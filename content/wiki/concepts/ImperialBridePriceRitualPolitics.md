...
tags: [western-han, imperial-marriage, ritual-politics, kinship, legitimacy]
sources:
...
皇后聘礼礼制政治 / Imperial bride-price ritual politics is the pattern where imperial marriage payments, selection rites, divination, ancestral notification, public refusal, and redistribution turn marriage wealth into dynastic legitimacy and political reputation.
...
- Imperial marriage is made legitimate through public procedure, divination, and ancestral notification rather than private household agreement alone.
- A large bride-price marks the empress role as dynastic status, not ordinary household exchange.
- Refusing part of the payment can turn receipt of wealth into a visible humility performance.
- Redistributing accepted payment converts marriage wealth into kinship capital and reputation for generosity.
- The same marriage event can tighten outer-relative power when the bride's natal family is already politically central.
- The concept is strongest when payment, ritual, clan distribution, and court authority appear in one sequence.
...
The concept currently rests on one Western Han episode note and should not be generalized to all Chinese bride-price practice without more sources. The exact purchasing power of the bride-price, the historical conversion, the full ritual wording, and Wang Mang's private motives remain source-scoped. The episode's modern "天价彩礼" opening is an analogy, not evidence that ancient imperial bride-price and modern marriage payments have the same social structure.
...
- [[EmpressSelectionRitualLegitimacy]] - imperial bride-price follows empress selection procedure and makes the chosen role publicly legible.
- [[LiAsPoliticalOrder]] - divination, ancestral notification, and regulated exchange make marriage part of ritual order.
- [[PublicRefusalStatusInflation]] - Wang Mang's partial acceptance anticipates later refusal loops that increase status.
- [[RitualRenunciationPoliticalCapital]] - refusal and humility convert material benefit into political credit.
- [[KinshipResourceStateBuilding]] - redistributed bride-price strengthens natal-clan relations and political support.
- [[OuterRelativeCourtPower]] - the bride's family gains or consolidates court leverage through imperial marriage.
