...
tags: [military-strategy, logistics, eastern-han, guangwu, civilian-protection]
sources:
...
Scorched-earth supply denial / 坚壁清野式断粮 is a military logistics pattern in which a commander sends forces ahead of an enemy to make local communities fortify, remove accessible supplies, and deny plunderable food, so that an enemy dependent on movement and looting collapses without requiring a decisive frontal battle.
...
- Supply denial becomes decisive when the enemy depends on plunder or local food during movement.
- The tactic requires speed ahead of the enemy, not only static fortification behind one's own army.
- Civilian defensive preparation is part of the military mechanism, because settlements must deny resources without being overrun.
- The point is not indiscriminate destruction; in this source, the focus is denying enemy access while protecting local stores and people inside fortified positions.
- Command value appears when a ruler accepts subordinate logistics advice after a recent defeat.
...
- [[ChenJunEasternHan|陈俊]] - commander whose advice grounds the concept.
- [[LiuXiu|刘秀]] - ruler who adopts the tactic after recovering from a serious defeat.
- [[BattlefieldEncirclementLogistics|战场围困与断粮]] - broader logistics pattern that also makes food access decisive in battle.
- [[FortifiedAttritionPatience|坚壁耗敌式耐心]] - adjacent patience pattern; this concept is narrower because it uses forward resource denial against a moving enemy.
- [[ResourceAsymmetryAttrition|资源不对称消耗战]] - related attrition frame focused on making the opponent's limiting resource decide the contest.
- [[BattlefieldInformationControl|战场信息控制]] - adjacent battlefield pattern because local denial changes what the enemy can assume about easy plunder and movement.
