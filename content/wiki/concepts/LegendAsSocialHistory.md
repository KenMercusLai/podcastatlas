...
Legend as social history is the frame added by [[111-huayi-modishou-kuailai-he-lishixuejia-yiqi-tuili-tonghua-zhenxiang-751190766]] for reading [[PiedPiperOfHamelin|花衣魔笛手]]. A legend differs from a free-floating fairy tale because it claims a place, time, witnesses, local traces, or documentary hints; but that does not mean it can be reduced to one literal event.
...
- [[EvidenceBoundFolkloreInquiry]] - method for handling legend evidence.
- [[FolkloreTraumaEncoding]] - emotional and historical-memory function of legends.
