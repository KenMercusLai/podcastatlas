...
tags: [court-politics, household-governance, impeachment, late-han, eastern-han]
sources:
...
Household Misconduct Political Liability is the pattern where family, guests, dependents, or domestic disorder become actionable political evidence against a public figure or high-status household, especially when moral reputation, patronage loss, and impeachment channels converge.
...
- Elite household governance can become part of public-office legitimacy when family disorder signals failure of order close to the official.
- Guests, dependents, spouses, children, and younger relatives can create liability even when the senior figure is personally reputable or cautious.
- Domestic scandal is politically powerful because it supplies concrete, narratable evidence to enemies, inspectors, or rulers.
- Moral reputation and old patronage are partial defenses, not immunity, once household conduct becomes visible.
- The pattern is especially dangerous in courts already prone to slander because concrete household facts give accusation a less abstract handle.
- Household liability can operate through both formal impeachment and informal imperial disapproval before punishment.
...
- [[MoralReputationPoliticalCapital]] - contrasts with this concept because reputation creates a defense resource while household scandal creates actionable liability.
- [[PatronageLossSelfProtection|失去靠山后的低调自保]] - upstream discipline that tries to prevent household display from becoming liability after protection disappears.
- [[AnonymousSlanderRetaliation]] - differs from this concept because household liability depends on concrete conduct even when courts also host fabricated accusation.
- [[CourtFeedbackCollapse]] - related because a court can hear loyal defense yet still act on later scandal when feedback protections are weak.
- [[PersonalTrustPoliticalFragility]] - related because private relational structure can alter public political risk.
- [[RuleOverKinshipPower]] - related because household and kinship order shape political accountability.
