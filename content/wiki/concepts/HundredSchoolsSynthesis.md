...
tags: [history, china, philosophy, governance, intellectual-history]
sources:
...
Hundred Schools synthesis / 诸子九流综合观 is the view that rival schools of thought arose from fractured political conditions and each preserved a partial insight that could be studied, corrected, and incorporated into governance under a wiser ordering center.
...
- The nine schools are explained historically, as products of political fragmentation after royal order weakens.
- Each school is treated as partial rather than wholly false.
- The framework keeps a Confucian and Six Classics center while still allowing selective use of non-Confucian traditions.
- The source's quoted "same destination, different roads" frame supports synthesis across intellectual difference.
- The concept turns philosophical classification into a practical theory of talent and policy use.
...
The source presents Liu Xin's synthesis sympathetically but not as neutral intellectual history. Its Six Classics-centered hierarchy can flatten differences among schools by treating them as branches or late offshoots of a Confucian-centered order. The episode does not test this model against sources from the non-Confucian schools themselves.
...
- [[BibliographicClassificationAsStatecraft|目录分类作为治国术]] - broader cataloging pattern that contains the nine-schools synthesis.
- [[ConfucianIdealGovernance|儒家理想治理]] - normative center that the source uses to evaluate and absorb other schools.
- [[LiAsPoliticalOrder|礼制政治秩序]] - ritual-political order behind the court-centered synthesis.
- [[YinYangFivePhasesPoliticalTheory|阴阳五行政治理论]] - one intellectual stream in the nine-schools field.
