...
tags: [governance, accountability, deterrence, court-politics, eastern-han]
sources:
...
Known-misconduct non-punishment is the deterrence failure that occurs when a ruler clearly discovers protected wrongdoing but stops at anger, rebuke, or restitution without establishing a legal consequence.
...
The concept is therefore a negative contrast to [[StrategicForbearanceGovernance|strategic forbearance governance]]. Forbearance can preserve trust, cooperation, or speech when the other side still has a usable path. Known-misconduct non-punishment preserves a protected actor's impunity after the fact, so the lesson becomes weaker deterrence rather than wiser restraint.

## Key Claims

- Discovery alone does not deter future misconduct if the discovered actor sees that consequences stop at rebuke.
- Restitution can repair the immediate victim's loss while still failing to mark the offense publicly enough.
- Protected kin or palace-connected actors make the pattern especially dangerous because ordinary officials already expect uneven enforcement.
- The ruler's private anger may even clarify the offense without making law credible.
- The pattern differs from mercy after judgment because the legal boundary is never established first.
...
- [[LegalJudgmentBeforeImperialGrace|先法度后恩宥]] - contrast because law-first mercy establishes the boundary before grace, while this pattern skips legal judgment.
- [[HighStatusLawEnforcementSignal|高位执法信号]] - contrast because public sanction against protected actors can make rules credible.
- [[RuleOverKinshipPower|法度压过亲缘特权]] - related governing principle that this case fails to satisfy.
- [[WeakAuthorityLeadership|弱势领导威信]] - adjacent leadership failure where a superior cannot make judgment operational through reward and punishment.
- [[CourtFeedbackCollapse|君臣反馈失灵]] - broader institutional consequence when correction or discovery does not convert into repair.
- [[StrategicForbearanceGovernance|退让留余地式治理]] - boundary contrast because not every restraint from punishment is strategic forbearance.
- [[PointingDeerAsHorse|指鹿为马]] - historical comparison Zhangdi uses to name the seriousness of Dou's truth suppression.
