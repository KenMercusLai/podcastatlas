...
- A formal judicial summons can carry an informal death expectation, converting procedure into coercion without requiring an explicit imperial order to commit suicide.
- Even before suicide is explicitly expected, Tingwei transfer can be politically lethal because custody itself marks guilt, humiliates senior officials, and gives enemies control over procedure.
- Ruler misunderstanding of legal-procedural meaning can be exploited by insiders who know the real consequence.
...
- Living through the summons can make the unofficial norm visible, but it does not make the formal process fair.
