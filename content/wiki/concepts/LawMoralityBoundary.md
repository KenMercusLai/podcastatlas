...
The source distinguishes positive moralism from negative moralism. It rejects criminalizing behavior merely because morality disapproves, but allows moral and factual context to matter when deciding whether a person should be excused, especially through the idea that law should not demand what cannot reasonably be expected.

[[102-jianghu-congtan-pianshu-heihua-he-minjian-daoyi-736516488]] gives the boundary an informal counterpart. In [[InformalJianghuOrder]], rules can carry moral language such as 义气 but still be driven by livelihood, secrecy, and bargaining power rather than public legal principle.
...
[[sp-04-liuqing-linyao-qiangsha-yibao-jutou-an-beihou-de-sikao-shang-guanyu-mincui-sixing-he-sixing-790230209]] adds a vigilante-justice and death-penalty boundary. Sympathy for the [[LuigiCaseSuspect|Luigi]] case can reveal moral disgust at [[USHealthInsuranceDenialPolitics]], but the source argues that disgust cannot by itself authorize private killing or make state execution self-evidently just.
...
- A legal right should have a moral foundation; a written entitlement is not automatically a real right if it protects domination.
...
- [[HanFei|Han Fei / 韩非]] and [[ShangYang|Shang Yang / 商鞅]] - Legalist contrast used by the source.
- [[PrivateRevengeModernLaw]] - existing wiki page where 情, 法, 私, and 公 already conflict.
- [[JudicialIndependencePublicOpinion]] - institutional risk when feeling or moral discretion pressures courts.
