...
tags: [statecraft, frontier, alliance, eastern-han, self-preservation]
sources:
...
Regional Self-Preservation Alliance / 区域自保联盟 is a collapse-period pattern in which local power-holders consolidate geography, offices, troops, elite agreement, and mutual rescue into a defensive regional order while waiting for a clearer sovereign alignment.
...
- Regional self-preservation begins with a defensible base rather than an abstract claim to sovereignty.
- Local elite consensus matters because commandery officials must accept a shared emergency hierarchy.
- Defensive alliance-building uses both governance and military readiness; people, grain, roads, ferries, cavalry, and beacon systems all matter.
- The pattern can remain provisional: the regional bloc survives while postponing final attachment to a higher sovereign.
- The source's Dou Rong case is a positive instance, but it does not prove that all self-preservation coalitions become durable or legitimate.
...
- [[DouRongEasternHan|窦融]] - principal case because his Hexi choice supplies the current evidence base.
- [[LiangTongEasternHan|梁统]] - allied commandery official who participates in the Hexi compact.
- [[SecurityForAuthorityExchange|交权换安全]] - downstream settlement pattern once a regional holder trades authority for household and regional security.
- [[LightTouchFrontierGovernance|宽简边疆治理]] - governance neighbor because regional self-preservation depends on routine order as much as on armies.
- [[XingshiqingStrategicAssessment|行势情战略评估]] - broader condition-reading frame because the bloc begins with judging terrain, troops, timing, and claimant uncertainty.
- [[CoalitionSelfPreservationFailure|联盟自保失灵]] - negative contrast because some coalitions fail when shared survival interests cannot discipline local actors.
- [[FrontierCommanderyRestoration|边郡恢复治理]] - later frontier policy neighbor because stabilizing commandery structures is part of restoring state capacity.
