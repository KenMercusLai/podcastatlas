...
type: concept
tags: [confucianism, text-standardization, late-han, education, institutions]
...
The episode also makes the stone classics a fragility marker. Seven years later, [[DongZhuo|董卓]]'s destruction of [[LuoyangLateHan|洛阳]] and the abandonment of Taixue damage the project, so a state attempt to stabilize classical authority is soon overtaken by the very political collapse it was meant to answer.

## Key Claims
- The Xiping Stone Classics are an official text-standardization project, not only a calligraphy or epigraphy anecdote.
- In a manuscript culture, public stone inscription can reduce copying and interpretation drift by giving students a stable comparison text.
- The project shows [[Taixue|太学]] as a public institutional site for classical authority before later episodes make Taixue a selection-channel rival to [[HongduMenxue|鸿都门学]].
- The political purpose is source-scoped: the episode reads the project as an attempt to reinforce loyal and filial order amid rebellions, not as proof that textual standardization alone can repair state failure.
