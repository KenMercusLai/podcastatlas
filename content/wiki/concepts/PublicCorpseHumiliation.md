...
type: concept
tags: [politics, violence, memory, revenge, late-han]
sources:
...
Public corpse humiliation is the use of a dead body as political or revenge communication. Because the dead can no longer be deterred, the violence works on witnesses, kin, students, retainers, and memory: a body is displayed, mutilated, lit, exposed, or denied normal mourning so that the victor can claim total moral reversal.
...
- Humiliation of the dead tries to control witnesses and memory rather than the dead person, and state-ordered corpse piles can intensify that message by placing dead enemies on public routes.
...
- [[FuneraryDefianceUnderPoliticalTerror|恐怖政治下的丧葬抗命]] - counter-pattern where mourning and burial duty reclaim the displayed body.
- [[RetaliatoryPoliticalTerror|报复性政治恐怖]] - coercive environment that makes public body display a warning to survivors.
...
- [[ZhaiYiRebellion|翟义起义]] - rebellion whose suppressed bodies become Wang Mang's roadside intimidation objects.
