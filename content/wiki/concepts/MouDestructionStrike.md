...
tags: [military-strategy, psychological-warfare, surrender, eastern-han]
sources:
...
A mou-destruction strike is the military-strategy pattern in which an attacker targets the opponent's planning center, key adviser, or governing confidence so resistance collapses before the attacker has to win by prolonged siege or general assault.
...
- "伐谋" can mean attacking the enemy's planning capacity, not merely out-thinking the enemy from a distance.
- A key adviser can be the real center of resistance when the commander depends on that adviser for confidence and options.
- The strike works psychologically because it changes the opponent's expectation about future advice, negotiation safety, and assault risk.
- The tactic differs from routine intimidation because it identifies and removes a specific decision-making node.
- The pattern needs force in the background; without credible follow-on attack, the killing would not automatically produce surrender.
- The case is norm-straining because Huangfu Wen is killed while acting in an envoy/adviser role.
...
- [[ForceBackedSurrenderPersuasion|武力背书式劝降]] - broader surrender mechanism that supplies the coercive background for this more targeted strike.
- [[PsychologicalSurrenderTrap|心理劝降陷阱]] - adjacent psychological collapse pattern, but usually through invitation and expectation rather than killing a planning node.
- [[WartimeCommandDecapitation|战时指挥斩首]] - related targeting pattern, but focused on command leadership rather than the adviser's plan-making role.
- [[EnvoyKillingTaboo|不斩来使]] - qualifying norm because this strategy can violate diplomatic or negotiation expectations.
- [[KouXunEasternHan|寇恂]] - actor who performs the current source's clearest example.
- [[HuangfuWenEasternHan|皇甫文]] - adviser whose death provides the concept's direct evidence.
