...
type: concept
tags: [late-han, political-violence, mourning, burial, moral-reputation]
sources:
...
Funerary defiance under political terror is the pattern where mourning, guarding, collecting, or returning a body becomes public resistance because a powerholder has turned death rites into intimidation. The act does not overturn the regime, but it protects reputation, restores minimal ritual dignity, and exposes fear's limit.
...
- A mourning ban can make ordinary grief into a political test.
- Public corpse display seeks to control memory as well as bodies.
- Defiant mourners protect the dead person's reputation by refusing to let intimidation define the final public image.
- Burial recovery can partly reverse symbolic humiliation even when it cannot undo the killing.
- Pardon by a remaining authority figure can convert private courage into a recognized public boundary.
- Withdrawal after burial shows that loyalty may survive while confidence in the court has collapsed.
...
- [[PublicCorpseHumiliation|公开尸体羞辱]] - upstream tactic that makes body display a political message.
- [[RetaliatoryPoliticalTerror|报复性政治恐怖]] - coercive environment that makes mourning dangerous.
- [[MoralReputationPoliticalCapital|道德名望政治资本]] - reputation resource that survives because mourners publicly honor the dead.
- [[PoliticalSurvivalFirst|安全第一政治生存]] - contrasting response because the mourners accept danger before later withdrawing.
- [[DeathDefyingRemonstrance|赴死式直谏]] - adjacent death-facing speech pattern, distinct because this case centers burial duty rather than persuasion.
- [[LoyalMinisterExitEthic|忠臣去国的退场伦理]] - related exit frame for refusing to keep serving a morally damaged court.
