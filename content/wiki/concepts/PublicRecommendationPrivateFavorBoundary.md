...
tags: [court-politics, workplace, personnel, favors, western-han]
sources:
...
举贤不立私恩 / Public Recommendation Private Favor Boundary is the line between recommending capable people for public reasons and converting that public recommendation into a private gratitude, gift, or dependency relationship.
...
- Public recommendation is not automatically private patronage.
- Gifts and gratitude after appointment can recode a public act as personal favor.
- Refusing private thanks can protect both the recommender and the appointee from factional suspicion.
- The ethical point is role clarity: talent selection should remain attached to institutional need.
- The strategy is severe because partial acceptance of the favor relationship can be harder to unwind later.
...
The source gives one anecdote rather than a complete institutional rule. The concept does not forbid mentoring, gratitude, or legitimate reference relationships. It applies where gifts, repeated access, or personal loyalty would make a public recommendation look like faction-building or private exchange.
...
- [[ZhangAnshiWesternHan]] - direct entity case for the recommendation boundary.
- [[SensitivePersonnelRecommendationBoundary]] - related personnel concept about when recommendations themselves become authority overreach.
- [[QuietCreditSelfProtection]] - adjacent no-credit-display strategy in the same episode.
- [[FinancialEmployeeMisconductControls]] - broader institutional-control field around gifts, obligation, and role misuse.
- [[WorkplaceRoleClarityBoundary]] - broader workplace boundary around keeping action inside role and mandate.
