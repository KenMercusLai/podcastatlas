...
type: concept
tags: [warfare, military-strategy, morale, sunzi, chu-han, late-han]
sources:
  ...
  - zizhi-tongjian-hanji-157-hanxin-beishuiyizhan-bingfa-jiedu-1-loiz8ge-a39tmigajool2spzri5i
...
- Forced resolve works only when the commander understands troop morale, enemy choices, terrain, and the likely path of contact.
- Prior intelligence matters because an enemy that refuses the expected fight can turn a no-retreat posture into a self-trap.
- A second surprise or information shock is usually needed so the enemy collapses instead of simply grinding down the committed force.
- Enemy-imposed route blockage can strengthen a trapped army if the blocked commander can convert pressure into morale and deception.
...
## Related Concepts
- [[ReturningArmyInterdictionRisk|归师勿遏式追击风险]] - narrower pursuit-risk pattern that can create death-ground resolve in a returning army.
- [[BattlefieldInformationControl|战场信息控制]] - intelligence and false signals decide whether death-ground pressure becomes usable.
- [[LureEnemyOutOfPosition|诱敌离位]] - false escape can draw the enemy out after a route-blockage setup.
- [[XingshiqingStrategicAssessment|行势情战略评估]] - broader condition-testing frame for whether a copied tactic fits conduct, situation, and human commitments.
- [[MilitaryMoraleThroughSharedHardship|同甘共苦式士气]] - related morale mechanism that explains why shared danger can deepen commitment only under the right conditions.
