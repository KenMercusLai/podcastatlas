...
tags: [succession, court-politics, western-han, governance]
sources:
...
既定太子改立风险 / Established heir replacement risk is the danger that removing a long-recognized crown prince will turn a ruler's personnel judgment into a destabilizing court, family, and institutional crisis.
...
- An established heir can become institutionally costly to replace even when the ruler doubts his ability.
- Alternative heirs become dangerous when their personal fitness encourages factions to imagine a viable replacement path.
- Maternal memory and prior household trauma can protect the existing heir by making replacement morally and politically costly.
-嫡长 status matters because it turns a family preference into a public legitimacy rule.
- The ruler can contain the alternative branch through appointment and instruction instead of formal displacement.
...
This concept currently rests on one Xuan-era source note. It should not be read as a claim that established heirs must always be preserved or that Liu Shi was substantively fit. The source itself presents Liu Shi as a foreseeable governing problem. The concept names the political cost of replacement after a crown-prince line has already become public and emotionally loaded.
...
- [[DeathbedHeirReplacementResistance|临终废储阻断]] - later near-replacement pattern where ministers block a dying ruler's attempt to change an established heir.
- [[AffectionDrivenSuccessionRisk|宠爱驱动的立储风险]] - broader risk field where family preference destabilizes succession.
- [[HaremSuccessionRiskControl|后宫继承风险控制]] - related household-order field where consort hierarchy and heir status must remain legible.
- [[FavoriteDrivenHeirDisplacement|宠幸驱动的废嫡立庶]] - adjacent pattern where favor drives displacement more directly.
- [[DynasticHeirRoleEntrapment|王朝继承人角色困局]] - related heir-role problem where the heir's public status can become hard to escape.
