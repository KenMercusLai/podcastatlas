...
class RepositoryIntegrationTest(unittest.TestCase):
    ...
    def test_generated_wiki_pages_use_wiki_rendering_for_single_and_list_routes(self):
        ...
        self.assertIn("$currentSynthesis.Params.summary", wiki_list)
        self.assertIn("$currentSynthesis.Params.last_updated", wiki_list)
        self.assertIn("$currentSynthesis.Params.episode_count", wiki_list)
        self.assertIn("$currentSynthesis.Params.source_count", wiki_list)
        self.assertIn("wiki-feature-coverage", wiki_list)
        self.assertNotIn("The atlas's evolving account of ideas and claims across all processed podcast sources.", wiki_list)
